        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityReference = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ...
                    ParentEntityType = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTaxEstimated = table.Column<bool>(type: "INTEGER", nullable: false),
                    TaxEstimationReason = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasAccountTerms = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ShowInFeed = table.Column<bool>(type: "INTEGER", nullable: false),
                    FeedPromotionName = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    ...
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true),
                    TargetRulesJson = table.Column<string>(type: "TEXT", nullable: true),
                    EligibilityRulesJson = table.Column<string>(type: "TEXT", nullable: true),
                    BuyXGetYConfigJson = table.Column<string>(type: "TEXT", nullable: true),
                    FreeShippingConfigJson = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplatePath = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ToExpression = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    CcExpression = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    BccExpression = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    FromExpression = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    SubjectExpression = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false),
                    AttachmentAliases = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestHeaders = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    ...
                    EmailRecipients = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    EmailSubject = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    EmailFrom = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderType = table.Column<string>(type: "TEXT", maxLength: 21, nullable: false),
                    LastFetchedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    LastRatesJson = table.Column<string>(type: "TEXT", nullable: true),
                    InventorySyncMode = table.Column<int>(type: "INTEGER", nullable: true),
                    IsTestMode = table.Column<bool>(type: "INTEGER", nullable: true),
                    IsVaultingEnabled = table.Column<bool>(type: "INTEGER", nullable: true),
                    MethodSettingsJson = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    RequiresCustomerComment = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    KeyId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    PublicKeyX = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    PublicKeyY = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Algorithm = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "ES256"),
                    CurveName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false, defaultValue: "P-256")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UcpJson = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuppressIfInCart = table.Column<bool>(type: "INTEGER", nullable: false),
                    DisplayLocation = table.Column<int>(type: "INTEGER", nullable: false),
                    CheckoutMode = table.Column<int>(type: "INTEGER", nullable: false),
                    DefaultChecked = table.Column<bool>(type: "INTEGER", nullable: false),
                    AutoAddToBasket = table.Column<bool>(type: "INTEGER", nullable: false),
                    StartsAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EndsAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Timezone = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    TriggerRulesJson = table.Column<string>(type: "TEXT", nullable: true),
                    RecommendationRulesJson = table.Column<string>(type: "TEXT", nullable: true),
                    EligibilityRulesJson = table.Column<string>(type: "TEXT", nullable: true),
                    DisplayStylesJson = table.Column<string>(type: "TEXT", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "TEXT", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAbandoned = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DateRecovered = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DateConverted = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DateExpired = table.Column<DateTime>(type: "TEXT", nullable: true),
                    RecoveredInvoiceId = table.Column<Guid>(type: "TEXT", nullable: true),
                    RecoveryToken = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    RecoveryTokenExpiresUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    RecoveryEmailsSent = table.Column<int>(type: "INTEGER", nullable: false),
                    LastRecoveryEmailSentUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    BasketTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressOne = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    AddressTwo = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    TownCity = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CountyState = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CountyStateCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Pin = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    CardType = table.Column<int>(type: "INTEGER", nullable: false),
                    InitialBalance = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    CurrentBalance = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    CurrencyCode = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    IsReloadable = table.Column<bool>(type: "INTEGER", nullable: false),
                    PurchasedByCustomerId = table.Column<Guid>(type: "TEXT", nullable: true),
                    IssuedToCustomerId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    PersonalMessage = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    SourceInvoiceId = table.Column<Guid>(type: "TEXT", nullable: true),
                    SourceLineItemId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ActivationDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ExpirationDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PhysicalCardNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderMethodId = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    ProviderCustomerId = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    MethodType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    ConsentDateUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ConsentIpAddress = table.Column<string>(type: "TEXT", maxLength: 45, nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateLastUsed = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultFulfilmentProviderConfigurationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductOptions = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    ShoppingFeedBrand = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ShoppingFeedCondition = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false, defaultValue: "new"),
                    RootImages = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    AllowExternalCarrierShipping = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    ...
                    ElementTypeAlias = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ViewAlias = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    IsSubscriptionProduct = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    SubscriptionBillingInterval = table.Column<int>(type: "INTEGER", nullable: true),
                    SubscriptionBillingIntervalCount = table.Column<int>(type: "INTEGER", nullable: true),
                    SubscriptionTrialDays = table.Column<int>(type: "INTEGER", nullable: true),
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingTaxGroupId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UpsellRuleId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedBy = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingProviderKey = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ShippingServiceCode = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ShippingServiceName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ShippingServiceCategory = table.Column<int>(type: "INTEGER", nullable: true),
                    ShippingCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    QuotedShippingCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: true),
                    ...
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false),
                    FulfilmentProviderConfigurationId = table.Column<Guid>(type: "TEXT", nullable: true),
                    FulfilmentProviderReference = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    FulfilmentSubmittedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    FulfilmentErrorMessage = table.Column<string>(type: "TEXT", nullable: true),
                    FulfilmentRetryCount = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebhookEventId = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Address = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ServiceRegionsJson = table.Column<string>(type: "TEXT", nullable: true),
                    ProviderConfigsJson = table.Column<string>(type: "TEXT", nullable: true),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ShoppingFeedTitle = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ShoppingFeedDescription = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    ...
                    ShoppingFeedBrand = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ShoppingFeedCondition = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true),
                    ShoppingFeedWidth = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    ShoppingFeedHeight = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalAmountInStoreCurrency = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: true),
                    ...
                    TaxGroupId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CustomerId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RmaNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ReturnType = table.Column<int>(type: "INTEGER", nullable: false),
                    CustomerNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    StaffNotes = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ApprovedBy = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ...
                    RefundAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    RestockingFee = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    CurrencyCode = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    RefundAmountInStoreCurrency = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: true),
                    RefundPaymentId = table.Column<Guid>(type: "TEXT", nullable: true),
                    GiftCardId = table.Column<Guid>(type: "TEXT", nullable: true),
                    DateRequested = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateApproved = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DateRejected = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCostsJson = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingWeightTiersJson = table.Column<string>(type: "TEXT", nullable: true),
                    ExcludedRegionsJson = table.Column<string>(type: "TEXT", nullable: true),
                    PostcodeRulesJson = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackStock = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentProviderAlias = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ProviderSubscriptionId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ProviderCustomerId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ProviderPlanId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    ResumeAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ExtendedData = table.Column<string>(type: "TEXT", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalLineItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    RefundAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: false),
                    ReturnReasonId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderInvoiceId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
