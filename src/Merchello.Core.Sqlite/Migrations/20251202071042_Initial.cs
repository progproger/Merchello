        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxRounding = table.Column<int>(type: "INTEGER", nullable: false),
                    SubTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    Discount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    AdjustedSubTotal = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_Company = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddress_AddressOne = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddress_AddressTwo = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddress_TownCity = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddress_CountyState_Name = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddress_CountyState_RegionCode = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    ShippingAddress_CountryCode = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    DeliveryDateSurcharge = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    HexColour = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedCost = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    CostOfGoods = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
                    ...
                    ExcludeFromCustomLabels = table.Column<bool>(type: "INTEGER", nullable: false),
