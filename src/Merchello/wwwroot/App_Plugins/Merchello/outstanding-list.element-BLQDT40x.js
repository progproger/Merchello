import { LitElement as S, nothing as m, html as r, css as w, state as o, customElement as T } from "@umbraco-cms/backoffice/external/lit";
...
import { M as O } from "./merchello-api-B1P1cUX9.js";
import { g as A } from "./store-settings-BBNVgcWv.js";
import { a as f, e as D } from "./formatting-BoIk_URG.js";
...
const z = new C("Merchello.MarkAsPaid.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
let s = class extends x(S) {
  ...
  async _handleMarkAsPaid() {
    ...
    const e = this._getSelectedInvoices(), t = this._getSelectedTotal(), a = await l(this, _)?.open(this, z, {
      data: {
        invoices: e,
...
//# sourceMappingURL=outstanding-list.element-BLQDT40x.js.map
