import { LitElement as C, html as s, nothing as _, css as G, state as f, customElement as z } from "@umbraco-cms/backoffice/external/lit";
...
var O = Object.defineProperty, D = Object.getOwnPropertyDescriptor, $ = (e) => {
  throw TypeError(e);
}, h = (e, i, r, o) => {
  for (var a = o > 1 ? void 0 : o ? D(i, r) : i, c = e.length - 1, b; c >= 0; c--)
    (b = e[c]) && (a = (o ? b(i, r, a) : b(a)) || a);
  return o && a && O(i, r, a), a;
}, w = (e, i, r) => i.has(e) || $("Cannot " + r), t = (e, i, r) => (w(e, i, "read from private field"), r ? r.call(e) : i.get(e)), g = (e, i, r) => i.has(e) ? $("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, r), v = (e, i, r, o) => (w(e, i, "write to private field"), i.set(e, r), r), u, l, n, y, p;
let d = class extends E(C) {
  ...
  connectedCallback() {
    super.connectedCallback(), v(this, n, !0), this._loadFilterGroups();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), v(this, n, !1), t(this, p).clear();
  }
  async _loadFilterGroups() {
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: i } = await m.getFilterGroups();
    if (t(this, n)) {
      if (i) {
  ...
  async _handleGroupReorder(e) {
    const { error: i } = await m.reorderFilterGroups(e);
  ...
  async _handleFilterReorder(e, i) {
    const { error: r } = await m.reorderFilters(e, i);
  ...
  async _handleDeleteFilterGroup(e, i) {
    ...
    const { error: c } = await m.deleteFilterGroup(i.id);
    if (t(this, n)) {
...
//# sourceMappingURL=filters-list.element-CB_Jh7j7.js.map
