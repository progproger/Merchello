...
import { c as G } from "./formatting-6Hz_EImA.js";
...
var S = Object.defineProperty, E = Object.getOwnPropertyDescriptor, v = (e) => {
  ...
  for (var o = i > 1 ? void 0 : i ? E(t, a) : t, g = e.length - 1, m; g >= 0; g--)
    (m = e[g]) && (o = (i ? m(t, a, o) : m(o)) || o);
  return i && o && S(t, a, o), o;
}, b = (e, t, a) => t.has(e) || v("Cannot " + a), n = (e, t, a) => (b(e, t, "read from private field"), t.get(e)), x = (e, t, a) => t.has(e) ? v("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), f = (e, t, a, i) => (b(e, t, "write to private field"), t.set(e, a), a), l, c;
let s = class extends $ {
  constructor() {
    super(), this._name = "", this._taxPercentage = "", this._isSaving = !1, this._errors = {}, this._rates = [], this._isLoadingRates = !1, this._isDeletingRate = null, x(this, l), x(this, c), this.consumeContext(T, (e) => {
      f(this, l, e);
  ...
  async _handleDeleteRate(e) {
    if (!n(this, l)) return;
    const t = e.regionName ? `${e.countryName ?? e.countryCode} - ${e.regionName}` : e.countryName ?? e.countryCode;
    if (!await n(this, l).open(this, C, {
      data: {
    ...
    }).onSubmit().catch(() => null)) return;
    this._isDeletingRate = e.id;
    const { error: o } = await h.deleteTaxGroupRate(e.id);
    if (this._isDeletingRate = null, o) {
      n(this, c)?.peek("danger", {
        data: { headline: "Error", message: o.message }
      });
      return;
    }
    n(this, c)?.peek("positive", {
...
//# sourceMappingURL=tax-group-modal.element-D3ly3__3.js.map
