import { LitElement as C, html as r, nothing as f, css as M, state as l, customElement as z, unsafeHTML as R } from "@umbraco-cms/backoffice/external/lit";
...
import { g as P } from "./formatting-CZRy3TEt.js";
...
}, T = (e, i, t) => i.has(e) || I("Cannot " + t), x = (e, i, t) => (T(e, i, "read from private field"), i.get(e)), B = (e, i, t) => i.has(e) ? I("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), $ = (e, i, t, a) => (T(e, i, "write to private field"), i.set(e, t), t), m;
let n = class extends S(C) {
  ...
  connectedCallback() {
    super.connectedCallback(), $(this, m, !0), this._loadProviders(), this._loadLogs();
  }
        ...
        ${a ? r`
              <div class="webhook-url-section">
                ...
                <div class="webhook-url-row">
                  ...
                  <uui-button look="secondary" compact @click=${() => this._copyToClipboard(o)}>
                    Copy
                  </uui-button>
                </div>
              </div>
...
//# sourceMappingURL=fulfilment-providers-list.element-CXi7oLf8.js.map
