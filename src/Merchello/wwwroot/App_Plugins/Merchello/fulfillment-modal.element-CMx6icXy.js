import { nothing as m, html as o, css as k, state as p, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as I } from "@umbraco-cms/backoffice/modal";
import { M as f } from "./merchello-api-C2InYbkz.js";
import { b as S } from "./formatting-33NafgjJ.js";
var $ = Object.defineProperty, z = Object.getOwnPropertyDescriptor, b = (t) => {
  throw TypeError(t);
}, d = (t, e, i, r) => {
  for (var s = r > 1 ? void 0 : r ? z(e, i) : e, a = t.length - 1, c; a >= 0; a--)
    (c = t[a]) && (s = (r ? c(e, i, s) : c(s)) || s);
  return r && s && $(e, i, s), s;
}, y = (t, e, i) => e.has(t) || b("Cannot " + i), g = (t, e, i) => (y(t, e, "read from private field"), e.get(t)), C = (t, e, i) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), _ = (t, e, i, r) => (y(t, e, "write to private field"), e.set(t, i), i), h;
let l = class extends I {
  ...
  connectedCallback() {
    super.connectedCallback(), _(this, h, !0), this._loadFulfillmentSummary();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), _(this, h, !1);
  }
      ...
      ({ shipment: e, warehouseName: i }) => o`
                    <div class="existing-shipment-card">
                      <div class="existing-shipment-header">
                        ...
                        <span class="date">${S(e.dateCreated)}</span>
                      </div>
...
//# sourceMappingURL=fulfillment-modal.element-CMx6icXy.js.map
