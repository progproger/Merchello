import { LitElement as T, nothing as g, html as n, css as w, state as c, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
import { M as h } from "./merchello-api-Cd16th0c.js";
import { g as A } from "./store-settings-Dmd0ngDF.js";
import { c as f, e as D } from "./formatting-CbhqdYyc.js";
import { l as M } from "./navigation-DfYj5Lv5.js";
import { M as S, a as E } from "./webhook-test-modal.token-BJ36MIGK.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
var L = Object.defineProperty, W = Object.getOwnPropertyDescriptor, k = (e) => {
  throw TypeError(e);
}, r = (e, t, i, o) => {
  for (var l = o > 1 ? void 0 : o ? W(t, i) : t, b = e.length - 1, _; b >= 0; b--)
    (_ = e[b]) && (l = (o ? _(t, i, l) : _(l)) || l);
  return o && l && L(t, i, l), l;
}, y = (e, t, i) => t.has(e) || k("Cannot " + i), a = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), m = (e, t, i) => t.has(e) ? k("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), v = (e, t, i, o) => (y(e, t, "write to private field"), t.set(e, i), i), p, d, u;
let s = class extends x(T) {
  constructor() {
    super(), this._subscriptions = [], this._categories = [], this._stats = null, this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._searchTerm = "", this._activeTab = "all", this._searchDebounceTimer = null, m(this, p), m(this, d), m(this, u, !1), this.consumeContext(C, (e) => {
      v(this, p, e);
  ...
  async _initializeAndLoad() {
    ...
    const { data: t } = await h.getWebhookTopicsByCategory();
    if (!a(this, u)) return;
    t && (this._categories = t);
    const { data: i } = await h.getWebhookStats();
  ...
  async _loadSubscriptions() {
    ...
    const { data: t, error: i } = await h.getWebhookSubscriptions(e);
    if (a(this, u)) {
      if (i) {
  ...
  async _handleEditSubscription(e, t) {
    if (e.preventDefault(), e.stopPropagation(), !a(this, d)) return;
    const { data: i } = await h.getWebhookSubscription(t.id);
    if (!i) return;
    (await a(this, d).open(this, S, {
      data: {
        subscription: i,
        topics: this._categories
      }
  ...
  async _handleTestSubscription(e, t) {
    e.preventDefault(), e.stopPropagation(), a(this, d) && a(this, d).open(this, E, {
      data: { subscription: t }
    });
  }
  async _handleToggleActive(e, t) {
    ...
    const { error: l } = await h.updateWebhookSubscription(t.id, {
      isActive: !t.isActive
    });
  ...
  async _handleDeleteSubscription(e, t) {
    if (e.preventDefault(), e.stopPropagation(), !confirm(`Delete webhook "${t.name}"? This cannot be undone.`))
      return;
    const { error: i } = await h.deleteWebhookSubscription(t.id);
    if (!a(this, u)) return;
    if (i) {
    ...
    const { data: o } = await h.getWebhookStats();
    o && (this._stats = o);
  }
  ...
  _renderSubscriptionRow(e) {
    return n`
      <uui-table-row class="clickable" @click=${() => this._handleViewDeliveries(e)}>
        ...
        <uui-table-cell>
          ${e.lastTriggeredUtc ? D(e.lastTriggeredUtc) : "Never"}
        </uui-table-cell>
        <uui-table-cell class="center">
...
//# sourceMappingURL=webhooks-list.element-DKB5n6J2.js.map
