import { nothing as i, html as s, css as m, state as p, customElement as b } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as x } from "@umbraco-cms/backoffice/modal";
import { M as _ } from "./merchello-api-Bc5VtWiv.js";
var y = Object.defineProperty, z = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, c = (e, r, a, o) => {
  for (var t = o > 1 ? void 0 : o ? z(r, a) : r, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (t = (o ? u(r, a, t) : u(t)) || t);
  return o && t && y(r, a, t), t;
}, g = (e, r, a) => r.has(e) || f("Cannot " + a), $ = (e, r, a) => (g(e, r, "read from private field"), r.get(e)), w = (e, r, a) => r.has(e) ? f("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, a), v = (e, r, a, o) => (g(e, r, "write to private field"), r.set(e, a), a), d;
let l = class extends x {
  constructor() {
    super(...arguments), this._isTesting = !1, this._errorMessage = null, w(this, d, !1);
  }
  connectedCallback() {
    super.connectedCallback(), v(this, d, !0);
  }
  ...
  async _handleTest() {
    ...
    const { data: r, error: a } = await _.testExchangeRateProvider(e.alias);
    if ($(this, d)) {
      if (a) {
  ...
  _formatRate(e) {
    return e >= 100 ? e.toFixed(2) : e >= 1 ? e.toFixed(4) : e.toFixed(6);
  }
  _renderProviderInfo() {
    const e = this.data?.provider;
    return e ? s`
  ...
  _renderResults() {
    ...
    const { success: e, errorMessage: r, baseCurrency: a, sampleRates: o, rateTimestamp: t, totalRatesCount: n } = this._testResult;
    return s`
...
l = c([
  b("merchello-exchange-rate-provider-test-modal")
], l);
const R = l;
export {
...
//# sourceMappingURL=test-provider-modal.element-CoyigyDY.js.map
