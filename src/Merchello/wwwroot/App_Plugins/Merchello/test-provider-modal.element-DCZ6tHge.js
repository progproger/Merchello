...
var b = /* @__PURE__ */ ((e) => (e[e.Pending = 0] = "Pending", e[e.Running = 1] = "Running", e[e.Completed = 2] = "Completed", e[e.Failed = 3] = "Failed", e))(b || {}), $ = Object.defineProperty, w = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, n = (e, t, i, u) => {
  for (var l = u > 1 ? void 0 : u ? w(t, i) : t, c = e.length - 1, v; c >= 0; c--)
    (v = e[c]) && (l = (u ? v(t, i, l) : v(l)) || l);
  return u && l && $(t, i, l), l;
}, y = (e, t, i) => t.has(e) || _("Cannot " + i), h = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), T = (e, t, i) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), m = (e, t, i, u) => (y(e, t, "write to private field"), t.set(e, i), i), d;
let o = class extends f {
  constructor() {
    super(...arguments), this._activeTab = "connection", this._isTestingConnection = !1, this._connectionError = null, this._isSubmittingOrder = !1, this._orderSubmissionError = null, this._testOrderNumber = "", this._testOrderCustomerEmail = "test@example.com", this._testOrderSku = "TEST-SKU-001", this._testOrderName = "Test Product", this._testOrderQuantity = 1, this._testOrderUnitPrice = 10, this._testOrderUseRealSandbox = !0, this._isLoadingWebhookTemplates = !1, this._webhookTemplates = [], this._selectedWebhookEvent = "", this._webhookProviderReference = "", this._webhookProviderShipmentId = "", this._webhookTrackingNumber = "", this._webhookCarrier = "", this._webhookCustomPayload = "", this._isSimulatingWebhook = !1, this._webhookSimulationError = null, this._isSyncingProducts = !1, this._productSyncError = null, this._isSyncingInventory = !1, this._inventorySyncError = null, T(this, d, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=test-provider-modal.element-DCZ6tHge.js.map
