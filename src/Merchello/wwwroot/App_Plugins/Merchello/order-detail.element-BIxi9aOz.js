import { LitElement as G, nothing as s, html as a, css as V, state as n, customElement as j, property as Z, unsafeHTML as ce } from "@umbraco-cms/backoffice/external/lit";
...
import { UMB_CURRENT_USER_CONTEXT as me } from "@umbraco-cms/backoffice/current-user";
...
import { S as H, b as L, P as K, a as p, h as te, j as fe } from "./formatting-D5bm7SYx.js";
...
var xe = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, ae = (e) => {
  ...
  for (var r = o > 1 ? void 0 : o ? $e(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && xe(i, t, r), r;
}, re = (e, i, t) => i.has(e) || ae("Cannot " + t), u = (e, i, t) => (re(e, i, "read from private field"), t ? t.call(e) : i.get(e)), U = (e, i, t) => i.has(e) ? ae("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), T = (e, i, t, o) => (re(e, i, "write to private field"), i.set(e, t), t), S, M, x, y;
let w = class extends B(G) {
  ...
  async _handleMarkAsShipped(e) {
    ...
    const { error: i } = await h.updateShipmentStatus(e.id, {
      newStatus: H.Shipped,
  ...
  async _handleCancelShipment(e) {
    ...
    if (!u(this, y)) return;
    this._isUpdatingStatus = !0;
    const { error: t } = await h.updateShipmentStatus(e.id, {
      ...
      (r) => a`
              <div class="item-row">
                ...
                <div class="item-info">
                  ...
                  ${r.sku ? a`<div class="item-sku">${r.sku}</div>` : s}
                </div>
...
var Se = Object.defineProperty, ze = Object.getOwnPropertyDescriptor, se = (e) => {
  ...
  for (var r = o > 1 ? void 0 : o ? ze(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && Se(i, t, r), r;
}, oe = (e, i, t) => i.has(e) || se("Cannot " + t), E = (e, i, t) => (oe(e, i, "read from private field"), i.get(e)), J = (e, i, t) => i.has(e) ? se("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), W = (e, i, t, o) => (oe(e, i, "write to private field"), i.set(e, t), t), I, A;
...
var Pe = Object.defineProperty, Me = Object.getOwnPropertyDescriptor, ne = (e) => {
  ...
  for (var r = o > 1 ? void 0 : o ? Me(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && Pe(i, t, r), r;
}, le = (e, i, t) => i.has(e) || ne("Cannot " + t), D = (e, i, t) => (le(e, i, "read from private field"), i.get(e)), Ie = (e, i, t) => i.has(e) ? ne("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (le(e, i, "write to private field"), i.set(e, t), t), $;
...
var Ee = Object.defineProperty, De = Object.getOwnPropertyDescriptor, de = (e) => {
  ...
  for (var r = o > 1 ? void 0 : o ? De(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && Ee(i, t, r), r;
}, ue = (e, i, t) => i.has(e) || de("Cannot " + t), l = (e, i, t) => (ue(e, i, "read from private field"), i.get(e)), R = (e, i, t) => i.has(e) ? de("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), F = (e, i, t, o) => (ue(e, i, "write to private field"), i.set(e, t), t), f, g, b, k;
let c = class extends B(G) {
      ...
      (r) => a`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-details">
                  <div class="fulfillment-item-name">${r.productRootName || r.name}</div>
                  ${r.selectedOptions?.length ? a`
                    <div class="fulfillment-item-options">
                      ${r.selectedOptions.map((d) => a`
                        <span class="fulfillment-item-option">${d.optionName}: ${d.valueName}</span>
                      `)}
                    </div>
                  ` : s}
                  <div class="fulfillment-item-sku">${r.sku || ""}</div>
                </div>
  ...
  _groupNotesByDate(e) {
    ...
    for (const o of t) {
      const r = new Date(o.date), d = this._getDateGroupLabel(r);
...
//# sourceMappingURL=order-detail.element-BIxi9aOz.js.map
