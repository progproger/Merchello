...
const w = {
  ...
  downloadCustomerStatement: async (e, t, s) => {
    try {
      ...
      const u = c.toString(), S = `${a}${m}/customers/${e}/statement${u ? `?${u}` : ""}`, g = await fetch(S, {
        method: "GET",
        credentials: d.credentials,
      ...
      const P = await g.blob(), v = g.headers.get("content-disposition");
      let y = "statement.pdf";
      if (v) {
...
//# sourceMappingURL=merchello-api-BT8AWvQk.js.map
