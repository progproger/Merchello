...
const P = new C("Merchello.ServiceRegion.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), L = new C("Merchello.ShippingOption.Detail.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
...
var N = Object.defineProperty, W = Object.getOwnPropertyDescriptor, $ = (e) => {
  ...
  for (var o = m > 1 ? void 0 : m ? W(i, a) : i, g = e.length - 1, _; g >= 0; g--)
    (_ = e[g]) && (o = (m ? _(i, a, o) : _(o)) || o);
  return m && o && N(i, a, o), o;
...
let n = class extends k(x) {
  ...
  async _openServiceRegionModal(e) {
    ...
    const a = await t(this, p).open(this, P, {
      data: {
  ...
  _renderOptionRow(e) {
    ...
    let o;
    return a ? o = "Live Rates" : e.fixedCost != null ? o = `$${e.fixedCost.toFixed(2)}` : e.costCount > 0 ? o = `${e.costCount} location(s)` : o = "—", s`
...
//# sourceMappingURL=warehouse-detail.element-cvYii8v1.js.map
