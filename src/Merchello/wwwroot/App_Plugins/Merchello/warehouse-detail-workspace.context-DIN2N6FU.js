...
import { M as h } from "./merchello-api-Z_Hs6xGH.js";
class m extends r {
  constructor(e) {
    super(e, o.toString()), this.workspaceAlias = "Merchello.Warehouse.Detail.Workspace", this.#t = !1, this.#s = new n(void 0), this.warehouse = this.#s.asObservable(), this.routes = new i(e), this.provideContext(o, this), this.routes.setRoutes([
      {
        path: "create",
        component: () => import("./warehouse-detail.element-s14MHaOK.js"),
        setup: () => {
...
//# sourceMappingURL=warehouse-detail-workspace.context-DIN2N6FU.js.map
