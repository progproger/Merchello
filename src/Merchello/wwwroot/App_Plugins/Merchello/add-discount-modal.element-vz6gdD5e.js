import { nothing as c, html as o, css as m, state as u, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as f } from "@umbraco-cms/backoffice/modal";
import { D as r, c as h } from "./formatting-BB_-NCdW.js";
import { M as _ } from "./merchello-api-B1skiL_A.js";
var y = Object.defineProperty, b = Object.getOwnPropertyDescriptor, a = (e, i, n, l) => {
  for (var t = l > 1 ? void 0 : l ? b(i, n) : i, d = e.length - 1, p; d >= 0; d--)
    (p = e[d]) && (t = (l ? p(i, n, t) : p(t)) || t);
  return l && t && y(i, n, t), t;
};
let s = class extends f {
  constructor() {
    super(...arguments), this._discountType = r.FixedAmount, this._discountValue = 0, this._discountReason = "", this._isVisibleToCustomer = !1, this._errors = {}, this._discountPreview = null, this._isLoadingPreview = !1, this._previewDebounceTimer = null;
  }
  connectedCallback() {
  ...
  _validate() {
    const e = {};
    return this._discountValue <= 0 && (e.value = "Discount value must be greater than 0"), this._discountType === r.Percentage && this._discountValue > 100 && (e.value = "Percentage cannot exceed 100%"), this._errors = e, Object.keys(e).length === 0;
  }
  _handleApply() {
  ...
  _getDiscountTypeOptions() {
    return [
      { name: "Fixed amount", value: "0", selected: this._discountType === r.FixedAmount },
      { name: "Percentage", value: "1", selected: this._discountType === r.Percentage }
    ];
  }
  /**
  ...
  _refreshDiscountPreview() {
    ...
    this._previewDebounceTimer && clearTimeout(this._previewDebounceTimer), this._previewDebounceTimer = setTimeout(async () => {
      ...
      try {
        ...
        i ? (console.error("Failed to preview discount:", i), this._discountPreview = null) : e && (this._discountPreview = {
          discountAmount: e.discountAmount
        });
      } catch (e) {
        console.error("Unexpected error previewing discount:", e), this._discountPreview = null;
      } finally {
        ...
        <div id="main">
          ...
          <div class="form-row">
            <label for="discount-value">
              Value ${this._discountType === r.Percentage ? "(%)" : i ? "" : "(per unit)"}
            </label>
            <div class="input-with-affix">
              ${this._discountType === r.FixedAmount ? o`<span class="prefix">${e}</span>` : c}
              <uui-input
                id="discount-value"
                type="number"
                ...
                step="0.01"
              ></uui-input>
              ${this._discountType === r.Percentage ? o`<span class="suffix">%</span>` : c}
            </div>
            ${this._errors.value ? o`<span class="error">${this._errors.value}</span>` : c}
          </div>
...
//# sourceMappingURL=add-discount-modal.element-vz6gdD5e.js.map
