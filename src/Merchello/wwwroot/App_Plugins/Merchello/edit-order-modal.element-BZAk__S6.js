...
import { D as h } from "./order.types-vEwMhKjb.js";
...
let a = class extends I {
  ...
  _getOptimisticLineItemTotal(e, i, o) {
    const t = e * i;
    return !o || o.value <= 0 ? t : o.type === h.FixedAmount ? Math.max(0, t - o.value * i) : t * (1 - o.value / 100);
  }
  /**
   * Calculate the discounted unit price for display.
   */
  _getDiscountedUnitPrice(e) {
    return !e.discount || e.discount.value <= 0 ? e.amount : e.discount.type === h.FixedAmount ? Math.max(0, e.amount - e.discount.value) : e.amount * (1 - e.discount.value / 100);
  }
...
//# sourceMappingURL=edit-order-modal.element-BZAk__S6.js.map
