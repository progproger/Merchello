...
import { b as m } from "./badge.styles-B9Lnx6kD.js";
var _ = Object.defineProperty, b = Object.getOwnPropertyDescriptor, t = (e, i, o, s) => {
  for (var a = s > 1 ? void 0 : s ? b(i, o) : i, c = e.length - 1, l; c >= 0; c--)
    (l = e[c]) && (a = (s ? l(i, o, a) : l(a)) || a);
...
t([
  n()
], r.prototype, "_regionCode", 2);
t([
  n()
], r.prototype, "_isExcluded", 2);
t([
  n()
], r.prototype, "_countries", 2);
t([
  n()
], r.prototype, "_regions", 2);
t([
  n()
], r.prototype, "_isLoadingRegions", 2);
t([
  n()
...
const S = r;
export {
  r as MerchelloServiceRegionModalElement,
  S as default
};
//# sourceMappingURL=service-region-modal.element-D5_6Knhu.js.map
