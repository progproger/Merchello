...
}, U = (e, t, i) => t.has(e) || q("Cannot " + i), d = (e, t, i) => (U(e, t, "read from private field"), t.get(e)), E = (e, t, i) => t.has(e) ? q("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), P = (e, t, i, r) => (U(e, t, "write to private field"), t.set(e, i), i), w, v, I, F;
const k = 5;
let h = class extends K(J) {
  constructor() {
    super(), this._isNew = !0, this._isLoading = !0, this._isSaving = !1, this._isRebuilding = !1, this._isPreviewLoading = !1, this._isRegeneratingToken = !1, this._loadError = null, this._validationErrors = {}, this._productTypes = [], this._collections = [], this._filterGroups = [], this._resolvers = [], this._countries = [], this._routes = [], this._activePath = "", this._customLabelArgsText = Array.from({ length: k }, () => "{}"), this._customLabelArgsErrors = Array.from({ length: k }, () => ""), this._customFieldArgsText = [], this._customFieldArgsErrors = [], this._isSlugManuallyEdited = !1, E(this, w), E(this, v), E(this, I), E(this, F, !1), this._initRoutes(), this.consumeContext(Y, (e) => {
      P(this, w, e), d(this, w) && (this._isNew = d(this, w).isNew, this.observe(d(this, w).feed, (t) => {
        t && this._applyFeed(t);
  ...
  _buildSelectionQueryInfo(e) {
    const t = this._resolveNamesByIds(this._productTypes, e.productTypeIds), i = this._resolveNamesByIds(this._collections, e.collectionIds), r = e.filterValueGroups.map((u) => {
      const n = this._filterGroups.find((C) => C.id === u.filterGroupId), b = this._resolveNamesByIds(n?.filters ?? [], u.filterIds);
      return {
  ...
  async _handleSave() {
    ...
    if (this._isNew) {
      ...
      this._isNew = !1, this._applyFeed(r), d(this, w)?.updateFeed(r), d(this, v)?.peek("positive", {
        data: {
    ...
    this._applyFeed(t), d(this, w)?.updateFeed(t), d(this, v)?.peek("positive", {
      data: {
        headline: "Feed saved",
  ...
  async _reloadCurrentFeed() {
    ...
    !d(this, F) || !e || (this._applyFeed(e), d(this, w)?.updateFeed(e));
  }
        ...
        ${p > 0 ? s`
              <div class="selection-toolbar">
                <div class="selection-meta">
                  <span class="selection-count">${C}</span>
            ...
            <div class="grid two-col-grid">
              <umb-property-layout label="Source Type">
                <uui-select
                  ...
                  @change=${(b) => this._updateCustomLabel(e.slot, (C) => ({
        ...C,
                  ...
                  ` : s`
                    <umb-property-layout label="Static Value">
                      <uui-input
                        slot="editor"
                        .value=${e.staticValue ?? ""}
                        @input=${(b) => this._updateCustomLabel(e.slot, (C) => ({
        ...C,
                    ...
                    ${p && u ? s`
                          <umb-property-layout label="Resolver Parameters (JSON)" class="full-row">
                            ...
                            ${o ? s`<p class="error-message">${o}</p>` : s`
                                  <p class="hint">${b}</p>
                                  <p class="hint">Example: <code>${C}</code></p>
                                `}
                          </umb-property-layout>
                        ` : c}
                  </div>
...
//# sourceMappingURL=product-feed-detail.element-erpM2v5k.js.map
