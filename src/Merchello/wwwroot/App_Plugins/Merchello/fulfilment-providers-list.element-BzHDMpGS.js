import { LitElement as C, html as r, nothing as b, css as $, state as o, customElement as z, unsafeHTML as A } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as S } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as L, UMB_MODAL_MANAGER_CONTEXT as O, UMB_CONFIRM_MODAL as R } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as N } from "@umbraco-cms/backoffice/notification";
import { M as _ } from "./merchello-api-DFeoGYDY.js";
import { g as x } from "./formatting-DPh4-DfL.js";
...
var U = Object.defineProperty, V = Object.getOwnPropertyDescriptor, I = (e) => {
  throw TypeError(e);
}, u = (e, i, t, s) => {
  for (var a = s > 1 ? void 0 : s ? V(i, t) : i, v = e.length - 1, g; v >= 0; v--)
    (g = e[v]) && (a = (s ? g(i, t, a) : g(a)) || a);
  return s && a && U(i, t, a), a;
}, F = (e, i, t) => i.has(e) || I("Cannot " + t), M = (e, i, t) => (F(e, i, "read from private field"), i.get(e)), H = (e, i, t) => i.has(e) ? I("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), P = (e, i, t, s) => (F(e, i, "write to private field"), i.set(e, t), t), m;
let n = class extends S(C) {
  constructor() {
    super(...arguments), this._logs = [], this._providers = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 20, this._totalItems = 0, this._totalPages = 0, this._filterProviderConfigId = "", this._filterSyncType = "", this._filterStatus = "", H(this, m, !1);
  }
  connectedCallback() {
    super.connectedCallback(), P(this, m, !0), this._loadProviders(), this._loadLogs();
  }
            ...
            <uui-table-row>
              ...
              <uui-table-cell>
                <span class="items-summary">
                  ...
                  ${e.itemsFailed > 0 ? r`<span class="failed-count">(${e.itemsFailed} failed)</span>` : b}
                </span>
              </uui-table-cell>
...
n = u([
  z("merchello-sync-logs-list")
], n);
var W = Object.defineProperty, G = Object.getOwnPropertyDescriptor, T = (e) => {
  throw TypeError(e);
}, y = (e, i, t, s) => {
  for (var a = s > 1 ? void 0 : s ? G(i, t) : i, v = e.length - 1, g; v >= 0; v--)
    (g = e[v]) && (a = (s ? g(i, t, a) : g(a)) || a);
  return s && a && W(i, t, a), a;
}, E = (e, i, t) => i.has(e) || T("Cannot " + t), l = (e, i, t) => (E(e, i, "read from private field"), i.get(e)), k = (e, i, t) => i.has(e) ? T("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), w = (e, i, t, s) => (E(e, i, "write to private field"), i.set(e, t), t), p, f, c;
const K = "supplier-direct";
let h = class extends S(C) {
  constructor() {
    super(), this._availableProviders = [], this._configuredProviders = [], this._isLoading = !0, this._errorMessage = null, k(this, p), k(this, f), k(this, c, !1), this.consumeContext(O, (e) => {
      w(this, p, e);
  ...
  connectedCallback() {
    super.connectedCallback(), w(this, c, !0), this._loadProviders();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), w(this, c, !1);
  }
  async _loadProviders() {
    this._isLoading = !0, this._errorMessage = null;
    try {
  ...
  async _toggleProvider(e) {
    ...
    if (l(this, c)) {
      if (i) {
        l(this, f)?.peek("danger", {
          data: { headline: "Error", message: i.message }
        });
        return;
      }
      l(this, f)?.peek("positive", {
        data: {
          headline: "Success",
  ...
  _openTestModal(e) {
    l(this, p) && l(this, p).open(this, B, {
      data: { provider: e }
    });
  }
  _renderProviderIcon(e, i, t) {
    const s = i ?? j(e);
    return s ? r`<span class="provider-icon-svg">${A(s)}</span>` : r`<uui-icon name="${t ?? "icon-box"}"></uui-icon>`;
  }
  _renderConfiguredProvider(e) {
    const i = this._availableProviders.find((s) => s.key === e.key), t = e.key !== K;
    return r`
      <div class="provider-card configured">
        ...
        ${e.description ? r`<p class="provider-description">${e.description}</p>` : b}
      </div>
    `;
  }
...
h = y([
  z("merchello-fulfilment-providers-list")
], h);
const ee = h;
export {
...
//# sourceMappingURL=fulfilment-providers-list.element-BzHDMpGS.js.map
