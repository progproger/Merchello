import { LitElement as w, nothing as g, html as n, css as T, state as h, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as $ } from "@umbraco-cms/backoffice/element-api";
import { UMB_NOTIFICATION_CONTEXT as C } from "@umbraco-cms/backoffice/notification";
import { UMB_MODAL_MANAGER_CONTEXT as A, UMB_CONFIRM_MODAL as z } from "@umbraco-cms/backoffice/modal";
import { M as p } from "./merchello-api-B1P1cUX9.js";
import { g as D } from "./store-settings-BBNVgcWv.js";
import { c as f, e as M } from "./formatting-BoIk_URG.js";
...
var P = Object.defineProperty, O = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, r = (e, t, i, o) => {
  for (var l = o > 1 ? void 0 : o ? O(t, i) : t, b = e.length - 1, v; b >= 0; b--)
    (v = e[b]) && (l = (o ? v(t, i, l) : v(l)) || l);
  return o && l && P(t, i, l), l;
  ...
  _renderSubscriptionRow(e) {
    return n`
      <uui-table-row class="clickable" @click=${() => this._handleViewDeliveries(e)}>
        ...
        <uui-table-cell>
          ${e.lastTriggeredUtc ? M(e.lastTriggeredUtc) : "Never"}
        </uui-table-cell>
        <uui-table-cell class="center">
...
//# sourceMappingURL=webhooks-list.element-DBp6l6ME.js.map
