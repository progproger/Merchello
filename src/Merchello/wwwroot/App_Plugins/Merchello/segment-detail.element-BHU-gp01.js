import { LitElement as A, html as r, nothing as d, css as P, property as z, state as o, customElement as k } from "@umbraco-cms/backoffice/external/lit";
...
import { M as f } from "./merchello-api-CCwReUh_.js";
import { o as re, p as se } from "./navigation-m-idaC9i.js";
import { UmbModalToken as oe, UMB_MODAL_MANAGER_CONTEXT as ne } from "@umbraco-cms/backoffice/modal";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { a as le } from "./formatting-BChIOrzE.js";
import { b as ue } from "./store-settings-BMDirEo-.js";
const de = new oe("Merchello.CustomerPicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var ce = Object.defineProperty, he = Object.getOwnPropertyDescriptor, X = (e) => {
  ...
  for (var s = a > 1 ? void 0 : a ? he(t, i) : t, n = e.length - 1, l; n >= 0; n--)
    (l = e[n]) && (s = (a ? l(t, i, s) : l(s)) || s);
  return a && s && ce(t, i, s), s;
}, K = (e, t, i) => t.has(e) || X("Cannot " + i), v = (e, t, i) => (K(e, t, "read from private field"), t.get(e)), R = (e, t, i) => t.has(e) ? X("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), D = (e, t, i, a) => (K(e, t, "write to private field"), t.set(e, i), i), I, w, $;
let c = class extends T(A) {
  constructor() {
    super(), this.segmentId = "", this._members = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._removingIds = /* @__PURE__ */ new Set(), R(this, I), R(this, w), R(this, $, !1), this.consumeContext(ne, (e) => {
      D(this, I, e);
  ...
  connectedCallback() {
    super.connectedCallback(), D(this, $, !0), this.segmentId && this._loadMembers();
  }
  ...
  async _loadMembers() {
    ...
    const { data: e, error: t } = await f.getSegmentMembers(
      this.segmentId,
      this._page,
      this._pageSize
    );
  ...
  async _handleAddMembers() {
    const e = this._members.map((a) => a.customerId), i = await v(this, I)?.open(this, de, {
      data: {
    ...
    if (v(this, $) && i?.selectedCustomerIds?.length) {
      const { error: a } = await f.addSegmentMembers(this.segmentId, {
        customerIds: i.selectedCustomerIds
      });
      if (a) {
        v(this, w)?.peek("danger", {
          data: { headline: "Add failed", message: a.message }
        });
        return;
      }
      v(this, w)?.peek("positive", {
        data: {
  ...
  async _handleRemoveMember(e) {
    if (!confirm(`Remove ${e.customerName || e.customerEmail} from this segment?`))
      return;
    this._removingIds = /* @__PURE__ */ new Set([...this._removingIds, e.customerId]);
    const { error: t } = await f.removeSegmentMembers(this.segmentId, {
      customerIds: [e.customerId]
    });
    if (v(this, $)) {
      if (this._removingIds = new Set([...this._removingIds].filter((i) => i !== e.customerId)), t) {
        v(this, w)?.peek("danger", {
          data: { headline: "Remove failed", message: t.message }
        });
        return;
      }
      v(this, w)?.peek("positive", {
      ...
      <uui-table-row>
        ...
        <uui-table-cell>
          <uui-button
            ...
            ${t ? r`<uui-loader-circle></uui-loader-circle>` : r`<uui-icon name="icon-delete"></uui-icon>`}
          </uui-button>
        </uui-table-cell>
      </uui-table-row>
    `;
  ...
  render() {
    return r`
      <div class="members-container">
        ...
        <!-- Pagination -->
        ${this._members.length > 0 && !this._isLoading ? r`
...
var me = Object.defineProperty, pe = Object.getOwnPropertyDescriptor, J = (e) => {
  ...
  for (var s = a > 1 ? void 0 : a ? pe(t, i) : t, n = e.length - 1, l; n >= 0; n--)
    (l = e[n]) && (s = (a ? l(t, i, s) : l(s)) || s);
  return a && s && me(t, i, s), s;
...
let y = class extends T(A) {
  constructor() {
    super(...arguments), this.criteria = [], this.matchMode = "All", this._criteriaRows = [], this._availableFields = [], this._isLoadingFields = !0, F(this, x, !1), F(this, E, 0);
  }
  connectedCallback() {
    super.connectedCallback(), L(this, x, !0), this._loadAvailableFields(), this._initializeCriteriaRows();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), L(this, x, !1);
  }
  updated(e) {
  ...
  async _loadAvailableFields() {
    ...
    const { data: e, error: t } = await f.getCriteriaFields();
    if (Y(this, x)) {
      if (t) {
        console.error("Failed to load criteria fields:", t), this._isLoadingFields = !1;
        return;
      }
  ...
  _updateCriterion(e, t) {
    this._criteriaRows = this._criteriaRows.map((i) => {
      ...
      if (t.field && t.field !== i.field) {
        const s = this._getOperatorsForField(t.field);
        a.operator = s[0] ?? "Equals", a.value = null, a.value2 = void 0;
      }
      return t.operator && t.operator !== "Between" && (a.value2 = void 0), a;
    }), this._emitChange();
  }
  _emitChange() {
    const e = this._criteriaRows.map(({ field: t, operator: i, value: a, value2: s }) => ({
      field: t,
      operator: i,
      value: a,
      value2: s
  ...
  _renderValueInput(e) {
    if (e.operator === "IsEmpty" || e.operator === "IsNotEmpty")
      return d;
    const i = this._getFieldMetadata(e.field)?.valueType ?? "String", a = i === "Number" || i === "Currency" ? "number" : i === "Date" ? "date" : "text", s = (n, l) => r`
      <uui-input
        type=${a}
        .value=${n ?? ""}
        @input=${(ie) => {
      const O = ie.target;
      let N = O.value;
      a === "number" && (N = O.value ? Number(O.value) : null), l(N);
    }}
        placeholder=${i === "Currency" ? "Amount" : i === "Date" ? "Select date" : "Value"}>
      </uui-input>
    `;
    return e.operator === "Between" ? r`
        <div class="between-inputs">
          ${s(e.value, (n) => this._updateCriterion(e.id, { value: n }))}
          <span class="between-and">and</span>
          ${s(e.value2, (n) => this._updateCriterion(e.id, { value2: n }))}
        </div>
      ` : s(e.value, (n) => this._updateCriterion(e.id, { value: n }));
  }
  ...
  render() {
    return this._isLoadingFields ? r`<div class="loading"><uui-loader></uui-loader></div>` : r`
      <uui-box headline="Criteria Rules">
        <div class="criteria-builder">
          ...
          ${this._criteriaRows.length === 0 ? r`<p class="empty-hint">No criteria defined. Add conditions to filter customers.</p>` : r`
...
M([
  z({ type: Array })
], y.prototype, "criteria", 2);
M([
  z({ type: String })
], y.prototype, "matchMode", 2);
M([
  o()
], y.prototype, "_criteriaRows", 2);
M([
  o()
], y.prototype, "_availableFields", 2);
M([
  o()
], y.prototype, "_isLoadingFields", 2);
y = M([
...
var _e = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, Z = (e) => {
  ...
  for (var s = a > 1 ? void 0 : a ? ge(t, i) : t, n = e.length - 1, l; n >= 0; n--)
    (l = e[n]) && (s = (a ? l(t, i, s) : l(s)) || s);
  return a && s && _e(t, i, s), s;
...
let u = class extends T(A) {
  ...
  async _loadPreview() {
    if (!this.segmentId) return;
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: t } = await f.previewSegmentMatches(
      this.segmentId,
      this._page,
      this._pageSize
    );
  ...
  async _loadStatistics() {
    ...
    const { data: e, error: t } = await f.getSegmentStatistics(this.segmentId);
    if (q(this, S)) {
      if (t) {
        console.error("Failed to load statistics:", t), this._isLoadingStats = !1;
        return;
      }
  ...
  _renderStatisticsCard() {
    return this._isLoadingStats || !this._statistics ? r`
        <uui-box>
...
var be = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, ee = (e) => {
  ...
  for (var s = a > 1 ? void 0 : a ? fe(t, i) : t, n = e.length - 1, l; n >= 0; n--)
    (l = e[n]) && (s = (a ? l(t, i, s) : l(s)) || s);
  return a && s && be(t, i, s), s;
}, te = (e, t, i) => t.has(e) || ee("Cannot " + i), h = (e, t, i) => (te(e, t, "read from private field"), i ? i.call(e) : t.get(e)), U = (e, t, i) => t.has(e) ? ee("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), V = (e, t, i, a) => (te(e, t, "write to private field"), t.set(e, i), i), g, b;
const G = () => document.createElement("div");
let m = class extends T(A) {
  constructor() {
    super(), this._formData = {}, this._isSaving = !1, this._activePath = "tab/details", this._routerPath = "", this._fieldErrors = {}, this._isNew = !0, U(this, g), U(this, b), this._routes = [
      { path: "tab/details", component: G },
      { path: "tab/preview", component: G },
      { path: "", redirectTo: "tab/details" }
    ], this.consumeContext(ae, (e) => {
      V(this, g, e), this._isNew = h(this, g).isNew, this.observe(h(this, g).segment, (t) => {
        this._segment = t, this._isNew = h(this, g)?.isNew ?? !0, t && (this._formData = { ...t });
      });
    }), this.consumeContext(H, (e) => {
      V(this, b, e);
    });
  ...
  async _handleSave() {
    ...
    try {
      if (this._isNew) {
        ...
        }, { data: t, error: i } = await f.createCustomerSegment(e);
        if (i) {
          h(this, b)?.peek("danger", {
            data: { headline: "Create failed", message: i.message }
          });
          return;
        }
        t && (h(this, g)?.updateSegment(t), h(this, b)?.peek("positive", {
        ...
        }, { data: t, error: i } = await f.updateCustomerSegment(this._segment.id, e);
        if (i) {
          h(this, b)?.peek("danger", {
    ...
    return r`
      <uui-tab-group slot="header">
        <uui-tab
          ...
          Details
          ${this._hasDetailsErrors() ? r`<uui-badge slot="extra" color="danger" attention>!</uui-badge>` : d}
        </uui-tab>
        ${e && !this._isNew ? r`
          <uui-tab
            label="Preview"
  ...
  _renderDetailsTab() {
    return r`
      ...
      { name: "Automated", value: "Automated", selected: this._formData.segmentType === "Automated" }
        ...
        ${this._formData.segmentType === "Manual" && this._isNew ? r`
          <div class="helper-text">
            After saving, you'll be able to add customers to this segment below.
          </div>
        ` : d}

        ${this._formData.segmentType === "Automated" ? r`
          <umb-property-layout
            label="Match Mode"
      ...
      ${this._segment?.isSystemSegment ? r`
  ...
  _renderPreviewTab() {
    return this._segment?.id ? r`
      <merchello-segment-preview .segmentId=${this._segment.id}></merchello-segment-preview>
    ` : r`<p>Save the segment first to preview matching customers.</p>`;
  }
  render() {
    return this._segment ? r`
      <umb-body-layout header-fit-height main-no-padding>
        ...
        <div id="header" slot="header">
          ...
          ${this._segment.isSystemSegment ? r`<uui-tag look="secondary">System</uui-tag>` : d}
        </div>
    ...
    ` : r`<div class="loading"><uui-loader></uui-loader></div>`;
  }
};
...
//# sourceMappingURL=segment-detail.element-BHU-gp01.js.map
