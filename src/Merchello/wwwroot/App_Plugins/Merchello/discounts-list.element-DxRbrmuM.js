...
import { g as P } from "./store-settings-CHgA9WE7.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { e as I } from "./formatting-B_f6AiQh.js";
import { j as O, k as U, l as N } from "./navigation-CvTcY6zJ.js";
import { b as B } from "./badge.styles-C7D4rnJo.js";
var R = Object.defineProperty, j = Object.getOwnPropertyDescriptor, g = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? j(t, i) : t, u = e.length - 1, d; u >= 0; u--)
...
const G = new A("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
...
var H = Object.defineProperty, V = Object.getOwnPropertyDescriptor, w = (e) => {
  ...
  for (var a = s > 1 ? void 0 : s ? V(t, i) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (a = (s ? d(t, i, a) : d(a)) || a);
...
let l = class extends x(k) {
  ...
  async _handleCreateDiscount() {
    if (!n(this, b)) return;
    const t = await n(this, b).open(this, G, {
      data: {}
    }).onSubmit().catch(() => {
    });
...
//# sourceMappingURL=discounts-list.element-DxRbrmuM.js.map
