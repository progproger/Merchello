import { nothing as i, html as a, css as z, state as u, customElement as A } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as V } from "@umbraco-cms/backoffice/modal";
import { M as v } from "./merchello-api-NdGX4WPd.js";
import { g as D, b as W } from "./store-settings-DgxY_Kcz.js";
import { m as U } from "./modal-layout.styles-C2OaUji5.js";
var y = /* @__PURE__ */ ((e) => (e[e.Redirect = 0] = "Redirect", e[e.HostedFields = 10] = "HostedFields", e[e.Widget = 20] = "Widget", e[e.DirectForm = 30] = "DirectForm", e))(y || {}), N = Object.defineProperty, q = Object.getOwnPropertyDescriptor, M = (e) => {
  throw TypeError(e);
}, l = (e, t, s, o) => {
  for (var d = o > 1 ? void 0 : o ? q(t, s) : t, c = e.length - 1, p; c >= 0; c--)
    (p = e[c]) && (d = (o ? p(t, s, d) : p(d)) || d);
  return o && d && N(t, s, d), d;
}, F = (e, t, s) => t.has(e) || M("Cannot " + s), r = (e, t, s) => (F(e, t, "read from private field"), s ? s.call(e) : t.get(e)), x = (e, t, s) => t.has(e) ? M("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), _ = (e, t, s, o) => (F(e, t, "write to private field"), t.set(e, s), s), m, g, C, h, w, f;
const L = "merchello-test-payment-provider-form", E = {
...
let n = class extends V {
  constructor() {
    super(...arguments), this._activeTab = "session", this._amount = 100, this._isTesting = !1, this._isLoadingPaymentForm = !1, this._paymentFormLoaded = !1, this._isProcessingPayment = !1, x(this, m), this._expressMethods = [], this._isLoadingExpressMethods = !1, this._webhookTemplates = [], this._isLoadingWebhookTemplates = !1, this._customWebhookPayload = "", this._useCustomPayload = !1, this._isSimulatingWebhook = !1, this._isGeneratingPaymentLink = !1, this._supportsPaymentLinks = !1, this._supportsVaulting = !1, this._isCreatingVaultSetup = !1, this._isConfirmingVault = !1, this._isChargingVault = !1, this._vaultChargeAmount = 10, this._vaultPaymentMethodToken = "", this._errorMessage = null, x(this, g, !1), x(this, C), x(this, h), x(this, w), x(this, f, /* @__PURE__ */ new Map());
  }
  connectedCallback() {
    super.connectedCallback(), _(this, g, !0), this._restoreSavedValues(), D(), this._checkPaymentLinkSupport(), this._checkVaultingSupport(), this._createLightDomContainer();
  }
  _createLightDomContainer() {
    _(this, h, document.createElement("div")), r(this, h).id = `merchello-payment-container-${Date.now()}`, r(this, h).style.cssText = "display: none;", this._getLightDomHost().appendChild(r(this, h));
  }
  _getLightDomHost() {
    if (r(this, w)?.isConnected)
      return r(this, w);
    const t = this.closest("uui-modal-sidebar, uui-modal-dialog") ?? this.parentElement ?? document.body;
    return _(this, w, t), t;
  }
  ...
  _cleanupLightDomContainers() {
    ...
    for (const e of r(this, f).values())
      e.remove();
    r(this, f).clear(), _(this, w, void 0);
  }
  _restoreSavedValues() {
    try {
  ...
  _injectCardinalZIndexFix() {
    ...
    `, document.head.appendChild(e), _(this, C, e);
  }
  _removeCardinalZIndexFix() {
    r(this, C) && (r(this, C).remove(), _(this, C, void 0));
  }
  ...
  async _handleLoadPaymentForm() {
    ...
    if (r(this, g)) {
      ...
      try {
        await this._loadScript(s.javaScriptSdkUrl), await this._loadScript(s.adapterUrl), this._injectCardinalZIndexFix(), this._paymentFormLoaded = !0, await this.updateComplete, await this._renderPaymentAdapter(s);
      } catch (d) {
        this._paymentFormLoaded = !1, this._paymentFormError = d instanceof Error ? d.message : "Failed to load payment form";
      }
  ...
  async _renderPaymentAdapter(e) {
    ...
    this._positionLightDomContainer(o, r(this, h)), r(this, h).style.display = "block", r(this, h).replaceChildren();
    const d = {
      showError: (c) => {
  ...
  async _loadExpressButton(e) {
    ...
    try {
      ...
      d && await this._loadScript(d), s.sdkUrl && await this._loadScript(s.sdkUrl), s.customAdapterUrl && await this._loadScript(s.customAdapterUrl), await new Promise((P) => requestAnimationFrame(P));
      ...
      p || (p = document.createElement("div"), p.id = `merchello-express-container-${e.methodAlias}-${Date.now()}`, this._getLightDomHost().appendChild(p), r(this, f).set(e.methodAlias, p)), this._positionLightDomContainer(c, p), p.style.display = "block", p.replaceChildren();
      ...
      const k = this.data?.setting.providerAlias || "", S = b[`${k}:${e.methodAlias}`] || b[k];
      if (!S?.render) {
      ...
      const R = {
        isProcessing: !1,
        error: null,
        processExpressCheckout: async (P, B, T, G, O) => {
          this._expressResult = {
            success: !0,
  ...
  // ============================================
  _handleClose() {
    this._cleanupLightDomContainers(), this.modalContext?.reject();
  }
  ...
  _renderSessionResults() {
    ...
    const { isSuccessful: e, integrationType: t, errorMessage: s, errorCode: o, sessionId: d, redirectUrl: c, clientToken: p, clientSecret: b, javaScriptSdkUrl: k, adapterUrl: S, formFields: R } = this._testResult;
    return a`
        ...
        <div class="result-details">
          ...
          ${S ? a`
            <div class="detail-row">
              ...
              <span class="detail-value monospace">${S}</span>
            </div>
          ` : i}
                ...
                ${R.map(($) => a`
                  <div class="form-field-item">
                    ...
                    <div class="field-meta">
                      ...
                      ${$.isRequired ? a`<span class="field-required">Required</span>` : i}
                    </div>
                  </div>
                `)}
              </div>
...
n = l([
  A("merchello-test-payment-provider-modal")
], n);
const Z = n;
export {
...
//# sourceMappingURL=test-provider-modal.element-BXy3s4Y3.js.map
