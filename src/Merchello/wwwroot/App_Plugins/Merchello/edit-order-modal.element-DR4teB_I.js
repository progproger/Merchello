import { html as r, nothing as c, css as T, state as p, customElement as z } from "@umbraco-cms/backoffice/external/lit";
...
import { M as y } from "./merchello-api-EmrUndo3.js";
import { c as a, D as b } from "./formatting-QYLVqNiR.js";
...
var q = Object.defineProperty, E = Object.getOwnPropertyDescriptor, S = (e) => {
  ...
  for (var s = t > 1 ? void 0 : t ? E(i, o) : i, n = e.length - 1, g; n >= 0; n--)
    (g = e[n]) && (s = (t ? g(i, o, s) : g(s)) || s);
...
let d = class extends D {
  ...
  _refreshPreview() {
    ...
    this._previewDebounceTimer && clearTimeout(this._previewDebounceTimer), this._previewDebounceTimer = setTimeout(async () => {
      ...
      o && (this._previewResult = o, this._updateLineItemTotalsFromPreview(o));
    }, 300);
  }
  /**
  ...
  _renderLineItem(e) {
    ...
    const i = this._invoice?.currencySymbol ?? "£", o = e.discount !== null, t = this._previewResult?.lineItems.find((m) => m.id === e.id), s = t?.hasInsufficientStock ?? !1, n = t?.canAddDiscount ?? !0, g = e.newQuantity < e.quantity, f = e.childLineItems ?? [];
    return r`
      ...
      return m !== null ? r`${i}${a(m, 2)}` : r`<span class="calculating">...</span>`;
    })()}
        </div>
      ...
      ${g && e.productId && e.isStockTracked ? r`
  ...
  _renderAddonLineItem(e, i, o) {
    ...
    return r`
      <div class="line-item child-item addon-item">
        ...
        <div class="line-item-total">
          ${t !== null ? r`+${o}${a(t, 2)}` : r`<span class="calculating">...</span>`}
        </div>
      ...
      <div class="line-item custom-item">
        <div class="line-item-product">
          ...
          <div class="line-item-details">
            ...
            ${e.isPhysicalProduct && e.warehouseName ? r`
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, o = this._subtotalBeforeDiscounts, t = this._discountTotal, s = this._adjustedSubtotal, n = this._newTax, g = this._newTotal, f = this._hasChanges(), m = this._lineItems.filter((u) => u.isRemoved), P = t > 0;
    return r`
...
//# sourceMappingURL=edit-order-modal.element-DR4teB_I.js.map
