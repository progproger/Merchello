import { LitElement as w, html as s, nothing as b, css as k, state as d, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
var L = Object.defineProperty, D = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, p = (e, t, i, a) => {
  for (var n = a > 1 ? void 0 : a ? D(t, i) : t, m = e.length - 1, _; m >= 0; m--)
    (_ = e[m]) && (n = (a ? _(t, i, n) : _(n)) || n);
  return a && n && L(t, i, n), n;
}, S = (e, t, i) => t.has(e) || y("Cannot " + i), r = (e, t, i) => (S(e, t, "read from private field"), t.get(e)), g = (e, t, i) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), h = (e, t, i, a) => (S(e, t, "write to private field"), t.set(e, i), i), u, c, l;
let o = class extends C(w) {
  constructor() {
    super(), this._suppliers = [], this._isLoading = !0, this._errorMessage = null, this._isDeleting = null, this._searchTerm = "", g(this, u), g(this, c), g(this, l, !1), this.consumeContext($, (e) => {
      h(this, u, e);
  ...
  async _handleDelete(e, t) {
    ...
    if (r(this, l)) {
      if (this._isDeleting = null, a) {
        this._errorMessage = `Failed to delete supplier: ${a.message}`, r(this, c)?.peek("danger", {
      ...
      <uui-table-row
        ...
        <uui-table-cell>
          <div class="supplier-info">
            ...
            ${e.code ? s`<span class="supplier-code">${e.code}</span>` : b}
          </div>
        </uui-table-cell>
...
//# sourceMappingURL=suppliers-list.element-DVJICkki.js.map
