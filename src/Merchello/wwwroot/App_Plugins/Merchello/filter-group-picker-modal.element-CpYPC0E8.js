import { html as r, css as g, state as c, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as b } from "@umbraco-cms/backoffice/modal";
import { M as m } from "./merchello-api-BT8AWvQk.js";
...
}, _ = (e, t, s) => t.has(e) || p("Cannot " + s), x = (e, t, s) => (_(e, t, "read from private field"), t.get(e)), C = (e, t, s) => t.has(e) ? p("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), h = (e, t, s, i) => (_(e, t, "write to private field"), t.set(e, s), s), d;
let a = class extends b {
  constructor() {
    super(...arguments), this._selectedIds = [], this._selectedNames = [], this._filterGroups = [], this._isLoading = !0, this._errorMessage = null, C(this, d, !1);
  }
  connectedCallback() {
    super.connectedCallback(), h(this, d, !0), this._loadFilterGroups();
  }
  ...
  async _loadFilterGroups() {
    ...
    this._filterGroups = (e ?? []).filter((i) => !s.includes(i.id)), this._isLoading = !1;
  }
  _toggleSelection(e) {
      ...
      <uui-table-row
        ...
        <uui-table-cell style="width: 40px;">
          <uui-checkbox
            .checked=${t}
            @change=${(i) => {
      i.stopPropagation(), this._toggleSelection(e);
    }}>
          </uui-checkbox>
        </uui-table-cell>
        <uui-table-cell>
...
//# sourceMappingURL=filter-group-picker-modal.element-CpYPC0E8.js.map
