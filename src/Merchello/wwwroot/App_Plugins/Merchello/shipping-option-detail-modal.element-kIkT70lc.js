import { html as r, nothing as d, css as x, state as o, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalToken as _, UmbModalBaseElement as k, UMB_MODAL_MANAGER_CONTEXT as S, UMB_CONFIRM_MODAL as y } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as $ } from "@umbraco-cms/backoffice/notification";
import { M as h } from "./merchello-api-DXy2hS5y.js";
const C = new _("Merchello.ShippingCost.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
}), T = new _("Merchello.ShippingWeightTier.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var O = Object.defineProperty, L = Object.getOwnPropertyDescriptor, b = (i) => {
  throw TypeError(i);
}, s = (i, e, t, n) => {
  for (var l = n > 1 ? void 0 : n ? L(e, t) : e, v = i.length - 1, g; v >= 0; v--)
    (g = i[v]) && (l = (n ? g(e, t, l) : g(l)) || l);
  return n && l && O(e, t, l), l;
}, D = (i, e, t) => e.has(i) || b("Cannot " + t), u = (i, e, t) => (D(i, e, "read from private field"), e.get(i)), m = (i, e, t) => e.has(i) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t), f = (i, e, t, n) => (D(i, e, "write to private field"), e.set(i, t), t), p, c;
let a = class extends k {
  constructor() {
    super(), this._isLoading = !1, this._isSaving = !1, this._errorMessage = null, this._detail = null, this._warehouses = [], this._availableProviders = [], this._methodConfig = null, this._isLoadingProviders = !1, this._name = "", this._warehouseId = "", this._fixedCost = null, this._daysFrom = 3, this._daysTo = 5, this._isNextDay = !1, this._nextDayCutOffTime = "", this._allowsDeliveryDateSelection = !1, this._minDeliveryDays = null, this._maxDeliveryDays = null, this._allowedDaysOfWeek = "", this._isDeliveryDateGuaranteed = !1, this._providerKey = "flat-rate", this._serviceType = null, this._providerSettings = {}, this._isEnabled = !0, m(this, p), m(this, c), this._daysOfWeek = [
...
a = s([
  w("merchello-shipping-option-detail-modal")
], a);
const E = a;
export {
...
//# sourceMappingURL=shipping-option-detail-modal.element-kIkT70lc.js.map
