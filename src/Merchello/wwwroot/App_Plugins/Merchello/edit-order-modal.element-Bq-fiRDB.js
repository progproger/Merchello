import { html as r, nothing as d, css as O, state as c, customElement as C } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalToken as $, UmbModalBaseElement as R, UMB_MODAL_MANAGER_CONTEXT as I } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as M } from "@umbraco-cms/backoffice/notification";
import { M as f } from "./merchello-api-CzSx3Q3Y.js";
import { D as h } from "./order.types-DjkMLpgj.js";
const P = new $("Merchello.AddCustomItem.Modal", {
  modal: {
    type: "dialog",
    size: "small"
  }
}), y = new $("Merchello.AddDiscount.Modal", {
  modal: {
    type: "dialog",
    size: "small"
  }
...
}, S = (e, i, o) => i.has(e) || k("Cannot " + o), v = (e, i, o) => (S(e, i, "read from private field"), i.get(e)), x = (e, i, o) => i.has(e) ? k("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, o), w = (e, i, o, t) => (S(e, i, "write to private field"), i.set(e, o), o), m, g;
let n = class extends R {
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, o = this._subtotalBeforeDiscounts, t = this._discountTotal, s = this._adjustedSubtotal, l = this._newTax, p = this._newTotal, b = this._hasChanges(), _ = this._lineItems.filter((a) => a.isRemoved), T = t > 0;
    return r`
      <umb-body-layout headline="Edit Order">
        <div id="main">
          ...
          <div class="payment-section">
            ...
            ${this._orders.map((a, z) => r`
              <div class="payment-row shipping-row ${this._removedShippingOrders.has(a.id) ? "removed" : ""}">
                <span>${a.shippingMethodName ?? "Shipping"}${this._orders.length > 1 ? ` (Order ${z + 1})` : ""}</span>
...
//# sourceMappingURL=edit-order-modal.element-Bq-fiRDB.js.map
