...
import { UmbModalToken as k, UmbModalBaseElement as R, UMB_MODAL_MANAGER_CONTEXT as D } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as A } from "@umbraco-cms/backoffice/notification";
import { M as y } from "./merchello-api-BuImeZL2.js";
...
import { c as a } from "./formatting-DGOWmvpU.js";
...
}, I = (e, i, o) => i.has(e) || S("Cannot " + o), h = (e, i, o) => (I(e, i, "read from private field"), i.get(e)), x = (e, i, o) => i.has(e) ? S("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, o), $ = (e, i, o, t) => (I(e, i, "write to private field"), i.set(e, o), o), v, _;
let d = class extends R {
  constructor() {
    super(), this._invoice = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._editReason = "", this._orders = [], this._lineItems = [], this._customItems = [], this._pendingProducts = [], this._taxGroups = [], this._removedShippingOrders = /* @__PURE__ */ new Set(), this._taxRemoved = !1, this._removedOrderDiscounts = /* @__PURE__ */ new Set(), this._pendingOrderDiscounts = [], this._previewResult = null, this._previewLoading = !1, x(this, v), x(this, _), this.consumeContext(D, (e) => {
      $(this, v, e);
  ...
  async _openProductPickerModal() {
    if (!h(this, v) || !this._invoice) return;
    const e = this._lineItems.filter((s) => s.productId && !s.isRemoved).map((s) => s.productId), i = this._pendingProducts.map((s) => s.productId), t = await h(this, v).open(this, M, {
      data: {
        config: {
          currencySymbol: this._invoice.currencySymbol,
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, o = this._subtotalBeforeDiscounts, t = this._discountTotal, s = this._adjustedSubtotal, r = this._newTax, g = this._newTotal, f = this._hasChanges(), m = this._lineItems.filter((u) => u.isRemoved), P = t > 0;
    return n`
...
//# sourceMappingURL=edit-order-modal.element-KE8B8NQD.js.map
