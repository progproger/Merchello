import { html as l, nothing as h, css as p, state as o, customElement as b } from "@umbraco-cms/backoffice/external/lit";
...
var y = Object.defineProperty, x = Object.getOwnPropertyDescriptor, g = (e) => {
  throw TypeError(e);
}, c = (e, t, s, i) => {
  for (var r = i > 1 ? void 0 : i ? x(t, s) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (r = (i ? d(t, s, r) : d(r)) || r);
  return i && r && y(t, s, r), r;
}, m = (e, t, s) => t.has(e) || g("Cannot " + s), $ = (e, t, s) => (m(e, t, "read from private field"), t.get(e)), C = (e, t, s) => t.has(e) ? g("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), _ = (e, t, s, i) => (m(e, t, "write to private field"), t.set(e, s), s), n;
let a = class extends f {
  constructor() {
    super(...arguments), this._selectedIds = [], this._selectedNames = [], this._segments = [], this._isLoading = !0, this._errorMessage = null, C(this, n, !1);
  }
  get _isMultiSelect() {
...
//# sourceMappingURL=segment-picker-modal.element-DmVfQKaX.js.map
