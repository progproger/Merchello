import { LitElement as N, nothing as o, html as a, css as F, state as d, customElement as U, property as Z, unsafeHTML as ee } from "@umbraco-cms/backoffice/external/lit";
...
import { UmbModalToken as S, UMB_MODAL_MANAGER_CONTEXT as B } from "@umbraco-cms/backoffice/modal";
...
import { I as y, P as j } from "./order.types-vEwMhKjb.js";
import { M as re } from "./customer-orders-modal.token-DUOTW0Xz.js";
import { b as R, a as p, h as se } from "./formatting-OQtsI2-n.js";
import { M as b } from "./merchello-api-CCwReUh_.js";
import { m as oe } from "./navigation-m-idaC9i.js";
import "./product-image.element-D7HwAIKr.js";
const ne = new S("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), le = new S("Merchello.EditOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), de = new S("Merchello.CancelInvoice.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), ue = new S("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var ce = Object.defineProperty, pe = Object.getOwnPropertyDescriptor, G = (e) => {
  throw TypeError(e);
}, D = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? pe(i, t) : i, l = e.length - 1, c; l >= 0; l--)
    (c = e[l]) && (r = (s ? c(i, t, r) : c(r)) || r);
  return s && r && ce(i, t, r), r;
}, X = (e, i, t) => i.has(e) || G("Cannot " + t), $ = (e, i, t) => (X(e, i, "read from private field"), t ? t.call(e) : i.get(e)), I = (e, i, t) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), A = (e, i, t, s) => (X(e, i, "write to private field"), i.set(e, t), t), M, O, k;
let w = class extends V(N) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, I(this, M), I(this, O), I(this, k, !1), this.consumeContext(W, (e) => {
  ...
  async _handleDeleteShipment(e) {
    ...
    const { error: t } = await b.deleteShipment(e.id);
    if ($(this, k)) {
      if (t) {
        alert(t.message);
        return;
      ...
      <div class="shipment-card">
        <div class="shipment-header">
          <div class="header-left">
            ...
            <span class="shipment-date">Created ${R(e.dateCreated)}</span>
          </div>
        ...
        <div class="shipment-details">
          ...
          ${e.actualDeliveryDate ? a`
                <div class="detail-row">
                  ...
                  <span class="value delivered">${R(e.actualDeliveryDate)}</span>
                </div>
              ` : o}
        </div>
...
const me = new S("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), he = new S("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var ve = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, Y = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? ge(i, t) : i, l = e.length - 1, c; l >= 0; l--)
    (c = e[l]) && (r = (s ? c(i, t, r) : c(r)) || r);
  return s && r && ve(i, t, r), r;
}, K = (e, i, t) => i.has(e) || Y("Cannot " + t), C = (e, i, t) => (K(e, i, "read from private field"), i.get(e)), q = (e, i, t) => i.has(e) ? Y("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (K(e, i, "write to private field"), i.set(e, t), t), x, z;
let _ = class extends V(N) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, q(this, x), q(this, z, !1), this.consumeContext(B, (e) => {
      L(this, x, e);
    });
  }
  connectedCallback() {
  ...
  _getStatusBadgeClass(e) {
    switch (e) {
      case y.Paid:
        return "paid";
      case y.PartiallyPaid:
        return "partial";
      case y.Refunded:
      case y.PartiallyRefunded:
        return "refunded";
      case y.AwaitingPayment:
        return "awaiting";
      default:
        return "unpaid";
    }
  }
  _getRiskLevelClass(e) {
    return e >= 75 ? "high-risk" : e >= 50 ? "medium-risk" : e >= 25 ? "low-risk" : "minimal-risk";
  }
  _renderPayment(e) {
      ...
      <div class="payment-item ${i ? "refund" : ""}">
        <div class="payment-main">
          <div class="payment-info">
            ...
            <div class="payment-date">${R(e.dateCreated)}</div>
            ${e.transactionId ? a`<div class="transaction-id">ID: ${e.transactionId}</div>` : o}
            ${e.riskScore != null ? a`<div class="risk-score ${this._getRiskLevelClass(e.riskScore)}">
                  Risk: ${e.riskScore}%
        ...
        <div class="status-summary">
          <div class="status-header">
            <div class="status-badges">
              ...
              ${e?.maxRiskScore != null ? a`<span class="risk-badge ${this._getRiskLevelClass(e.maxRiskScore)}">
                    <uui-icon name="icon-alert"></uui-icon>
                    Risk: ${e.maxRiskScore}%
                  </span>` : o}
            </div>
...
}, Q = (e, i, t) => i.has(e) || J("Cannot " + t), n = (e, i, t) => (Q(e, i, "read from private field"), i.get(e)), T = (e, i, t) => i.has(e) ? J("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), E = (e, i, t, s) => (Q(e, i, "write to private field"), i.set(e, t), t), h, v, f, g;
let u = class extends V(N) {
  constructor() {
  ...
  async _openCancelInvoiceModal() {
    if (!this._order || !n(this, v)) return;
    const i = await n(this, v).open(this, de, {
      data: {
    ...
    return a`
      ...
      (c) => a`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-total">${p(c.amount * c.quantity, r, l)}</div>
              </div>
            `
    )}
        </div>
  ...
  render() {
    ...
    return a`
      <umb-body-layout header-fit-height main-no-padding>
        <!-- Back button -->
        <uui-button slot="header" compact href=${oe()} label="Back to orders" class="back-button">
...
//# sourceMappingURL=order-detail.element-CkKOJTEL.js.map
