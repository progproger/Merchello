const e = [
  {
    ...
    js: () => import("./entrypoint-BS_UWR-K.js")
  }
], o = [
  // Section
  {
  ...
  // Stats Dashboard
  {
    ...
    element: () => import("./stats-dashboard.element-CNMJaQr7.js"),
    meta: {
      label: "Stats",
      pathname: "stats"
    },
  ...
  // Fulfillment modal for creating shipments
  {
    ...
    js: () => import("./fulfillment-modal.element-CG4CxDOM.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-CArgSI_I.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-CsNvjkXh.js")
  },
  ...
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-5vm9IBzJ.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-DDUTICTG.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element--kLu1Ovk.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-BanOWzbm.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-FD3PaZNk.js")
  },
  // Create order modal for creating draft orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-tChSkjnZ.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-B5LECmI6.js")
  },
  ...
  // Workspace view - the orders list
  {
    ...
    js: () => import("./orders-list.element-CH4o5aZ-.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Workspace for individual order detail (routable)
  {
    ...
    api: () => import("./order-detail-workspace.context-DKTIqYde.js"),
    meta: {
  ...
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-jjJYW_ig.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-Be0sLY0Z.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Routable workspace for segment detail (edit/create)
  {
    ...
    api: () => import("./segment-detail-workspace.context-7Y5scBUS.js"),
    meta: {
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-BCI4jCMG.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-By1ko_lZ.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-BuyvnanB.js")
  }
], t = [
  ...
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-BvHR7QT4.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-CWkpqlo2.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-ivNIiLmj.js")
  }
], s = [
  ...
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-DDHYxBjh.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-fvGYhYVg.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-CqaPNvUt.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-DW-pN_E7.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-M5Vrznew.js")
  }
], c = [
  ...
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-DxvNhDCy.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-B4iVR_fS.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-DtiaTga6.js")
  }
], n = [
  ...
  // Workspace view for discounts list
  {
    ...
    js: () => import("./discounts-list.element-S_URO9UX.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Routable workspace for discount detail (create/edit)
  {
    ...
    api: () => import("./discount-detail-workspace.context-BNwRRXjw.js"),
    meta: {
  ...
  // Workspace view for tax groups list
  {
    ...
    js: () => import("./tax-workspace.element-D3ljduz9.js"),
    weight: 100,
    meta: {
      label: "Tax Groups",
      pathname: "tax-groups",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element-D9UbI1iL.js")
  }
], M = [
  // ============================================
  ...
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-D2p864Gu.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-2DRs7bwx.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-DFVMDpcv.js")
  }
], u = [
  // ============================================
  ...
  // List view for warehouses
  {
    ...
    js: () => import("./warehouses-list.element-C-rC3p36.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Routable workspace for warehouse detail/edit
  {
    ...
    api: () => import("./warehouse-detail-workspace.context-CAs6ByoX.js"),
    meta: {
  ...
  // Detail view for warehouse editing
  {
    ...
    js: () => import("./warehouse-detail.element-CA9Vdcyc.js"),
    weight: 100,
    meta: {
      label: "Warehouse",
      pathname: "warehouse",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-yqUtjjON.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-BdppKDfS.js")
  }
], y = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-5m9tuLWc.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-Bz8LUuzD.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-Bm7g6vcw.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-C5ORiNqb.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-DwcJ4eEx.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-BtHHLJn-.js")
  }
], k = [
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-CZR8ILDE.js")
  },
  ...
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-BSx8_BnZ.js")
  }
], P = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-B-R1tunZ.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-BEmrhYDz.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-BTk2gV8L.js")
  }
], w = [
...
], W = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-DJXakQEu.js"),
    meta: {
...
], f = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-BFfrD8CS.js"),
    meta: {
...
], b = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-CIS0UUz9.js"),
    meta: {
...
], C = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-CzO1z1vg.js"),
    meta: {
