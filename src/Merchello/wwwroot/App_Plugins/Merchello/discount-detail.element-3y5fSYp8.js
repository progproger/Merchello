...
import { UmbModalToken as B, UMB_MODAL_MANAGER_CONTEXT as G, UMB_CONFIRM_MODAL as se } from "@umbraco-cms/backoffice/modal";
import { e as H, b, c as D, a as f, f as v, g as c, D as W, d as re } from "./discount.types-Du4rtOaW.js";
import { M as x } from "./merchello-api-658q9849.js";
import { g as oe } from "./store-settings-B0mEEUwl.js";
import { u as ne, v as ue, w as le } from "./navigation-Y0bwD8V1.js";
import { a as ce, c as F } from "./formatting-nNQcXJwZ.js";
import { M as de } from "./customer-picker-modal.token-BZSMisS9.js";
import { M as he } from "./product-picker-modal.token-BfbHsSHl.js";
import { M as pe } from "./collection-picker-modal.token-DEqocfk-.js";
import { M as me } from "./product-type-picker-modal.token-BIXbr0YK.js";
import { M as ge } from "./filter-picker-modal.token-DlO79hNz.js";
var ve = Object.defineProperty, ye = Object.getOwnPropertyDescriptor, V = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? ye(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && ve(t, i, r), r;
};
let R = class extends L(z) {
  constructor() {
  ...
  _formatValue() {
    return this.discount ? this.discount.valueType === b.Percentage ? `${this.discount.value}% off` : this.discount.valueType === b.FixedAmount ? `${this.discount.value} off` : this.discount.valueType === b.Free ? "Free" : "" : "";
  }
  _formatDate(e) {
...
var be = Object.defineProperty, _e = Object.getOwnPropertyDescriptor, $ = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? _e(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && be(t, i, r), r;
};
let C = class extends L(z) {
  constructor() {
...
const fe = new B("Merchello.SegmentPicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var Ce = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, K = (e) => {
  throw TypeError(e);
}, U = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? $e(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && Ce(t, i, r), r;
}, j = (e, t, i) => t.has(e) || K("Cannot " + i), O = (e, t, i) => (j(e, t, "read from private field"), t.get(e)), xe = (e, t, i) => t.has(e) ? K("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), De = (e, t, i, a) => (j(e, t, "write to private field"), t.set(e, i), i), w;
const Y = [
...
let P = class extends L(z) {
  constructor() {
    super(), this.rules = [], this.readonly = !1, xe(this, w), this.consumeContext(G, (e) => {
      De(this, w, e);
    });
  }
  _dispatchChange() {
  ...
  _getEligibilityTypeLabel(e) {
    return Y.find((t) => t.value === e)?.label ?? "Unknown";
  }
  _getTypeIcon(e) {
    switch (e) {
      case v.AllCustomers:
  ...
  async _openCustomerPicker(e, t) {
    if (!O(this, w)) return;
    const a = await O(this, w).open(this, de, {
      data: {
    ...
    if (a?.selectedCustomerIds?.length) {
      ...
      for (const u of a.selectedCustomerIds) {
        ...
        if (o) {
          const te = [o.firstName, o.lastName].filter(Boolean).join(" ") || o.email;
          r.push(te);
        }
      }
      this._handleUpdateRule(e, {
  ...
  async _openSegmentPicker(e, t) {
    if (!O(this, w)) return;
    const a = await O(this, w).open(this, fe, {
      data: {
...
const we = new B("Merchello.SupplierPicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), Ie = new B("Merchello.WarehousePicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var Pe = Object.defineProperty, Se = Object.getOwnPropertyDescriptor, X = (e) => {
  throw TypeError(e);
}, q = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? Se(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && Pe(t, i, r), r;
}, Q = (e, t, i) => t.has(e) || X("Cannot " + i), _ = (e, t, i) => (Q(e, t, "read from private field"), t.get(e)), ke = (e, t, i) => t.has(e) ? X("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Re = (e, t, i, a) => (Q(e, t, "write to private field"), t.set(e, i), i), m;
const Z = [
...
let S = class extends L(z) {
  constructor() {
    super(), this.rules = [], this.readonly = !1, ke(this, m), this.consumeContext(G, (e) => {
      Re(this, m, e);
    });
  }
  _dispatchChange() {
  ...
  _getTargetTypeLabel(e) {
    return Z.find((t) => t.value === e)?.label ?? "Unknown";
  }
  async _openProductPicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, he, {
      data: {
        config: {
          currencySymbol: "",
  ...
  async _openCollectionPicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, pe, {
      data: {
  ...
  async _openProductTypePicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, me, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openSupplierPicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, we, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openWarehousePicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, Ie, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openFilterPicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, ge, {
      data: {
...
var Ae = Object.defineProperty, Le = Object.getOwnPropertyDescriptor, J = (e) => {
  throw TypeError(e);
}, y = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? Le(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && Ae(t, i, r), r;
}, ee = (e, t, i) => t.has(e) || J("Cannot " + i), l = (e, t, i) => (ee(e, t, "read from private field"), t.get(e)), M = (e, t, i) => t.has(e) ? J("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), k = (e, t, i, a) => (ee(e, t, "write to private field"), t.set(e, i), i), p, g, N, T;
let h = class extends L(z) {
  constructor() {
    super(), this._isNew = !0, this._isLoading = !0, this._isSaving = !1, this._validationErrors = /* @__PURE__ */ new Map(), this._codeAvailable = null, this._isGeneratingCode = !1, this._targetRules = [], this._eligibilityRules = [], this._discountCodeLength = 8, this._routes = [], this._activePath = "", M(this, p), M(this, g), M(this, N), M(this, T), this._initRoutes(), this._loadSettings(), this.consumeContext(ie, (e) => {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), l(this, T) && (clearTimeout(l(this, T)), k(this, T, void 0));
  }
  async _loadSettings() {
    const e = await oe();
  ...
  _getValueTypeOptions() {
    const e = [
      { name: "Percentage", value: b.Percentage, selected: this._discount?.valueType === b.Percentage },
      { name: "Fixed amount", value: b.FixedAmount, selected: this._discount?.valueType === b.FixedAmount }
    ];
    return this._discount?.category === W.BuyXGetY && e.push({ name: "Free", value: b.Free, selected: this._discount?.valueType === b.Free }), e;
  }
  ...
  _handleCodeInput(e) {
    ...
    this._handleInputChange("code", i || null), l(this, T) && clearTimeout(l(this, T)), i ? k(this, T, setTimeout(() => {
        ...
        <div class="form-grid">
          <umb-property-layout label="Value Type">
            <uui-select
              ...
              .value=${this._discount?.valueType ?? b.Percentage}
              @change=${(e) => this._handleInputChange("valueType", e.target.value)}
            ></uui-select>
          </umb-property-layout>

          ${this._discount?.valueType !== b.Free ? s`
                <umb-property-layout
                  label=${this._discount?.valueType === b.Percentage ? "Percentage (%)" : "Amount"}
                  ?mandatory=${!0}
                  ...
                  <uui-input
                    ...
                    type="number"
                    min="0"
                    max=${this._discount?.valueType === b.Percentage ? "100" : ""}
                    step="0.01"
      ...
      <umb-body-layout header-fit-height main-no-padding>
        ...
        ${this._isNew ? n : s`
              <div slot="header" class="header-actions">
                ${this._discount?.status === re.Active ? s`
                      <uui-button
                        look="secondary"
                        color="warning"
                        label="Deactivate"
...
//# sourceMappingURL=discount-detail.element-3y5fSYp8.js.map
