...
import { M as p } from "./merchello-api-BT8AWvQk.js";
import "@umbraco-cms/backoffice/media";
var M = Object.defineProperty, k = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, s = (e, i, t, a) => {
  for (var l = a > 1 ? void 0 : a ? k(i, t) : i, c = e.length - 1, m; c >= 0; c--)
    (m = e[c]) && (l = (a ? m(i, t, l) : m(l)) || l);
  return a && l && M(i, t, l), l;
}, b = (e, i, t) => i.has(e) || f("Cannot " + t), _ = (e, i, t) => (b(e, i, "read from private field"), i.get(e)), g = (e, i, t) => i.has(e) ? f("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), v = (e, i, t, a) => (b(e, i, "write to private field"), i.set(e, t), t), d, h;
let r = class extends y {
  constructor() {
    super(), this._name = "", this._hexColour = "", this._image = null, this._isSaving = !1, this._isDeleting = !1, this._errors = {}, g(this, d), g(this, h, !1), this.consumeContext($, (e) => {
      v(this, d, e);
    });
  }
  get _isEditMode() {
  ...
  async _handleDelete() {
    const e = this.data?.filter?.id;
    if (!e || !await _(this, d)?.open(this, w, {
      data: {
    ...
    this._isDeleting = !0;
    const { error: a } = await p.deleteFilter(e);
    if (_(this, h)) {
  ...
  render() {
    const e = this._isEditMode ? "Edit Filter" : "Add Filter", i = this._isEditMode ? "Save Changes" : "Create Filter", t = this._isEditMode ? "Saving..." : "Creating...", a = this._image ? [{ key: this._image, mediaKey: this._image }] : [];
    return o`
        ...
        <div id="main">
          ...
          <div class="form-row">
            ...
            <uui-input
              id="filter-name"
              .value=${this._name}
              @input=${(l) => this._name = l.target.value}
...
s([
  n()
], r.prototype, "_hexColour", 2);
s([
  n()
], r.prototype, "_image", 2);
s([
  n()
...
const O = r;
export {
  r as MerchelloFilterModalElement,
  O as default
};
//# sourceMappingURL=filter-modal.element-rcflu6dZ.js.map
