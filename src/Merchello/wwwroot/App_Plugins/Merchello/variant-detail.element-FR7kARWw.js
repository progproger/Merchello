...
import { a as k } from "./navigation-m-G5wLvz.js";
...
let a = class extends $(S) {
  ...
  constructor() {
    super(), this._product = null, this._variant = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._routes = [], this._activePath = "", this._formData = {}, this._filterGroups = [], this._assignedFilterIds = [], this._originalAssignedFilterIds = [], this._variantShippingOptions = [], this._variantExcludedOptionIds = [], b(this, d), b(this, h), b(this, m), b(this, g, !1), this.consumeContext(D, (t) => {
      ...
      }), this.observe(r(this, d).variantId, (e) => {
        f(this, m, e), this._updateVariantFromProduct();
      }), this.observe(r(this, d).filterGroups, (e) => {
  ...
  async _handleSave() {
    if (!(!this._product || !this._variant)) {
      ...
      try {
        ...
        if (!r(this, g)) return;
        this._errorMessage = t instanceof Error ? t.message : "An unexpected error occurred", r(this, h)?.peek("danger", { data: { headline: "Error", message: this._errorMessage } }), console.error("Variant save failed:", t);
      } finally {
        this._isSaving = !1;
      }
    }
...
//# sourceMappingURL=variant-detail.element-FR7kARWw.js.map
