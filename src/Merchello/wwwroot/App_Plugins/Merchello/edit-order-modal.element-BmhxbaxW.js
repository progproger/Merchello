...
import { M as y } from "./merchello-api-LENiBVrz.js";
import { D as b } from "./order.types-_6ggCmi6.js";
import { M as A } from "./product-picker-modal.token-BfbHsSHl.js";
import "./line-item-identity.element-DTtPHFdM.js";
import { c as a } from "./formatting-CeWY__1B.js";
...
let u = class extends D {
  ...
  async _openProductPickerModal() {
    if (!h(this, v) || !this._invoice) return;
    const e = this._lineItems.filter((s) => s.productId && !s.isRemoved).map((s) => s.productId), i = this._pendingProducts.map((s) => s.productId), t = await h(this, v).open(this, A, {
      data: {
        config: {
          currencySymbol: this._invoice.currencySymbol,
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, o = this._subtotalBeforeDiscounts, t = this._discountTotal, s = this._adjustedSubtotal, r = this._newTax, g = this._newTotal, f = this._hasChanges(), m = this._lineItems.filter((d) => d.isRemoved), P = t > 0;
    return n`
        ...
        <div id="main">
          ...
          ${m.length > 0 ? n`
            <div class="removed-items-section">
              <h4>Removed Items</h4>
              ${m.map((d) => this._renderRemovedItem(d))}
            </div>
          ` : c}
          ...
          <div class="payment-section">
            ...
            ${this._orders.map((d, O) => n`
              <div class="payment-row shipping-row ${this._removedShippingOrders.has(d.id) ? "removed" : ""}">
                <span>${d.shippingMethodName ?? "Shipping"}${this._orders.length > 1 ? ` (Order ${O + 1})` : ""}</span>
                <div class="summary-edit-controls">
                  ${this._removedShippingOrders.has(d.id) ? n`
                  ...
                  ` : n`
                    <div class="summary-input">
                      ...
                      <uui-input
                        ...
                        @input=${(C) => this._updateOrderShipping(d.id, parseFloat(C.target.value) || 0)}
                        min="0"
                        step="0.01"
                      ></uui-input>
                    </div>
...
//# sourceMappingURL=edit-order-modal.element-BmhxbaxW.js.map
