...
import { M as m } from "./merchello-api-CU-ozmmd.js";
...
let r = class extends O(D) {
  ...
  async _openCreateSupplierModal() {
    ...
    a(this, o) && i?.created && i.supplier && (this._suppliers = [...this._suppliers, i.supplier], this._formData = { ...this._formData, supplierId: i.supplier.id });
  }
  async _handleSave() {
...
//# sourceMappingURL=warehouse-detail.element-DQs0KxB_.js.map
