import { LitElement as D, nothing as u, html as i, css as T, property as g, state as n, query as S, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
import { k as R, y as I } from "./navigation-COkStlQk.js";
...
var j = Object.defineProperty, L = Object.getOwnPropertyDescriptor, m = (e, t, a, s) => {
  for (var o = s > 1 ? void 0 : s ? L(t, a) : t, h = e.length - 1, _; h >= 0; h--)
    (_ = e[h]) && (o = (s ? _(t, a, o) : _(o)) || o);
...
let d = class extends w(D) {
  ...
  _selectToken(e) {
    ...
    if (o !== -1) {
      const h = t.slice(0, o), _ = t.slice(a), P = `${h}{{${e.path}}}${_}`;
...
var B = Object.defineProperty, U = Object.getOwnPropertyDescriptor, C = (e) => {
  ...
  for (var o = s > 1 ? void 0 : s ? U(t, a) : t, h = e.length - 1, _; h >= 0; h--)
    (_ = e[h]) && (o = (s ? _(t, a, o) : _(o)) || o);
  return s && o && B(t, a, o), o;
}, A = (e, t, a) => t.has(e) || C("Cannot " + a), l = (e, t, a) => (A(e, t, "read from private field"), t.get(e)), x = (e, t, a) => t.has(e) ? C("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), y = (e, t, a, s) => (A(e, t, "write to private field"), t.set(e, a), a), v, b, p;
function k() {
  return document.createElement("div");
}
let r = class extends w(D) {
  constructor() {
    super(), this._formData = {}, this._topicCategories = [], this._templates = [], this._availableTokens = [], this._availableAttachments = [], this._isSaving = !1, this._isLoadingMetadata = !0, this._activePath = "tab/details", this._routerPath = "", this._fieldErrors = {}, this._isNew = !0, this._testEmailRecipient = "", this._isSendingTest = !1, x(this, v), x(this, b), x(this, p), this._routes = [
    ...
    try {
      if (this._isNew) {
        ...
        if (t) {
          ...
          s && l(this, v)?.updateEmail(s), l(this, p)?.peek("positive", {
      ...
      (e) => i`
        ...
        this._handleAttachmentToggle(e.alias, a.checked);
                      ...
                      <div class="attachment-info">
                        ${e.iconSvg ? i`<span class="attachment-icon" .innerHTML=${e.iconSvg}></span>` : u}
...
//# sourceMappingURL=email-editor.element-BzPNDRbG.js.map
