import { nothing as c, html as u, css as h, state as n, customElement as y } from "@umbraco-cms/backoffice/external/lit";
...
var v = Object.defineProperty, g = Object.getOwnPropertyDescriptor, l = (e, r, i, a) => {
  for (var t = a > 1 ? void 0 : a ? g(r, i) : r, s = e.length - 1, d; s >= 0; s--)
    (d = e[s]) && (t = (a ? d(r, i, t) : d(t)) || t);
...
let o = class extends _ {
  ...
  async _handleSubmit(e) {
    ...
    if (this._isEditMode) {
      const a = this.data?.productType?.id;
      if (!a) {
        this._generalError = "Product type ID is missing", this._isSaving = !1;
        return;
      }
      const { data: t, error: s } = await p.updateProductType(a, {
        name: i
      });
      ...
      const { data: a, error: t } = await p.createProductType({
        name: i
      });
      ...
      this.value = { productType: a, isCreated: !0 }, this.modalContext?.submit();
    }
  }
  _handleCancel() {
  ...
  render() {
    const e = this._isEditMode ? "Edit Product Type" : "Add Product Type", r = this._isEditMode ? "Save Changes" : "Create Product Type", i = this._isEditMode ? "Saving..." : "Creating...";
    return u`
...
o = l([
  y("merchello-product-type-modal")
], o);
const $ = o;
export {
...
//# sourceMappingURL=product-type-modal.element-DWUsxmwC.js.map
