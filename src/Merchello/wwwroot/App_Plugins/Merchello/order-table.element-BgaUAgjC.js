...
import { d as f, O as v, e as g, g as C, a as y, h as _ } from "./formatting-nNQcXJwZ.js";
import { g as $ } from "./navigation-Y0bwD8V1.js";
import { b as k } from "./badge.styles-DUcdl6GY.js";
var S = Object.defineProperty, x = Object.getOwnPropertyDescriptor, i = (e, t, a, r) => {
  for (var c = r > 1 ? void 0 : r ? x(t, a) : t, n = e.length - 1, o; n >= 0; n--)
    (o = e[n]) && (c = (r ? o(t, a, c) : o(c)) || c);
  return r && c && S(t, a, c), c;
};
  ...
  _renderCell(e, t) {
    switch (t) {
      ...
      case "invoiceNumber":
        ...
        `;
      case "date":
        return l`<uui-table-cell>${_(e.dateCreated)}</uui-table-cell>`;
      case "customer":
      ...
      case "fulfillmentStatus":
        return l`
          <uui-table-cell>
            <span class="badge ${C(e.fulfillmentStatus)}">
              ${e.fulfillmentStatus}
            </span>
          </uui-table-cell>
        `;
      case "itemCount":
        return l`<uui-table-cell>${g(e.itemCount)}</uui-table-cell>`;
      case "deliveryMethod":
...
//# sourceMappingURL=order-table.element-BgaUAgjC.js.map
