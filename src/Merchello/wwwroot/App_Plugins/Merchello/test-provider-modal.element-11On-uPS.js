...
import { g as S, b as m } from "./store-settings-DgxY_Kcz.js";
import { b as x } from "./formatting-DU6_gkL3.js";
import { m as L } from "./modal-layout.styles-C2OaUji5.js";
var T = Object.defineProperty, z = Object.getOwnPropertyDescriptor, C = (t) => {
  throw TypeError(t);
}, o = (t, e, r, u) => {
  for (var l = u > 1 ? void 0 : u ? z(e, r) : e, h = t.length - 1, p; h >= 0; h--)
    (p = t[h]) && (l = (u ? p(e, r, l) : p(l)) || l);
  return u && l && T(e, r, l), l;
}, f = (t, e, r) => e.has(t) || C("Cannot " + r), v = (t, e, r) => (f(t, e, "read from private field"), e.get(t)), I = (t, e, r) => e.has(t) ? C("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), _ = (t, e, r, u) => (f(t, e, "write to private field"), e.set(t, r), r), c;
const y = "merchello-test-provider-form";
let i = class extends $ {
  constructor() {
    super(...arguments), this._warehouseId = "", this._countryCode = "", this._regionCode = "", this._postalCode = "", this._city = "", this._weightKg = 1, this._lengthCm = "", this._widthCm = "", this._heightCm = "", this._itemsSubtotal = 100, this._warehouses = [], this._countries = [], this._regions = [], this._isLoadingData = !0, this._isLoadingRegions = !1, this._isTesting = !1, this._errorMessage = null, I(this, c, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=test-provider-modal.element-11On-uPS.js.map
