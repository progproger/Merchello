...
import { UmbModalToken as $, UmbModalBaseElement as w, UMB_MODAL_MANAGER_CONTEXT as G, UMB_CONFIRM_MODAL as f } from "@umbraco-cms/backoffice/modal";
...
var S = Object.defineProperty, z = Object.getOwnPropertyDescriptor, T = (e) => {
  throw TypeError(e);
}, d = (e, i, a, s) => {
  for (var o = s > 1 ? void 0 : s ? z(i, a) : i, b = e.length - 1, m; b >= 0; b--)
    (m = e[b]) && (o = (s ? m(i, a, o) : m(o)) || o);
  return s && o && S(i, a, o), o;
...
let l = class extends w {
  ...
  async _handleAddTaxGroup() {
    const i = await r(this, p)?.open(this, x, {
      data: {}
    })?.onSubmit().catch(() => {
    });
  ...
  async _handleEditTaxGroup(e) {
    const a = await r(this, p)?.open(this, x, {
      data: { taxGroup: e }
    })?.onSubmit().catch(() => {
    });
  ...
  async _handleDeleteOverride(e, i) {
    e.preventDefault(), e.stopPropagation();
    const a = i.regionName ? `${i.countryName} - ${i.regionName}` : i.countryName || i.countryCode, s = r(this, p)?.open(this, f, {
      data: {
...
//# sourceMappingURL=tax-provider-config-modal.element-0FxH-iRv.js.map
