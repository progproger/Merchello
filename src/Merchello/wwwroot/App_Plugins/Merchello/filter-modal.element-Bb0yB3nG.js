  ...
  async _handleSave() {
    if (this._validate())
      if (this._isSaving = !0, this._isEditMode) {
        ...
        this.value = { filter: t, updated: !0 }, this.modalContext?.submit();
      } else {
        ...
        this.value = { filter: t, created: !0 }, this.modalContext?.submit();
      }
  }
  async _handleDelete() {
    const e = this.data?.filter?.id;
    ...
    this.value = { deleted: !0 }, this.modalContext?.submit();
  }
  _handleCancel() {
...
//# sourceMappingURL=filter-modal.element-Bb0yB3nG.js.map
