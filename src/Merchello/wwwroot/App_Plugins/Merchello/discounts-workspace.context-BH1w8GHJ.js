...
import { i as a } from "./bundle.manifests-BpTbgcjM.js";
import { D as h, a as d, b as p, c as m, d as g } from "./discount.types-oO6YJLvR.js";
import { M as f } from "./merchello-api-D-qg1PlO.js";
import { g as y } from "./store-settings-Silr5K1w.js";
const S = "Merchello.Discounts.Workspace";
class _ extends n {
  constructor(t) {
    super(t, u.toString()), this.workspaceAlias = S, this.#o = new r(this), this.#e = !1, this.#n = 1e3, this.#s = new l(void 0), this.discount = this.#s.asObservable(), this.#a = new i(!1), this.isLoading = this.#a.asObservable(), this.#r = new i(!1), this.isSaving = this.#r.asObservable(), this.#o.setEntityType(a), this.#o.setUnique("discounts"), this.routes = new c(t), this._loadSettings(), this.routes.setRoutes([
      // Create discount route (before :id to avoid matching "create" as an id)
      {
        path: "edit/discounts/create",
        component: () => import("./discount-detail.element-DMeqt6O5.js"),
        setup: () => {
...
//# sourceMappingURL=discounts-workspace.context-BH1w8GHJ.js.map
