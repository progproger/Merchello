import { html as r, css as b, state as u, customElement as m } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as v } from "@umbraco-cms/backoffice/modal";
import { M as g } from "./merchello-api-EmrUndo3.js";
var f = Object.defineProperty, y = Object.getOwnPropertyDescriptor, p = (e) => {
  throw TypeError(e);
}, c = (e, t, s, i) => {
  for (var l = i > 1 ? void 0 : i ? y(t, s) : t, o = e.length - 1, n; o >= 0; o--)
    (n = e[o]) && (l = (i ? n(t, s, l) : n(l)) || l);
  return i && l && f(t, s, l), l;
}, _ = (e, t, s) => t.has(e) || p("Cannot " + s), x = (e, t, s) => (_(e, t, "read from private field"), t.get(e)), S = (e, t, s) => t.has(e) ? p("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), h = (e, t, s, i) => (_(e, t, "write to private field"), t.set(e, s), s), d;
let a = class extends v {
  constructor() {
    super(...arguments), this._selectedIds = [], this._selectedNames = [], this._suppliers = [], this._isLoading = !0, this._errorMessage = null, S(this, d, !1);
  }
  connectedCallback() {
    super.connectedCallback(), h(this, d, !0), this._loadSuppliers();
  }
  ...
  async _loadSuppliers() {
    ...
    const { data: e, error: t } = await g.getSuppliers();
    if (!x(this, d)) return;
    if (t) {
...
a = c([
  m("merchello-supplier-picker-modal")
], a);
const I = a;
export {
...
//# sourceMappingURL=supplier-picker-modal.element-BlJX0Y5Q.js.map
