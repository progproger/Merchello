...
import { c as d } from "./formatting-YHMza1vS.js";
...
var N = Object.defineProperty, E = Object.getOwnPropertyDescriptor, I = (e) => {
  throw TypeError(e);
}, c = (e, i, s, t) => {
  for (var o = t > 1 ? void 0 : t ? E(i, s) : i, r = e.length - 1, g; r >= 0; r--)
    (g = e[r]) && (o = (t ? g(i, s, o) : g(o)) || o);
  return t && o && N(i, s, o), o;
}, C = (e, i, s) => i.has(e) || I("Cannot " + s), v = (e, i, s) => (C(e, i, "read from private field"), i.get(e)), $ = (e, i, s) => i.has(e) ? I("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, s), k = (e, i, s, t) => (C(e, i, "write to private field"), i.set(e, s), s), h, _;
let u = class extends R {
  constructor() {
    super(), this._invoice = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._editReason = "", this._orders = [], this._lineItems = [], this._customItems = [], this._pendingProducts = [], this._taxGroups = [], this._removedShippingOrders = /* @__PURE__ */ new Set(), this._taxRemoved = !1, this._removedOrderDiscounts = /* @__PURE__ */ new Set(), this._pendingOrderDiscounts = [], this._pendingOrderDiscountCodes = [], this._previewResult = null, this._previewLoading = !1, $(this, h), $(this, _), this.consumeContext(A, (e) => {
      k(this, h, e);
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, s = this._subtotalBeforeDiscounts, t = this._discountTotal, o = this._adjustedSubtotal, r = this._newTax, g = this._newTotal, f = this._hasChanges(), m = this._lineItems.filter((a) => a.isRemoved), P = t > 0, w = this._previewResult?.warnings ?? [];
    return n`
...
//# sourceMappingURL=edit-order-modal.element-Cai8DfGg.js.map
