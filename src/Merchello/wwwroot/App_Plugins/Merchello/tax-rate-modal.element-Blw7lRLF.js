import { nothing as g, html as s, css as v, state as n, customElement as f } from "@umbraco-cms/backoffice/external/lit";
...
import { M as c } from "./merchello-api-B76CV0sD.js";
import { m as x } from "./modal-layout.styles-C2OaUji5.js";
var b = Object.defineProperty, R = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, r = (e, t, i, d) => {
  for (var u = d > 1 ? void 0 : d ? R(t, i) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (u = (d ? h(t, i, u) : h(u)) || u);
  return d && u && b(t, i, u), u;
}, m = (e, t, i) => t.has(e) || _("Cannot " + i), l = (e, t, i) => (m(e, t, "read from private field"), t.get(e)), S = (e, t, i) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), $ = (e, t, i, d) => (m(e, t, "write to private field"), t.set(e, i), i), o;
let a = class extends C {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._countryCode = "", this._regionCode = "", this._taxPercentage = 0, this._countries = [], this._regions = [], S(this, o), this.consumeContext(y, (e) => {
      $(this, o, e);
    });
  }
  connectedCallback() {
...
//# sourceMappingURL=tax-rate-modal.element-Blw7lRLF.js.map
