...
import { b as S } from "./formatting-MfE1tvkN.js";
...
var E = Object.defineProperty, D = Object.getOwnPropertyDescriptor, f = (e) => {
  ...
  for (var u = i > 1 ? void 0 : i ? D(t, a) : t, g = e.length - 1, m; g >= 0; g--)
    (m = e[g]) && (u = (i ? m(t, a, u) : m(u)) || u);
  return i && u && E(t, a, u), u;
}, v = (e, t, a) => t.has(e) || f("Cannot " + a), o = (e, t, a) => (v(e, t, "read from private field"), t.get(e)), x = (e, t, a) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), b = (e, t, a, i) => (v(e, t, "write to private field"), t.set(e, a), a), n, c;
let s = class extends $ {
  constructor() {
  ...
  async _handleDeleteRate(e) {
    ...
    const t = e.regionName ? `${e.countryName ?? e.countryCode} - ${e.regionName}` : e.countryName ?? e.countryCode, a = o(this, n).open(this, C, {
      data: {
        ...
        content: `Delete the tax rate for ${t}.`,
        confirmLabel: "Delete",
        color: "danger"
      }
    });
    ...
    return r`
      ...
      (e) => r`
                      <uui-table-row>
                        ...
                        <uui-table-cell>
                          ${e.regionName ?? e.regionCode ?? "All regions"}
                        </uui-table-cell>
...
//# sourceMappingURL=tax-group-modal.element-JbqM0RBi.js.map
