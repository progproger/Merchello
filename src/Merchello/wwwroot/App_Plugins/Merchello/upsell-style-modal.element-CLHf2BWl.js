...
var y = Object.defineProperty, f = Object.getOwnPropertyDescriptor, u = (e, t, i, r) => {
  for (var l = r > 1 ? void 0 : r ? f(t, i) : t, a = e.length - 1, o; a >= 0; a--)
    (o = e[a]) && (l = (r ? o(t, i, l) : o(l)) || l);
  return r && l && y(t, i, l), l;
};
const c = [
...
let d = class extends m {
  ...
  _setElementStyle(e, t, i) {
    const r = { ...this._styles }, l = { ...this._getSurfaceStyle(e) }, a = { ...this._getElementStyle(e, t) }, o = i(a);
    this._isElementStyleEmpty(o) ? delete l[t] : l[t] = o, this._isSurfaceStyleEmpty(l) ? delete r[e] : r[e] = l, this._styles = r;
  }
  _handleColorChange(e, t, i, r) {
    const a = r.target.value?.trim() ?? "";
    this._setElementStyle(e, t, (o) => ({
      ...o,
      [i]: a || void 0
    }));
  }
  ...
  _handleNumberChange(e, t, i, r) {
    ...
    const o = Number(a);
    !Number.isFinite(o) || o < 0 || this._setElementStyle(e, t, (n) => ({
      ...n,
      [i]: Math.round(o)
    }));
  }
  ...
  _normalizeStyles(e) {
    ...
    for (const i of c) {
      ...
      for (const a of p) {
        ...
        if (!o) continue;
        const n = {
          textColor: o.textColor?.trim() || void 0,
          backgroundColor: o.backgroundColor?.trim() || void 0,
          borderColor: o.borderColor?.trim() || void 0,
          borderStyle: o.borderStyle?.trim() || void 0,
          borderWidth: o.borderWidth,
          borderRadius: o.borderRadius
        };
        this._isElementStyleEmpty(n) || (l[a.key] = n);
      }
      this._isSurfaceStyleEmpty(l) || (t[i.key] = l);
    }
...
//# sourceMappingURL=upsell-style-modal.element-CLHf2BWl.js.map
