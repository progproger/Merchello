import { nothing as r, html as a, css as b, state as c, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
var k = Object.defineProperty, x = Object.getOwnPropertyDescriptor, _ = (e) => {
  ...
  for (var t = l > 1 ? void 0 : l ? x(i, s) : i, d = e.length - 1, p; d >= 0; d--)
    (p = e[d]) && (t = (l ? p(i, s, t) : p(t)) || t);
  return l && t && k(i, s, t), t;
}, m = (e, i, s) => i.has(e) || _("Cannot " + s), v = (e, i, s) => (m(e, i, "read from private field"), i.get(e)), S = (e, i, s) => i.has(e) ? _("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, s), g = (e, i, s, l) => (m(e, i, "write to private field"), i.set(e, s), s), n;
          ...
          <div class="form-field">
            ...
            <div class="password-field-wrapper">
              <uui-input
                ...
                placeholder="${e.placeholder ?? ""}"
                ?required=${e.isRequired}
                @input=${(l) => this._handleValueChange(e.key, l.target.value)}
              ></uui-input>
              <uui-button
                compact
                look="secondary"
...
o = u([
  $("merchello-address-lookup-provider-config-modal")
], o);
const q = o;
export {
...
//# sourceMappingURL=address-lookup-provider-config-modal.element-DyB4ZTvb.js.map
