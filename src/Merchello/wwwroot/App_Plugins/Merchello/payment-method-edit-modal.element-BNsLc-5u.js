...
import { g as b } from "./brand-icons-AsNEBTKB.js";
...
let s = class extends C {
  constructor() {
    super(), this._displayNameOverride = "", this._iconMediaKey = null, this._backgroundColor = "", this._borderColor = "", this._textColor = "", this._useSelectedColors = !1, this._selectedBackgroundColor = "", this._selectedBorderColor = "", this._selectedTextColor = "", this._isSaving = !1, this._errorMessage = null, S(this, u), this.consumeContext(f, (e) => {
      $(this, u, e);
    });
  }
  connectedCallback() {
  ...
  async _handleSave() {
    ...
    const { error: i } = await y.updatePaymentMethodSetting(
      e,
      o.methodAlias,
      r
    );
...
//# sourceMappingURL=payment-method-edit-modal.element-BNsLc-5u.js.map
