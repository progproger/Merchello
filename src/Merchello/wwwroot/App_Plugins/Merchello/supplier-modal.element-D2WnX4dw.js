...
import { M as c } from "./merchello-api-CkNG-K-m.js";
  ...
  async _handleSave() {
    if (this._validate())
      if (this._isSaving = !0, this._isEditMode) {
        ...
        this.value = { supplier: i, updated: !0 }, this.modalContext?.submit();
      } else {
        ...
        this.value = { supplier: e, created: !0 }, this.modalContext?.submit();
      }
  }
  _handleCancel() {
...
//# sourceMappingURL=supplier-modal.element-D2WnX4dw.js.map
