import { LitElement as x, html as t, nothing as z, css as E, state as l, customElement as R } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as k } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as _, UMB_MODAL_MANAGER_CONTEXT as w } from "@umbraco-cms/backoffice/modal";
...
import { g as M } from "./store-settings-BBNVgcWv.js";
const A = new _("Merchello.ExchangeRateProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), $ = new _("Merchello.ExchangeRateProvider.Test.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var P = Object.defineProperty, L = Object.getOwnPropertyDescriptor, b = (e) => {
  throw TypeError(e);
}, d = (e, i, a, p) => {
  for (var n = p > 1 ? void 0 : p ? L(i, a) : i, g = e.length - 1, m; g >= 0; g--)
    (m = e[g]) && (n = (p ? m(i, a, n) : m(n)) || n);
  return p && n && P(i, a, n), n;
}, y = (e, i, a) => i.has(e) || b("Cannot " + a), s = (e, i, a) => (y(e, i, "read from private field"), i.get(e)), f = (e, i, a) => i.has(e) ? b("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), h = (e, i, a, p) => (y(e, i, "write to private field"), i.set(e, a), a), c, u, o;
let r = class extends k(x) {
  constructor() {
    super(), this._providers = [], this._snapshot = null, this._isLoading = !0, this._isRefreshing = !1, this._errorMessage = null, this._storeCurrency = "USD", f(this, c), f(this, u), f(this, o, !1), this.consumeContext(w, (e) => {
      h(this, c, e);
        ...
        <div class="provider-main">
          <div class="provider-info">
            ...
            <div class="provider-details">
              ...
              ${e.description ? t`<p class="provider-description">${e.description}</p>` : z}
            </div>
          </div>
...
r = d([
  R("merchello-exchange-rate-providers-list")
], r);
const B = r;
export {
...
//# sourceMappingURL=exchange-rate-providers-list.element-BTlWm_iS.js.map
