...
import { UmbModalToken as z, UMB_MODAL_MANAGER_CONTEXT as O, UMB_CONFIRM_MODAL as A } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as N } from "@umbraco-cms/backoffice/notification";
import { M as b } from "./merchello-api-NdGX4WPd.js";
import { g as P } from "./formatting-DU6_gkL3.js";
import { c as U } from "./collection-layout.styles-I8XQedsa.js";
const D = new z("Merchello.FulfilmentProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), W = new z("Merchello.TestFulfilmentProvider.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var j = Object.defineProperty, B = Object.getOwnPropertyDescriptor, I = (e) => {
  throw TypeError(e);
}, u = (e, i, t, a) => {
  for (var o = a > 1 ? void 0 : a ? B(i, t) : i, d = e.length - 1, g; d >= 0; d--)
    (g = e[d]) && (o = (a ? g(i, t, o) : g(o)) || o);
  return a && o && j(i, t, o), o;
}, T = (e, i, t) => i.has(e) || I("Cannot " + t), x = (e, i, t) => (T(e, i, "read from private field"), i.get(e)), H = (e, i, t) => i.has(e) ? I("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), C = (e, i, t, a) => (T(e, i, "write to private field"), i.set(e, t), t), m;
...
var G = Object.defineProperty, K = Object.getOwnPropertyDescriptor, E = (e) => {
  ...
  for (var o = a > 1 ? void 0 : a ? K(i, t) : i, d = e.length - 1, g; d >= 0; d--)
    (g = e[d]) && (o = (a ? g(i, t, o) : g(o)) || o);
  return a && o && G(i, t, o), o;
...
let v = class extends L($) {
  ...
  _renderConfiguredProvider(e) {
    const i = this._availableProviders.find((d) => d.key === e.key), t = e.key !== X, a = i?.supportsWebhooks ?? e.supportsWebhooks, o = `${window.location.origin}/umbraco/merchello/webhooks/fulfilment/${e.key}`;
    return r`
...
//# sourceMappingURL=fulfilment-providers-list.element-V9z955F7.js.map
