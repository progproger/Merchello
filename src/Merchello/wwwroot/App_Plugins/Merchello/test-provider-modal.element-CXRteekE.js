...
let n = class extends V {
  ...
  async _loadExpressButton(e) {
    ...
    try {
      ...
      p || (p = document.createElement("div"), p.id = `merchello-express-container-${e.methodAlias}-${Date.now()}`, this._getLightDomHost().appendChild(p), r(this, f).set(e.methodAlias, p)), this._positionLightDomContainer(c, p), p.style.display = "block", p.innerHTML = "";
      ...
      const R = {
        isProcessing: !1,
        error: null,
        processExpressCheckout: async (P, B, T, G, H) => {
          this._expressResult = {
            success: !0,
...
//# sourceMappingURL=test-provider-modal.element-CXRteekE.js.map
