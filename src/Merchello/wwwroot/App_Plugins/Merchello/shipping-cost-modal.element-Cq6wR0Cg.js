import { nothing as _, html as r, css as C, state as a, customElement as m } from "@umbraco-cms/backoffice/external/lit";
...
import { b as g, g as S } from "./store-settings-DgxY_Kcz.js";
import { m as w } from "./modal-layout.styles-C2OaUji5.js";
var x = Object.defineProperty, $ = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, s = (e, t, o, d) => {
  for (var u = d > 1 ? void 0 : d ? $(t, o) : t, h = e.length - 1, p; h >= 0; h--)
    (p = e[h]) && (u = (d ? p(t, o, u) : p(u)) || u);
  return d && u && x(t, o, u), u;
}, f = (e, t, o) => t.has(e) || y("Cannot " + o), c = (e, t, o) => (f(e, t, "read from private field"), t.get(e)), R = (e, t, o) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, o), E = (e, t, o, d) => (f(e, t, "write to private field"), t.set(e, o), o), n;
let i = class extends v {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._countryCode = "", this._regionCode = "", this._cost = 0, this._currencySymbol = g(), this._countries = [], this._regions = [], R(this, n), this.consumeContext(b, (e) => {
      E(this, n, e);
    });
  }
  connectedCallback() {
...
i = s([
  m("merchello-shipping-cost-modal")
], i);
const I = i;
export {
...
//# sourceMappingURL=shipping-cost-modal.element-Cq6wR0Cg.js.map
