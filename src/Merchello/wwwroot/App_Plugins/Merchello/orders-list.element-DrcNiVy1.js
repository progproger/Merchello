import { LitElement as x, html as c, css as O, state as r, customElement as T } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as S } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as b, UMB_MODAL_MANAGER_CONTEXT as C } from "@umbraco-cms/backoffice/modal";
...
import "./order-table.element-D3rb0f-x.js";
import { n as k } from "./navigation-D1KCp5wk.js";
...
var z = Object.defineProperty, D = Object.getOwnPropertyDescriptor, f = (e) => {
  ...
  for (var n = l > 1 ? void 0 : l ? D(t, i) : t, _ = e.length - 1, m; _ >= 0; _--)
    (m = e[_]) && (n = (l ? m(t, i, n) : m(n)) || n);
  return l && n && z(t, i, n), n;
}, y = (e, t, i) => t.has(e) || f("Cannot " + i), o = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), v = (e, t, i) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, l) => (y(e, t, "write to private field"), t.set(e, i), i), u, h, d;
let a = class extends S(x) {
  ...
  async _handleCreateOrder() {
    ...
    o(this, d) && t?.created && t.invoiceId && k(t.invoiceId);
  }
  _renderLoadingState() {
...
//# sourceMappingURL=orders-list.element-DrcNiVy1.js.map
