import { LitElement as P, html as d, nothing as T, css as k, state as h, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as M } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as z, UMB_MODAL_MANAGER_CONTEXT as C } from "@umbraco-cms/backoffice/modal";
...
const v = new z("Merchello.ProductType.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var E = Object.defineProperty, $ = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, l = (e, t, i, a) => {
  for (var n = a > 1 ? void 0 : a ? $(t, i) : t, y = e.length - 1, m; y >= 0; y--)
...
let s = class extends M(P) {
  constructor() {
    super(), this._productTypes = [], this._isLoading = !0, this._errorMessage = null, this._deletingId = null, g(this, c), g(this, u), g(this, o, !1), this.consumeContext(C, (e) => {
      p(this, c, e);
  ...
  async _loadProductTypes() {
    ...
    const { data: e, error: t } = await f.getProductTypes();
    if (r(this, o)) {
      if (t) {
  ...
  async _handleAddProductType() {
    const t = await r(this, c)?.open(this, v, {
      data: {}
    })?.onSubmit().catch(() => {
    });
    r(this, o) && t?.created && (r(this, u)?.peek("positive", {
      data: {
  ...
  async _handleEditProductType(e) {
    const i = await r(this, c)?.open(this, v, {
      data: { productType: e }
    })?.onSubmit().catch(() => {
    });
    r(this, o) && i?.updated && (r(this, u)?.peek("positive", {
      data: {
...
//# sourceMappingURL=product-types-list.element-BW3rUjtS.js.map
