import { LitElement as f, nothing as k, html as u, css as y, property as x, customElement as $, state as o } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as w } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as T, UMB_MODAL_MANAGER_CONTEXT as P } from "@umbraco-cms/backoffice/modal";
import { I as d } from "./order.types-DjkMLpgj.js";
import { M as b } from "./merchello-api-CzSx3Q3Y.js";
import { c as z, a as C } from "./formatting-CH1NCLNK.js";
function D(e) {
  if (e.totalItems === 0)
    return "0 items";
...
var M = Object.defineProperty, E = Object.getOwnPropertyDescriptor, g = (e, t, a, s) => {
  for (var r = s > 1 ? void 0 : s ? E(t, a) : t, n = e.length - 1, c; n >= 0; n--)
    (c = e[n]) && (r = (s ? c(t, a, r) : c(r)) || r);
  return s && r && M(t, a, r), r;
};
let p = class extends w(f) {
  constructor() {
  ...
  _handleNext() {
    _(this.state) && !this.disabled && this._dispatchPageChange(this.state.page + 1);
  }
  ...
  render() {
    if (this.state.totalItems === 0)
      return k;
    const e = v(this.state), t = _(this.state);
    return u`
...
const I = new T("Merchello.Export.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var L = Object.defineProperty, A = Object.getOwnPropertyDescriptor, O = (e) => {
  throw TypeError(e);
}, l = (e, t, a, s) => {
  for (var r = s > 1 ? void 0 : s ? A(t, a) : t, n = e.length - 1, c; n >= 0; n--)
    (c = e[n]) && (r = (s ? c(t, a, r) : c(r)) || r);
  return s && r && L(t, a, r), r;
}, S = (e, t, a) => t.has(e) || O("Cannot " + a), m = (e, t, a) => (S(e, t, "read from private field"), t.get(e)), N = (e, t, a) => t.has(e) ? O("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), U = (e, t, a, s) => (S(e, t, "write to private field"), t.set(e, a), a), h;
let i = class extends w(f) {
  constructor() {
    super(), this._orders = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedOrders = /* @__PURE__ */ new Set(), this._stats = null, this._searchTerm = "", this._isDeleting = !1, this._searchDebounceTimer = null, N(this, h), this.consumeContext(P, (e) => {
      U(this, h, e);
    });
  }
  connectedCallback() {
  ...
  _getPaymentStatusBadgeClass(e) {
    switch (e) {
      case d.Paid:
        return "paid";
      case d.PartiallyPaid:
        return "partial";
      case d.Refunded:
      case d.PartiallyRefunded:
        return "refunded";
      case d.AwaitingPayment:
        return "awaiting";
      default:
        return "unpaid";
    }
  ...
  _renderErrorState() {
    return u`<div class="error">${this._errorMessage}</div>`;
  }
  _renderEmptyState() {
    return u`
    ...
    return u`
      ...
      (e) => u`
              <uui-table-row>
                ...
                <uui-table-cell>${z(e.dateCreated)}</uui-table-cell>
...
//# sourceMappingURL=orders-list.element-tGPBeGRh.js.map
