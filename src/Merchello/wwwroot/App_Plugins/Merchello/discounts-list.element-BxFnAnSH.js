import { LitElement as S, nothing as D, html as o, css as x, property as y, customElement as w, state as r } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as M } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as P, UMB_MODAL_MANAGER_CONTEXT as I } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as L } from "@umbraco-cms/backoffice/notification";
import { M as T } from "./merchello-api-DXy2hS5y.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { D as b, a as f, b as k, c as $, d as z } from "./discount.types-fIKwcJXq.js";
import { e as O } from "./formatting-DbC6qaCT.js";
import { h as U, i as B, j as N } from "./navigation-BP2IjQvn.js";
import { b as F } from "./badge.styles-DUcdl6GY.js";
var R = Object.defineProperty, j = Object.getOwnPropertyDescriptor, m = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? j(t, a) : t, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (i = (s ? u(t, a, i) : u(i)) || i);
  return s && i && R(t, a, i), i;
};
let p = class extends M(S) {
  constructor() {
      ...
      (e) => o`
            ...
            >
              ...
              <uui-table-cell class="name-cell">
                <a href=${U(e.id)} @click=${(t) => t.stopPropagation()}>
                  ${e.name}
                </a>
...
const G = new P("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var V = Object.defineProperty, W = Object.getOwnPropertyDescriptor, A = (e) => {
  throw TypeError(e);
}, c = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? W(t, a) : t, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (i = (s ? u(t, a, i) : u(i)) || i);
  return s && i && V(t, a, i), i;
}, E = (e, t, a) => t.has(e) || A("Cannot " + a), d = (e, t, a) => (E(e, t, "read from private field"), t.get(e)), C = (e, t, a) => t.has(e) ? A("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), v = (e, t, a, s) => (E(e, t, "write to private field"), t.set(e, a), a), _, g, h;
let l = class extends M(S) {
  constructor() {
    super(), this._discounts = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedDiscounts = /* @__PURE__ */ new Set(), this._searchTerm = "", this._isDeleting = !1, this._searchDebounceTimer = null, C(this, _), C(this, g), C(this, h, !1), this.consumeContext(I, (e) => {
      v(this, _, e);
  ...
  async _handleDeleteSelected() {
    ...
    if (e === 0 || !confirm(
      `Are you sure you want to delete ${e} discount${e !== 1 ? "s" : ""}? This action cannot be undone.`
    )) return;
    this._isDeleting = !0;
    const a = Array.from(this._selectedDiscounts);
    let s = 0, i = 0;
    for (const n of a) {
      const { error: u } = await T.deleteDiscount(n);
      if (!d(this, h)) return;
      u ? i++ : s++;
    }
    this._isDeleting = !1, i > 0 ? d(this, g)?.peek("warning", {
  ...
  async _handleCreateDiscount() {
    if (!d(this, _)) return;
    const t = await d(this, _).open(this, G, {
      data: {}
    }).onSubmit().catch(() => {
    });
    d(this, h) && t?.selectedCategory !== void 0 && B(t.selectedCategory);
  }
...
//# sourceMappingURL=discounts-list.element-BxFnAnSH.js.map
