...
import { UmbModalToken as E, UMB_MODAL_MANAGER_CONTEXT as z, UMB_CONFIRM_MODAL as A } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as P } from "@umbraco-cms/backoffice/notification";
import { c as $, d as m } from "./discount.types-Du4rtOaW.js";
import { M as C } from "./merchello-api-BuImeZL2.js";
import { g as I } from "./store-settings-ovrk2IWq.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { e as L } from "./formatting-DGOWmvpU.js";
import { f as O, h as U, i as N } from "./navigation-BGhEgega.js";
import { b as B } from "./badge.styles-DUcdl6GY.js";
var R = Object.defineProperty, W = Object.getOwnPropertyDescriptor, g = (e, t, i, s) => {
...
let p = class extends x(k) {
  ...
  _getMethodIcon(e) {
    return e === $.Automatic ? "icon-bolt" : "icon-receipt-dollar";
  }
  _formatUsage(e) {
      ...
      (e) => o`
            ...
            >
              ...
              <uui-table-cell class="name-cell">
                <a href=${O(e.id)} @click=${(t) => t.stopPropagation()}>
                  ${e.name}
                </a>
...
const j = new E("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var H = Object.defineProperty, F = Object.getOwnPropertyDescriptor, w = (e) => {
  throw TypeError(e);
}, c = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? F(t, i) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (a = (s ? d(t, i, a) : d(a)) || a);
...
let l = class extends x(k) {
  ...
  async _loadDiscounts() {
    ...
    const { data: t, error: i } = await C.getDiscounts(e);
    if (n(this, h)) {
      if (i) {
  ...
  async _handleDeleteSelected() {
    ...
    let s = 0, a = 0;
    for (const u of i) {
      const { error: d } = await C.deleteDiscount(u);
      if (!n(this, h)) return;
      d ? a++ : s++;
    }
  ...
  async _handleCreateDiscount() {
    if (!n(this, b)) return;
    const t = await n(this, b).open(this, j, {
      data: {}
    }).onSubmit().catch(() => {
    });
...
//# sourceMappingURL=discounts-list.element-GmK073OR.js.map
