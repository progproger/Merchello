import { html as a, nothing as d, css as f, state as n, customElement as y } from "@umbraco-cms/backoffice/external/lit";
...
var $ = Object.defineProperty, b = Object.getOwnPropertyDescriptor, m = (e) => {
  throw TypeError(e);
}, o = (e, t, r, i) => {
  for (var u = i > 1 ? void 0 : i ? b(t, r) : t, h = e.length - 1, c; h >= 0; h--)
    (c = e[h]) && (u = (i ? c(t, r, u) : c(u)) || u);
  return i && u && $(t, r, u), u;
}, g = (e, t, r) => t.has(e) || m("Cannot " + r), _ = (e, t, r) => (g(e, t, "read from private field"), t.get(e)), w = (e, t, r) => t.has(e) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), x = (e, t, r, i) => (g(e, t, "write to private field"), t.set(e, r), r), l;
let s = class extends v {
  constructor() {
    super(), w(this, l), this._isLoading = !0, this._isSaving = !1, this._productTypes = [], this._taxGroups = [], this._warehouses = [], this._formData = {
      name: "",
      sku: "",
      price: 0,
      productTypeId: "",
      taxGroupId: "",
      warehouseIds: []
    }, this._errors = {}, this.consumeContext(I, (e) => {
      x(this, l, e);
    });
  }
...
//# sourceMappingURL=create-product-modal.element-ocrKiSJq.js.map
