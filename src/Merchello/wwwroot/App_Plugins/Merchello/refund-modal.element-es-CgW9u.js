import { nothing as t, html as n, css as m, state as u, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as h } from "@umbraco-cms/backoffice/modal";
import { M as v } from "./merchello-api-Z_Hs6xGH.js";
import { a as p, b } from "./formatting-DRJa6LJv.js";
var g = Object.defineProperty, y = Object.getOwnPropertyDescriptor, o = (e, a, i, l) => {
  for (var s = l > 1 ? void 0 : l ? y(a, i) : a, d = e.length - 1, c; d >= 0; d--)
    (c = e[d]) && (s = (l ? c(a, i, s) : c(s)) || s);
  return l && s && g(a, i, s), s;
};
    ...
    return n`
      ...
      this._isManualRefund = i.target.checked;
        ...
        <div slot="actions">
          ...
          >
            ${this._isSaving ? n`<uui-loader-circle></uui-loader-circle>` : t}
            Process Refund
          </uui-button>
        </div>
      </umb-body-layout>
...
//# sourceMappingURL=refund-modal.element-es-CgW9u.js.map
