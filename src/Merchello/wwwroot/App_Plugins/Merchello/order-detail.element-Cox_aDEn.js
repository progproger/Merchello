import { LitElement as q, nothing as o, html as a, css as K, state as n, customElement as X, property as se, unsafeHTML as _e } from "@umbraco-cms/backoffice/external/lit";
import { g as ie, p as ke } from "./purify.es-CDO-jhEy.js";
import { UmbElementMixin as Y } from "@umbraco-cms/backoffice/element-api";
import { UMB_WORKSPACE_CONTEXT as oe } from "@umbraco-cms/backoffice/workspace";
import { UmbModalToken as G, UMB_MODAL_MANAGER_CONTEXT as ee, UMB_CONFIRM_MODAL as Z } from "@umbraco-cms/backoffice/modal";
...
import { f as N, a as c, e as Se } from "./formatting-SQYZJ8LX.js";
import { M as v } from "./merchello-api-BtThjGiA.js";
...
}), De = new G("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var Me = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, le = (e) => {
  throw TypeError(e);
}, k = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? Ee(i, t) : i, u = e.length - 1, m; u >= 0; u--)
    (m = e[u]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Me(i, t, r), r;
}, ue = (e, i, t) => i.has(e) || le("Cannot " + t), d = (e, i, t) => (ue(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? le("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), B = (e, i, t, s) => (ue(e, i, "write to private field"), i.set(e, t), t), P, M, x, w;
let b = class extends Y(q) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, this._hasOutstandingBalance = !1, this._paymentStatusDisplay = "", this._balanceDue = 0, this._currencyCode = "", this._currencySymbol = "", W(this, P), W(this, M), W(this, x), W(this, w, !1), this.consumeContext(oe, (e) => {
  ...
  connectedCallback() {
    super.connectedCallback(), B(this, w, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), B(this, w, !1);
  }
  async _loadShipments() {
    if (!this._invoiceId) return;
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: i } = await v.getFulfillmentSummary(this._invoiceId);
    d(this, w) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  _syncPaymentState(e) {
  ...
  async _handleDeleteShipment(e) {
    ...
    if (!d(this, w)) return;
    const { error: t } = await v.deleteShipment(e.id);
    if (d(this, w)) {
      if (t) {
        d(this, x)?.peek("danger", {
  ...
  async _handleMarkAsShipped(e) {
    ...
    const { error: i } = await v.updateShipmentStatus(e.id, {
      newStatus: J.Shipped,
  ...
  async _handleCancelShipment(e) {
    ...
    if (!d(this, w)) return;
    this._isUpdatingStatus = !0;
    const { error: t } = await v.updateShipmentStatus(e.id, {
  ...
  _renderShipmentCard(e, i) {
    const t = this._getCarrierClass(e.carrier), s = this._expandedShipmentId === e.id;
    return a`
      <div class="shipment-card">
        <div class="shipment-header">
          <div class="header-left">
            <span class="shipment-status-badge ${e.statusCssClass}">${e.statusLabel}</span>
            ${e.carrier ? a`<span class="carrier-badge ${t}">${e.carrier}</span>` : o}
  ...
  _renderStatusActions(e, i) {
    return !e.canMarkAsShipped && !e.canMarkAsDelivered && !e.canCancel ? o : a`
      ...
      ${i ? this._renderTrackingForm(e) : o}
    `;
  }
  ...
  async _copyToClipboard(e) {
    try {
      await navigator.clipboard.writeText(e), d(this, x)?.peek("positive", {
  ...
  _renderOutstandingPaymentWarning() {
    if (!this._hasOutstandingBalance)
      return o;
    const e = this._paymentStatusDisplay?.trim(), i = c(this._balanceDue, this._currencyCode, this._currencySymbol);
    return a`
...
k([
  n()
], b.prototype, "_invoiceId", 2);
k([
  n()
], b.prototype, "_fulfillmentData", 2);
k([
  n()
...
k([
  n()
], b.prototype, "_expandedShipmentId", 2);
k([
  n()
], b.prototype, "_trackingForm", 2);
k([
  n()
], b.prototype, "_isUpdatingStatus", 2);
k([
  n()
], b.prototype, "_hasOutstandingBalance", 2);
k([
  n()
], b.prototype, "_paymentStatusDisplay", 2);
k([
  n()
], b.prototype, "_balanceDue", 2);
k([
  n()
], b.prototype, "_currencyCode", 2);
k([
  n()
], b.prototype, "_currencySymbol", 2);
b = k([
...
var Te = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, de = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? Oe(i, t) : i, u = e.length - 1, m; u >= 0; u--)
    (m = e[u]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Te(i, t, r), r;
}, ce = (e, i, t) => i.has(e) || de("Cannot " + t), T = (e, i, t) => (ce(e, i, "read from private field"), i.get(e)), ae = (e, i, t) => i.has(e) ? de("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, s) => (ce(e, i, "write to private field"), i.set(e, t), t), E, F;
let D = class extends Y(q) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, ae(this, E), ae(this, F, !1), this.consumeContext(ee, (e) => {
      Q(this, E, e);
    });
  }
  connectedCallback() {
    ...
    if (this.invoiceId) {
      ...
      try {
        const [e, i] = await Promise.all([
          v.getInvoicePayments(this.invoiceId),
          v.getPaymentStatus(this.invoiceId)
        ]);
        if (!T(this, F)) return;
        if (e.error) {
  ...
  async _openManualPaymentModal() {
    if (!T(this, E) || !this._status) return;
    (await T(this, E).open(this, Le, {
      data: {
  ...
  async _openRefundModal(e) {
    if (!T(this, E)) return;
    const i = this._status?.creditDue ?? 0, t = i > 0 && i < e.refundableAmount, s = i > 0 ? t && e.canRefundViaProvider && !e.supportsPartialRefunds ? void 0 : Math.min(i, e.refundableAmount) : void 0;
    (await T(this, E).open(this, Ae, {
      data: { payment: e, suggestedRefundAmount: s }
    }).onSubmit().catch(() => {
      ...
      <div class="payment-item ${i ? "refund" : ""}">
        <div class="payment-main">
          ...
          <div class="payment-amount ${i ? "negative" : ""}">
            ${i ? "-" : ""}${c(Math.abs(e.amount), e.currencyCode, e.currencySymbol)}
          </div>
    ...
    return a`
      <div class="payment-panel">
        ...
        <div class="status-summary">
          ...
          ${e != null && e.creditDue > 0 ? a`
                <div class="overpaid-alert">
                  <uui-icon name="icon-alert"></uui-icon>
                  <span>This invoice has been overpaid by ${c(e.creditDue, e.currencyCode, e.currencySymbol)}. A refund is recommended.</span>
                </div>
              ` : o}
          ...
          ${e ? a`
                <div class="status-details">
                  <div class="status-row">
                    ...
                    <span>${c(e.invoiceTotal, e.currencyCode, e.currencySymbol)}</span>
                  </div>
                  <div class="status-row">
                    <span>Total Paid</span>
                    <span class="positive">${c(e.totalPaid, e.currencyCode, e.currencySymbol)}</span>
                  </div>
                  ${e.totalRefunded > 0 ? a`
                        <div class="status-row">
                          <span>Total Refunded</span>
                          <span class="negative">-${c(e.totalRefunded, e.currencyCode, e.currencySymbol)}</span>
                        </div>
                      ` : o}
                  ${e.creditDue > 0 ? a`
                        <div class="status-row total overpaid">
                          <span>${e.balanceStatusLabel}</span>
                          <span class="warning">${c(e.creditDue, e.currencyCode, e.currencySymbol)}</span>
                        </div>
                      ` : a`
                        <div class="status-row total">
                          ...
                          <span class="${e.balanceStatusCssClass === "underpaid" ? "negative" : ""}">
                            ${c(e.balanceDue, e.currencyCode, e.currencySymbol)}
                          </span>
                        </div>
                      `}
                </div>
...
R([
  se({ type: String })
], D.prototype, "invoiceId", 2);
R([
  n()
], D.prototype, "_payments", 2);
R([
  n()
...
var Fe = Object.defineProperty, Ne = Object.getOwnPropertyDescriptor, pe = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? Ne(i, t) : i, u = e.length - 1, m; u >= 0; u--)
    (m = e[u]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Fe(i, t, r), r;
}, me = (e, i, t) => i.has(e) || pe("Cannot " + t), O = (e, i, t) => (me(e, i, "read from private field"), i.get(e)), Re = (e, i, t) => i.has(e) ? pe("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), re = (e, i, t, s) => (me(e, i, "write to private field"), i.set(e, t), t), S;
let C = class extends Y(q) {
  ...
  async _loadData() {
    if (this.invoiceId) {
      ...
      try {
        const [e, i] = await Promise.all([
          v.getPaymentLinkProviders(),
          v.getPaymentLink(this.invoiceId)
        ]);
        if (!O(this, S)) return;
        if (e.error) {
          this._errorMessage = e.error.message, this._isLoading = !1;
  ...
  async _generateLink() {
    if (!(!this.invoiceId || !this._selectedProvider)) {
      ...
      try {
        const e = await v.createPaymentLink({
          invoiceId: this.invoiceId,
  ...
  async _deactivateLink() {
    if (this.invoiceId) {
      ...
      try {
        const e = await v.deactivatePaymentLink(this.invoiceId);
        if (!O(this, S)) return;
    ...
    return this._linkInfo?.hasActiveLink ? a`
      <div class="active-link">
        <div class="link-header">
          ...
          ${this._linkInfo.providerDisplayName ? a`<span class="link-provider">${this._linkInfo.providerDisplayName}</span>` : o}
        </div>
        ...
        <div class="link-meta">
          ${this._linkInfo.createdBy ? a`<span>Created by ${this._linkInfo.createdBy}</span>` : o}
          ${this._linkInfo.createdAt ? a`<span>${N(this._linkInfo.createdAt)}</span>` : o}
        </div>
  ...
  _renderPaidStatus() {
    return this._linkInfo?.isPaid ? a`
      <div class="paid-status">
        ...
        ${this._linkInfo.createdAt ? a`<span class="paid-date">${N(this._linkInfo.createdAt)}</span>` : o}
      </div>
    ` : o;
  }
  _renderGenerator() {
    return this._linkInfo?.hasActiveLink || this._linkInfo?.isPaid ? o : this._providers.length === 0 ? a`
...
z([
  n()
], C.prototype, "_linkInfo", 2);
z([
  n()
], C.prototype, "_selectedProvider", 2);
z([
  n()
], C.prototype, "_isLoading", 2);
z([
  n()
], C.prototype, "_isGenerating", 2);
z([
  n()
], C.prototype, "_isDeactivating", 2);
z([
  n()
], C.prototype, "_errorMessage", 2);
z([
  n()
], C.prototype, "_copySuccess", 2);
C = z([
...
var Ue = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, he = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? Be(i, t) : i, u = e.length - 1, m; u >= 0; u--)
    (m = e[u]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Ue(i, t, r), r;
}, ve = (e, i, t) => i.has(e) || he("Cannot " + t), l = (e, i, t) => (ve(e, i, "read from private field"), i.get(e)), j = (e, i, t) => i.has(e) ? he("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), V = (e, i, t, s) => (ve(e, i, "write to private field"), i.set(e, t), t), _, f, y, $;
let p = class extends Y(q) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, j(this, _), j(this, f), j(this, y), j(this, $, !1), this.consumeContext(oe, (e) => {
      V(this, _, e), l(this, _) && this.observe(l(this, _).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), V(this, $, !0), this._createRoutes(), this._loadCountries();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), V(this, $, !1);
  }
  async _loadCountries() {
    const { data: e } = await v.getCountries();
    l(this, $) && e && (this._countries = e);
  }
  ...
  async _openFulfillmentModal() {
    if (!this._order || !l(this, f)) return;
    const e = this._order.id, i = this._order.balanceDue > 0;
    await l(this, f).open(this, Pe, {
      data: {
        invoiceId: e,
    ...
    }), l(this, $) && l(this, _)?.load(e);
  }
  async _releaseSupplierDirectOrder(e) {
    if (!this._order || !l(this, f)) return;
    const i = l(this, f).open(this, Z, {
      data: {
        headline: "Release to Supplier",
        content: "This will submit this order to Supplier Direct immediately. If no shipment exists yet, a Preparing shipment will be created automatically.",
    ...
    const { data: t, error: s } = await v.releaseOrderFulfillment(e.id);
    if (!l(this, $)) return;
    if (s) {
      l(this, y)?.peek("danger", {
        data: {
    ...
    const r = t?.message?.trim() || "Order released to supplier.";
    l(this, y)?.peek(t?.alreadyReleased ? "warning" : "positive", {
      data: {
        headline: t?.alreadyReleased ? "Already Released" : "Released to Supplier",
        message: r
      }
    }), l(this, _)?.load(this._order.id);
  }
  async _openEditOrderModal() {
    if (!this._order || !l(this, f)) return;
    const e = this._order.id;
    await l(this, f).open(this, $e, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), l(this, $) && l(this, _)?.load(e);
  }
  async _openCancelInvoiceModal() {
    if (!this._order || !l(this, f)) return;
    const i = await l(this, f).open(this, Ie, {
      data: {
    ...
    l(this, $) && i?.cancelled && (l(this, y)?.peek("positive", {
      data: {
  ...
  async _openCustomerEditModal() {
    if (!this._order?.customerId || !l(this, f)) return;
    const { data: e, error: i } = await v.getCustomer(this._order.customerId);
    if (i || !e) {
      l(this, y)?.peek("danger", {
    ...
    (await l(this, f).open(this, we, {
      data: { customer: e }
    })?.onSubmit().catch(() => {
    }))?.isUpdated && l(this, y)?.peek("positive", {
  ...
  _renderMarkdown(e) {
    ...
    const i = ie.parse(e), t = ke.sanitize(i);
    return _e(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
  ...
  async _saveEditing() {
    ...
    if (this._editingSection === "contact") {
      ...
      e = await v.updateBillingAddress(this._order.id, i);
    } else if (this._editingSection === "shipping") {
      const i = {
        ...this._order.shippingAddress,
        ...this._editFormData
      };
      e = await v.updateShippingAddress(this._order.id, i);
    } else {
      const i = {
        ...this._order.billingAddress,
        ...this._editFormData
    ...
    if (l(this, $)) {
      ...
      l(this, y)?.peek("positive", {
        data: { headline: "Address updated", message: "Changes have been saved successfully" }
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, l(this, _)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    const { error: e } = await v.updatePurchaseOrder(
      this._order.id,
    ...
    if (l(this, $)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", l(this, _)?.load(this._order.id);
    }
  }
  ...
  _renderFulfillmentCard(e) {
    const i = this._order?.canFulfill ?? !1, t = this._order?.currencyCode, s = this._order?.currencySymbol, r = this._getFulfillmentLineItemRows(e.lineItems ?? []);
    return a`
      <div class="card fulfillment-card">
        ...
        <div class="fulfillment-shipping-method">
          ...
          <div class="fulfillment-shipping-details">
            ...
            <span class="fulfillment-shipping-cost ${e.shippingCost === 0 ? "free-shipping" : ""}">${e.shippingCost === 0 ? "FREE" : c(e.shippingCost, t, s)}</span>
          </div>
        </div>
        <div class="fulfillment-line-items">
          ${r.map((u) => this._renderFulfillmentLineItem(
      u.item,
      u.isChild,
      t,
      s
        ...
        <div class="fulfillment-footer">
          <div class="fulfillment-actions">
            ${e.canReleaseSupplierDirect ? a`
                  <uui-button
                    look="secondary"
                    label="Release to Supplier"
                    @click=${() => this._releaseSupplierDirectOrder(e)}
                  >
                    Release to Supplier
                  </uui-button>
                ` : o}
            <uui-button
              ...
              ?disabled=${!i}
              @click=${i ? this._openFulfillmentModal : o}
            >
              ${i ? "Fulfill" : "Fulfilled"}
            </uui-button>
          </div>
  ...
  _getFulfillmentLineItemRows(e) {
    const i = e.filter((h) => this._isAddonLineItem(h)), t = e.filter((h) => !this._isAddonLineItem(h)), s = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map();
    i.forEach((h) => {
      const I = h.parentLineItemId?.trim();
      if (I) {
        const H = s.get(I);
        H ? H.push(h) : s.set(I, [h]);
        return;
      }
      const L = h.parentLineItemSku?.trim();
      if (!L) return;
      const U = r.get(L);
      U ? U.push(h) : r.set(L, [h]);
    });
    const u = [], m = /* @__PURE__ */ new Set();
    return t.forEach((h) => {
      u.push({ item: h, isChild: !1 });
      const I = (h.childLineItems ?? []).filter((A) => this._isAddonLineItem(A)), L = h.id?.trim(), U = h.sku?.trim(), H = L ? s.get(L) ?? [] : [], ge = U ? r.get(U) ?? [] : [];
      [...I, ...H, ...ge].filter((A, fe, be) => be.findIndex((ye) => ye.id === A.id) === fe).forEach((A) => {
        u.push({ item: A, isChild: !0 }), m.add(A.id);
      });
    }), i.forEach((h) => {
      m.has(h.id) || u.push({ item: h, isChild: !1 });
    }), u;
  }
  ...
  _renderFulfillmentLineItem(e, i, t, s) {
    const r = i || this._isAddonLineItem(e), u = this._resolveFulfillmentMediaKey(e, i), m = r ? [] : e.selectedOptions ?? [], h = r ? e.name || e.productRootName || "Add-on" : e.productRootName || e.name || "Unknown item", I = r ? "+" : "";
    return a`
      <div class="fulfillment-line-item ${r ? "is-addon" : ""}">
        ...
        <div class="fulfillment-item-pricing">
          <span class="fulfillment-item-price">${I}${c(e.amount, t, s)}</span>
          <span class="fulfillment-item-multiply">x</span>
          <span class="fulfillment-item-qty">${e.quantity}</span>
        </div>
        <div class="fulfillment-item-total">${I}${c(e.calculatedTotal, t, s)}</div>
      </div>
    `;
  }
  ...
  async _handlePostNote() {
    ...
    if (l(this, $)) {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, l(this, _)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
      ...
      <umb-body-layout header-fit-height main-no-padding>
        ...
        <umb-body-layout header-fit-height header-no-padding>
          ...
          <uui-tab-group slot="header">
            <uui-tab
              label="Details"
              href=${this._getTabHref("details") ?? o}
              ?active=${i === "details"}
            >
              Details
            </uui-tab>
            <uui-tab
              label="Shipments"
              href=${this._getTabHref("shipments") ?? o}
              ?active=${i === "shipments"}
            >
              Shipments
            </uui-tab>
            <uui-tab
              label="Payments"
              href=${this._getTabHref("payments") ?? o}
              ?active=${i === "payments"}
            >
              Payments
            </uui-tab>
            ...
            <div class="card payment-card">
              ...
              <div class="payment-summary">
                <div class="summary-row">
                  ...
                  <span>${c(e.subTotal, e.currencyCode, e.currencySymbol)}</span>
                </div>
                ${e.discountTotal > 0 ? a`
                  <div class="summary-row discount">
                    <span>Discounts</span>
                    <span></span>
                    <span>-${c(e.discountTotal, e.currencyCode, e.currencySymbol)}</span>
                  </div>
                  ${e.discounts?.map((t) => a`
                    <div class="summary-row discount-detail">
                      <span>${t.name || "Discount"} (-${c(t.amount, e.currencyCode, e.currencySymbol)})</span>
                      <span></span>
                      <span></span>
                    </div>
                  `)}
                ...
                <div class="summary-row">
                  ...
                  <span class="${e.shippingCost === 0 ? "free-shipping" : ""}">${e.shippingCost === 0 ? "FREE" : c(e.shippingCost, e.currencyCode, e.currencySymbol)}</span>
                </div>
                ${e.tax > 0 ? a`
                  <div class="summary-row">
                    <span>Tax</span>
                    <span></span>
                    <span>${c(e.tax, e.currencyCode, e.currencySymbol)}</span>
                  </div>
                ` : o}
                <div class="summary-row total">
                  <span>Total</span>
                  <span></span>
                  <span>${c(e.total, e.currencyCode, e.currencySymbol)}</span>
                </div>
                ${e.totalInStoreCurrency != null && e.storeCurrencyCode !== e.currencyCode ? a`
                  <div class="summary-row">
                    <span>Total (Store)</span>
                    <span></span>
                    <span>${c(e.totalInStoreCurrency, e.storeCurrencyCode, e.storeCurrencySymbol)}</span>
                  </div>
                ` : o}
                <div class="summary-row ${e.balanceStatusCssClass}">
                  <span>Paid</span>
                  <span></span>
                  <span>${c(e.amountPaid, e.currencyCode, e.currencySymbol)}</span>
                </div>
                ${e.amountPaidInStoreCurrency != null && e.storeCurrencyCode !== e.currencyCode ? a`
                  <div class="summary-row">
                    <span>Paid (Store)</span>
                    <span></span>
                    <span>${c(e.amountPaidInStoreCurrency, e.storeCurrencyCode, e.storeCurrencySymbol)}</span>
                  </div>
                ` : o}
                ${e.creditDue > 0 ? a`
                  <div class="summary-row balance ${e.balanceStatusCssClass}">
                    <span>${e.balanceStatusLabel}</span>
                    <span></span>
                    <span>${c(e.creditDue, e.currencyCode, e.currencySymbol)}</span>
                  </div>
                ` : e.balanceStatusLabel ? a`
                  <div class="summary-row balance ${e.balanceStatusCssClass}">
                    <span>${e.balanceStatusLabel}</span>
                    <span></span>
                    <span>${c(Math.abs(e.balanceDue), e.currencyCode, e.currencySymbol)}</span>
                  </div>
                ` : o}
                ${e.creditDue > 0 && e.creditDueInStoreCurrency != null && e.storeCurrencyCode !== e.currencyCode ? a`
                  <div class="summary-row">
                    <span>${e.balanceStatusLabel} (Store)</span>
                    <span></span>
                    <span>${c(e.creditDueInStoreCurrency ?? 0, e.storeCurrencyCode, e.storeCurrencySymbol)}</span>
                  </div>
                ` : e.balanceDueInStoreCurrency != null && e.storeCurrencyCode !== e.currencyCode && e.balanceStatusLabel ? a`
                  <div class="summary-row">
                    <span>${e.balanceStatusLabel} (Store)</span>
                    <span></span>
                    <span>${c(Math.abs(e.balanceDueInStoreCurrency ?? 0), e.storeCurrencyCode, e.storeCurrencySymbol)}</span>
                  </div>
                ` : o}
              </div>
            </div>
...
g([
  n()
], p.prototype, "_routerPath", 2);
g([
  n()
], p.prototype, "_activePath", 2);
g([
  n()
], p.prototype, "_newNoteText", 2);
g([
  n()
], p.prototype, "_isVisibleToCustomer", 2);
g([
  n()
], p.prototype, "_isPostingNote", 2);
g([
  n()
], p.prototype, "_noteError", 2);
g([
  n()
], p.prototype, "_currentUser", 2);
g([
  n()
], p.prototype, "_editingSection", 2);
g([
  n()
], p.prototype, "_editFormData", 2);
g([
  n()
], p.prototype, "_isSavingAddress", 2);
g([
  n()
], p.prototype, "_validationErrors", 2);
g([
  n()
], p.prototype, "_countries", 2);
g([
  n()
], p.prototype, "_isEditingPurchaseOrder", 2);
g([
  n()
], p.prototype, "_purchaseOrderValue", 2);
g([
  n()
], p.prototype, "_isSavingPurchaseOrder", 2);
p = g([
  X("merchello-order-detail")
], p);
const ai = p;
export {
  p as MerchelloOrderDetailElement,
  ai as default
};
//# sourceMappingURL=order-detail.element-Cox_aDEn.js.map
