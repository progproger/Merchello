import { nothing as d, html as o, css as k, state as m, customElement as I } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as S } from "@umbraco-cms/backoffice/modal";
import { M as f } from "./merchello-api-CU-ozmmd.js";
import { b as w } from "./formatting-Cu4HXsjc.js";
import "./product-image.element-D7HwAIKr.js";
var $ = Object.defineProperty, z = Object.getOwnPropertyDescriptor, _ = (t) => {
  throw TypeError(t);
}, c = (t, e, i, r) => {
  for (var s = r > 1 ? void 0 : r ? z(e, i) : e, a = t.length - 1, p; a >= 0; a--)
...
//# sourceMappingURL=fulfillment-modal.element-B-j-VLjb.js.map
