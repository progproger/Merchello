import { html as d, css as b, state as c, customElement as m } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as v } from "@umbraco-cms/backoffice/modal";
import { M as f } from "./merchello-api-BxVn4Zbt.js";
...
}, p = (e, t, s) => t.has(e) || _("Cannot " + s), x = (e, t, s) => (p(e, t, "read from private field"), t.get(e)), C = (e, t, s) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), h = (e, t, s, i) => (p(e, t, "write to private field"), t.set(e, s), s), o;
let a = class extends v {
  constructor() {
    super(...arguments), this._selectedIds = [], this._selectedNames = [], this._selectedAliases = [], this._productTypes = [], this._isLoading = !0, this._errorMessage = null, C(this, o, !1);
  }
  connectedCallback() {
  ...
  _renderContent() {
    return this._isLoading ? d`<div class="loading"><uui-loader></uui-loader></div>` : this._errorMessage ? d`<div class="error-banner">${this._errorMessage}</div>` : this._productTypes.length === 0 ? d`<p class="empty-state">No product types available.</p>` : d`
...
a = r([
  m("merchello-product-type-picker-modal")
], a);
const P = a;
export {
...
//# sourceMappingURL=product-type-picker-modal.element-CsAc-uZL.js.map
