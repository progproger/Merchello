...
import { D as S, a as C, b as U, c as h, d as f } from "./discount.types-YWYxoniA.js";
import { M as T } from "./merchello-api-s-9cx0Ue.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { a as B, i as N } from "./formatting-BzzWJIvp.js";
import { h as F, i as R, j } from "./navigation-m-G5wLvz.js";
import { b as G } from "./badge.styles-DUcdl6GY.js";
var V = Object.defineProperty, W = Object.getOwnPropertyDescriptor, m = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? W(t, a) : t, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (i = (s ? u(t, a, i) : u(i)) || i);
  return s && i && V(t, a, i), i;
};
let b = class extends M(k) {
  constructor() {
      ...
      (e) => o`
            ...
            >
              ...
              <uui-table-cell class="name-cell">
                <a href=${F(e.id)} @click=${(t) => t.stopPropagation()}>
                  ${e.name}
                </a>
...
const X = new I("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var H = Object.defineProperty, Y = Object.getOwnPropertyDescriptor, A = (e) => {
  throw TypeError(e);
}, c = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? Y(t, a) : t, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (i = (s ? u(t, a, i) : u(i)) || i);
  return s && i && H(t, a, i), i;
}, E = (e, t, a) => t.has(e) || A("Cannot " + a), d = (e, t, a) => (E(e, t, "read from private field"), t.get(e)), $ = (e, t, a) => t.has(e) ? A("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), v = (e, t, a, s) => (E(e, t, "write to private field"), t.set(e, a), a), _, g, p;
let l = class extends M(k) {
  constructor() {
    super(), this._discounts = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedDiscounts = /* @__PURE__ */ new Set(), this._searchTerm = "", this._isDeleting = !1, this._searchDebounceTimer = null, $(this, _), $(this, g), $(this, p, !1), this.consumeContext(L, (e) => {
      v(this, _, e);
  ...
  connectedCallback() {
    super.connectedCallback(), v(this, p, !0), this._loadDiscounts();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), v(this, p, !1), this._searchDebounceTimer && clearTimeout(this._searchDebounceTimer);
  }
  async _loadDiscounts() {
    ...
    this._searchTerm.trim() && (e.search = this._searchTerm.trim()), this._activeTab === "active" ? e.status = h.Active : this._activeTab === "scheduled" ? e.status = h.Scheduled : this._activeTab === "expired" ? e.status = h.Expired : this._activeTab === "draft" && (e.status = h.Draft);
  ...
  async _handleDeleteSelected() {
    ...
    if (e === 0 || !await d(this, _)?.open(this, O, {
      data: {
    ...
    let i = 0, n = 0;
    for (const u of s) {
      const { error: P } = await T.deleteDiscount(u);
      if (!d(this, p)) return;
      P ? n++ : i++;
    }
  ...
  async _handleCreateDiscount() {
    if (!d(this, _)) return;
    const t = await d(this, _).open(this, X, {
      data: {}
    }).onSubmit().catch(() => {
    });
    d(this, p) && t?.selectedCategory !== void 0 && R(t.selectedCategory);
  }
  _handleDiscountClick(e) {
    j(e.detail.discountId);
  }
  _renderLoadingState() {
...
//# sourceMappingURL=discounts-list.element-BNHhmOyH.js.map
