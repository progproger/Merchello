import { LitElement as k, nothing as p, html as s, css as C, state as n, customElement as w } from "@umbraco-cms/backoffice/external/lit";
...
import { g as T } from "./store-settings-Silr5K1w.js";
import { i as R } from "./formatting-DC2_cf8C.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
var z = Object.defineProperty, S = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, o = (e, a, t, l) => {
  for (var u = l > 1 ? void 0 : l ? S(a, t) : a, v = e.length - 1, m; v >= 0; v--)
    (m = e[v]) && (u = (l ? m(a, t, u) : m(u)) || u);
  return l && u && z(a, t, u), u;
}, y = (e, a, t) => a.has(e) || f("Cannot " + t), r = (e, a, t) => (y(e, a, "read from private field"), a.get(e)), _ = (e, a, t) => a.has(e) ? f("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, t), g = (e, a, t, l) => (y(e, a, "write to private field"), a.set(e, t), t), c, d, h;
let i = class extends x(k) {
  constructor() {
    super(), this._checkouts = [], this._stats = null, this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._searchTerm = "", _(this, c), _(this, d, !1), _(this, h), this.consumeContext($, (e) => {
      g(this, c, e);
    });
  }
  connectedCallback() {
  ...
  async _loadStats() {
    ...
    if (r(this, d)) {
      if (a) {
        console.error("Failed to load abandoned checkout stats:", a);
        return;
      }
      e && (this._stats = e);
    }
  ...
  _renderRow(e) {
    ...
    return s`
      <uui-table-row>
        ...
        <uui-table-cell>
          ${e.dateAbandoned ? s`<span class="date">${R(e.dateAbandoned)}</span>` : s`<span class="no-date">-</span>`}
        </uui-table-cell>
        <uui-table-cell>
...
//# sourceMappingURL=abandoned-checkouts-list.element-B1u5IfAB.js.map
