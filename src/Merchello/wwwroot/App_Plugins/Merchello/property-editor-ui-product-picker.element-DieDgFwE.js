...
import { M as N } from "./merchello-api-BM4-Q40x.js";
import { g as G, b as H } from "./store-settings-DKmhm5Dt.js";
import { a as K } from "./formatting-YtMaawx1.js";
...
var X = Object.defineProperty, j = Object.getOwnPropertyDescriptor, J = Object.getPrototypeOf, Q = Reflect.set, w = (t) => {
  ...
  for (var s = n > 1 ? void 0 : n ? j(e, i) : e, f = t.length - 1, u; f >= 0; f--)
    (u = t[f]) && (s = (n ? u(e, i, s) : u(s)) || s);
  return n && s && X(e, i, s), s;
}, P = (t, e, i) => e.has(t) || w("Cannot " + i), l = (t, e, i) => (P(t, e, "read from private field"), i ? i.call(t) : e.get(t)), g = (t, e, i) => e.has(t) ? w("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), b = (t, e, i, n) => (P(t, e, "write to private field"), e.set(t, i), i), a = (t, e, i) => (P(t, e, "access private method"), i), Y = (t, e, i, n) => ({
  set _(s) {
    b(t, e, s);
  },
  get _() {
...
}), Z = (t, e, i, n) => (Q(J(t), i, n, e), n), I, v, x, d, o, S, k, y, $, M, C, U, E, L;
let c = class extends R(
  B,
  void 0
) {
  constructor() {
    super(), g(this, o), this.readonly = !1, this._selection = [], this._maxItems = 1, this._collectionIds = [], this._productTypeIds = [], this._filterValueIds = [], this._isLoading = !1, g(this, I), g(this, v, !1), g(this, x, 0), g(this, d, new W(this, {
      ...
      onChange: ({ model: t }) => {
        this._selection = t, a(this, o, k).call(this);
      }
  ...
  render() {
    return this._isLoading && this._selection.length === 0 ? r`<uui-loader></uui-loader>` : this._maxItems === 1 ? a(this, o, U).call(this) : a(this, o, E).call(this);
  }
};
...
k = function() {
  ...
  Z(c.prototype, this, "value", t), this.dispatchEvent(new F());
};
y = async function() {
  if (this.readonly || !l(this, I)) return;
  const t = this._selection.map((s) => s.id), e = await l(this, I).open(this, q, {
    data: {
      config: {
        currencySymbol: H(),
        excludeProductIds: t,
  ...
  l(this, d).setModel(this._selection), a(this, o, k).call(this);
};
$ = function(t) {
  this._selection = this._selection.filter((e) => e.id !== t), l(this, d).setModel(this._selection), a(this, o, k).call(this);
};
M = function() {
  this._selection = [], l(this, d).setModel([]), a(this, o, k).call(this);
};
C = function(t) {
  return K(t);
};
...
//# sourceMappingURL=property-editor-ui-product-picker.element-DieDgFwE.js.map
