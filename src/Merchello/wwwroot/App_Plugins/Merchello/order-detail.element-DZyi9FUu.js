import { LitElement as F, nothing as o, html as a, css as R, state as d, customElement as U, property as Z, unsafeHTML as ee } from "@umbraco-cms/backoffice/external/lit";
...
import { b as N, a as p, h as re } from "./formatting-BOik_7Em.js";
import { M as g } from "./merchello-api-CkNG-K-m.js";
...
var ue = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, G = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? ce(i, t) : i, n = e.length - 1, c; n >= 0; n--)
    (c = e[n]) && (r = (s ? c(i, t, r) : c(r)) || r);
  return s && r && ue(i, t, r), r;
}, X = (e, i, t) => i.has(e) || G("Cannot " + t), $ = (e, i, t) => (X(e, i, "read from private field"), t ? t.call(e) : i.get(e)), I = (e, i, t) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), A = (e, i, t, s) => (X(e, i, "write to private field"), i.set(e, t), t), M, D, k;
let w = class extends B(F) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, I(this, M), I(this, D), I(this, k, !1), this.consumeContext(V, (e) => {
  ...
  connectedCallback() {
    super.connectedCallback(), A(this, k, !0);
  }
  ...
  async _loadShipments() {
    ...
    $(this, k) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  async _handleEditShipment(e) {
    if (!$(this, D)) return;
    (await $(this, D).open(this, de, {
      data: { shipment: e }
    }).onSubmit().catch(() => {
...
var he = Object.defineProperty, ve = Object.getOwnPropertyDescriptor, Y = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? ve(i, t) : i, n = e.length - 1, c; n >= 0; n--)
    (c = e[n]) && (r = (s ? c(i, t, r) : c(r)) || r);
  return s && r && he(i, t, r), r;
}, K = (e, i, t) => i.has(e) || Y("Cannot " + t), C = (e, i, t) => (K(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? Y("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (K(e, i, "write to private field"), i.set(e, t), t), x, z;
let _ = class extends B(F) {
  constructor() {
  ...
  connectedCallback() {
    super.connectedCallback(), L(this, z, !0), this.invoiceId && this._loadPayments();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), L(this, z, !1);
  }
  updated(e) {
  ...
  async _openManualPaymentModal() {
    if (!C(this, x) || !this._status) return;
    (await C(this, x).open(this, pe, {
      data: {
...
var ge = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, J = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? fe(i, t) : i, n = e.length - 1, c; n >= 0; n--)
    (c = e[n]) && (r = (s ? c(i, t, r) : c(r)) || r);
  return s && r && ge(i, t, r), r;
}, Q = (e, i, t) => i.has(e) || J("Cannot " + t), l = (e, i, t) => (Q(e, i, "read from private field"), i.get(e)), T = (e, i, t) => i.has(e) ? J("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), E = (e, i, t, s) => (Q(e, i, "write to private field"), i.set(e, t), t), h, b, y, v;
let u = class extends B(F) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, T(this, h), T(this, b), T(this, y), T(this, v, !1), this.consumeContext(V, (e) => {
      E(this, h, e), l(this, h) && this.observe(l(this, h).order, (i) => {
  ...
  _simpleHash(e) {
    ...
    for (let r = 0; r < e.length; r++) {
      ...
      i = Math.imul(i ^ n, 2654435761), t = Math.imul(t ^ n, 1597334677);
    }
  ...
  async _openFulfillmentModal() {
    if (!this._order || !l(this, b)) return;
    const e = this._order.id;
    await l(this, b).open(this, oe, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), l(this, v) && l(this, h)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !l(this, b)) return;
    const e = this._order.id;
    await l(this, b).open(this, ne, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), l(this, v) && l(this, h)?.load(e);
  }
  ...
  async _saveEditing() {
    ...
    if (l(this, v)) {
      if (this._isSavingAddress = !1, e.error) {
        console.error("Failed to save address:", e.error), l(this, y)?.peek("danger", {
      ...
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, l(this, h)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (l(this, v)) {
      if (this._isSavingPurchaseOrder = !1, e) {
        console.error("Failed to save purchase order:", e), l(this, y)?.peek("danger", {
      ...
      }), this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", l(this, h)?.load(this._order.id);
    }
  }
    ...
    return a`
      <div class="form-field ${r ? "has-error" : ""}">
        <uui-input
          ...
          @input=${(n) => this._updateFormField(e, n.target.value)}
        ></uui-input>
  ...
  _renderCountrySelect() {
    ...
    return a`
      ...
      if (this._editFormData = {
        ...
        const { countryCode: r, ...n } = this._validationErrors;
        this._validationErrors = n;
      }
    }}
        ></uui-select>
  ...
  _renderFulfillmentCard(e) {
    const i = this._getStatusLabel(e.status), t = this._order?.fulfillmentStatus === "Fulfilled", s = e.status >= 50 ? "shipped" : "unfulfilled", r = this._order?.currencyCode, n = this._order?.currencySymbol;
    return a`
      <div class="card fulfillment-card">
        ...
        <div class="fulfillment-shipping-method">
          ...
          <div class="fulfillment-shipping-details">
            ...
            <span class="fulfillment-shipping-cost">${p(e.shippingCost, r, n)}</span>
          </div>
        </div>
      ...
      (c) => a`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-pricing">
                  <span class="fulfillment-item-price">${p(c.amount, r, n)}</span>
                  <span class="fulfillment-item-multiply">×</span>
                  <span class="fulfillment-item-qty">${c.quantity}</span>
                </div>
                <div class="fulfillment-item-total">${p(c.amount * c.quantity, r, n)}</div>
              </div>
            `
    )}
        </div>
  ...
  _groupNotesByDate(e) {
    ...
    for (const s of t) {
      const r = new Date(s.date), n = this._getDateGroupLabel(r);
      i.has(n) || i.set(n, []), i.get(n).push(s);
    }
    return i;
  }
  _handlePaymentChange() {
    this._order && l(this, h)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (l(this, v)) {
      if (this._isPostingNote = !1, e) {
        this._noteError = e.message || "Failed to post note", console.error("Failed to post note:", e), l(this, y)?.peek("danger", {
      ...
      }), this._newNoteText = "", this._visibleToCustomer = !1, l(this, h)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
            ...
            <div class="card payment-card">
              ...
              <div class="payment-summary">
                <div class="summary-row">
                  <span>Subtotal</span>
                  <span>${e.orders.reduce((t, s) => t + s.lineItems.reduce((r, n) => r + n.quantity, 0), 0)} items</span>
                ...
                ${e.balanceDue !== 0 ? a`
                  <div class="summary-row balance ${e.balanceDue > 0 ? "underpaid" : "overpaid"}">
                    ...
                    <span></span>
                    <span>${e.balanceDue > 0 ? p(e.balanceDue, e.currencyCode, e.currencySymbol) : p(Math.abs(e.balanceDue), e.currencyCode, e.currencySymbol)}</span>
                  </div>
                ` : o}
                ${e.balanceDueInStoreCurrency != null && e.storeCurrencyCode !== e.currencyCode ? a`
                  <div class="summary-row">
                    <span>${(e.balanceDueInStoreCurrency ?? 0) > 0 ? "Balance Due (Store)" : "Credit Due (Store)"}</span>
                    <span></span>
        ...
        (r) => a`
                                <div class="timeline-event ${r.visibleToCustomer ? "customer-visible" : ""}">
                                  ...
                                  <div class="timeline-event-content">
                                    ${r.visibleToCustomer ? a`<span class="customer-badge">Customer visible</span>` : o}
...
//# sourceMappingURL=order-detail.element-DZyi9FUu.js.map
