import { nothing as i, html as s, css as b, state as v, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as _ } from "@umbraco-cms/backoffice/modal";
import { M as y } from "./merchello-api-B76CV0sD.js";
import { b as p } from "./formatting-MfE1tvkN.js";
import { m as z } from "./modal-layout.styles-C2OaUji5.js";
var $ = Object.defineProperty, w = Object.getOwnPropertyDescriptor, g = (e) => {
  throw TypeError(e);
}, c = (e, r, a, o) => {
  for (var t = o > 1 ? void 0 : o ? w(r, a) : r, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (t = (o ? u(r, a, t) : u(t)) || t);
  return o && t && $(r, a, t), t;
}, m = (e, r, a) => r.has(e) || g("Cannot " + a), k = (e, r, a) => (m(e, r, "read from private field"), r.get(e)), T = (e, r, a) => r.has(e) ? g("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, a), f = (e, r, a, o) => (m(e, r, "write to private field"), r.set(e, a), a), d;
let l = class extends _ {
  constructor() {
    super(...arguments), this._isTesting = !1, this._errorMessage = null, T(this, d, !1);
  }
  connectedCallback() {
...
l = c([
  x("merchello-exchange-rate-provider-test-modal")
], l);
const D = l;
export {
...
//# sourceMappingURL=test-provider-modal.element-0FTBFWOB.js.map
