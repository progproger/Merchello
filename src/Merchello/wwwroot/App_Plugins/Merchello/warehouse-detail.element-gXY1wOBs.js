...
import { i as M, k as E, l as y } from "./navigation-m-idaC9i.js";
...
let r = class extends O(D) {
  ...
  async _openCreateSupplierModal() {
    ...
    a(this, o) && i?.isCreated && i.supplier && (this._suppliers = [...this._suppliers, i.supplier], this._formData = { ...this._formData, supplierId: i.supplier.id });
  }
  async _handleSave() {
  ...
  async _openServiceRegionModal(e) {
    ...
    a(this, o) && t?.isSaved && a(this, l)?.reload();
  }
  ...
  async _openShippingOptionModal(e) {
    ...
    a(this, o) && t?.isSaved && (this._loadShippingOptions(), a(this, l)?.reload());
  }
...
//# sourceMappingURL=warehouse-detail.element-gXY1wOBs.js.map
