...
import { M as d } from "./merchello-api-NdGX4WPd.js";
import { b as m, g as S } from "./store-settings-DgxY_Kcz.js";
import { m as x } from "./modal-layout.styles-C2OaUji5.js";
var w = Object.defineProperty, T = Object.getOwnPropertyDescriptor, y = (t) => {
  throw TypeError(t);
}, r = (t, e, a, c) => {
  for (var u = c > 1 ? void 0 : c ? T(e, a) : e, h = t.length - 1, p; h >= 0; h--)
    (p = t[h]) && (u = (c ? p(e, a, u) : p(u)) || u);
  return c && u && w(e, a, u), u;
}, _ = (t, e, a) => e.has(t) || y("Cannot " + a), n = (t, e, a) => (_(t, e, "read from private field"), e.get(t)), $ = (t, e, a) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), P = (t, e, a, c) => (_(t, e, "write to private field"), e.set(t, a), a), s;
let i = class extends b {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._countryCode = "", this._pattern = "", this._matchType = "Prefix", this._action = "Block", this._surcharge = 0, this._currencySymbol = m(), this._description = "", this._countries = [], $(this, s), this.consumeContext(C, (t) => {
      P(this, s, t);
    });
  }
  connectedCallback() {
...
//# sourceMappingURL=shipping-postcode-rule-modal.element-CNa0BUgN.js.map
