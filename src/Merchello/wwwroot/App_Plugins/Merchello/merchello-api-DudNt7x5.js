...
async function n(e) {
  try {
    const t = await u(), a = o.baseUrl || "", r = await fetch(`${a}${l}/${e}`, {
      method: "GET",
    ...
    let c;
    return s.includes("application/json") ? c = await r.json() : c = await r.text(), { data: c };
  } catch (t) {
...
async function i(e, t) {
  try {
    const a = await u(), r = o.baseUrl || "", s = await fetch(`${r}${l}/${e}`, {
      method: "POST",
      credentials: o.credentials,
      headers: a,
    ...
    if (!s.ok) {
      ...
      return { error: new Error(p || `HTTP ${s.status}: ${s.statusText}`) };
    }
...
const h = {
  ...
  updateBillingAddress: (e, t) => d(`orders/${e}/billing-address`, t),
  updateShippingAddress: (e, t) => d(`orders/${e}/shipping-address`, t),
  ...
  updateShipment: (e, t) => d(`shipments/${e}`, t),
...
//# sourceMappingURL=merchello-api-DudNt7x5.js.map
