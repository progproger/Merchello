...
import { b as M } from "./formatting-D5bm7SYx.js";
...
let l = class extends $ {
  ...
  async _deleteShipment(t) {
    ...
    if (!g(this, m)) return;
    const { error: i } = await _.deleteShipment(t);
    if (g(this, m)) {
      if (i) {
...
//# sourceMappingURL=fulfillment-modal.element-DfG3YwIo.js.map
