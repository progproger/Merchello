...
import { c as $ } from "./collection-layout.styles-I8XQedsa.js";
const C = new _("Merchello.AddressLookupProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), L = new _("Merchello.AddressLookupProvider.Test.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var E = Object.defineProperty, S = Object.getOwnPropertyDescriptor, y = (i) => {
  throw TypeError(i);
}, l = (i, e, t, d) => {
  for (var n = d > 1 ? void 0 : d ? S(e, t) : e, m = i.length - 1, h; m >= 0; m--)
    (h = i[m]) && (n = (d ? h(e, t, n) : h(n)) || n);
  return d && n && E(e, t, n), n;
}, x = (i, e, t) => e.has(i) || y("Cannot " + t), s = (i, e, t) => (x(i, e, "read from private field"), e.get(i)), b = (i, e, t) => e.has(i) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t), p = (i, e, t, d) => (x(i, e, "write to private field"), e.set(i, t), t), c, u, r;
let o = class extends A(k) {
  constructor() {
    super(), this._providers = [], this._isLoading = !0, this._isDeactivating = !1, this._errorMessage = null, b(this, c), b(this, u), b(this, r, !1), this.consumeContext(D, (i) => {
      p(this, c, i);
...
//# sourceMappingURL=address-lookup-providers-list.element-DGk_4dza.js.map
