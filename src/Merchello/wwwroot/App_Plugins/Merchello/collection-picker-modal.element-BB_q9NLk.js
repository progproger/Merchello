...
}, _ = (e, t, l) => t.has(e) || p("Cannot " + l), S = (e, t, l) => (_(e, t, "read from private field"), t.get(e)), M = (e, t, l) => t.has(e) ? p("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, l), h = (e, t, l, i) => (_(e, t, "write to private field"), t.set(e, l), l), n;
let s = class extends f {
  constructor() {
    super(...arguments), this._selectedIds = [], this._collections = [], this._isLoading = !0, this._errorMessage = null, this._searchTerm = "", M(this, n, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=collection-picker-modal.element-BB_q9NLk.js.map
