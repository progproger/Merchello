...
var b = Object.defineProperty, D = Object.getOwnPropertyDescriptor, l = (e, a, t, i) => {
  for (var r = i > 1 ? void 0 : i ? D(a, t) : a, s = e.length - 1, d; s >= 0; s--)
    (d = e[s]) && (r = (i ? d(a, t, r) : d(r)) || r);
  return i && r && b(a, t, r), r;
};
let o = class extends f {
  ...
  async _handleGenerate() {
    ...
    const { periodStart: a, periodEnd: t } = this._getDateRange(), { blob: i, filename: r, error: s } = await _.downloadCustomerStatement(
      e,
      a,
      t
    );
    if (this._isGenerating = !1, s || !i) {
      this._error = s?.message ?? "Failed to generate statement";
      return;
    }
    const d = URL.createObjectURL(i), n = document.createElement("a");
...
l([
  u()
], o.prototype, "_periodOption", 2);
l([
  u()
], o.prototype, "_customStartDate", 2);
l([
  u()
], o.prototype, "_customEndDate", 2);
l([
  u()
], o.prototype, "_isGenerating", 2);
l([
  u()
...
const E = o;
export {
  o as MerchelloGenerateStatementModalElement,
  E as default
};
//# sourceMappingURL=generate-statement-modal.element-CzqxojzD.js.map
