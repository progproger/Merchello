import { nothing as r, html as a, css as $, state as c, customElement as b } from "@umbraco-cms/backoffice/external/lit";
...
var y = Object.defineProperty, k = Object.getOwnPropertyDescriptor, _ = (e) => {
  ...
  for (var t = l > 1 ? void 0 : l ? k(i, s) : i, d = e.length - 1, p; d >= 0; d--)
    (p = e[d]) && (t = (l ? p(i, s, t) : p(t)) || t);
  return l && t && y(i, s, t), t;
}, m = (e, i, s) => i.has(e) || _("Cannot " + s), v = (e, i, s) => (m(e, i, "read from private field"), i.get(e)), C = (e, i, s) => i.has(e) ? _("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, s), g = (e, i, s, l) => (m(e, i, "write to private field"), i.set(e, s), s), n;
let o = class extends f {
  constructor() {
    super(...arguments), this._fields = [], this._values = {}, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, C(this, n, !1);
  }
  connectedCallback() {
  ...
  async _loadFields() {
    ...
    for (const t of this._fields)
      this._values[t.key] = l[t.key] ?? t.defaultValue ?? "";
    this._isLoading = !1;
  }
...
o = u([
  b("merchello-address-lookup-provider-config-modal")
], o);
const M = o;
export {
...
//# sourceMappingURL=address-lookup-provider-config-modal.element-Dhn_bSHf.js.map
