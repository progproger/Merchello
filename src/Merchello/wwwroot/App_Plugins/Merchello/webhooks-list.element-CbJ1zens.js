import { LitElement as w, nothing as g, html as n, css as y, state as c, customElement as T } from "@umbraco-cms/backoffice/external/lit";
...
import { g as z } from "./store-settings-Silr5K1w.js";
import { i as A } from "./formatting-DC2_cf8C.js";
import { M as f, a as E } from "./webhook-test-modal.token-BJ36MIGK.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
var M = Object.defineProperty, D = Object.getOwnPropertyDescriptor, S = (e) => {
  throw TypeError(e);
}, r = (e, t, i, o) => {
  for (var l = o > 1 ? void 0 : o ? D(t, i) : t, b = e.length - 1, _; b >= 0; b--)
    (_ = e[b]) && (l = (o ? _(t, i, l) : _(l)) || l);
  return o && l && M(t, i, l), l;
}, k = (e, t, i) => t.has(e) || S("Cannot " + i), a = (e, t, i) => (k(e, t, "read from private field"), t.get(e)), m = (e, t, i) => t.has(e) ? S("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), v = (e, t, i, o) => (k(e, t, "write to private field"), t.set(e, i), i), p, d, u;
let s = class extends $(w) {
  constructor() {
    super(), this._subscriptions = [], this._categories = [], this._stats = null, this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._searchTerm = "", this._activeTab = "all", this._searchDebounceTimer = null, m(this, p), m(this, d), m(this, u, !1), this.consumeContext(x, (e) => {
      v(this, p, e);
  ...
  _renderSubscriptionRow(e) {
    return n`
      <uui-table-row class="clickable" @click=${() => this._handleViewDeliveries(e)}>
        ...
        <uui-table-cell>
          ${e.lastTriggeredUtc ? A(e.lastTriggeredUtc) : "Never"}
        </uui-table-cell>
        <uui-table-cell class="center">
...
//# sourceMappingURL=webhooks-list.element-CbJ1zens.js.map
