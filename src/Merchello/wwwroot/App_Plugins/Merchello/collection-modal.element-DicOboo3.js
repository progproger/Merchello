...
var b = Object.defineProperty, g = Object.getOwnPropertyDescriptor, l = (t, e, i, r) => {
  for (var o = r > 1 ? void 0 : r ? g(e, i) : e, s = t.length - 1, n; s >= 0; s--)
...
let a = class extends v {
  ...
  async _handleSave(t) {
    ...
    if (this._isEditMode) {
      ...
      const { data: r, error: o } = await h.updateProductCollection(i, {
        name: e
      });
      ...
      this.value = { collection: r, isUpdated: !0 }, this.modalContext?.submit();
    } else {
      const { data: i, error: r } = await h.createProductCollection({
        name: e
      });
...
const M = a;
export {
  a as MerchelloCollectionModalElement,
  M as default
};
//# sourceMappingURL=collection-modal.element-DicOboo3.js.map
