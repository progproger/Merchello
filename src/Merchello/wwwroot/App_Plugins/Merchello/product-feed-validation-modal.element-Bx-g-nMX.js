import { html as s, nothing as d, css as v, state as o, customElement as _ } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as m } from "@umbraco-cms/backoffice/modal";
import { M as h } from "./merchello-api-Dp_zU_yi.js";
import { c as f } from "./formatting-B_f6AiQh.js";
var b = Object.defineProperty, g = Object.getOwnPropertyDescriptor, l = (e, i, t, a) => {
  for (var r = a > 1 ? void 0 : a ? g(i, t) : i, c = e.length - 1, n; c >= 0; c--)
    (n = e[c]) && (r = (a ? n(i, t, r) : n(r)) || r);
...
let u = class extends m {
  ...
  _scheduleProductSearch(e) {
    ...
    this._productSearchDebounceTimer = setTimeout(async () => {
      ...
      const { data: a, error: r } = await h.searchOrderProducts(t, P);
  ...
  async _refreshValidation() {
    const e = this._selectedPreviewProduct ? [this._selectedPreviewProduct.id] : [], i = await this._runValidation(e, "issues");
    i && (this._validation = i, this._syncSelectedPreview(i));
  }
  ...
  async _runValidation(e, i) {
    ...
    }, { data: r, error: c } = await h.validateProductFeed(t, a);
    return i === "issues" ? this._isLoadingIssues = !1 : this._isLoadingPreview = !1, c || !r ? (this._errorMessage = c?.message ?? "Unable to validate feed.", null) : r;
  }
  _close() {
  ...
  _renderAutocompleteResults() {
    return this._showProductResults ? this._productQuery.trim().length < p ? d : s`
  ...
  _renderIssuesTab() {
    ...
    return s`
      <uui-box headline="Issues">
        ...
        ${e.warnings.length > 0 ? s`
              <div class="warnings-wrap">
                <h5>Feed warnings</h5>
                <ul class="list">
                  ${e.warnings.map((r) => s`<li>${r}</li>`)}
                </ul>
              </div>
            ` : d}
        ...
        ${this._selectedPreviewProduct ? s`
              <div class="selected-preview-item">
                <div class="selected-preview-meta">
                  ...
                  ${this._selectedPreviewProduct.sku ? s`<span class="selected-preview-sku">SKU: ${this._selectedPreviewProduct.sku}</span>` : d}
                </div>
...
//# sourceMappingURL=product-feed-validation-modal.element-Bx-g-nMX.js.map
