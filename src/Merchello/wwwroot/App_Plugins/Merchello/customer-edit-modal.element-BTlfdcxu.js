...
import { M as y } from "./merchello-api-B76CV0sD.js";
import "@umbraco-cms/backoffice/member";
import { UmbElementMixin as A } from "@umbraco-cms/backoffice/element-api";
import { m as E } from "./modal-layout.styles-C2OaUji5.js";
var M = Object.defineProperty, N = Object.getOwnPropertyDescriptor, d = (e, t, i, u) => {
  for (var r = u > 1 ? void 0 : u ? N(t, i) : t, m = e.length - 1, n; m >= 0; m--)
    (n = e[m]) && (r = (u ? n(t, i, r) : n(r)) || r);
  return u && r && M(t, i, r), r;
};
...
var F = Object.defineProperty, I = Object.getOwnPropertyDescriptor, x = (e) => {
  throw TypeError(e);
}, o = (e, t, i, u) => {
  for (var r = u > 1 ? void 0 : u ? I(t, i) : t, m = e.length - 1, n; m >= 0; m--)
    (n = e[m]) && (r = (u ? n(t, i, r) : n(r)) || r);
  return u && r && F(t, i, r), r;
}, S = (e, t, i) => t.has(e) || x("Cannot " + i), z = (e, t, i) => (S(e, t, "read from private field"), t.get(e)), K = (e, t, i) => t.has(e) ? x("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), f = (e, t, i, u) => (S(e, t, "write to private field"), t.set(e, i), i), h;
const v = "MerchelloCustomerEditForm";
let s = class extends L {
  constructor() {
    super(...arguments), this._email = "", this._firstName = "", this._lastName = "", this._memberKey = "", this._originalMemberKey = "", this._tags = [], this._allTags = [], this._isFlagged = !1, this._acceptsMarketing = !1, this._hasAccountTerms = !1, this._paymentTermsDays = "", this._originalPaymentTermsDays = "", this._creditLimit = "", this._originalCreditLimit = "", this._isSaving = !1, this._errors = {}, K(this, h, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=customer-edit-modal.element-BTlfdcxu.js.map
