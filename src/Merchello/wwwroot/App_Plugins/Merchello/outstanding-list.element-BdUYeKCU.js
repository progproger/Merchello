import { LitElement as k, html as s, nothing as b, css as y, state as o, customElement as w } from "@umbraco-cms/backoffice/external/lit";
...
import { g as M } from "./store-settings-Silr5K1w.js";
import { a as x, i as O } from "./formatting-DC2_cf8C.js";
import { n as A } from "./navigation-Y0bwD8V1.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
const z = new $("Merchello.MarkAsPaid.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var D = Object.defineProperty, P = Object.getOwnPropertyDescriptor, m = (e) => {
  ...
  for (var n = r > 1 ? void 0 : r ? P(t, a) : t, g = e.length - 1, _; g >= 0; g--)
    (_ = e[g]) && (n = (r ? _(t, a, n) : _(n)) || n);
  return r && n && D(t, a, n), n;
}, f = (e, t, a) => t.has(e) || m("Cannot " + a), u = (e, t, a) => (f(e, t, "read from private field"), t.get(e)), v = (e, t, a) => t.has(e) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), d = (e, t, a, r) => (f(e, t, "write to private field"), t.set(e, a), a), h, p, c;
let i = class extends C(k) {
  constructor() {
    super(), this._invoices = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._accountCustomersOnly = !0, this._selectedInvoices = /* @__PURE__ */ new Set(), this._currencyCode = "USD", v(this, h), v(this, p), v(this, c, !1), this.consumeContext(T, (e) => {
      d(this, h, e);
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), d(this, c, !1);
  }
  async _initializeAndLoad() {
    const e = await M();
    u(this, c) && (this._pageSize = e.defaultPaginationPageSize, this._currencyCode = e.currencyCode, this._loadInvoices());
  }
  async _loadInvoices() {
  ...
  async _handleMarkAsPaid() {
    ...
    ), t = await u(this, h)?.open(this, z, {
      data: {
        invoices: e,
        currencyCode: this._currencyCode
      }
    })?.onSubmit();
    t?.changed && (u(this, p)?.peek("positive", {
      data: {
  ...
  _renderRow(e) {
    ...
    return s`
      <uui-table-row
        ...
        <uui-table-cell class="checkbox-col" @click=${(r) => r.stopPropagation()}>
          <uui-checkbox
            .checked=${t}
...
//# sourceMappingURL=outstanding-list.element-BdUYeKCU.js.map
