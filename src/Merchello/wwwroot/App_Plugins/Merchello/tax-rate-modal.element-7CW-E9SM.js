...
import { M as c } from "./merchello-api-DkRa4ImO.js";
...
}, v = (e, t, i) => t.has(e) || _("Cannot " + i), l = (e, t, i) => (v(e, t, "read from private field"), t.get(e)), P = (e, t, i) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), O = (e, t, i, d) => (v(e, t, "write to private field"), t.set(e, i), i), o;
let a = class extends C {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._countryCode = "", this._stateOrProvinceCode = "", this._taxPercentage = 0, this._countries = [], this._regions = [], P(this, o), this.consumeContext(y, (e) => {
      O(this, o, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), this._loadCountries(), this.data?.rate && (this._countryCode = this.data.rate.countryCode, this._stateOrProvinceCode = this.data.rate.stateOrProvinceCode ?? "", this._taxPercentage = this.data.rate.taxPercentage, this._countryCode && this._loadRegions(this._countryCode));
  }
  ...
  _handleCountryChange(e) {
    ...
    this._countryCode = t, this._stateOrProvinceCode = "", this._regions = [], t && this._loadRegions(t);
  }
...
//# sourceMappingURL=tax-rate-modal.element-7CW-E9SM.js.map
