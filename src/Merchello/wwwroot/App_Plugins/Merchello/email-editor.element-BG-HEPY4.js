...
var L = Object.defineProperty, j = Object.getOwnPropertyDescriptor, m = (e, t, i, a) => {
  for (var o = a > 1 ? void 0 : a ? j(t, i) : t, c = e.length - 1, _; c >= 0; c--)
    (_ = e[c]) && (o = (a ? _(t, i, o) : _(o)) || o);
  return a && o && L(t, i, o), o;
};
...
}, P = (e, t, i) => t.has(e) || C("Cannot " + i), l = (e, t, i) => (P(e, t, "read from private field"), i ? i.call(e) : t.get(e)), E = (e, t, i) => t.has(e) ? C("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), y = (e, t, i, a) => (P(e, t, "write to private field"), t.set(e, i), i), v, b, p;
function k() {
  return document.createElement("div");
}
let r = class extends $(T) {
  constructor() {
    super(), this._formData = {}, this._topicCategories = [], this._templates = [], this._availableTokens = [], this._isSaving = !1, this._isLoadingMetadata = !0, this._activePath = "tab/details", this._routerPath = "", this._fieldErrors = {}, this._isNew = !0, this._testEmailRecipient = "", this._isSendingTest = !1, E(this, v), E(this, b), E(this, p), this._routes = [
      { path: "tab/details", component: k },
      { path: "tab/advanced", component: k },
      { path: "", redirectTo: "tab/details" }
    ], this.consumeContext(A, (e) => {
      y(this, v, e), this._isNew = l(this, v).isNew, this.observe(l(this, v).email, (t) => {
  ...
  async _loadTokensForTopic(e) {
    const { data: t } = await f.getTopicTokens(e);
  ...
  async _handleSave() {
    ...
    try {
      if (this._isNew) {
        ...
        }, { data: t, error: i } = await f.createEmailConfiguration(e);
        if (i) {
        ...
        if (t) {
          const { data: a } = await f.getEmailConfiguration(t.id);
          a && l(this, v)?.updateEmail(a), l(this, p)?.peek("positive", {
        ...
        const e = {
          ...
          fromExpression: this._formData.fromExpression,
          description: this._formData.description
        }, { data: t, error: i } = await f.updateEmailConfiguration(this._email.id, e);
        if (i) {
          l(this, p)?.peek("danger", {
...
//# sourceMappingURL=email-editor.element-BG-HEPY4.js.map
