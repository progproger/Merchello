import { LitElement as $, unsafeHTML as C, html as r, nothing as d, css as z, state as v, property as R, customElement as E, query as T } from "@umbraco-cms/backoffice/external/lit";
...
_([
  R({ type: Boolean, attribute: "auto-load" })
...
}, O = (e, i, a) => i.has(e) || I("Cannot " + a), o = (e, i, a) => (O(e, i, "read from private field"), i.get(e)), y = (e, i, a) => i.has(e) ? I("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), w = (e, i, a, t) => (O(e, i, "write to private field"), i.set(e, a), a), n, u, l, P;
let c = class extends L($) {
  ...
  async _deleteProvider(e) {
    ...
    if (!o(this, l)) return;
    const { error: a } = await m.deletePaymentProvider(e.id);
    if (o(this, l)) {
      if (a) {
        o(this, u)?.peek("danger", {
    ...
    return r`
      ...
      <uui-box headline="Configured Payment Providers">
        ...
        <div class="providers-list configured">
          ${this._configuredProviders.length === 0 ? r`<p class="no-items">No payment providers configured yet.</p>` : this._configuredProviders.map(
...
//# sourceMappingURL=payment-providers-list.element-7uAK2HBt.js.map
