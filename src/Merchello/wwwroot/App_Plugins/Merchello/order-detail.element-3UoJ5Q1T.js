import { LitElement as nt, nothing as m, html as s, css as ot, state as h, customElement as st, property as $i, unsafeHTML as Mi } from "@umbraco-cms/backoffice/external/lit";
...
import { b as tt, a as R, d as Li } from "./formatting-c8l-daf7.js";
...
const ke = k(Array.prototype.forEach), Ni = k(Array.prototype.lastIndexOf), Ft = k(Array.prototype.pop), ue = k(Array.prototype.push), Pi = k(Array.prototype.splice), ze = k(String.prototype.toLowerCase), Ve = k(String.prototype.toString), Ke = k(String.prototype.match), ce = k(String.prototype.replace), Fi = k(String.prototype.indexOf), Ui = k(String.prototype.trim), L = k(Object.prototype.hasOwnProperty), S = k(RegExp.prototype.test), pe = Hi(TypeError);
function k(e) {
  return function(t) {
...
function U(e) {
  ...
  for (const [a, r] of Zt(e))
    L(e, a) && (Array.isArray(r) ? t[a] = Gi(r) : r && typeof r == "object" && r.constructor === Object ? t[a] = U(r) : t[a] = r);
  return t;
}
function me(e, t) {
  for (; e !== null; ) {
...
function ei() {
  ...
  const Ci = a.createElement("form"), wt = function(i) {
    ...
    return je[i.namespaceURI] ? i.namespaceURI === Ae ? n.namespaceURI === N ? l === "svg" : n.namespaceURI === we ? l === "svg" && (p === "annotation-xml" || Se[p]) : !!At[l] : i.namespaceURI === we ? n.namespaceURI === N ? l === "math" : n.namespaceURI === Ae ? l === "math" && Ce[p] : !!St[l] : i.namespaceURI === N ? n.namespaceURI === Ae && !Ce[p] || n.namespaceURI === we && !Se[p] ? !1 : !St[l] && (wi[l] || !At[l]) : !!(le === "application/xhtml+xml" && je[i.namespaceURI]) : !1;
  }, O = function(i) {
    ue(t.removed, {
      element: i
    });
    ...
    if (Q === N)
      try {
        n = new di().parseFromString(p, le);
      } catch {
      }
    if (!n || !n.documentElement) {
      n = Re.createDocument(Q, "template", null);
      try {
        n.documentElement.innerHTML = We ? ne : p;
      } catch {
      }
    }
  ...
  const $t = function(i) {
    ...
    if (!(X.tagCheck instanceof Function && X.tagCheck(l)) && (!_[l] || oe[l])) {
      if (!oe[l] && zt(l) && (f.tagNameCheck instanceof RegExp && S(f.tagNameCheck, l) || f.tagNameCheck instanceof Function && f.tagNameCheck(l)))
        return !1;
      if (Ge && !J[l]) {
        const p = ye(i) || i.parentNode, x = mi(i) || i.childNodes;
        if (x && p) {
          const g = x.length;
          for (let D = g - 1; D >= 0; --D) {
            const F = ui(x[D], !0);
            F.__removalCount = (i.__removalCount || 0) + 1, p.insertBefore(F, pi(i));
          }
        }
      }
      return O(i), !0;
    }
    return i instanceof ut && !ki(i) || (l === "noscript" || l === "noembed" || l === "noframes") && S(/<\/no(script|embed|frames)/i, i.innerHTML) ? (O(i), !0) : (V && i.nodeType === fe.text && (n = i.textContent, ke([Oe, Ie, Ne], (p) => {
      n = ce(n, p, " ");
    ...
    for (; p--; ) {
      ...
      if (w && typeof be == "object" && typeof be.getAttributeType == "function" && !D)
      ...
      if (T !== Xe)
        try {
          D ? i.setAttributeNS(D, g, T) : i.setAttribute(g, T), qe(i) ? O(i) : Ft(t.removed);
        } catch {
          W(g, i);
        }
    }
...
}, oi = (e, t, a) => t.has(e) || ni("Cannot " + a), z = (e, t, a) => (oi(e, t, "read from private field"), t.get(e)), Xt = (e, t, a) => t.has(e) ? ni("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), Vt = (e, t, a, r) => (oi(e, t, "write to private field"), t.set(e, a), a), I, Y;
let E = class extends lt(nt) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._activeTab = "details", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], Xt(this, I), Xt(this, Y), this.consumeContext(Kt, (e) => {
      Vt(this, I, e), z(this, I) && this.observe(z(this, I).order, (t) => {
  ...
  async _openFulfillmentModal() {
    if (!this._order || !z(this, Y)) return;
    await z(this, Y).open(this, ia, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), z(this, I)?.load(this._order.id);
  }
  async _openEditOrderModal() {
    if (!this._order || !z(this, Y)) return;
    await z(this, Y).open(this, aa, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), z(this, I)?.load(this._order.id);
  }
  ...
  async _saveEditing() {
    ...
    this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, z(this, I)?.load(this._order.id);
  }
      ...
      (o) => s`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-pricing">
                  <span class="fulfillment-item-price">${R(o.amount)}</span>
                  <span class="fulfillment-item-multiply">×</span>
                  <span class="fulfillment-item-qty">${o.quantity}</span>
                </div>
                <div class="fulfillment-item-total">${R(o.amount * o.quantity)}</div>
              </div>
            `
    )}
        </div>
  ...
  _handlePaymentChange() {
    this._order && z(this, I)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    this._newNoteText = "", this._visibleToCustomer = !1, z(this, I)?.load(this._order.id);
  }
  _renderLoadingState() {
    return s`<div class="loading"><uui-loader></uui-loader></div>`;
  }
...
//# sourceMappingURL=order-detail.element-3UoJ5Q1T.js.map
