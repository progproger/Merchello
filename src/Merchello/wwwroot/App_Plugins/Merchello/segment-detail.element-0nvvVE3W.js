import { LitElement as E, html as s, nothing as c, css as P, property as z, state as o, customElement as k } from "@umbraco-cms/backoffice/external/lit";
...
import { t as re, u as se } from "./navigation-COkStlQk.js";
...
import { a as ue } from "./formatting-CeWY__1B.js";
import { a as de } from "./store-settings-Biy0PIJu.js";
...
let h = class extends T(E) {
  ...
  async _handleRemoveMember(e) {
    const t = e.customerName || e.customerEmail, i = _(this, x)?.open(this, ne, {
      data: {
    ...
    const { error: a } = await y.removeSegmentMembers(this.segmentId, {
...
}, j = (e, t, i) => t.has(e) || Z("Cannot " + i), B = (e, t, i) => (j(e, t, "read from private field"), t.get(e)), ve = (e, t, i) => t.has(e) ? Z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), q = (e, t, i, a) => (j(e, t, "write to private field"), t.set(e, i), i), S;
let u = class extends T(E) {
  ...
  connectedCallback() {
    super.connectedCallback(), q(this, S, !0), this.segmentId && (this._loadPreview(), this._loadStatistics());
  }
  disconnectedCallback() {
    super.disconnectedCallback(), q(this, S, !1);
  }
  updated(e) {
...
}, te = (e, t, i) => t.has(e) || ee("Cannot " + i), d = (e, t, i) => (te(e, t, "read from private field"), t.get(e)), U = (e, t, i) => t.has(e) ? ee("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), V = (e, t, i, a) => (te(e, t, "write to private field"), t.set(e, i), i), g, f;
function G() {
  return document.createElement("div");
}
let m = class extends T(E) {
  constructor() {
    super(), this._formData = {}, this._isSaving = !1, this._activePath = "tab/details", this._routerPath = "", this._fieldErrors = {}, this._isNew = !0, U(this, g), U(this, f), this._routes = [
      { path: "tab/details", component: G },
      { path: "tab/preview", component: G },
      { path: "", redirectTo: "tab/details" }
    ], this.consumeContext(ae, (e) => {
      V(this, g, e), d(this, g) && (this._isNew = d(this, g).isNew, this.observe(d(this, g).segment, (t) => {
        this._segment = t, this._isNew = d(this, g)?.isNew ?? !0, t && (this._formData = { ...t });
      }, "_segment"));
    }), this.consumeContext(H, (e) => {
      V(this, f, e);
    });
  ...
  async _handleSave() {
    ...
    try {
      if (this._isNew) {
        ...
        t && (d(this, g)?.updateSegment(t), d(this, f)?.peek("positive", {
      ...
      ${this._formData.segmentType === "Manual" && !this._isNew && this._segment?.id ? s`
        <uui-box headline="Members (${this._segment?.memberCount ?? 0})">
          <merchello-segment-members-table
            ...
            @members-changed=${() => d(this, g)?.reloadSegment()}>
          </merchello-segment-members-table>
        </uui-box>
      ` : c}
...
//# sourceMappingURL=segment-detail.element-0nvvVE3W.js.map
