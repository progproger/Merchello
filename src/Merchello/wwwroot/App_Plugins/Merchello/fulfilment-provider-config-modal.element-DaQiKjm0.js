...
var S = Object.defineProperty, M = Object.getOwnPropertyDescriptor, f = (e) => {
  ...
  for (var r = a > 1 ? void 0 : a ? M(i, s) : i, c = e.length - 1, u; c >= 0; c--)
    (u = e[c]) && (r = (a ? u(i, s, r) : u(r)) || r);
  ...
  async _loadFields() {
    ...
    if (v(this, p)) {
      ...
      if (this._serviceMappings = this._shippingOptions.map((r) => ({
        ...
        if (!v(this, p)) return;
        if (r.data) {
          const c = this._values.ServiceMappings;
          if (c)
            try {
              const u = JSON.parse(c);
              this._serviceMappings = this._serviceMappings.map((g) => ({
                ...g,
                providerServiceCode: u[g.shippingOptionId] ?? ""
              }));
            } catch {
            }
        }
                      ...
                      <div class="service-mappings">
                        ${this._serviceMappings.map((s) => t`
                          <div class="mapping-row">
                            ...
                            <uui-input
                              label="Service code for ${s.shippingOptionName}"
...
//# sourceMappingURL=fulfilment-provider-config-modal.element-DaQiKjm0.js.map
