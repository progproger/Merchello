...
import { b as N, a as h, h as Se } from "./formatting-CbhqdYyc.js";
import { M as g } from "./merchello-api-Cd16th0c.js";
import { r as ze } from "./navigation-DfYj5Lv5.js";
...
}, de = (e, i, t) => i.has(e) || le("Cannot " + t), u = (e, i, t) => (de(e, i, "read from private field"), i.get(e)), j = (e, i, t) => i.has(e) ? le("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), B = (e, i, t, o) => (de(e, i, "write to private field"), i.set(e, t), t), z, E, x, k;
let w = class extends Y(q) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, j(this, z), j(this, E), j(this, x), j(this, k, !1), this.consumeContext(oe, (e) => {
      B(this, z, e), u(this, z) && this.observe(u(this, z).order, (i) => {
  ...
  async _loadShipments() {
    ...
    u(this, k) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  async _handleEditShipment(e) {
    if (!u(this, E)) return;
    (await u(this, E).open(this, Me, {
      data: { shipment: e }
    }).onSubmit().catch(() => {
    }))?.isUpdated && this._loadShipments();
  }
  async _handleDeleteShipment(e) {
    const i = u(this, E)?.open(this, ie, {
      data: {
    ...
    if (u(this, k)) {
      ...
      this._loadShipments(), this._invoiceId && u(this, z)?.load(this._invoiceId);
    }
  }
  ...
  async _handleMarkAsShipped(e) {
    ...
    if (u(this, k)) {
      ...
      }), this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._loadShipments(), this._invoiceId && u(this, z)?.load(this._invoiceId);
    }
  }
...
var Oe = Object.defineProperty, Te = Object.getOwnPropertyDescriptor, ue = (e) => {
  throw TypeError(e);
}, R = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Te(i, t) : i, l = e.length - 1, p; l >= 0; l--)
    (p = e[l]) && (r = (o ? p(i, t, r) : p(r)) || r);
  return o && r && Oe(i, t, r), r;
}, ce = (e, i, t) => i.has(e) || ue("Cannot " + t), O = (e, i, t) => (ce(e, i, "read from private field"), i.get(e)), ae = (e, i, t) => i.has(e) ? ue("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (ce(e, i, "write to private field"), i.set(e, t), t), L, F;
...
}, ve = (e, i, t) => i.has(e) || he("Cannot " + t), d = (e, i, t) => (ve(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? he("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), V = (e, i, t, o) => (ve(e, i, "write to private field"), i.set(e, t), t), b, f, _, $;
let c = class extends Y(q) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, W(this, b), W(this, f), W(this, _), W(this, $, !1), this.consumeContext(oe, (e) => {
      V(this, b, e), d(this, b) && this.observe(d(this, b).order, (i) => {
  ...
  async _openFulfillmentModal() {
    if (!this._order || !d(this, f)) return;
    const e = this._order.id;
    await d(this, f).open(this, Ie, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), d(this, $) && d(this, b)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !d(this, f)) return;
    const e = this._order.id;
    await d(this, f).open(this, xe, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), d(this, $) && d(this, b)?.load(e);
  }
  async _openCancelInvoiceModal() {
    if (!this._order || !d(this, f)) return;
    const i = await d(this, f).open(this, Pe, {
      data: {
    ...
    d(this, $) && i?.cancelled && (d(this, _)?.peek("positive", {
      data: {
  ...
  async _openCustomerEditModal() {
    if (!this._order?.customerId || !d(this, f)) return;
    ...
    (await d(this, f).open(this, we, {
      data: { customer: e }
    })?.onSubmit().catch(() => {
    }))?.isUpdated && d(this, _)?.peek("positive", {
  ...
  async _saveEditing() {
    ...
    if (d(this, $)) {
      ...
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, d(this, b)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (d(this, $)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", d(this, b)?.load(this._order.id);
    }
  }
  ...
  _handlePaymentChange() {
    this._order && d(this, b)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (d(this, $)) {
      if (this._isPostingNote = !1, e) {
        this._noteError = e.message || "Failed to post note", d(this, _)?.peek("danger", {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, d(this, b)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
//# sourceMappingURL=order-detail.element-D6egwskE.js.map
