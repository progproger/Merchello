const e = [
  {
    ...
    js: () => import("./entrypoint-CwhDAWuv.js")
  }
], o = [
  // Section
  {
  ...
  // Health Checks Dashboard
  {
    ...
    element: () => import("./health-checks-dashboard.element-x58vMKVV.js"),
    meta: {
      label: "Health Checks",
  ...
  // Tree Repository
  {
    ...
    api: () => import("./tree-repository-CsmTcyIT.js")
  },
  // Tree
  {
    type: "tree",
...
], l = "merchello-root", i = "merchello-orders", t = "merchello-products", r = "merchello-customers", s = "merchello-collections", c = "merchello-filters", n = "merchello-product-types", p = "merchello-product-feed", m = "merchello-product-import-export", d = "merchello-analytics", h = "merchello-discounts", M = "merchello-suppliers", y = "merchello-warehouses", u = "merchello-emails", k = "merchello-providers", P = "merchello-webhooks", E = "merchello-outstanding", w = "merchello-abandoned-checkouts", b = "merchello-notifications", T = "merchello-upsells", g = [
  // Fulfillment modal for creating shipments
  {
    type: "modal",
    alias: "Merchello.Fulfillment.Modal",
    name: "Merchello Fulfillment Modal",
    js: () => import("./fulfillment-modal.element-7PWgxkkF.js")
  },
  // Shipment edit modal for updating tracking info
  {
    ...
    js: () => import("./shipment-edit-modal.element-e_MmlP7v.js")
  },
  // Manual payment modal for recording offline payments
  {
    ...
    js: () => import("./manual-payment-modal.element-_sXQiNr9.js")
  },
  // Refund modal for processing refunds
  {
    ...
    js: () => import("./refund-modal.element-Dh9E-Rd7.js")
  },
  // Cancel invoice modal for cancelling invoices
  {
    ...
    js: () => import("./cancel-invoice-modal.element-D7d9_aup.js")
  },
  // Export modal for exporting orders to CSV
  {
    ...
    js: () => import("./export-modal.element-BMNLsLLl.js")
  },
  // Edit order modal for editing order details
  {
    ...
    js: () => import("./edit-order-modal.element-CFW-6_d2.js")
  },
  // Add custom item modal for edit order
  {
    ...
    js: () => import("./add-custom-item-modal.element-C4cXudX4.js")
  },
  // Add discount modal for edit order
  {
    ...
    js: () => import("./add-discount-modal.element-Dk2krV86.js")
  },
  // Create order modal for creating manual orders from backoffice
  {
    ...
    js: () => import("./create-order-modal.element-BLHFk09g.js")
  },
  // Customer orders modal for viewing all orders by a customer
  {
    ...
    js: () => import("./customer-orders-modal.element-BmulnV4y.js")
  },
  // Generate statement modal for downloading customer statement PDFs
  {
    ...
    js: () => import("./generate-statement-modal.element-DG2FSVyp.js")
  },
  // Workspace for orders list (when clicking "Orders" in tree)
  {
    ...
    api: () => import("./orders-workspace.context-B7cmd1u7.js"),
    meta: {
      entityType: i
    }
  },
  // Workspace view - the orders list (used when on list route)
  {
    ...
    js: () => import("./orders-list.element-GvwyI0Nn.js"),
    weight: 100,
    meta: {
      label: "Orders",
      pathname: "list",
  ...
  // Mark as paid modal
  {
    ...
    js: () => import("./mark-as-paid-modal.element-D0HG5_oc.js")
  },
  // Workspace for outstanding list (when clicking "Outstanding" in tree)
  {
    ...
    api: () => import("./outstanding-workspace.context-tN8V2MUe.js"),
    meta: {
      entityType: E
    }
  },
  // Workspace view - the outstanding list
  {
    ...
    js: () => import("./outstanding-list.element-n_O3BgsG.js"),
    weight: 100,
    meta: {
      label: "Outstanding",
      pathname: "list",
  ...
  // Workspace for abandoned checkouts list (when clicking "Abandoned Checkouts" in tree)
  {
    ...
    api: () => import("./abandoned-checkouts-workspace.context-D16_vB5S.js"),
    meta: {
      entityType: w
    }
  },
  // Workspace view - the abandoned checkouts list
  {
    ...
    js: () => import("./abandoned-checkouts-list.element-B8QzLa_p.js"),
    weight: 100,
    meta: {
  ...
  // Detail modal (sidebar)
  {
    ...
    js: () => import("./abandoned-checkout-detail-modal.element-DwsjcyOh.js")
  }
], f = [
  // Create product modal
  {
    ...
    js: () => import("./create-product-modal.element-Ch3PwdjH.js")
  },
  // Option editor modal
  {
    type: "modal",
    ...
    js: () => import("./option-editor-modal.element-ikrIxjzA.js")
  },
  // Variant batch update modal
  {
    ...
    js: () => import("./variant-batch-update-modal.element-dtoegfK_.js")
  },
  // Workspace for products list (when clicking "Products" in tree)
  {
    ...
    api: () => import("./products-workspace.context-CIxDJReC.js"),
    meta: {
      entityType: t
    }
  },
  // Workspace view for products list (used when on list route)
  {
    ...
    js: () => import("./products-list.element-B8HGnSKL.js"),
    weight: 100,
    meta: {
      label: "Products",
      pathname: "products",
  ...
  // Workspace for customers (when clicking "Customers" in tree)
  {
    ...
    api: () => import("./customers-workspace.context-m6t74xiV.js"),
    meta: {
      entityType: r
    }
  },
  // Workspace view - the customers list
  {
    ...
    js: () => import("./customers-list.element-CU4bd-xf.js"),
    weight: 100,
    meta: {
      label: "Customers",
      pathname: "list",
  ...
  // Workspace view - the segments list (tab in Customers workspace)
  {
    ...
    js: () => import("./segments-list.element-CDiD9ZyB.js"),
    weight: 90,
    meta: {
      label: "Segments",
      pathname: "segments",
  ...
  // Customer edit modal
  {
    ...
    js: () => import("./customer-edit-modal.element-BK4KTavL.js")
  },
  // Customer picker modal (for adding members to segments)
  {
    ...
    js: () => import("./customer-picker-modal.element-P9ZOPgBY.js")
  },
  // Segment picker modal (for discount eligibility)
  {
    ...
    js: () => import("./segment-picker-modal.element-n90RfLgR.js")
  }
], S = [
  // Workspace for collections (when clicking "Collections" in tree)
  {
    ...
    api: () => import("./collections-workspace.context-BqaIxwWO.js"),
    meta: {
      entityType: s
    }
  },
  // Workspace view for collections
  {
    ...
    js: () => import("./collections-workspace.element-BwZ5o75P.js"),
    weight: 100,
    meta: {
      label: "Collections",
  ...
  // Collection picker modal (for discount targeting)
  {
    ...
    js: () => import("./collection-picker-modal.element-DbWO8w9w.js")
  },
  // Collection create/edit modal
  {
    ...
    js: () => import("./collection-modal.element-BOEsKZbC.js")
  }
], j = [
  // Workspace for filters (when clicking "Filters" in tree)
  {
    ...
    api: () => import("./filters-workspace.context-B2Cf5yjc.js"),
    meta: {
      entityType: c
    }
  },
  // Workspace view for filters list
  {
    ...
    js: () => import("./filters-list.element-CD0j01vm.js"),
    weight: 100,
    meta: {
      label: "Filters",
      pathname: "filters",
  ...
  // Modal for creating/editing filter groups
  {
    ...
    js: () => import("./filter-group-modal.element-D9MujV7O.js")
  },
  // Modal for creating/editing filters
  {
    ...
    js: () => import("./filter-modal.element-BfKjTkt9.js")
  },
  // Filter picker modal (for discount targeting)
  {
    ...
    js: () => import("./filter-picker-modal.element-BgiAX3Md.js")
  },
  // Filter group picker modal (for property editor)
  {
    ...
    js: () => import("./filter-group-picker-modal.element-DnTo7KpO.js")
  }
], V = [
  // Workspace for product types (when clicking "Product Types" in tree)
  {
    ...
    api: () => import("./product-types-workspace.context-DxNxCnU0.js"),
    meta: {
      entityType: n
    }
  },
  // Workspace view for product types
  {
    ...
    js: () => import("./product-types-list.element-CvVOoJrA.js"),
    weight: 100,
    meta: {
      label: "Product Types",
  ...
  // Modal for create/edit product type
  {
    ...
    js: () => import("./product-type-modal.element-BxIMxjx1.js")
  },
  // Product type picker modal (for discount targeting)
  {
    ...
    js: () => import("./product-type-picker-modal.element-NtNPTY2Z.js")
  }
], A = [
  // Workspace for product feed (when clicking "Product Feed" in tree)
  {
    ...
    api: () => import("./product-feed-workspace.context-BJN0vVEk.js"),
    meta: {
      entityType: p
    }
  },
  // Workspace view for product feed
  {
    ...
    js: () => import("./product-feeds-list.element-Dzf3ZpB6.js"),
    weight: 100,
    meta: {
      label: "Product Feeds",
  ...
  },
  {
    ...
    js: () => import("./product-feed-validation-modal.element-C4zNO-0F.js")
  }
], v = [
  {
    type: "workspace",
    ...
    api: () => import("./product-import-export-workspace.context-CjBIkmTy.js"),
    meta: {
      entityType: m
    }
  },
  {
    ...
    js: () => import("./product-import-export-page.element-CwMpeODs.js"),
    weight: 100,
    meta: {
      label: "Import & Export",
      pathname: "sync",
  ...
  // Workspace for providers (when clicking "Providers" in tree)
  {
    ...
    api: () => import("./providers-workspace.context-BoL5_g9P.js"),
    meta: {
      entityType: k
    }
  }
  ...
  // Workspace for analytics (when clicking "Analytics" in tree)
  {
    ...
    api: () => import("./analytics-workspace.context-BZJ8iSor.js"),
    meta: {
      entityType: d
    }
  },
  // Workspace view for analytics
  {
    ...
    js: () => import("./analytics-workspace.element-ruuRPubM.js"),
    weight: 100,
    meta: {
      label: "Analytics",
      pathname: "analytics",
  ...
  // Workspace for discounts list (when clicking "Discounts" in tree)
  {
    ...
    api: () => import("./discounts-workspace.context-BW8Kb0Q_.js"),
    meta: {
      entityType: h
    }
  },
  // Workspace view for discounts list (used when on list route)
  {
    ...
    js: () => import("./discounts-list.element-CLhpguFv.js"),
    weight: 100,
    meta: {
      label: "Discounts",
      pathname: "discounts",
  ...
  // Workspace for emails (when clicking "Emails" in tree)
  {
    ...
    api: () => import("./email-workspace.context-VUHjXNft.js"),
    meta: {
      entityType: u
    }
  },
  // Workspace view - the email list
  {
    ...
    js: () => import("./email-list.element-HwmknoWA.js"),
    weight: 100,
    meta: {
      label: "Emails",
      pathname: "list",
  ...
  // Email preview modal
  {
    ...
    js: () => import("./email-preview-modal.element-COMM-kZP.js")
  }
], x = [
  // Workspace for webhooks (when clicking "Webhooks" in tree)
  {
    ...
    api: () => import("./webhooks-workspace.context-CJ3H1lV0.js"),
    meta: {
      entityType: P
    }
  },
  // Workspace view - the webhooks list
  {
    ...
    js: () => import("./webhooks-list.element-B-0YaYi4.js"),
    weight: 100,
    meta: {
      label: "Webhooks",
      pathname: "list",
  ...
  // Webhook subscription create/edit modal
  {
    ...
    js: () => import("./webhook-subscription-modal.element-Cia6ShHZ.js")
  },
  // Webhook test modal
  {
    type: "modal",
    ...
    js: () => import("./webhook-test-modal.element-Cxr0yh0t.js")
  },
  // Delivery detail modal
  {
    ...
    js: () => import("./delivery-detail-modal.element-DU8sTqEY.js")
  },
  // Integration guide modal
  {
    ...
    js: () => import("./webhook-integration-guide-modal.element-CzQxFoUp.js")
  }
], R = [
  // Workspace for notifications (when clicking "Notifications" in tree)
  {
    ...
    api: () => import("./notifications-workspace.context-BNEOtb6E.js"),
    meta: {
      entityType: b
    }
  },
  // Workspace view - the notifications list (rendered inside workspace editor shell)
  {
    ...
    js: () => import("./notifications-list.element-CTIchwFZ.js"),
    weight: 100,
    meta: {
      label: "Notifications",
      pathname: "list",
  ...
  // Workspace view for tax providers list (appears as "Tax" tab in Providers workspace)
  {
    ...
    js: () => import("./tax-providers-list.element-B0vGRDGT.js"),
    weight: 85,
    meta: {
      label: "Tax",
      pathname: "tax",
  ...
  // Tax group modal (handles both create and edit)
  {
    ...
    js: () => import("./tax-group-modal.element--O8aOInD.js")
  },
  // Tax rate modal (handles both create and edit for geographic rates)
  {
    ...
    js: () => import("./tax-rate-modal.element-toZqmBz9.js")
  },
  // Tax provider config modal
  {
    ...
    js: () => import("./tax-provider-config-modal.element-C71dyvpl.js")
  },
  // Test tax provider modal
  {
    ...
    js: () => import("./test-tax-provider-modal.element-CDSao3W6.js")
  },
  // Shipping tax override modal
  {
    ...
    js: () => import("./shipping-tax-override-modal.element-C4HHMPQd.js")
  }
], D = [
  // ============================================
  ...
  // Main workspace for suppliers list
  {
    ...
    api: () => import("./suppliers-workspace.context-BHXA2kaK.js"),
    meta: {
      entityType: M
    }
  },
  // List view for suppliers
  {
    ...
    js: () => import("./suppliers-list.element-B-oJ4DyD.js"),
    weight: 100,
    meta: {
      label: "Suppliers",
      pathname: "suppliers",
  ...
  // Supplier modal (handles both create and edit)
  {
    ...
    js: () => import("./supplier-modal.element-BAIb6OEo.js")
  },
  // Supplier picker modal (for discount targeting)
  {
    ...
    js: () => import("./supplier-picker-modal.element-RLpDwG0T.js")
  }
], Y = [
  // ============================================
  ...
  // Main workspace for warehouses list (child of Settings in tree)
  {
    ...
    api: () => import("./warehouses-workspace.context-CvctyjWE.js"),
    meta: {
      entityType: y
    }
  },
  // List view for warehouses (used when on list route)
  {
    ...
    js: () => import("./warehouses-list.element-Dc0m0Afw.js"),
    weight: 100,
    meta: {
      label: "Warehouses",
      pathname: "warehouses",
  ...
  // Service region modal
  {
    ...
    js: () => import("./service-region-modal.element-DGxx3v1v.js")
  },
  // Warehouse picker modal (for discount targeting)
  {
    ...
    js: () => import("./warehouse-picker-modal.element-CvIxvYnC.js")
  }
], $ = [
  // Workspace view for shipping providers (under Providers workspace)
  {
    ...
    js: () => import("./shipping-providers-list.element-TNLzyuXf.js"),
    weight: 90,
    meta: {
      label: "Shipping",
      pathname: "shipping",
  ...
  // Shipping provider configuration modal
  {
    ...
    js: () => import("./shipping-provider-config-modal.element-BFcWuMNb.js")
  },
  // Test shipping provider modal
  {
    ...
    js: () => import("./test-provider-modal.element-mm0Gm-vF.js")
  },
  // Shipping option detail modal
  {
    ...
    js: () => import("./shipping-option-detail-modal.element-aWfkeBlm.js")
  },
  // Shipping cost modal
  {
    type: "modal",
    ...
    js: () => import("./shipping-cost-modal.element-DOySZHZi.js")
  },
  // Shipping weight tier modal
  {
    ...
    js: () => import("./shipping-weight-tier-modal.element-Bt7h5SR1.js")
  },
  // Shipping destination exclusion modal
  {
    ...
    js: () => import("./shipping-destination-exclusion-modal.element-BSQohVAJ.js")
  },
  // Shipping postcode rule modal
  {
    ...
    js: () => import("./shipping-postcode-rule-modal.element-DCFdHDyx.js")
  }
], N = [
  // Workspace view for payment providers (under Providers workspace)
  {
    ...
    js: () => import("./payment-providers-list.element-CeayPSsf.js"),
    weight: 100,
    meta: {
      label: "Payments",
      pathname: "payments",
  ...
  // Modal for configuring a payment provider
  {
    ...
    js: () => import("./payment-provider-config-modal.element-jm_u0Stq.js")
  },
  // Modal for configuring payment methods within a provider
  {
    ...
    js: () => import("./payment-methods-config-modal.element-YX199IeF.js")
  },
  // Modal for editing a single payment method's display settings
  {
    ...
    js: () => import("./payment-method-edit-modal.element-5VZrsmBl.js")
  },
  // Modal for displaying setup instructions
  {
    ...
    js: () => import("./setup-instructions-modal.element-D0s02Zcw.js")
  },
  // Modal for testing a payment provider
  {
    ...
    js: () => import("./test-provider-modal.element-DMAQt2tJ.js")
  }
], H = [
  // Workspace view for fulfilment providers (under Providers workspace)
  {
    ...
    js: () => import("./fulfilment-providers-list.element-Cy39egts.js"),
    weight: 75,
    meta: {
      label: "Fulfilment",
      pathname: "fulfilment",
  ...
  // Configuration modal
  {
    ...
    js: () => import("./fulfilment-provider-config-modal.element-BpuVkItt.js")
  },
  // Test modal
  {
    type: "modal",
    ...
    js: () => import("./test-provider-modal.element-C5R1YDut.js")
  }
], G = [
  {
    type: "modal",
    ...
    element: () => import("./health-check-detail-modal.element-B89BHGPy.js")
  }
], B = [
  // Workspace view for exchange rate providers (under Providers workspace)
  {
    ...
    js: () => import("./exchange-rate-providers-list.element-BFxB9DXZ.js"),
    weight: 80,
  ...
  // Modal for configuring an exchange rate provider
  {
    ...
    js: () => import("./exchange-rate-provider-config-modal.element-Bvb8Qkzv.js")
  },
  // Modal for testing an exchange rate provider
  {
    ...
    js: () => import("./test-provider-modal.element-87ohtTI9.js")
  }
], q = [
  // Workspace view for address lookup providers (under Providers workspace)
  {
    ...
    js: () => import("./address-lookup-providers-list.element-C7AwU6Wz.js"),
    weight: 85,
    meta: {
  ...
  // Modal for configuring an address lookup provider
  {
    ...
    js: () => import("./address-lookup-provider-config-modal.element-Keqpgu2L.js")
  },
  // Modal for testing an address lookup provider
  {
    ...
    js: () => import("./test-provider-modal.element-04Bww-lr.js")
  }
], K = [
  {
    type: "workspace",
    ...
    api: () => import("./upsells-workspace.context-BC7xGn94.js"),
    meta: {
      entityType: T
    }
  },
  {
    ...
    js: () => import("./upsells-list.element-j0F7B82b.js"),
    weight: 100,
    meta: {
      label: "Upsells",
      pathname: "upsells",
  ...
  },
  {
    ...
    js: () => import("./create-upsell-modal.element-DFxZTrON.js")
  },
  {
    type: "modal",
  ...
  // Workspace for root (when clicking "Merchello" in tree)
  {
    ...
    api: () => import("./settings-workspace.context-B7l6EIGj.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./settings-workspace.element-_hZr7PYK.js"),
    weight: 100,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  // Product picker modal for selecting products in orders and property editors
  {
    ...
    js: () => import("./product-picker-modal.element-BL32AYVj.js")
  }
], J = [
  {
    ...
    element: () => import("./property-editor-ui-collection-picker.element-EdxIWIlv.js"),
    meta: {
...
], Q = [
  {
    ...
    element: () => import("./property-editor-ui-product-type-picker.element-nZswbbFI.js"),
    meta: {
...
], Z = [
  {
    ...
    element: () => import("./property-editor-ui-filter-group-picker.element-CbJiUDDB.js"),
    meta: {
...
], ee = [
  {
    ...
    element: () => import("./property-editor-ui-filter-value-picker.element-CfuKZ4uj.js"),
    meta: {
...
], oe = [
  {
    ...
    element: () => import("./property-editor-ui-product-picker.element-6_uE1uUL.js"),
    meta: {
...
], ae = [
  {
    ...
    element: () => import("./property-editor-ui-google-shopping-category-picker.element-DaUdILNV.js"),
    meta: {
...
//# sourceMappingURL=bundle.manifests-7tZy4Zbf.js.map
