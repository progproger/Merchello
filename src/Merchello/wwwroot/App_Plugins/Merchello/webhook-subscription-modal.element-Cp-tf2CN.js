import { html as s, nothing as l, css as f, state as u, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as $, UMB_MODAL_MANAGER_CONTEXT as S, UMB_CONFIRM_MODAL as k } from "@umbraco-cms/backoffice/modal";
import { W as h, g as w } from "./webhooks.types-BKPXEUdT.js";
import { M as p } from "./merchello-api-NdGX4WPd.js";
import { m as H } from "./modal-layout.styles-C2OaUji5.js";
var T = Object.defineProperty, M = Object.getOwnPropertyDescriptor, g = (e) => {
  throw TypeError(e);
}, o = (e, t, i, a) => {
  for (var n = a > 1 ? void 0 : a ? M(t, i) : t, c = e.length - 1, m; c >= 0; c--)
    (m = e[c]) && (n = (a ? m(t, i, n) : m(n)) || n);
  return a && n && T(t, i, n), n;
}, y = (e, t, i) => t.has(e) || g("Cannot " + i), b = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), A = (e, t, i) => t.has(e) ? g("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), x = (e, t, i, a) => (y(e, t, "write to private field"), t.set(e, i), i), d;
const _ = "MerchelloWebhookSubscriptionForm";
let r = class extends $ {
  constructor() {
    super(), this._name = "", this._topic = "", this._targetUrl = "", this._authType = h.HmacSha256, this._authHeaderName = "", this._authHeaderValue = "", this._timeoutSeconds = 30, this._isActive = !0, this._secret = "", this._showSecret = !1, this._isSaving = !1, this._isPinging = !1, this._pingResult = null, this._errors = {}, A(this, d), this.consumeContext(S, (e) => {
      x(this, d, e);
    });
  }
  get _isEditMode() {
...
//# sourceMappingURL=webhook-subscription-modal.element-Cp-tf2CN.js.map
