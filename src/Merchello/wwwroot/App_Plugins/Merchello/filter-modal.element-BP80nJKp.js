import { nothing as c, html as n, css as x, state as h, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
var S = Object.defineProperty, F = Object.getOwnPropertyDescriptor, C = (e) => {
  ...
  for (var r = a > 1 ? void 0 : a ? F(t, i) : t, o = e.length - 1, d; o >= 0; o--)
    (d = e[o]) && (r = (a ? d(t, i, r) : d(r)) || r);
...
let s = class extends k {
  ...
  async _handleSave(e) {
    ...
    if (this._isEditMode) {
      ...
      const { data: d, error: v } = await _.updateFilter(o, {
        name: t,
      ...
      this.value = { filter: d, isUpdated: !0 }, this.modalContext?.submit();
      return;
    }
            ...
            <uui-form>
              <form id=${f} @submit=${this._handleSave}>
                <uui-form-layout-item>
                  ...
                  ${this._errors.name ? n`<span class="error" role="alert">${this._errors.name}</span>` : c}
                </uui-form-layout-item>
...
//# sourceMappingURL=filter-modal.element-BP80nJKp.js.map
