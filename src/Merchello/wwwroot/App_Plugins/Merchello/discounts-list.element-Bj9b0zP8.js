...
import { UmbModalToken as P, UMB_MODAL_MANAGER_CONTEXT as L, UMB_CONFIRM_MODAL as z } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as I } from "@umbraco-cms/backoffice/notification";
import { c as S, b as C, e as O, d as p, D as f } from "./discount.types-oO6YJLvR.js";
import { M as T } from "./merchello-api-BAKL0aIE.js";
import { g as U } from "./store-settings-BZqgqZ5a.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { a as B, i as N } from "./formatting-CG1-kUla.js";
import { f as F, h as R, i as G } from "./navigation-Y0bwD8V1.js";
import { b as V } from "./badge.styles-DUcdl6GY.js";
var W = Object.defineProperty, X = Object.getOwnPropertyDescriptor, m = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? X(t, a) : t, u = e.length - 1, d; u >= 0; u--)
...
const j = new P("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
...
var H = Object.defineProperty, Y = Object.getOwnPropertyDescriptor, A = (e) => {
  ...
  for (var i = s > 1 ? void 0 : s ? Y(t, a) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (i = (s ? d(t, a, i) : d(i)) || i);
  return s && i && H(t, a, i), i;
}, E = (e, t, a) => t.has(e) || A("Cannot " + a), n = (e, t, a) => (E(e, t, "read from private field"), t.get(e)), $ = (e, t, a) => t.has(e) ? A("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), v = (e, t, a, s) => (E(e, t, "write to private field"), t.set(e, a), a), b, g, h;
let l = class extends M(k) {
  ...
  async _handleDeleteSelected() {
    ...
    let s = 0, i = 0;
    for (const u of a) {
      const { error: d } = await T.deleteDiscount(u);
      if (!n(this, h)) return;
      d ? i++ : s++;
    }
    this._isDeleting = !1, i > 0 ? n(this, g)?.peek("warning", {
  ...
  async _handleCreateDiscount() {
    ...
    n(this, h) && t?.selectedCategory !== void 0 && R(t.selectedCategory);
  }
  _handleDiscountClick(e) {
    G(e.detail.discountId);
  }
  _renderLoadingState() {
...
//# sourceMappingURL=discounts-list.element-Bj9b0zP8.js.map
