import { nothing as r, html as a, css as f, state as u, customElement as y } from "@umbraco-cms/backoffice/external/lit";
...
var $ = Object.defineProperty, k = Object.getOwnPropertyDescriptor, _ = (e) => {
  ...
  for (var o = n > 1 ? void 0 : n ? k(s, i) : s, c = e.length - 1, p; c >= 0; c--)
    (p = e[c]) && (o = (n ? p(s, i, o) : p(o)) || o);
  return n && o && $(s, i, o), o;
}, m = (e, s, i) => s.has(e) || _("Cannot " + i), h = (e, s, i) => (m(e, s, "read from private field"), s.get(e)), x = (e, s, i) => s.has(e) ? _("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(e) : s.set(e, i), g = (e, s, i, n) => (m(e, s, "write to private field"), s.set(e, i), i), d;
let t = class extends b {
  constructor() {
    super(...arguments), this._fields = [], this._values = {}, this._displayName = "", this._isEnabled = !0, this._isTestMode = !0, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, x(this, d, !1);
  }
  connectedCallback() {
  ...
  async _loadFields() {
    ...
    const { data: i, error: n } = await v.getPaymentProviderFields(e.alias);
    if (!h(this, d)) return;
    if (n) {
...
//# sourceMappingURL=payment-provider-config-modal.element-C6WeID0e.js.map
