import { html as n, css as m, state as d, customElement as f } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as g } from "@umbraco-cms/backoffice/modal";
import { M as b } from "./merchello-api-B1P1cUX9.js";
var v = Object.defineProperty, C = Object.getOwnPropertyDescriptor, h = (t) => {
  throw TypeError(t);
}, c = (t, e, r, i) => {
  for (var s = i > 1 ? void 0 : i ? C(e, r) : e, l = t.length - 1, o; l >= 0; l--)
    (o = t[l]) && (s = (i ? o(e, r, s) : o(s)) || s);
  return i && s && v(e, r, s), s;
}, _ = (t, e, r) => e.has(t) || h("Cannot " + r), y = (t, e, r) => (_(t, e, "read from private field"), e.get(t)), S = (t, e, r) => e.has(t) ? h("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), p = (t, e, r, i) => (_(t, e, "write to private field"), e.set(t, r), r), u;
let a = class extends g {
  constructor() {
    super(...arguments), this._filterGroups = [], this._selectedFilterIds = [], this._isLoading = !0, this._errorMessage = null, this._searchTerm = "", S(this, u, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=filter-picker-modal.element-U7KFECxx.js.map
