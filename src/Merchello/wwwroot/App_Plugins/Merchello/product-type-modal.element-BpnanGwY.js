...
import { M as p } from "./merchello-api-CkNG-K-m.js";
var _ = Object.defineProperty, y = Object.getOwnPropertyDescriptor, n = (e, t, a, s) => {
  for (var r = s > 1 ? void 0 : s ? y(t, a) : t, l = e.length - 1, d; l >= 0; l--)
    (d = e[l]) && (r = (s ? d(t, a, r) : d(r)) || r);
  return s && r && _(t, a, r), r;
};
  ...
  async _handleSave() {
    if (this._validate())
      if (this._isSaving = !0, this._isEditMode) {
        ...
        this.value = { productType: t, updated: !0 }, this.modalContext?.submit();
      } else {
        ...
        this.value = { productType: e, created: !0 }, this.modalContext?.submit();
      }
  }
  _handleCancel() {
...
const T = i;
export {
  i as MerchelloProductTypeModalElement,
  T as default
};
//# sourceMappingURL=product-type-modal.element-BpnanGwY.js.map
