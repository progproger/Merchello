import { LitElement as F, nothing as o, html as a, css as U, state as d, customElement as B, property as ie, unsafeHTML as te } from "@umbraco-cms/backoffice/external/lit";
import { d as H, p as ae } from "./purify.es-Cuv6u9x0.js";
import { UmbElementMixin as V } from "@umbraco-cms/backoffice/element-api";
import { UMB_WORKSPACE_CONTEXT as G } from "@umbraco-cms/backoffice/workspace";
import { UmbModalToken as P, UMB_MODAL_MANAGER_CONTEXT as q, UMB_CONFIRM_MODAL as re } from "@umbraco-cms/backoffice/modal";
...
import { M as oe } from "./customer-orders-modal.token-DUOTW0Xz.js";
import { b as N, a as p, h as ne } from "./formatting-DbC6qaCT.js";
...
}, K = (e, i, t) => i.has(e) || Y("Cannot " + t), _ = (e, i, t) => (K(e, i, "read from private field"), t ? t.call(e) : i.get(e)), T = (e, i, t) => i.has(e) ? Y("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), M = (e, i, t, s) => (K(e, i, "write to private field"), i.set(e, t), t), D, z, L, w;
let C = class extends V(F) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, T(this, D), T(this, z), T(this, L), T(this, w, !1), this.consumeContext(G, (e) => {
      M(this, D, e), this.observe(_(this, D).order, (i) => {
...
A([
  d()
], C.prototype, "_invoiceId", 2);
A([
  d()
], C.prototype, "_fulfillmentData", 2);
A([
  d()
...
let x = class extends V(F) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, W(this, $), W(this, S, !1), this.consumeContext(q, (e) => {
      R(this, $, e);
    });
  }
  connectedCallback() {
  ...
  async _openManualPaymentModal() {
    if (!k(this, $) || !this._status) return;
    (await k(this, $).open(this, ve, {
      data: {
...
}, ee = (e, i, t) => i.has(e) || Z("Cannot " + t), n = (e, i, t) => (ee(e, i, "read from private field"), i.get(e)), I = (e, i, t) => i.has(e) ? Z("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), O = (e, i, t, s) => (ee(e, i, "write to private field"), i.set(e, t), t), h, v, f, g;
let u = class extends V(F) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, I(this, h), I(this, v), I(this, f), I(this, g, !1), this.consumeContext(G, (e) => {
      O(this, h, e), n(this, h) && this.observe(n(this, h).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), O(this, g, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), O(this, g, !1);
  }
  ...
  _renderMarkdown(e) {
    ...
    const i = H.parse(e), t = ae.sanitize(i);
    return te(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
      ...
      <umb-body-layout header-fit-height main-no-padding>
        ...
        <div id="header" slot="header">
          ...
          <div class="header-title">
            ...
            <span class="order-meta">${ne(e.dateCreated)} from ${e.channel}</span>
          </div>
...
//# sourceMappingURL=order-detail.element-ZlsWlICN.js.map
