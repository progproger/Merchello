...
import { c as d } from "./formatting-DGOWmvpU.js";
import { M as h } from "./merchello-api-BuImeZL2.js";
var v = Object.defineProperty, f = Object.getOwnPropertyDescriptor, a = (i, e, r, l) => {
  for (var p = l > 1 ? void 0 : l ? f(e, r) : e, c = i.length - 1, u; c >= 0; c--)
    (u = i[c]) && (p = (l ? u(e, r, p) : u(p)) || p);
...
let s = class extends g {
  ...
  async _loadWarehouses() {
    ...
    try {
      const { data: i, error: e } = await h.getWarehousesList();
  ...
  async _loadShippingOptions() {
    ...
    try {
      const { data: e, error: r } = await h.getShippingOptionsForWarehouse(
  ...
  _refreshTaxPreview() {
    this._taxPreviewDebounceTimer && clearTimeout(this._taxPreviewDebounceTimer), this._taxPreviewDebounceTimer = setTimeout(async () => {
      ...
      try {
        const { data: i, error: e } = await h.previewCustomItemTax({
          price: this._price,
          quantity: this._quantity,
          taxGroupId: this._selectedTaxGroupId
        });
  ...
  _renderDetailsStep() {
    const i = this.data?.currencySymbol ?? "£", e = this._taxPreview !== null, r = this._taxPreview?.taxRate, l = this._taxPreview?.subtotal, p = this._taxPreview?.taxAmount, c = this._taxPreview?.total;
    return t`
      ...
      ${this._price > 0 ? t`
        <div class="summary ${this._isLoadingTaxPreview || !e ? "loading" : ""}">
          ...
          <div class="summary-row total">
            <span>Total</span>
            <span>
              ${e && c !== void 0 ? `${i}${d(c, 2)}` : t`<span class="calculating">...</span>`}
            </span>
          </div>
        </div>
      ` : n}
      ...
      <div class="shipping-step">
        ...
        ${e ? t`
          <div class="destination-info">
            ...
            <span>Shipping to: ${e.regionCode ? `${e.regionCode}, ` : ""}${e.countryCode}</span>
          </div>
        ` : t`
...
//# sourceMappingURL=add-custom-item-modal.element-CoojvPjC.js.map
