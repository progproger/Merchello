...
import { a as o } from "./bundle.manifests-_x6cFs6i.js";
import { M as h } from "./merchello-api-BB625Gjj.js";
...
class _ extends i {
  constructor(t) {
    super(t, n.toString()), this.workspaceAlias = m, this.#r = new a(this), this.#e = new p(void 0), this.order = this.#e.asObservable(), this.#r.setEntityType(o), this.#r.setUnique("orders"), this.routes = new d(t), this.routes.setRoutes([
      ...
      {
        path: "edit/orders/:id",
        component: () => import("./order-detail.element-BM00G-h_.js"),
        setup: (r, e) => {
...
//# sourceMappingURL=orders-workspace.context-BRs_O-hB.js.map
