import { nothing as d, html as c, css as v, state as u, customElement as p } from "@umbraco-cms/backoffice/external/lit";
...
var f = Object.defineProperty, b = Object.getOwnPropertyDescriptor, n = (i, e, s, o) => {
  for (var a = o > 1 ? void 0 : o ? b(e, s) : e, t = i.length - 1, l; t >= 0; t--)
    (l = i[t]) && (a = (o ? l(e, s, a) : l(a)) || a);
  return o && a && f(e, s, a), a;
};
    ...
    return c`
      ...
      this._reason = e.target.value;
        ...
        <div slot="actions">
          ...
          >
            ${this._isSaving ? c`<uui-loader-circle></uui-loader-circle>` : d}
            Cancel Invoice
          </uui-button>
        </div>
      </umb-body-layout>
...
r = n([
  p("merchello-cancel-invoice-modal")
], r);
const M = r;
export {
...
//# sourceMappingURL=cancel-invoice-modal.element-AwVb2vj4.js.map
