...
import { M as p } from "./merchello-api-CU-ozmmd.js";
...
let i = class extends m {
  ...
  async _handleSave() {
    ...
    if (this._isEditMode) {
      ...
      this.value = { taxGroup: r, updated: !0 }, this.modalContext?.submit();
    } else {
      ...
      this.value = { taxGroup: e, created: !0 }, this.modalContext?.submit();
    }
  }
  _handleCancel() {
...
//# sourceMappingURL=tax-group-modal.element-CujYbotg.js.map
