import { LitElement as F, nothing as o, html as a, css as R, state as l, customElement as U, property as Z, unsafeHTML as ee } from "@umbraco-cms/backoffice/external/lit";
...
import { b as N, a as p, h as re } from "./formatting-Cu4HXsjc.js";
import { M as g } from "./merchello-api-CU-ozmmd.js";
...
}, Q = (e, i, t) => i.has(e) || J("Cannot " + t), n = (e, i, t) => (Q(e, i, "read from private field"), i.get(e)), T = (e, i, t) => i.has(e) ? J("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), E = (e, i, t, s) => (Q(e, i, "write to private field"), i.set(e, t), t), h, b, _, v;
let u = class extends B(F) {
  ...
  async _openFulfillmentModal() {
    if (!this._order || !n(this, b)) return;
    const e = this._order.id;
    await n(this, b).open(this, oe, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), n(this, v) && n(this, h)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !n(this, b)) return;
    const e = this._order.id;
    await n(this, b).open(this, ne, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), n(this, v) && n(this, h)?.load(e);
  }
  ...
  async _saveEditing() {
    ...
    if (n(this, v)) {
      if (this._isSavingAddress = !1, e.error) {
        console.error("Failed to save address:", e.error), n(this, _)?.peek("danger", {
  ...
  async _savePurchaseOrder() {
    ...
    if (n(this, v)) {
      if (this._isSavingPurchaseOrder = !1, e) {
        console.error("Failed to save purchase order:", e), n(this, _)?.peek("danger", {
      ...
      }), this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", n(this, h)?.load(this._order.id);
    }
  }
  ...
  async _handlePostNote() {
    ...
    if (n(this, v)) {
      if (this._isPostingNote = !1, e) {
        this._noteError = e.message || "Failed to post note", console.error("Failed to post note:", e), n(this, _)?.peek("danger", {
      ...
      }), this._newNoteText = "", this._visibleToCustomer = !1, n(this, h)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
//# sourceMappingURL=order-detail.element-BP_RhME9.js.map
