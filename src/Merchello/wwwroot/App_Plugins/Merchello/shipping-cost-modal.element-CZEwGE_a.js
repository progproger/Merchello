import { nothing as g, html as a, css as v, state as n, customElement as C } from "@umbraco-cms/backoffice/external/lit";
...
var b = Object.defineProperty, w = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, s = (e, t, o, l) => {
  for (var u = l > 1 ? void 0 : l ? w(t, o) : t, h = e.length - 1, p; h >= 0; h--)
    (p = e[h]) && (u = (l ? p(t, o, u) : p(u)) || u);
  return l && u && b(t, o, u), u;
}, f = (e, t, o) => t.has(e) || _("Cannot " + o), c = (e, t, o) => (f(e, t, "read from private field"), t.get(e)), x = (e, t, o) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, o), S = (e, t, o, l) => (f(e, t, "write to private field"), t.set(e, o), o), r;
let i = class extends m {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._countryCode = "", this._regionCode = "", this._cost = 0, this._countries = [], this._regions = [], x(this, r), this.consumeContext(y, (e) => {
      S(this, r, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), this._loadCountries(), this.data?.cost && (this._countryCode = this.data.cost.countryCode, this._regionCode = this.data.cost.regionCode ?? "", this._cost = this.data.cost.cost, this._countryCode && this._countryCode !== "*" && this._loadRegions(this._countryCode));
  }
      ...
      <umb-body-layout headline="${e ? "Edit" : "Add"} Shipping Rate">
        ...
        <div slot="actions">
          ...
          <uui-button
            ...
            @click=${this._save}
          >
            ${this._isSaving ? a`<uui-loader-circle></uui-loader-circle>` : g}
...
//# sourceMappingURL=shipping-cost-modal.element-CZEwGE_a.js.map
