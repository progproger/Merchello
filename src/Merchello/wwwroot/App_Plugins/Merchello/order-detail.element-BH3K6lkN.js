...
import { b as I, a as p, h as te } from "./formatting-266ZBdsy.js";
...
var ne = Object.defineProperty, de = Object.getOwnPropertyDescriptor, G = (e) => {
  throw TypeError(e);
}, M = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? de(i, t) : i, d = e.length - 1, m; d >= 0; d--)
...
const le = new z("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
...
var me = Object.defineProperty, he = Object.getOwnPropertyDescriptor, K = (e) => {
  throw TypeError(e);
}, c = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? he(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && me(i, t, r), r;
}, J = (e, i, t) => i.has(e) || K("Cannot " + t), u = (e, i, t) => (J(e, i, "read from private field"), i.get(e)), L = (e, i, t) => i.has(e) ? K("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), O = (e, i, t, s) => (J(e, i, "write to private field"), i.set(e, t), t), h, g, f;
let l = class extends U(N) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._activeTab = "details", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, L(this, h), L(this, g), L(this, f, !1), this.consumeContext(W, (e) => {
      O(this, h, e), u(this, h) && this.observe(u(this, h).order, (i) => {
  ...
  async _saveEditing() {
    ...
    if (u(this, f)) {
      ...
      this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, u(this, h)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (u(this, f)) {
      ...
      this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", u(this, h)?.load(this._order.id);
    }
  }
  ...
  _handlePaymentChange() {
    this._order && u(this, h)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (u(this, f)) {
      ...
      this._newNoteText = "", this._visibleToCustomer = !1, u(this, h)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
c([
  n()
], l.prototype, "_newNoteText", 2);
c([
  n()
], l.prototype, "_visibleToCustomer", 2);
c([
  n()
], l.prototype, "_isPostingNote", 2);
c([
  n()
], l.prototype, "_noteError", 2);
c([
  n()
], l.prototype, "_currentUser", 2);
c([
  n()
], l.prototype, "_editingSection", 2);
c([
  n()
], l.prototype, "_editFormData", 2);
c([
  n()
], l.prototype, "_isSavingAddress", 2);
c([
  n()
], l.prototype, "_validationErrors", 2);
c([
  n()
], l.prototype, "_countries", 2);
c([
  n()
], l.prototype, "_editingPurchaseOrder", 2);
c([
  n()
], l.prototype, "_purchaseOrderValue", 2);
c([
  n()
], l.prototype, "_isSavingPurchaseOrder", 2);
l = c([
...
//# sourceMappingURL=order-detail.element-BH3K6lkN.js.map
