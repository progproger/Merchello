...
import { M as m } from "./merchello-api-B1P1cUX9.js";
import { M as W } from "./setup-instructions-modal.token-CR5MFRlI.js";
import { g as B, a as F } from "./brand-icons-vhzlavjm.js";
const j = new M("Merchello.PaymentProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), G = new M("Merchello.PaymentMethods.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
...
let p = class extends L(k) {
  ...
  _renderRegionBadges(e) {
    return !e || e.length === 0 ? d : o`
      ${e.map(
      (i) => o`<span class="region-badge" title="${i.name}">${i.code}</span>`
    )}
    `;
  }
  _renderMethod(e, i = !1) {
...
var J = Object.defineProperty, K = Object.getOwnPropertyDescriptor, O = (e) => {
  throw TypeError(e);
}, b = (e, i, r, a) => {
  for (var s = a > 1 ? void 0 : a ? K(i, r) : i, h = e.length - 1, g; h >= 0; h--)
    (g = e[h]) && (s = (a ? g(i, r, s) : g(s)) || s);
  return a && s && J(i, r, s), s;
}, A = (e, i, r) => i.has(e) || O("Cannot " + r), t = (e, i, r) => (A(e, i, "read from private field"), i.get(e)), y = (e, i, r) => i.has(e) ? O("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, r), w = (e, i, r, a) => (A(e, i, "write to private field"), i.set(e, r), r), n, u, l, P;
let c = class extends L(k) {
  ...
  _openSetupInstructions(e) {
    !t(this, n) || !e.setupInstructions || t(this, n).open(this, W, {
      data: {
...
//# sourceMappingURL=payment-providers-list.element-BngHln7P.js.map
