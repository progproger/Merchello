...
import { a as _ } from "./formatting-B_f6AiQh.js";
const O = new v("Merchello.ShippingCost.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
}), R = new v("Merchello.ShippingWeightTier.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
}), E = new v("Merchello.ShippingDestinationExclusion.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
...
var I = Object.defineProperty, W = Object.getOwnPropertyDescriptor, x = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? W(t, i) : t, g = e.length - 1, m; g >= 0; g--)
...
let l = class extends S {
  ...
  async _openExclusionModal(e) {
    if (!o(this, c)) return;
    const i = await o(this, c).open(this, E, {
      data: {
        exclusion: e,
...
//# sourceMappingURL=shipping-option-detail-modal.element-DeKqhaLj.js.map
