...
import { a as d } from "./formatting-DQoM1drN.js";
import { e as _ } from "./navigation-Bu0pwyW2.js";
import { b as y } from "./badge.styles-DUcdl6GY.js";
const x = {
  select: "",
  rootName: "Product",
  sku: "SKU",
...
var k = Object.defineProperty, P = Object.getOwnPropertyDescriptor, g = (e, r, i, n) => {
  for (var t = n > 1 ? void 0 : n ? P(r, i) : r, l = e.length - 1, o; l >= 0; l--)
    (o = e[l]) && (t = (n ? o(r, i, t) : o(t)) || t);
  return n && t && k(r, i, t), t;
};
...
var C = Object.defineProperty, O = Object.getOwnPropertyDescriptor, u = (e, r, i, n) => {
  for (var t = n > 1 ? void 0 : n ? O(r, i) : r, l = e.length - 1, o; l >= 0; l--)
    (o = e[l]) && (t = (n ? o(r, i, t) : o(t)) || t);
  return n && t && C(r, i, t), t;
};
let s = class extends f(b) {
  constructor() {
  ...
  _handleSelectAll(e) {
    const i = e.target.checked ? this.products.map((n) => n.id) : [];
    this._dispatchSelectionChange(i);
  }
  _handleSelectProduct(e, r) {
    r.stopPropagation();
    const n = r.target.checked ? [...this.selectedIds, e] : this.selectedIds.filter((t) => t !== e);
  ...
  _renderCell(e, r) {
    switch (r) {
      ...
      case "purchaseable":
        return a`<uui-table-cell><span class="badge ${e.purchaseable ? "badge-positive" : "badge-danger"}">${e.purchaseable ? "Available" : "Unavailable"}</span></uui-table-cell>`;
      case "variants":
...
//# sourceMappingURL=product-table.element-BI-fydXR.js.map
