import { LitElement as F, nothing as n, html as a, css as R, state as d, customElement as U, property as Z, unsafeHTML as ee } from "@umbraco-cms/backoffice/external/lit";
import { d as H, p as ie } from "./purify.es-Cuv6u9x0.js";
import { UmbElementMixin as B } from "@umbraco-cms/backoffice/element-api";
import { UMB_WORKSPACE_CONTEXT as V } from "@umbraco-cms/backoffice/workspace";
import { UmbModalToken as S, UMB_MODAL_MANAGER_CONTEXT as q } from "@umbraco-cms/backoffice/modal";
...
import { I as f, P as j } from "./order.types-B45a7FtJ.js";
import { b as N, a as p, h as re } from "./formatting-DJ1nSxNW.js";
...
}), de = new S("Merchello.CustomerOrders.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), le = new S("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var ue = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, G = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? ce(i, t) : i, l = e.length - 1, m; l >= 0; l--)
...
let y = class extends B(F) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, W(this, x), W(this, z, !1), this.consumeContext(q, (e) => {
      I(this, x, e);
    });
  }
  connectedCallback() {
  ...
  _renderPayment(e) {
    const i = e.paymentType === j.Refund || e.paymentType === j.PartialRefund;
    return a`
...
var ge = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, J = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? fe(i, t) : i, l = e.length - 1, m; l >= 0; l--)
    (m = e[l]) && (r = (s ? m(i, t, r) : m(r)) || r);
...
let u = class extends B(F) {
  ...
  _renderMarkdown(e) {
    H.setOptions({ breaks: !0, gfm: !0 });
    const i = H.parse(e), t = ie.sanitize(i);
    return ee(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
...
//# sourceMappingURL=order-detail.element-DbWri8sG.js.map
