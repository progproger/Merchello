...
import { c as p } from "./formatting-CeWY__1B.js";
...
}, h = (e, r, a) => r.has(e) || g("Cannot " + a), w = (e, r, a) => (h(e, r, "read from private field"), r.get(e)), k = (e, r, a) => r.has(e) ? g("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, a), f = (e, r, a, o) => (h(e, r, "write to private field"), r.set(e, a), a), d;
    ...
    return s`
      ...
      ([u, m]) => s`
                        <div class="rate-row">
                          ...
                          <span class="rate-value">${this._formatRate(m)}</span>
                        </div>
                      `
    )}
                  </div>
...
//# sourceMappingURL=test-provider-modal.element-BBYKYO1c.js.map
