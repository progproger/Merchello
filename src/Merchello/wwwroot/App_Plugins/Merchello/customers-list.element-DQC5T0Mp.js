import { LitElement as C, html as r, nothing as b, css as y, state as o, customElement as w } from "@umbraco-cms/backoffice/external/lit";
...
import { M as E } from "./merchello-api-Dp_zU_yi.js";
import { g as M } from "./store-settings-CHgA9WE7.js";
import { M as $, a as k } from "./customer-orders-modal.token-BBooCVRJ.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-D2dcD7_8.js";
var L = Object.defineProperty, O = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, s = (e, t, a, c) => {
  for (var l = c > 1 ? void 0 : c ? O(t, a) : t, p = e.length - 1, _; p >= 0; p--)
    (_ = e[p]) && (l = (c ? _(t, a, l) : _(l)) || l);
  return c && l && L(t, a, l), l;
...
let i = class extends S(C) {
  constructor() {
    super(), this._customers = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._searchTerm = "", this._searchDebounceTimer = null, g(this, d), g(this, m), g(this, n, !1), this.consumeContext(T, (e) => {
      h(this, d, e);
  ...
  async _handleEditCustomer(e) {
    const a = await u(this, d)?.open(this, k, {
      data: { customer: e }
    })?.onSubmit().catch(() => {
    });
...
//# sourceMappingURL=customers-list.element-DQC5T0Mp.js.map
