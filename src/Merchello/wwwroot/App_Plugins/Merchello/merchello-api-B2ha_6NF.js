...
async function r(e) {
  try {
    const t = await m(), s = d.baseUrl || "", n = await fetch(`${s}${l}/${e}`, {
      method: "GET",
...
async function i(e, t) {
  try {
    const s = await m(), n = d.baseUrl || "", a = await fetch(`${n}${l}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: s,
...
const h = {
  ...
  createDraftOrder: (e) => i("orders/draft", e),
  ...
  updatePaymentMethodSetting: (e, t, s) => o(`payment-providers/${e}/methods/${t}`, s),
  /** Reorder payment methods for a provider */
  reorderPaymentMethods: (e, t) => o(`payment-providers/${e}/methods/reorder`, t),
  // ============================================
  // Payments API
  // ============================================
...
//# sourceMappingURL=merchello-api-B2ha_6NF.js.map
