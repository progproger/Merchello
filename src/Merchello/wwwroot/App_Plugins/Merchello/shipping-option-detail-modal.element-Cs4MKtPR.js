...
import { M as h } from "./merchello-api-658q9849.js";
import { a as m } from "./formatting-nNQcXJwZ.js";
const C = new b("Merchello.ShippingCost.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
...
var L = Object.defineProperty, M = Object.getOwnPropertyDescriptor, D = (i) => {
  ...
  for (var n = l > 1 ? void 0 : l ? M(e, t) : e, v = i.length - 1, g; v >= 0; v--)
    (g = i[v]) && (n = (l ? g(e, t, n) : g(n)) || n);
  return l && n && L(e, t, n), n;
}, x = (i, e, t) => e.has(i) || D("Cannot " + t), u = (i, e, t) => (x(i, e, "read from private field"), e.get(i)), f = (i, e, t) => e.has(i) ? D("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t), _ = (i, e, t, l) => (x(i, e, "write to private field"), e.set(i, t), t), p, c;
let a = class extends S {
  ...
  async _onProviderChange(i) {
    this._providerKey = i, this._serviceType = null, this._providerSettings = {}, this._methodConfig = null;
    try {
  ...
  get _usesLiveRates() {
    return this._availableProviders.find((e) => e.key === this._providerKey)?.capabilities?.usesLiveRates ?? !1;
  }
  ...
  async _deleteWeightTier(i) {
    const e = i.weightRangeDisplay ?? `${i.minWeightKg}+ kg`, t = u(this, p)?.open(this, y, {
      data: {
  ...
  _toggleDay(i) {
    ...
    if (e.includes(i))
      ...
      const t = this._daysOfWeek.map((n) => n.value), l = [...e, i].sort(
        (n, v) => t.indexOf(n) - t.indexOf(v)
      );
      this._allowedDaysOfWeek = l.join(",");
    }
  }
  ...
  render() {
    ...
    return this._isLoading ? r`
      ...
      if (this._serviceType = e.target.value || null, !this._name && this._serviceType) {
        const l = this._methodConfig?.fields.find((n) => n.key === "serviceType")?.options?.find((n) => n.value === this._serviceType);
        l && (this._name = l.label);
      }
    }}
                      ></uui-select>
...
//# sourceMappingURL=shipping-option-detail-modal.element-Cs4MKtPR.js.map
