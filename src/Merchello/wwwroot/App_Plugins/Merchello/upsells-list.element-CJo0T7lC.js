import { LitElement as S, nothing as $, html as c, css as w, state as o, customElement as D } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as z } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as M, UMB_MODAL_MANAGER_CONTEXT as L, UMB_CONFIRM_MODAL as A } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as P } from "@umbraco-cms/backoffice/notification";
import { c as E, a as b, b as g } from "./upsell.types-ChZp0X_-.js";
import { M as v } from "./merchello-api-LENiBVrz.js";
import { g as I } from "./store-settings-Biy0PIJu.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { p as x } from "./navigation-COkStlQk.js";
import { c as k, a as O } from "./formatting-CeWY__1B.js";
const R = new M("Merchello.CreateUpsell.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
...
var N = Object.defineProperty, B = Object.getOwnPropertyDescriptor, U = (e) => {
  ...
  for (var u = n > 1 ? void 0 : n ? B(t, i) : t, _ = e.length - 1, C; _ >= 0; _--)
    (C = e[_]) && (u = (n ? C(t, i, u) : C(u)) || u);
  return n && u && N(t, i, u), u;
}, T = (e, t, i) => t.has(e) || U("Cannot " + i), a = (e, t, i) => (T(e, t, "read from private field"), t.get(e)), m = (e, t, i) => t.has(e) ? U("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), d = (e, t, i, n) => (T(e, t, "write to private field"), t.set(e, i), i), p, h, r, f, y;
let l = class extends z(S) {
  constructor() {
    super(), this._upsells = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedUpsells = /* @__PURE__ */ new Set(), this._searchTerm = "", this._isDeleting = !1, this._searchDebounceTimer = null, m(this, p), m(this, h), m(this, r, !1), m(this, f), m(this, y), this.consumeContext(L, (e) => {
      d(this, p, e);
  ...
  async _initializeAndLoad() {
    const e = await I();
    a(this, r) && (this._pageSize = e.defaultPaginationPageSize, d(this, f, e.currencyCode), d(this, y, e.currencySymbol), this._loadUpsells());
  }
  ...
  async _loadUpsells() {
    ...
    const { data: t, error: i } = await v.getUpsells(e);
    if (a(this, r)) {
      if (i) {
  ...
  async _handleDeleteSelected() {
    ...
    for (const u of this._selectedUpsells) {
      const { error: _ } = await v.deleteUpsell(u);
      if (!a(this, r)) return;
      _ ? n++ : i++;
    }
  ...
  async _handleActivateSelected() {
    for (const e of this._selectedUpsells)
      if (await v.activateUpsell(e), !a(this, r)) return;
    a(this, h)?.peek("positive", {
  ...
  async _handleDeactivateSelected() {
    for (const e of this._selectedUpsells)
      if (await v.deactivateUpsell(e), !a(this, r)) return;
    a(this, h)?.peek("positive", {
  ...
  async _handleCreateUpsell() {
    if (!a(this, p)) return;
    const t = await a(this, p).open(this, R, {
      data: {}
    }).onSubmit().catch(() => {
    });
    a(this, r) && t?.id && x(t.id);
  }
    ...
    return c`
      ...
      (t) => c`
            ...
            >
              ...
              <uui-table-cell>
                <div class="name-cell">
                  ...
                  ${t.heading ? c`<small class="heading-preview">${t.heading}</small>` : $}
                </div>
              </uui-table-cell>
              <uui-table-cell>
        ...
        (i) => c`<uui-icon name=${i}></uui-icon>`
              ...
              <uui-table-cell style="text-align: right;">${k(t.totalImpressions)}</uui-table-cell>
              <uui-table-cell style="text-align: right;">${this._formatCtr(t.totalImpressions, t.totalClicks)}</uui-table-cell>
              <uui-table-cell style="text-align: right;">${k(t.totalConversions)}</uui-table-cell>
              <uui-table-cell style="text-align: right;">${O(t.totalRevenue, a(this, f), a(this, y))}</uui-table-cell>
            </uui-table-row>
          `
    )}
      </uui-table>
  ...
  _renderContent() {
    return this._isLoading ? c`<div class="loading"><uui-loader></uui-loader></div>` : this._errorMessage ? c`<div class="error">${this._errorMessage}</div>` : this._upsells.length === 0 ? c`
      ...
      <umb-body-layout header-fit-height main-no-padding>
        <div class="upsells-container">
          <div class="header-actions">
            ${this._selectedUpsells.size > 0 ? c`
...
//# sourceMappingURL=upsells-list.element-CJo0T7lC.js.map
