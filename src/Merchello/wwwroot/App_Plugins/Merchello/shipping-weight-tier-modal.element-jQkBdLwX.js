...
import { b as p, g as S } from "./store-settings-BBNVgcWv.js";
var x = Object.defineProperty, W = Object.getOwnPropertyDescriptor, m = (i) => {
  ...
  return d && u && x(e, a, u), u;
}, y = (i, e, a) => e.has(i) || m("Cannot " + a), l = (i, e, a) => (y(i, e, "read from private field"), e.get(i)), w = (i, e, a) => e.has(i) ? m("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, a), $ = (i, e, a, d) => (y(i, e, "write to private field"), e.set(i, a), a), s;
...
//# sourceMappingURL=shipping-weight-tier-modal.element-jQkBdLwX.js.map
