import { html as r, nothing as h, css as A, state as l, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as I, UMB_MODAL_MANAGER_CONTEXT as P } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as k } from "@umbraco-cms/backoffice/notification";
import { M as g } from "./merchello-api-DXy2hS5y.js";
import { M as F, a as E } from "./product-picker-modal.token-MV3YBEIK.js";
var O = Object.defineProperty, M = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, n = (e, i, t, s) => {
  for (var d = s > 1 ? void 0 : s ? M(i, t) : i, a = e.length - 1, c; a >= 0; a--)
    (c = e[a]) && (d = (s ? c(i, t, d) : c(d)) || d);
  return s && d && O(i, t, d), d;
}, C = (e, i, t) => i.has(e) || f("Cannot " + t), u = (e, i, t) => (C(e, i, "read from private field"), i.get(e)), v = (e, i, t) => i.has(e) ? f("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), y = (e, i, t, s) => (C(e, i, "write to private field"), i.set(e, t), t), p, _, m;
function b() {
  return {
    name: null,
    email: null,
...
let o = class extends I {
  constructor() {
    super(), this._billingAddress = b(), this._shippingAddress = b(), this._useShippingAddress = !1, this._customItems = [], this._pendingProducts = [], this._customerSearchResults = [], this._selectedCustomer = null, this._isSearchingCustomer = !1, this._showCustomerDropdown = !1, this._isSaving = !1, this._isLoading = !0, this._errorMessage = null, this._taxGroups = [], this._countries = [], this._currencySymbol = "£", this._validationErrors = {}, v(this, p), v(this, _), v(this, m), this.consumeContext(P, (e) => {
      y(this, p, e);
  ...
  _handleCustomerSearchInput(e) {
    ...
    y(this, m, setTimeout(async () => {
      this._isSearchingCustomer = !0;
      const s = t.includes("@"), { data: d, error: a } = await g.searchCustomers(
        s ? t : void 0,
        s ? void 0 : t
      );
  ...
  async _openAddCustomItemModal() {
    if (!u(this, p)) return;
    const i = await u(this, p).open(this, F, {
      data: {
  ...
  async _openProductPickerModal() {
    if (!u(this, p)) return;
    const e = this._useShippingAddress ? this._shippingAddress : this._billingAddress, i = this._pendingProducts.map((d) => d.productId), s = await u(this, p).open(this, E, {
      data: {
        config: {
          currencySymbol: this._currencySymbol,
  ...
  async _handleSave() {
    ...
    }, { data: i, error: t } = await g.createDraftOrder(e);
    if (this._isSaving = !1, t) {
      this._errorMessage = t.message;
      return;
    }
    i?.isSuccessful && i.invoiceId ? (u(this, _)?.peek("positive", {
      data: {
  ...
  _renderAddressField(e, i, t, s = "text", d = !1) {
    const c = (e === "billing" ? this._billingAddress : this._shippingAddress)[i] ?? "", x = this._validationErrors[`${e}.${i}`], $ = e === "billing" ? this._updateBillingField : this._updateShippingField;
    return r`
      <umb-property-layout
        label=${t}
        ?mandatory=${d}
...
//# sourceMappingURL=create-order-modal.element-Dm8pZEwG.js.map
