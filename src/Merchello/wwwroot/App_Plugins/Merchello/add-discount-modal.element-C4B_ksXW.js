import { nothing as u, html as o, css as m, state as r, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as f } from "@umbraco-cms/backoffice/modal";
import { D as l, c as h } from "./formatting-DRJa6LJv.js";
        ...
        <div id="main">
          ...
          <div class="form-row">
            ...
            <div class="input-with-affix">
              ${this._discountType === l.FixedAmount ? o`<span class="prefix">${e}</span>` : u}
              <uui-input
                id="discount-value"
                type="number"
                ...
                step="0.01"
              ></uui-input>
              ${this._discountType === l.Percentage ? o`<span class="suffix">%</span>` : u}
            </div>
            ${this._errors.value ? o`<span class="error">${this._errors.value}</span>` : u}
          </div>
...
//# sourceMappingURL=add-discount-modal.element-C4B_ksXW.js.map
