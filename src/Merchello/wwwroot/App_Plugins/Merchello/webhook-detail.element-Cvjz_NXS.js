...
import { O as v, a as E } from "./webhooks.types-BbN-5DbD.js";
import { M as _ } from "./merchello-api-D-qg1PlO.js";
import { g as L } from "./store-settings-Silr5K1w.js";
import { i as k } from "./formatting-DC2_cf8C.js";
import { UMB_WORKSPACE_CONTEXT as O } from "@umbraco-cms/backoffice/workspace";
import { M as I, a as P } from "./webhook-test-modal.token-BJ36MIGK.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
const A = new w("Merchello.Webhook.Delivery.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
...
var W = Object.defineProperty, B = Object.getOwnPropertyDescriptor, $ = (e) => {
  throw TypeError(e);
}, r = (e, i, a, p) => {
  for (var u = p > 1 ? void 0 : p ? B(i, a) : i, m = e.length - 1, y; m >= 0; m--)
    (y = e[m]) && (u = (p ? y(i, a, u) : y(u)) || u);
  return p && u && W(i, a, u), u;
}, z = (e, i, a) => i.has(e) || $("Cannot " + a), t = (e, i, a) => (z(e, i, "read from private field"), a ? a.call(e) : i.get(e)), f = (e, i, a) => i.has(e) ? $("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), b = (e, i, a, p) => (z(e, i, "write to private field"), i.set(e, a), a), g, c, l, h;
let s = class extends C(D) {
  constructor() {
    super(), this._subscription = null, this._deliveries = [], this._isLoading = !0, this._isLoadingDeliveries = !1, this._errorMessage = null, this._page = 1, this._pageSize = 20, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._showSecret = !1, f(this, g), f(this, c), f(this, l), f(this, h, !1), this.consumeContext(O, (e) => {
      b(this, g, e), this.observe(t(this, g).subscription, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), b(this, h, !0), this._initializeSettings();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), b(this, h, !1);
  }
  async _initializeSettings() {
    const e = await L();
    t(this, h) && (this._pageSize = Math.min(e.defaultPaginationPageSize, 20), this._isLoading = !1);
  }
  async _loadDeliveries() {
    ...
    this._activeTab === "succeeded" ? e.status = v.Succeeded : this._activeTab === "failed" ? e.status = v.Failed : this._activeTab === "pending" && (e.status = v.Pending);
  ...
  async _handleEdit() {
    ...
    (await t(this, l).open(this, I, {
      data: {
        subscription: this._subscription,
        topics: e ?? []
      }
    }).onSubmit().catch(() => {
    }))?.saved && t(this, g)?.reloadSubscription();
  }
  async _handleTest() {
  ...
  _handleIntegrationGuide() {
    !t(this, l) || !this._subscription || t(this, l).open(this, R, {
  ...
  _renderDeliveryRow(e) {
    const i = e.status === v.Failed || e.status === v.Abandoned;
    return o`
...
//# sourceMappingURL=webhook-detail.element-Cvjz_NXS.js.map
