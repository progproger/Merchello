...
import { c as i } from "./bundle.manifests-DpXnf-5Q.js";
import { M as c } from "./merchello-api-Rt7qKkDA.js";
const p = "Merchello.Customers.Workspace";
class f extends r {
  constructor(t) {
    super(t, n.toString()), this.workspaceAlias = p, this.#i = new a(this), this.#e = !1, this.#s = new h(void 0), this.segment = this.#s.asObservable(), this.#i.setEntityType(i), this.#i.setUnique("customers"), this.routes = new m(t), this.routes.setRoutes([
      // Create segment route
      {
        path: "edit/customers/segment/create",
        component: () => import("./segment-detail.element-Dsu0uRV1.js"),
        setup: () => {
  ...
  async loadSegment(t) {
    this.#t = t;
    const { data: s, error: e } = await c.getCustomerSegment(t);
    if (e) {
...
export {
  p as MERCHELLO_CUSTOMERS_WORKSPACE_ALIAS,
  f as MerchelloCustomersWorkspaceContext,
  f as api
};
//# sourceMappingURL=customers-workspace.context-DOZFqyM8.js.map
