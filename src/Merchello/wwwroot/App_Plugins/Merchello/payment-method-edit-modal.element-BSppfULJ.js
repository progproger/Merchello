import { html as a, unsafeHTML as p, nothing as n, css as _, state as c, customElement as g } from "@umbraco-cms/backoffice/external/lit";
...
import { g as b } from "./brand-icons-vhzlavjm.js";
import { m as x } from "./modal-layout.styles-C2OaUji5.js";
var k = Object.defineProperty, w = Object.getOwnPropertyDescriptor, v = (e) => {
  throw TypeError(e);
}, d = (e, o, r, t) => {
  for (var i = t > 1 ? void 0 : t ? w(o, r) : o, l = e.length - 1, h; l >= 0; l--)
    (h = e[l]) && (i = (t ? h(o, r, i) : h(i)) || i);
  return t && i && k(o, r, i), i;
}, m = (e, o, r) => o.has(e) || v("Cannot " + r), S = (e, o, r) => (m(e, o, "read from private field"), o.get(e)), $ = (e, o, r) => o.has(e) ? v("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(e) : o.set(e, r), M = (e, o, r, t) => (m(e, o, "write to private field"), o.set(e, r), r), u;
let s = class extends C {
  constructor() {
    super(), this._displayNameOverride = "", this._iconMediaKey = null, this._backgroundColor = "", this._borderColor = "", this._textColor = "", this._useSelectedColors = !1, this._selectedBackgroundColor = "", this._selectedBorderColor = "", this._selectedTextColor = "", this._isSaving = !1, this._errorMessage = null, $(this, u), this.consumeContext(y, (e) => {
      M(this, u, e);
    });
  }
  connectedCallback() {
...
//# sourceMappingURL=payment-method-edit-modal.element-BSppfULJ.js.map
