import { unsafeHTML as x, html as s, nothing as r, css as C, state as u, customElement as E } from "@umbraco-cms/backoffice/external/lit";
...
import { g as L } from "./brand-icons-Wu7yNU5M.js";
const A = new w("Merchello.PaymentMethod.Edit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var P = Object.defineProperty, T = Object.getOwnPropertyDescriptor, M = (e) => {
  throw TypeError(e);
}, c = (e, i, t, a) => {
  for (var n = a > 1 ? void 0 : a ? T(i, t) : i, v = e.length - 1, _; v >= 0; v--)
    (_ = e[v]) && (n = (a ? _(i, t, n) : _(n)) || n);
  return a && n && P(i, t, n), n;
...
let o = class extends $ {
  constructor() {
    super(), this._methods = [], this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._hasChanges = !1, g(this, l, !1), g(this, m), g(this, h), g(this, b, new z(this, {
...
//# sourceMappingURL=payment-methods-config-modal.element-LSZY0Y2f.js.map
