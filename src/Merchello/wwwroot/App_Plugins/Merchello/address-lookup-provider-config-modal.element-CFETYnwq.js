import { nothing as a, html as r, css as f, state as c, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
      ...
      case "Url":
        return r`
          <div class="form-field">
            ...
            ${e.description ? r`<p class="field-description">${e.description}</p>` : a}
            <uui-input
              id="${e.key}"
        ...
        return r`
          <div class="form-field">
            ...
            <uui-input
              ...
              @input=${(s) => this._handleValueChange(e.key, s.target.value)}
            ></uui-input>
            ${e.isSensitive && i ? r`<small class="sensitive-note">Value is stored securely</small>` : a}
          </div>
        `;
      case "Textarea":
        return r`
    ...
    return r`
      <umb-body-layout headline="Configure ${e?.displayName ?? "Provider"}">
        ...
        <div slot="actions">
          ...
          >
            ${this._isSaving ? r`<uui-loader-circle></uui-loader-circle>` : a}
            Save
          </uui-button>
        </div>
      </umb-body-layout>
...
//# sourceMappingURL=address-lookup-provider-config-modal.element-CFETYnwq.js.map
