import { LitElement as w, html as s, nothing as _, css as z, state as g, customElement as C } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as E } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as $, UMB_MODAL_MANAGER_CONTEXT as S } from "@umbraco-cms/backoffice/modal";
...
import { M as f } from "./merchello-api-Bc5VtWiv.js";
import "./merchello-empty-state.element-mt97UoA5.js";
const F = new $("Merchello.FilterGroup.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), k = new $("Merchello.Filter.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var L = Object.defineProperty, O = Object.getOwnPropertyDescriptor, G = (e) => {
  throw TypeError(e);
}, p = (e, i, r, o) => {
  for (var a = o > 1 ? void 0 : o ? O(i, r) : i, v = e.length - 1, b; v >= 0; v--)
    (b = e[v]) && (a = (o ? b(i, r, a) : b(a)) || a);
  return o && a && L(i, r, a), a;
}, M = (e, i, r) => i.has(e) || G("Cannot " + r), t = (e, i, r) => (M(e, i, "read from private field"), r ? r.call(e) : i.get(e)), h = (e, i, r) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, r), m = (e, i, r, o) => (M(e, i, "write to private field"), i.set(e, r), r), u, l, n, y, c;
let d = class extends E(w) {
  constructor() {
    super(), this._filterGroups = [], this._isLoading = !0, this._errorMessage = null, this._isDeletingGroup = null, this._expandedGroups = /* @__PURE__ */ new Set(), h(this, u), h(this, l), h(this, n, !1), h(this, y, new x(this, {
    ...
    })), h(this, c, /* @__PURE__ */ new Map()), this.consumeContext(S, (e) => {
      m(this, u, e);
  ...
  connectedCallback() {
    super.connectedCallback(), m(this, n, !0), this._loadFilterGroups();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), m(this, n, !1), t(this, c).clear();
  }
  async _loadFilterGroups() {
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: i } = await f.getFilterGroups();
    if (t(this, n)) {
      if (i) {
      ...
      if (e) {
        this._filterGroups = e, t(this, y).setModel(this._filterGroups), this._expandedGroups = new Set(e.map((r) => r.id)), t(this, c).clear();
        for (const r of e)
  ...
  async _handleFilterReorder(e, i) {
    const { error: r } = await f.reorderFilters(e, i);
  ...
  async _handleAddFilterGroup() {
    ...
    t(this, n) && i?.created && (t(this, l)?.peek("positive", {
      data: {
  ...
  async _handleEditFilterGroup(e) {
    ...
    t(this, n) && r?.updated && (t(this, l)?.peek("positive", {
      data: {
  ...
  async _handleDeleteFilterGroup(e, i) {
    ...
    const r = i.filters?.length || 0;
    if (!confirm(
      `Are you sure you want to delete filter group "${i.name}"?

${r > 0 ? `This will also delete ${r} filter${r > 1 ? "s" : ""} in this group.` : ""}

This action cannot be undone.`
    )) return;
    this._isDeletingGroup = i.id;
    const { error: a } = await f.deleteFilterGroup(i.id);
    if (t(this, n)) {
      if (this._isDeletingGroup = null, a) {
        this._errorMessage = `Failed to delete filter group: ${a.message}`, t(this, l)?.peek("danger", {
  ...
  async _handleAddFilter(e) {
    ...
    t(this, n) && r?.created && (t(this, l)?.peek("positive", {
      data: {
  ...
  async _handleEditFilter(e, i) {
    ...
    t(this, n) && (o?.updated ? (t(this, l)?.peek("positive", {
      data: {
        headline: "Filter updated",
        message: `"${o.filter?.name}" has been updated successfully`
      }
    }), this._loadFilterGroups()) : o?.deleted && (t(this, l)?.peek("positive", {
...
//# sourceMappingURL=filters-list.element-DsynX1H2.js.map
