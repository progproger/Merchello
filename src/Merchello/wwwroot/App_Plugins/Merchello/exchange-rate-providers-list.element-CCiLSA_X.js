...
import { c as A } from "./collection-layout.styles-BLT_S_EA.js";
const $ = new _("Merchello.ExchangeRateProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), P = new _("Merchello.ExchangeRateProvider.Test.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var L = Object.defineProperty, S = Object.getOwnPropertyDescriptor, b = (e) => {
  throw TypeError(e);
}, d = (e, i, a, p) => {
  for (var n = p > 1 ? void 0 : p ? S(i, a) : i, g = e.length - 1, m; g >= 0; g--)
    (m = e[g]) && (n = (p ? m(i, a, n) : m(n)) || n);
  return p && n && L(i, a, n), n;
...
//# sourceMappingURL=exchange-rate-providers-list.element-CCiLSA_X.js.map
