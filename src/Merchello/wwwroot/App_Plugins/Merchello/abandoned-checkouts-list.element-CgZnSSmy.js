import { LitElement as w, html as s, nothing as p, css as A, state as u, customElement as S } from "@umbraco-cms/backoffice/external/lit";
...
import { g as z } from "./store-settings-CHgA9WE7.js";
import { e as L, c as b, d as I } from "./formatting-B_f6AiQh.js";
...
var M = Object.defineProperty, P = Object.getOwnPropertyDescriptor, $ = (e) => {
  throw TypeError(e);
}, l = (e, t, a, c) => {
  for (var o = c > 1 ? void 0 : c ? P(t, a) : t, C = e.length - 1, k; C >= 0; C--)
    (k = e[C]) && (o = (c ? k(t, a, o) : k(o)) || o);
  return c && o && M(t, a, o), o;
}, T = (e, t, a) => t.has(e) || $("Cannot " + a), i = (e, t, a) => (T(e, t, "read from private field"), t.get(e)), m = (e, t, a) => t.has(e) ? $("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), _ = (e, t, a, c) => (T(e, t, "write to private field"), t.set(e, a), a), x = (e, t, a, c) => ({
  set _(o) {
    _(e, t, o);
  },
  get _() {
...
let r = class extends R(w) {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), _(this, n, !1), i(this, h) && (clearTimeout(i(this, h)), _(this, h, null));
  }
  ...
  _getQueryParams() {
    ...
    return t && (e.search = t), this._activeTab !== "all" && (e.status = V[this._activeTab]), e;
  }
  _getPaginationState() {
    return {
      page: this._page,
  ...
  async _loadStats() {
    ...
    const e = ++x(this, f)._, { data: t, error: a } = await g.getAbandonedCheckoutStats();
  ...
  async _loadCheckouts() {
    ...
    const e = ++x(this, y)._, { data: t, error: a } = await g.getAbandonedCheckouts(this._getQueryParams());
  ...
  _handleSearchInput(e) {
    this._searchInputValue = e.target.value, i(this, h) && clearTimeout(i(this, h)), _(this, h, setTimeout(() => {
      ...
      <uui-table-row>
        <uui-table-cell>
          <div class="customer-cell">
            ...
            ${e.customerName ? s`<span class="customer-name">${e.customerName}</span>` : p}
          </div>
        </uui-table-cell>
        <uui-table-cell>
        ...
        <uui-table-cell>
          <div class="email-count-cell">
            ...
            ${e.recoveryEmailsSent >= v ? s`<span class="email-limit-label">Max reached</span>` : p}
          </div>
        </uui-table-cell>
...
r = l([
  S("merchello-abandoned-checkouts-list")
], r);
const Q = r;
export {
...
//# sourceMappingURL=abandoned-checkouts-list.element-CgZnSSmy.js.map
