import { LitElement as x, unsafeHTML as M, html as s, nothing as u, css as C, state as g, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as I } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as y, UMB_MODAL_MANAGER_CONTEXT as $, UMB_CONFIRM_MODAL as S } from "@umbraco-cms/backoffice/modal";
...
const T = new y("Merchello.ShippingProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), z = new y("Merchello.TestShippingProvider.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var O = Object.defineProperty, R = Object.getOwnPropertyDescriptor, P = (e) => {
  throw TypeError(e);
}, p = (e, i, r, a) => {
  for (var l = a > 1 ? void 0 : a ? R(i, r) : i, f = e.length - 1, m; f >= 0; f--)
    (m = e[f]) && (l = (a ? m(i, r, l) : m(l)) || l);
  return a && l && O(i, r, l), l;
}, k = (e, i, r) => i.has(e) || P("Cannot " + r), o = (e, i, r) => (k(e, i, "read from private field"), i.get(e)), _ = (e, i, r) => i.has(e) ? P("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, r), h = (e, i, r, a) => (k(e, i, "write to private field"), i.set(e, r), r), t, c, n;
let d = class extends I(x) {
  constructor() {
    super(), this._availableProviders = [], this._configuredProviders = [], this._isLoading = !0, this._errorMessage = null, _(this, t), _(this, c), _(this, n, !1), this.consumeContext($, (e) => {
      h(this, t, e);
...
//# sourceMappingURL=shipping-providers-list.element-B99Va8nt.js.map
