...
import { UMB_MODAL_MANAGER_CONTEXT as S, UMB_CONFIRM_MODAL as k } from "@umbraco-cms/backoffice/modal";
...
import { d as D } from "./formatting-MfE1tvkN.js";
...
import { c as M } from "./collection-layout.styles-BLT_S_EA.js";
var L = Object.defineProperty, P = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, o = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? P(t, i) : t, m = e.length - 1, b; m >= 0; m--)
    (b = e[m]) && (a = (s ? b(t, i, a) : b(a)) || a);
  return s && a && L(t, i, a), a;
}, v = (e, t, i) => t.has(e) || y("Cannot " + i), c = (e, t, i) => (v(e, t, "read from private field"), t.get(e)), f = (e, t, i) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, s) => (v(e, t, "write to private field"), t.set(e, i), i), _, d, u;
let r = class extends T(E) {
  constructor() {
    super(), this._emails = [], this._categories = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._searchTerm = "", this._selectedCategory = null, this._isDeletingEmailId = null, this._isTogglingEmailIds = /* @__PURE__ */ new Set(), this._searchDebounceTimer = null, f(this, _), f(this, d), f(this, u, !1), this.consumeContext(S, (e) => {
      p(this, _, e);
...
//# sourceMappingURL=email-list.element-Br_IEgIp.js.map
