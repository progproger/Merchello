import { LitElement as x, html as u, nothing as l, css as P, state as o, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
}, S = (t, e, i) => e.has(t) || y("Cannot " + i), r = (t, e, i) => (S(t, e, "read from private field"), e.get(t)), b = (t, e, i) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), f = (t, e, i, n) => (S(t, e, "write to private field"), e.set(t, i), i), d, h, m, g;
let a = class extends D(x) {
  // ============================================
  // Constructor & Lifecycle
  // ============================================
  constructor() {
    super(), this._product = null, this._variant = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._routes = [], this._activePath = "", this._formData = {}, this._filterGroups = [], this._assignedFilterIds = [], this._originalAssignedFilterIds = [], this._variantShippingOptions = [], this._variantExcludedOptionIds = [], b(this, d), b(this, h), b(this, m), b(this, g, !1), this.consumeContext(F, (t) => {
...
//# sourceMappingURL=variant-detail.element-DdzW2SIV.js.map
