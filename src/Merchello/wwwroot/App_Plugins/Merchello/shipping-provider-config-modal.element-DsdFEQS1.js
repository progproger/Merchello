...
var x = Object.defineProperty, k = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, n = (e, a, i, o) => {
  for (var s = o > 1 ? void 0 : o ? k(a, i) : a, u = e.length - 1, h; u >= 0; u--)
    (h = e[u]) && (s = (o ? h(a, i, s) : h(s)) || s);
  return o && s && x(a, i, s), s;
}, _ = (e, a, i) => a.has(e) || y("Cannot " + i), c = (e, a, i) => (_(e, a, "read from private field"), a.get(e)), C = (e, a, i) => a.has(e) ? y("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, i), v = (e, a, i, o) => (_(e, a, "write to private field"), a.set(e, i), i), l;
let r = class extends $ {
  constructor() {
    super(...arguments), this._fields = [], this._values = {}, this._displayName = "", this._isEnabled = !0, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, C(this, l, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=shipping-provider-config-modal.element-DsdFEQS1.js.map
