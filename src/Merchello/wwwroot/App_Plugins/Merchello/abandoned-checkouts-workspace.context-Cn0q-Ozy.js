...
import { q as e } from "./bundle.manifests-BN1Pqtvn.js";
  ...
  constructor(t) {
    super(t, s.toString()), this.workspaceAlias = a, this.#t = new n(this), this.#t.setEntityType(e), this.#t.setUnique("abandoned-checkouts"), this.routes = new r(t), this.routes.setRoutes([
      // Abandoned checkouts list route
      {
        ...
        component: () => import("./abandoned-checkouts-workspace-editor.element-ByqEk9bi.js"),
        setup: () => {
        }
      },
      // Default redirect
...
//# sourceMappingURL=abandoned-checkouts-workspace.context-Cn0q-Ozy.js.map
