...
import { M as d } from "./merchello-api-DFeoGYDY.js";
var b = Object.defineProperty, x = Object.getOwnPropertyDescriptor, _ = (i) => {
  throw TypeError(i);
}, o = (i, e, t, h) => {
  for (var u = h > 1 ? void 0 : h ? x(e, t) : e, g = i.length - 1, c; g >= 0; g--)
    (c = i[g]) && (u = (h ? c(e, t, u) : c(u)) || u);
  return h && u && b(e, t, u), u;
}, m = (i, e, t) => e.has(i) || _("Cannot " + t), l = (i, e, t) => (m(i, e, "read from private field"), e.get(i)), W = (i, e, t) => e.has(i) ? _("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t), w = (i, e, t, h) => (m(i, e, "write to private field"), e.set(i, t), t), s;
let a = class extends y {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._countryCode = "", this._regionCode = "", this._minWeightKg = 0, this._maxWeightKg = null, this._surcharge = 0, this._countries = [], this._regions = [], W(this, s), this.consumeContext(C, (i) => {
      w(this, s, i);
    });
  }
  connectedCallback() {
    super.connectedCallback(), this._loadCountries(), this.data?.tier && (this._countryCode = this.data.tier.countryCode, this._regionCode = this.data.tier.regionCode ?? "", this._minWeightKg = this.data.tier.minWeightKg, this._maxWeightKg = this.data.tier.maxWeightKg ?? null, this._surcharge = this.data.tier.surcharge, this._countryCode && this._countryCode !== "*" && this._loadRegions(this._countryCode));
  }
  ...
  render() {
    ...
    return n`
      ...
      this._maxWeightKg = t ? parseFloat(t) : null;
    }}
...
//# sourceMappingURL=shipping-weight-tier-modal.element-BlcAug-p.js.map
