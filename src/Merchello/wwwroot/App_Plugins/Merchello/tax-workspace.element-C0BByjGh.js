...
import { UmbModalToken as M, UMB_MODAL_MANAGER_CONTEXT as G, UMB_CONFIRM_MODAL as C } from "@umbraco-cms/backoffice/modal";
...
const x = new M("Merchello.TaxGroup.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var E = Object.defineProperty, D = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, c = (e, a, t, u) => {
  for (var i = u > 1 ? void 0 : u ? D(a, t) : a, g = e.length - 1, m; g >= 0; g--)
    (m = e[g]) && (i = (u ? m(a, t, i) : m(i)) || i);
  return u && i && E(a, t, i), i;
}, v = (e, a, t) => a.has(e) || f("Cannot " + t), r = (e, a, t) => (v(e, a, "read from private field"), a.get(e)), b = (e, a, t) => a.has(e) ? f("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, t), p = (e, a, t, u) => (v(e, a, "write to private field"), a.set(e, t), t), d, n, o;
let s = class extends w(y) {
  constructor() {
    super(), this._taxGroups = [], this._isLoading = !0, this._errorMessage = null, this._isDeleting = null, b(this, d), b(this, n), b(this, o, !1), this.consumeContext(G, (e) => {
      p(this, d, e);
  ...
  async _handleAddTaxGroup() {
    const a = await r(this, d)?.open(this, x, {
      data: {}
    })?.onSubmit().catch(() => {
    });
    r(this, o) && a?.isCreated && (r(this, n)?.peek("positive", {
      data: { headline: "Tax group created", message: `"${a.taxGroup?.name}" has been created successfully` }
    }), this._loadTaxGroups());
  }
  async _handleEditTaxGroup(e) {
    const t = await r(this, d)?.open(this, x, {
      data: { taxGroup: e }
    })?.onSubmit().catch(() => {
    });
    r(this, o) && t?.isUpdated && (r(this, n)?.peek("positive", {
      data: { headline: "Tax group updated", message: `"${t.taxGroup?.name}" has been updated successfully` }
    }), this._loadTaxGroups());
  }
  async _handleDelete(e, a) {
    if (e.preventDefault(), e.stopPropagation(), !await r(this, d)?.open(this, C, {
      data: {
        headline: "Delete Tax Group",
        content: `Are you sure you want to delete tax group "${a.name}"? Products using this tax group will need to be reassigned.`,
        confirmLabel: "Delete",
        color: "danger"
      }
    })?.onSubmit().catch(() => {
    ...
    if (r(this, o)) {
      if (this._isDeleting = null, i) {
        this._errorMessage = `Failed to delete tax group: ${i.message}`, r(this, n)?.peek("danger", {
          data: { headline: "Failed to delete", message: i.message || "Could not delete tax group" }
        });
        return;
      }
      r(this, n)?.peek("positive", {
...
//# sourceMappingURL=tax-workspace.element-C0BByjGh.js.map
