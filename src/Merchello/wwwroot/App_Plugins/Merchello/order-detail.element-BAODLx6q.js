import { LitElement as F, nothing as o, html as a, css as O, state as l, customElement as R, property as Q, unsafeHTML as Z } from "@umbraco-cms/backoffice/external/lit";
...
import { UmbModalToken as M, UMB_MODAL_MANAGER_CONTEXT as j } from "@umbraco-cms/backoffice/modal";
import { UMB_CURRENT_USER_CONTEXT as ie } from "@umbraco-cms/backoffice/current-user";
import { b as N, a as u, d as te } from "./formatting-CH1NCLNK.js";
import { M as h } from "./merchello-api-CzSx3Q3Y.js";
import { I as C, P as B } from "./order.types-DjkMLpgj.js";
const ae = new M("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), re = new M("Merchello.EditOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), se = new M("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var oe = Object.defineProperty, ne = Object.getOwnPropertyDescriptor, G = (e) => {
  throw TypeError(e);
}, D = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? ne(i, t) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && oe(i, t, r), r;
}, V = (e, i, t) => i.has(e) || G("Cannot " + t), x = (e, i, t) => (V(e, i, "read from private field"), t ? t.call(e) : i.get(e)), A = (e, i, t) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), T = (e, i, t, s) => (V(e, i, "write to private field"), i.set(e, t), t), S, E, $;
let _ = class extends U(F) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, A(this, S), A(this, E), A(this, $, !1), this.consumeContext(H, (e) => {
      T(this, S, e), this.observe(x(this, S).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), T(this, $, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), T(this, $, !1);
  }
  ...
  async _handleDeleteShipment(e) {
    ...
    if (x(this, $)) {
      ...
      this._loadShipments(), this._invoiceId && x(this, S)?.load(this._invoiceId);
    }
  }
...
D([
  l()
], _.prototype, "_invoiceId", 2);
D([
  l()
], _.prototype, "_fulfillmentData", 2);
D([
  l()
...
const le = new M("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), de = new M("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var ue = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, X = (e) => {
  throw TypeError(e);
}, z = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? ce(i, t) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && ue(i, t, r), r;
}, Y = (e, i, t) => i.has(e) || X("Cannot " + t), w = (e, i, t) => (Y(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? X("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (Y(e, i, "write to private field"), i.set(e, t), t), f, k;
let g = class extends U(F) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, W(this, f), W(this, k, !1), this.consumeContext(j, (e) => {
      L(this, f, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), L(this, k, !0), this.invoiceId && this._loadPayments();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), L(this, k, !1);
  }
  updated(e) {
  ...
  async _openManualPaymentModal() {
    if (!w(this, f) || !this._status) return;
    (await w(this, f).open(this, le, {
      data: {
          ...
          ${e ? a`
                <div class="status-details">
                  <div class="status-row">
                    ...
                    <span>${u(e.invoiceTotal)}</span>
                  </div>
                  <div class="status-row">
                    <span>Total Paid</span>
                    <span class="positive">${u(e.totalPaid)}</span>
                  </div>
                  ${e.totalRefunded > 0 ? a`
                        <div class="status-row">
                          <span>Total Refunded</span>
                          <span class="negative">-${u(e.totalRefunded)}</span>
                        </div>
                      ` : o}
...
var pe = Object.defineProperty, me = Object.getOwnPropertyDescriptor, K = (e) => {
  throw TypeError(e);
}, p = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? me(i, t) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && pe(i, t, r), r;
}, J = (e, i, t) => i.has(e) || K("Cannot " + t), c = (e, i, t) => (J(e, i, "read from private field"), i.get(e)), I = (e, i, t) => i.has(e) ? K("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), P = (e, i, t, s) => (J(e, i, "write to private field"), i.set(e, t), t), v, b, y;
let d = class extends U(F) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._activeTab = "details", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], I(this, v), I(this, b), I(this, y, !1), this.consumeContext(H, (e) => {
      P(this, v, e), c(this, v) && this.observe(c(this, v).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), P(this, y, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), P(this, y, !1);
  }
  async _loadCountries() {
    const { data: e } = await h.getCountries();
    c(this, y) && e && (this._countries = e);
  }
  ...
  async _openFulfillmentModal() {
    if (!this._order || !c(this, b)) return;
    await c(this, b).open(this, ae, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), c(this, v)?.load(this._order.id);
  }
  async _openEditOrderModal() {
    if (!this._order || !c(this, b)) return;
    await c(this, b).open(this, re, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), c(this, v)?.load(this._order.id);
  }
  ...
  async _saveEditing() {
    ...
    if (c(this, y)) {
      ...
      this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, c(this, v)?.load(this._order.id);
    }
  }
      ...
      (r) => a`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-pricing">
                  <span class="fulfillment-item-price">${u(r.amount)}</span>
                  <span class="fulfillment-item-multiply">×</span>
                  <span class="fulfillment-item-qty">${r.quantity}</span>
                </div>
                <div class="fulfillment-item-total">${u(r.amount * r.quantity)}</div>
              </div>
            `
    )}
        </div>
  ...
  _handlePaymentChange() {
    this._order && c(this, v)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (c(this, y)) {
      ...
      this._newNoteText = "", this._visibleToCustomer = !1, c(this, v)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
            ...
            <div class="card payment-card">
              ...
              <div class="payment-summary">
                <div class="summary-row">
                  ...
                  <span>${u(e.subTotal)}</span>
                </div>
                ${e.discountTotal > 0 ? a`
                  <div class="summary-row discount">
                    <span>Discounts</span>
                    <span></span>
                    <span>-${u(e.discountTotal)}</span>
                  </div>
                ` : o}
                <div class="summary-row">
                  <span>Shipping</span>
                  <span>${e.orders[0]?.deliveryMethod || "Standard"}</span>
                  <span>${u(e.shippingCost)}</span>
                </div>
                ${e.tax > 0 ? a`
                  <div class="summary-row">
                    <span>Tax</span>
                ...
                ${e.balanceDue !== 0 ? a`
                  <div class="summary-row balance ${e.balanceDue > 0 ? "underpaid" : "overpaid"}">
                    ...
                    <span></span>
                    <span>${e.balanceDue > 0 ? u(e.balanceDue) : u(Math.abs(e.balanceDue))}</span>
                  </div>
                ` : o}
              </div>
            </div>
...
//# sourceMappingURL=order-detail.element-BAODLx6q.js.map
