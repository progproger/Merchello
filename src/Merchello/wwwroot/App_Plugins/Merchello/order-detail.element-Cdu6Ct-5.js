import { LitElement as F, nothing as n, html as a, css as R, state as l, customElement as U, property as Z, unsafeHTML as ee } from "@umbraco-cms/backoffice/external/lit";
import { d as q, p as ie } from "./purify.es-Cuv6u9x0.js";
import { UmbElementMixin as B } from "@umbraco-cms/backoffice/element-api";
import { UMB_WORKSPACE_CONTEXT as V } from "@umbraco-cms/backoffice/workspace";
import { UmbModalToken as S, UMB_MODAL_MANAGER_CONTEXT as j } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as te } from "@umbraco-cms/backoffice/notification";
import { UMB_CURRENT_USER_CONTEXT as ae } from "@umbraco-cms/backoffice/current-user";
import { I as f, P as H } from "./order.types-B45a7FtJ.js";
import { b as N, a as p, h as re } from "./formatting-CssnSMc6.js";
import { M as g } from "./merchello-api-BSrPLgGs.js";
import { k as se } from "./navigation-D1KCp5wk.js";
const oe = new S("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), ne = new S("Merchello.EditOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), le = new S("Merchello.CustomerOrders.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), de = new S("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var ue = Object.defineProperty, ce = Object.getOwnPropertyDescriptor, G = (e) => {
  throw TypeError(e);
}, D = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? ce(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && ue(i, t, r), r;
}, X = (e, i, t) => i.has(e) || G("Cannot " + t), $ = (e, i, t) => (X(e, i, "read from private field"), t ? t.call(e) : i.get(e)), L = (e, i, t) => i.has(e) ? G("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), A = (e, i, t, s) => (X(e, i, "write to private field"), i.set(e, t), t), M, O, C;
let w = class extends B(F) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, L(this, M), L(this, O), L(this, C, !1), this.consumeContext(V, (e) => {
      A(this, M, e), this.observe($(this, M).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), A(this, C, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), A(this, C, !1);
  }
  async _loadShipments() {
    if (!this._invoiceId) return;
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: i } = await g.getFulfillmentSummary(this._invoiceId);
    $(this, C) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  async _handleEditShipment(e) {
    if (!$(this, O)) return;
    (await $(this, O).open(this, de, {
      data: { shipment: e }
    }).onSubmit().catch(() => {
  ...
  async _handleDeleteShipment(e) {
    ...
    if ($(this, C)) {
      ...
      this._loadShipments(), this._invoiceId && $(this, M)?.load(this._invoiceId);
    }
  }
      ...
      (s) => a`
              <div class="item-row">
                ...
                <div class="item-info">
                  ...
                  ${s.sku ? a`<div class="item-sku">${s.sku}</div>` : n}
                </div>
...
const pe = new S("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), me = new S("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var he = Object.defineProperty, ve = Object.getOwnPropertyDescriptor, Y = (e) => {
  throw TypeError(e);
}, P = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? ve(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && he(i, t, r), r;
}, K = (e, i, t) => i.has(e) || Y("Cannot " + t), k = (e, i, t) => (K(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? Y("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), I = (e, i, t, s) => (K(e, i, "write to private field"), i.set(e, t), t), x, z;
let y = class extends B(F) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, W(this, x), W(this, z, !1), this.consumeContext(j, (e) => {
      I(this, x, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), I(this, z, !0), this.invoiceId && this._loadPayments();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), I(this, z, !1);
  }
  updated(e) {
  ...
  async _openManualPaymentModal() {
    if (!k(this, x) || !this._status) return;
    (await k(this, x).open(this, pe, {
      data: {
        ...
        <div class="payment-main">
          <div class="payment-info">
            <div class="payment-method">
              ...
              ${e.paymentProviderAlias ? a`<span class="provider-badge">${e.paymentProviderAlias}</span>` : n}
            </div>
            <div class="payment-date">${N(e.dateCreated)}</div>
            ${e.transactionId ? a`<div class="transaction-id">ID: ${e.transactionId}</div>` : n}
            ${e.description ? a`<div class="payment-description">${e.description}</div>` : n}
            ${e.refundReason ? a`<div class="refund-reason">Reason: ${e.refundReason}</div>` : n}
          </div>
...
P([
  Z({ type: String })
], y.prototype, "invoiceId", 2);
P([
  l()
], y.prototype, "_payments", 2);
P([
  l()
...
var ge = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, J = (e) => {
  throw TypeError(e);
}, c = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? fe(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && ge(i, t, r), r;
}, Q = (e, i, t) => i.has(e) || J("Cannot " + t), o = (e, i, t) => (Q(e, i, "read from private field"), i.get(e)), T = (e, i, t) => i.has(e) ? J("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), E = (e, i, t, s) => (Q(e, i, "write to private field"), i.set(e, t), t), h, b, _, v;
let u = class extends B(F) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, T(this, h), T(this, b), T(this, _), T(this, v, !1), this.consumeContext(V, (e) => {
      E(this, h, e), o(this, h) && this.observe(o(this, h).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), E(this, v, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), E(this, v, !1);
  }
  async _loadCountries() {
    const { data: e } = await g.getCountries();
    o(this, v) && e && (this._countries = e);
  }
  ...
  async _openFulfillmentModal() {
    if (!this._order || !o(this, b)) return;
    const e = this._order.id;
    await o(this, b).open(this, oe, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), o(this, v) && o(this, h)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !o(this, b)) return;
    const e = this._order.id;
    await o(this, b).open(this, ne, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), o(this, v) && o(this, h)?.load(e);
  }
  ...
  _renderMarkdown(e) {
    ...
    const i = q.parse(e), t = ie.sanitize(i);
    return ee(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
  ...
  async _saveEditing() {
    ...
    if (o(this, v)) {
      if (this._isSavingAddress = !1, e.error) {
        console.error("Failed to save address:", e.error), o(this, _)?.peek("danger", {
          data: { headline: "Failed to save", message: e.error.message || "Could not save address changes" }
        });
        return;
      }
      o(this, _)?.peek("positive", {
        data: { headline: "Address updated", message: "Changes have been saved successfully" }
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, o(this, h)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (o(this, v)) {
      if (this._isSavingPurchaseOrder = !1, e) {
        console.error("Failed to save purchase order:", e), o(this, _)?.peek("danger", {
      ...
      }), this._editingPurchaseOrder = !1, this._purchaseOrderValue = "", o(this, h)?.load(this._order.id);
    }
  }
  ...
  _renderInput(e, i, t, s = "text") {
    ...
    return a`
      <div class="form-field ${r ? "has-error" : ""}">
        ...
        ></uui-input>
        ${r ? a`<span class="field-error">${this._validationErrors[e]}</span>` : n}
      </div>
    `;
  }
  _getCountryOptions() {
  ...
  _renderCountrySelect() {
    ...
    return a`
      ...
      if (this._editFormData = {
        ...
        ></uui-select>
        ${e ? a`<span class="field-error">${this._validationErrors.countryCode}</span>` : n}
      </div>
    `;
  }
      ...
      <div class="card fulfillment-card">
        ...
        <div class="fulfillment-shipping-method">
          ...
          <div class="fulfillment-shipping-details">
            ...
            <span class="fulfillment-shipping-cost">${p(e.shippingCost)}</span>
          </div>
        </div>
        ...
        <div class="fulfillment-footer">
          <div class="fulfillment-actions">
            <uui-button
              ...
              ?disabled=${t}
              @click=${t ? n : this._openFulfillmentModal}
            >
              ${t ? "Fulfilled" : "Fulfil"}
            </uui-button>
  ...
  _handlePaymentChange() {
    this._order && o(this, h)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (o(this, v)) {
      if (this._isPostingNote = !1, e) {
        this._noteError = e.message || "Failed to post note", console.error("Failed to post note:", e), o(this, _)?.peek("danger", {
      ...
      }), this._newNoteText = "", this._visibleToCustomer = !1, o(this, h)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
  ...
  render() {
    ...
    return a`
      <umb-body-layout header-fit-height main-no-padding>
        <!-- Back button -->
        <uui-button slot="header" compact href=${se()} label="Back to orders" class="back-button">
        ...
        <div id="header" slot="header">
          ...
          <div class="header-title">
            ...
            <span class="order-meta">${re(e.dateCreated)} from ${e.channel}</span>
          </div>
      ...
      this._newNoteText = t.target.value, this._noteError = null;
                  ...
                  ${this._noteError ? a`<div class="note-error">${this._noteError}</div>` : n}
                </div>
              </div>
        ...
        (r) => a`
                                <div class="timeline-event ${r.visibleToCustomer ? "customer-visible" : ""}">
                                  ...
                                  <div class="timeline-event-content">
                                    ${r.visibleToCustomer ? a`<span class="customer-badge">Customer visible</span>` : n}
                                    <div class="event-text markdown-content">${this._renderMarkdown(r.text)}</div>
                                    ${r.author ? a`<span class="event-author">by ${r.author}</span>` : n}
                                  </div>
          ...
          <div class="sidebar">
            ...
            <div class="card">
              <div class="card-header-with-action">
                ...
                ${this._editingPurchaseOrder ? n : a`
            ...
            <div class="card">
              ...
              <div class="section">
                ...
                ` : a`
                  ...
                  ${this._getGoogleMapsUrl(e.shippingAddress) ? a`<a href=${this._getGoogleMapsUrl(e.shippingAddress)} target="_blank" rel="noopener noreferrer" class="view-map">View map</a>` : n}
                `}
              </div>
              <div class="section">
                <div class="section-header">
...
c([
  l()
], u.prototype, "_visibleToCustomer", 2);
c([
  l()
...
c([
  l()
], u.prototype, "_editingPurchaseOrder", 2);
c([
  l()
...
//# sourceMappingURL=order-detail.element-Cdu6Ct-5.js.map
