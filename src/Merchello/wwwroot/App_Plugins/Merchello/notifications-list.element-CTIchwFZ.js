...
import { c as F } from "./collection-layout.styles-I8XQedsa.js";
function $(e) {
  switch (e) {
    case "Validation":
...
var X = Object.defineProperty, Y = Object.getOwnPropertyDescriptor, z = (e) => {
  throw TypeError(e);
}, f = (e, i, a, o) => {
  for (var c = o > 1 ? void 0 : o ? Y(i, a) : i, n = e.length - 1, l; n >= 0; n--)
    (l = e[n]) && (c = (o ? l(i, a, c) : l(c)) || c);
  return o && c && X(i, a, c), c;
}, v = (e, i, a) => i.has(e) || z("Cannot " + a), p = (e, i, a) => (v(e, i, "read from private field"), i.get(e)), w = (e, i, a) => i.has(e) ? z("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), q = (e, i, a, o) => (v(e, i, "write to private field"), i.set(e, a), a), t = (e, i, a) => (v(e, i, "access private method"), a), u, r, k, g, b, C, D, N, E, y, S, x, _, L, P, T, H, R, M, O, A, U, W;
let d = class extends G {
  constructor() {
    super(), w(this, r), this._loading = !0, this._loadError = null, this._searchTerm = "", this._expandedDomains = /* @__PURE__ */ new Set(), w(this, u), this.consumeContext(V, (e) => {
      q(this, u, e), p(this, u) && (this.observe(
        p(this, u).data,
        (i) => {
          const a = !!this._data;
...
C = function(e) {
  ...
  for (const o of this._data.domains)
    t(this, r, y).call(this, o, i).length > 0 && a.add(o.domain);
...
S = function() {
  ...
  return this._data.domains.map((i) => ({
    domain: i,
    notifications: t(this, r, y).call(this, i, e)
  ...
  return s`
      <uui-box class="error-box" headline="Could not load notifications">
        <div class="error-content">
          <p>${this._loadError}</p>
          <uui-button look="secondary" label="Retry" @click=${t(this, r, b)}>Retry</uui-button>
        </div>
      </uui-box>
    `;
};
  ...
  return s`
      <uui-box>
        <merchello-empty-state
          ...
          <uui-button slot="actions" look="secondary" label="Refresh" @click=${t(this, r, b)}>
            Refresh
          </uui-button>
        </merchello-empty-state>
      </uui-box>
  ...
  return s`
      ...
      <uui-box headline="Priority Legend">
        <div class="priority-legend">
          ${K.map(
    (n) => s`
              <div class="legend-item ${$(n.category)}">
            ...
            <div class="handler-item ${i.hasDuplicatePriority ? "duplicate-priority" : ""}">
              ...
              <div class="handler-main">
                <div class="handler-top">
                  ...
                  <span class="priority-badge ${$(i.priorityCategory)}">
                    ${i.priority}
                  </span>
...
//# sourceMappingURL=notifications-list.element-CTIchwFZ.js.map
