import { LitElement as P, html as n, nothing as T, css as M, state as h, customElement as k } from "@umbraco-cms/backoffice/external/lit";
...
var A = Object.defineProperty, L = Object.getOwnPropertyDescriptor, _ = (e) => {
  ...
  for (var a = u > 1 ? void 0 : u ? L(t, i) : t, y = e.length - 1, m; y >= 0; y--)
    (m = e[y]) && (a = (u ? m(t, i, a) : m(a)) || a);
  return u && a && A(t, i, a), a;
}, b = (e, t, i) => t.has(e) || _("Cannot " + i), r = (e, t, i) => (b(e, t, "read from private field"), t.get(e)), g = (e, t, i) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, u) => (b(e, t, "write to private field"), t.set(e, i), i), c, d, o;
let s = class extends x(P) {
  constructor() {
    super(), this._productTypes = [], this._isLoading = !0, this._errorMessage = null, this._deletingId = null, g(this, c), g(this, d), g(this, o, !1), this.consumeContext(z, (e) => {
      p(this, c, e);
  ...
  async _handleAddProductType() {
    ...
    r(this, o) && t?.isCreated && (r(this, d)?.peek("positive", {
      data: {
  ...
  async _handleEditProductType(e) {
    ...
    r(this, o) && i?.isUpdated && (r(this, d)?.peek("positive", {
      data: {
  ...
  async _handleDeleteProductType(e, t) {
    if (e.preventDefault(), e.stopPropagation(), !await r(this, c)?.open(this, w, {
      data: {
    ...
    if (r(this, o)) {
      if (this._deletingId = null, a) {
        this._errorMessage = `Failed to delete product type: ${a.message}`, r(this, d)?.peek("danger", {
    ...
    return n`
      <div class="product-type-row" @click=${() => this._handleEditProductType(e)}>
        <div class="product-type-info">
          ...
          ${e.alias ? n`<span class="product-type-alias">${e.alias}</span>` : T}
        </div>
  ...
  _renderContent() {
    return this._isLoading ? this._renderLoadingState() : this._errorMessage ? this._renderErrorState() : this._productTypes.length === 0 ? this._renderEmptyState() : n`
...
//# sourceMappingURL=product-types-list.element-C0R4uY_4.js.map
