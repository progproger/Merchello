...
import { e as V, b as _, c as w, a as C, f as v, g as c, D as q, d as oe } from "./discount.types-Du4rtOaW.js";
    ...
    return s`
      <uui-box>
        ...
        <div class="summary-list">
          ...
          ${this.discount.requirementType !== C.None ? this._renderSummaryItem(
      "Minimum",
      this.discount.requirementType === C.MinimumPurchaseAmount ? `${this.discount.requirementValue} purchase` : `${this.discount.requirementValue} items`,
...
$([
  T({ type: String })
], f.prototype, "discountId", 2);
$([
  d()
], f.prototype, "_performance", 2);
$([
  d()
...
$([
  d()
], f.prototype, "_dateRange", 2);
$([
  d()
], f.prototype, "_activePreset", 2);
$([
  d()
], f.prototype, "_showCustomPicker", 2);
$([
  d()
], f.prototype, "_customStartDate", 2);
$([
  d()
], f.prototype, "_customEndDate", 2);
f = $([
...
let h = class extends L(z) {
  ...
  _getValueTypeOptions() {
    const e = [
      { name: "Percentage", value: _.Percentage, selected: this._discount?.valueType === _.Percentage },
      { name: "Fixed amount", value: _.FixedAmount, selected: this._discount?.valueType === _.FixedAmount }
    ];
    return this._discount?.category === q.BuyXGetY && e.push({ name: "Free", value: _.Free, selected: this._discount?.valueType === _.Free }), e;
  }
  _getRequirementTypeOptions() {
    return [
      { name: "No minimum requirements", value: C.None, selected: this._discount?.requirementType === C.None },
      { name: "Minimum purchase amount", value: C.MinimumPurchaseAmount, selected: this._discount?.requirementType === C.MinimumPurchaseAmount },
      { name: "Minimum quantity of items", value: C.MinimumQuantity, selected: this._discount?.requirementType === C.MinimumQuantity }
    ];
  }
  _getHeadline() {
    ...
    return s`
      <uui-box headline="Minimum Requirements">
        <div class="form-grid">
          ...
          ${this._discount?.requirementType !== C.None ? s`
                <umb-property-layout
                  label=${this._discount?.requirementType === C.MinimumPurchaseAmount ? "Minimum Amount" : "Minimum Quantity"}
                  ?mandatory=${!0}
                  ...
                  <uui-input
                    ...
                    type="number"
                    min="0"
                    step=${this._discount?.requirementType === C.MinimumPurchaseAmount ? "0.01" : "1"}
...
//# sourceMappingURL=discount-detail.element-r-zRMWuF.js.map
