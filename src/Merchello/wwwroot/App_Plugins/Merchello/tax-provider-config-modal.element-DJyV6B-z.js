import { nothing as l, html as t, css as O, state as c, customElement as C } from "@umbraco-cms/backoffice/external/lit";
...
var M = Object.defineProperty, z = Object.getOwnPropertyDescriptor, T = (e) => {
  ...
  for (var u = s > 1 ? void 0 : s ? z(i, a) : i, b = e.length - 1, m; b >= 0; b--)
    (m = e[b]) && (u = (s ? m(i, a, u) : m(u)) || u);
  return s && u && M(i, a, u), u;
}, k = (e, i, a) => i.has(e) || T("Cannot " + a), r = (e, i, a) => (k(e, i, "read from private field"), i.get(e)), _ = (e, i, a) => i.has(e) ? T("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), v = (e, i, a, s) => (k(e, i, "write to private field"), i.set(e, a), a), o, p, h;
let n = class extends w {
  ...
  connectedCallback() {
    super.connectedCallback(), v(this, o, !0), this._loadData();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), v(this, o, !1);
  }
  async _loadData() {
  ...
  async _handleAddTaxGroup() {
    ...
    r(this, o) && i?.isCreated && (r(this, h)?.peek("positive", {
      data: {
  ...
  async _handleEditTaxGroup(e) {
    ...
    r(this, o) && a?.isUpdated && (r(this, h)?.peek("positive", {
      data: {
  ...
  async _handleAddOverride() {
    ...
    r(this, o) && i?.isSaved && this._loadShippingOverrides();
  }
  async _handleEditOverride(e) {
    ...
    r(this, o) && a?.isSaved && this._loadShippingOverrides();
  }
  async _handleDeleteOverride(e, i) {
    ...
    r(this, o) && (this._deletedOverrideIds = [...this._deletedOverrideIds, i.id], this._shippingOverrides = this._shippingOverrides.filter((u) => u.id !== i.id));
  }
  ...
  _renderTabs() {
    return t`
      <uui-tab-group class="tabs">
        ...
        >
          Shipping Taxes
          ${this._deletedOverrideIds.length > 0 ? t`<uui-badge slot="extra" color="warning" attention>Unsaved</uui-badge>` : l}
        </uui-tab>
      </uui-tab-group>
    `;
  }
      ...
      <uui-table-row>
        <uui-table-cell>
          <div class="region-cell">
            ...
            ${e.stateOrProvinceCode ? l : t`<span class="country-badge">Country-wide</span>`}
          </div>
        </uui-table-cell>
        <uui-table-cell>
...
d([
  c()
], n.prototype, "_isLoadingTaxGroups", 2);
d([
  c()
], n.prototype, "_isDeleting", 2);
d([
  c()
], n.prototype, "_shippingOverrides", 2);
d([
  c()
], n.prototype, "_isLoadingOverrides", 2);
d([
  c()
], n.prototype, "_deletedOverrideIds", 2);
n = d([
  C("merchello-tax-provider-config-modal")
], n);
const N = n;
export {
  n as MerchelloTaxProviderConfigModalElement,
  N as default
};
//# sourceMappingURL=tax-provider-config-modal.element-DJyV6B-z.js.map
