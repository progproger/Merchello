import { html as a, css as p, state as c, customElement as f } from "@umbraco-cms/backoffice/external/lit";
...
let r = class extends b {
  ...
  _renderCustomerList() {
    return this._customers.length === 0 ? a`<p class="empty-state">No customers found matching "${this._searchTerm}"</p>` : a`
  ...
  _renderContent() {
    return this._isLoading ? a`<div class="loading"><uui-loader></uui-loader></div>` : this._errorMessage ? a`<div class="error-banner">${this._errorMessage}</div>` : this._hasSearched ? this._renderCustomerList() : a`<p class="hint">Search for customers to add to the segment.</p>`;
  }
  render() {
...
l([
  c()
], r.prototype, "_selectedIds", 2);
l([
  c()
], r.prototype, "_customers", 2);
l([
  c()
...
const $ = r;
export {
  r as MerchelloCustomerPickerModalElement,
  $ as default
};
//# sourceMappingURL=customer-picker-modal.element-DFsuxq4a.js.map
