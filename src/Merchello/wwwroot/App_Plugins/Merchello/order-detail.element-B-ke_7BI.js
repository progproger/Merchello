...
}, ue = (e, i, t) => i.has(e) || le("Cannot " + t), d = (e, i, t) => (ue(e, i, "read from private field"), i.get(e)), j = (e, i, t) => i.has(e) ? le("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), V = (e, i, t, o) => (ue(e, i, "write to private field"), i.set(e, t), t), z, E, b, x;
let w = class extends Y(W) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, j(this, z), j(this, E), j(this, b), j(this, x, !1), this.consumeContext(oe, (e) => {
      V(this, z, e), d(this, z) && this.observe(d(this, z).order, (i) => {
  ...
  async _loadShipments() {
    ...
    d(this, x) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  ...
  async _copyToClipboard(e) {
    try {
      await navigator.clipboard.writeText(e), d(this, b)?.peek("positive", {
...
}, ce = (e, i, t) => i.has(e) || de("Cannot " + t), T = (e, i, t) => (ce(e, i, "read from private field"), i.get(e)), ae = (e, i, t) => i.has(e) ? de("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (ce(e, i, "write to private field"), i.set(e, t), t), L, F;
...
}, ve = (e, i, t) => i.has(e) || he("Cannot " + t), u = (e, i, t) => (ve(e, i, "read from private field"), i.get(e)), q = (e, i, t) => i.has(e) ? he("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), B = (e, i, t, o) => (ve(e, i, "write to private field"), i.set(e, t), t), y, f, _, $;
let c = class extends Y(W) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, q(this, y), q(this, f), q(this, _), q(this, $, !1), this.consumeContext(oe, (e) => {
      B(this, y, e), u(this, y) && this.observe(u(this, y).order, (i) => {
  ...
  async _openFulfillmentModal() {
    ...
    }), u(this, $) && u(this, y)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !u(this, f)) return;
    const e = this._order.id;
    await u(this, f).open(this, $e, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), u(this, $) && u(this, y)?.load(e);
  }
  ...
  async _saveEditing() {
    ...
    if (u(this, $)) {
      ...
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, u(this, y)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (u(this, $)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", u(this, y)?.load(this._order.id);
    }
  }
  ...
  _handlePaymentChange() {
    this._order && u(this, y)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (u(this, $)) {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, u(this, y)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
//# sourceMappingURL=order-detail.element-B-ke_7BI.js.map
