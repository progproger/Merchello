import { LitElement as x, html as c, css as O, state as o, customElement as T } from "@umbraco-cms/backoffice/external/lit";
...
import { g as k } from "./store-settings-ueHqTlgT.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import "./order-table.element-Dosbx44m.js";
import { M as w } from "./edit-order-modal.token-BUHVPYdq.js";
import { n as z, a as D } from "./navigation-CgHIQALx.js";
import { a as E } from "./formatting-6Hz_EImA.js";
const L = new b("Merchello.Export.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), I = new b("Merchello.CreateOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
});
var A = Object.defineProperty, P = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, r = (e, t, i, u) => {
  for (var n = u > 1 ? void 0 : u ? P(t, i) : t, _ = e.length - 1, m; _ >= 0; _--)
    (m = e[_]) && (n = (u ? m(t, i, n) : m(n)) || n);
  return u && n && A(t, i, n), n;
}, y = (e, t, i) => t.has(e) || f("Cannot " + i), s = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), v = (e, t, i) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, u) => (y(e, t, "write to private field"), t.set(e, i), i), d, h, l;
let a = class extends C(x) {
  constructor() {
    super(), this._orders = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedOrders = /* @__PURE__ */ new Set(), this._stats = null, this._searchTerm = "", this._isDeleting = !1, this._searchDebounceTimer = null, v(this, d), v(this, h), v(this, l, !1), this._tableColumns = [
      "select",
      "invoiceNumber",
      "date",
      "customer",
  ...
  connectedCallback() {
    super.connectedCallback(), p(this, l, !0), this._initializeAndLoad();
  }
  async _initializeAndLoad() {
    const e = await k();
    s(this, l) && (this._pageSize = e.defaultPaginationPageSize, this._loadOrders(), this._loadStats());
  }
  disconnectedCallback() {
    super.disconnectedCallback(), p(this, l, !1), this._searchDebounceTimer && clearTimeout(this._searchDebounceTimer);
  }
  async _loadOrders() {
  ...
  async _handleDeleteSelected() {
    ...
    if (e === 0 || !await s(this, d)?.open(this, $, {
      data: {
    ...
    this._isDeleting = !0;
    const u = Array.from(this._selectedOrders), { error: n } = await g.deleteOrders(u);
    if (s(this, l)) {
  ...
  async _handleExport() {
    s(this, d) && s(this, d).open(this, L, {
      data: {}
    });
  }
  async _handleCreateOrder() {
    if (!s(this, d)) return;
    const t = await s(this, d).open(this, I, {
      data: {}
    }).onSubmit().catch(() => {
    });
    if (s(this, l) && t?.isCreated && t.invoiceId)
      if (this._loadOrders(), this._loadStats(), t.shouldOpenEdit) {
        if (await s(this, d).open(this, w, {
    ...
    return c`
      ...
      <div class="orders-container">
        ...
        <div class="stats-grid">
          ...
          <uui-box class="stat-box--outstanding" @click=${() => D()}>
            <div class="stat-content stat-content--clickable">
              <div class="stat-icon stat-icon--outstanding">
                <uui-icon name="icon-timer"></uui-icon>
              </div>
              <div class="stat-details">
                <div class="stat-number">${E(this._stats?.totalOutstandingValue ?? 0, this._stats?.currencyCode ?? "USD")}</div>
...
//# sourceMappingURL=orders-list.element-BRdT5Ix6.js.map
