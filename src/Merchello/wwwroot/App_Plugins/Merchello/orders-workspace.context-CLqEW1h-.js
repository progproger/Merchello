...
import { a as o } from "./bundle.manifests-BmZ8i5JU.js";
...
class _ extends i {
  constructor(t) {
    super(t, n.toString()), this.workspaceAlias = m, this.#r = new a(this), this.#e = new p(void 0), this.order = this.#e.asObservable(), this.#r.setEntityType(o), this.#r.setUnique("orders"), this.routes = new d(t), this.routes.setRoutes([
      ...
      {
        path: "edit/orders/:id",
        component: () => import("./order-detail.element-__nkD8f0.js"),
        setup: (r, e) => {
...
//# sourceMappingURL=orders-workspace.context-CLqEW1h-.js.map
