  ...
  async _handleSave() {
    if (this._validate())
      if (this._isSaving = !0, this._isEditMode) {
        ...
        this.value = { filterGroup: r, updated: !0 }, this.modalContext?.submit();
      } else {
        ...
        this.value = { filterGroup: e, created: !0 }, this.modalContext?.submit();
      }
  }
  _handleCancel() {
...
//# sourceMappingURL=filter-group-modal.element-BUMVwPVD.js.map
