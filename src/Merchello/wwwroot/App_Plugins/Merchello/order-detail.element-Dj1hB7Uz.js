import { LitElement as V, nothing as s, html as a, css as G, state as n, customElement as j, property as Z, unsafeHTML as ce } from "@umbraco-cms/backoffice/external/lit";
...
import { S as H, b as O, P as K, a as p, h as te, j as fe } from "./formatting-CG1-kUla.js";
...
var $e = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, ae = (e) => {
  throw TypeError(e);
}, P = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? xe(i, t) : i, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && $e(i, t, r), r;
}, re = (e, i, t) => i.has(e) || ae("Cannot " + t), d = (e, i, t) => (re(e, i, "read from private field"), i.get(e)), U = (e, i, t) => i.has(e) ? ae("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), T = (e, i, t, o) => (re(e, i, "write to private field"), i.set(e, t), t), S, M, $, y;
let w = class extends B(V) {
  constructor() {
      ...
      <div class="shipment-card">
        <div class="shipment-header">
          <div class="header-left">
            ...
            <span class="shipment-date">Created ${O(e.dateCreated)}</span>
          </div>
        ...
        <div class="shipment-details">
          ...
          ${e.shippedDate ? a`
                <div class="detail-row">
                  ...
                  <span class="value">${O(e.shippedDate)}</span>
                </div>
              ` : s}
          ${e.trackingNumber ? a`
                <div class="detail-row">
          ...
          ${e.actualDeliveryDate ? a`
                <div class="detail-row">
                  ...
                  <span class="value delivered">${O(e.actualDeliveryDate)}</span>
                </div>
              ` : s}
        </div>
      ...
      <div class="payment-item ${i ? "refund" : ""}">
        <div class="payment-main">
          <div class="payment-info">
            ...
            <div class="payment-date">${O(e.dateCreated)}</div>
...
}, le = (e, i, t) => i.has(e) || ne("Cannot " + t), D = (e, i, t) => (le(e, i, "read from private field"), i.get(e)), Ie = (e, i, t) => i.has(e) ? ne("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (le(e, i, "write to private field"), i.set(e, t), t), x;
let _ = class extends B(V) {
  constructor() {
    ...
    return this._linkInfo?.hasActiveLink ? a`
      <div class="active-link">
        ...
        <div class="link-meta">
          ...
          ${this._linkInfo.createdAt ? a`<span>${O(this._linkInfo.createdAt)}</span>` : s}
        </div>
  ...
  _renderPaidStatus() {
    return this._linkInfo?.isPaid ? a`
      <div class="paid-status">
        ...
        ${this._linkInfo.createdAt ? a`<span class="paid-date">${O(this._linkInfo.createdAt)}</span>` : s}
      </div>
    ` : s;
  }
  _renderGenerator() {
...
var Ee = Object.defineProperty, De = Object.getOwnPropertyDescriptor, ue = (e) => {
  throw TypeError(e);
}, h = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? De(i, t) : i, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && Ee(i, t, r), r;
}, de = (e, i, t) => i.has(e) || ue("Cannot " + t), l = (e, i, t) => (de(e, i, "read from private field"), i.get(e)), R = (e, i, t) => i.has(e) ? ue("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), N = (e, i, t, o) => (de(e, i, "write to private field"), i.set(e, t), t), f, g, b, k;
let c = class extends B(V) {
  constructor() {
                ...
                <div class="fulfillment-item-details">
                  ...
                  ${r.selectedOptions?.length ? a`
                    <div class="fulfillment-item-options">
                      ${r.selectedOptions.map((u) => a`
                        <span class="fulfillment-item-option">${u.optionName}: ${u.valueName}</span>
                      `)}
                    </div>
                  ` : s}
...
//# sourceMappingURL=order-detail.element-Dj1hB7Uz.js.map
