import { nothing as c, html as s, css as m, state as n, customElement as p } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as h } from "@umbraco-cms/backoffice/modal";
import { M as v } from "./merchello-api-DudNt7x5.js";
import { a as b } from "./formatting-B7Ourlxi.js";
var g = Object.defineProperty, _ = Object.getOwnPropertyDescriptor, r = (t, e, l, o) => {
  for (var i = o > 1 ? void 0 : o ? _(e, l) : e, u = t.length - 1, d; u >= 0; u--)
    (d = t[u]) && (i = (o ? d(e, l, i) : d(i)) || i);
  return o && i && g(e, l, i), i;
};
const f = [
...
let a = class extends h {
  ...
  async _handleSave() {
    ...
    const { error: e } = await v.recordManualPayment(t, {
      amount: this._amount,
  ...
  render() {
    const t = this.data?.balanceDue ?? 0;
    return s`
      ...
      this._amount = parseFloat(e.target.value) || 0;
            ...
            ></uui-input>
            ${this._amount > t ? s`<small class="warning">Amount exceeds balance due</small>` : c}
          </div>
...
r([
  n()
], a.prototype, "_amount", 2);
r([
  n()
], a.prototype, "_paymentMethod", 2);
r([
  n()
...
const P = a;
export {
  a as MerchelloManualPaymentModalElement,
  P as default
};
//# sourceMappingURL=manual-payment-modal.element-8TGl5Qce.js.map
