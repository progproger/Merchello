...
import { b as c } from "./formatting-DU6_gkL3.js";
...
function x(e, t) {
  ...
  o.setAttribute("href", s), o.setAttribute("download", t), o.style.visibility = "hidden", document.body.appendChild(o), o.addEventListener("click", (l) => l.stopPropagation(), { once: !0 }), o.click(), document.body.removeChild(o), URL.revokeObjectURL(s);
}
function y(e) {
...
var E = Object.defineProperty, C = Object.getOwnPropertyDescriptor, u = (e, t, i, a) => {
  for (var o = a > 1 ? void 0 : a ? C(t, i) : t, s = e.length - 1, l; s >= 0; s--)
...
let n = class extends b {
  ...
  async _handleExport() {
    ...
    const s = D(i, [
      ...
      { header: "Inv Date", accessor: (r) => y(r.invoiceDate) },
    ...
    x(s, l), this._isExporting = !1, this.value = { exported: !0 }, this.modalContext?.submit();
  }
  _handleCancel() {
...
//# sourceMappingURL=export-modal.element-DDkIC_Ic.js.map
