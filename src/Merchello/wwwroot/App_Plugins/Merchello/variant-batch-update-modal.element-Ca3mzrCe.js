...
var x = Object.defineProperty, E = Object.getOwnPropertyDescriptor, u = (e, t, s, r) => {
  for (var a = r > 1 ? void 0 : r ? E(t, s) : t, l = e.length - 1, c; l >= 0; l--)
    (c = e[l]) && (a = (r ? c(t, s, a) : c(a)) || a);
  return r && a && x(t, s, a), a;
};
const p = [
...
let o = class extends S {
  ...
  async _updateVariantWithRetry(e, t, s) {
    let r;
    for (let a = 1; a <= b; a++) {
      const { error: l } = await y.updateVariant(e, t, s);
      if (!l)
        return {};
      if (r = l, !this._isRetryableUpdateError(l) || a === b)
        return { error: l };
      await this._delay(C * a);
    }
    return { error: r };
  }
  async _saveVariantsWithLimitedConcurrency(e) {
    ...
    }, a = Math.min(P, this._variants.length);
...
//# sourceMappingURL=variant-batch-update-modal.element-Ca3mzrCe.js.map
