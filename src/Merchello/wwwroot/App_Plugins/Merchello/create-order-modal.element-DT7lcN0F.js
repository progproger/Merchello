import { html as r, nothing as p, css as w, state as a, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
import { a as m } from "./formatting-6Hz_EImA.js";
var O = Object.defineProperty, k = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, d = (e, i, s, t) => {
  for (var o = t > 1 ? void 0 : t ? k(i, s) : i, l = e.length - 1, u; l >= 0; l--)
    (u = e[l]) && (o = (t ? u(i, s, o) : u(o)) || o);
  return t && o && O(i, s, o), o;
}, C = (e, i, s) => i.has(e) || f("Cannot " + s), h = (e, i, s) => (C(e, i, "read from private field"), i.get(e)), b = (e, i, s) => i.has(e) ? f("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, s), v = (e, i, s, t) => (C(e, i, "write to private field"), i.set(e, s), s), _, c;
function y() {
  return {
    name: null,
    email: null,
...
let n = class extends F {
  ...
  _handleCustomerSearchInput(e) {
    ...
    v(this, c, setTimeout(async () => {
      ...
      const t = s.includes("@"), { data: o, error: l } = await g.searchCustomers(
        t ? s : void 0,
        t ? void 0 : s
      );
  ...
  async _selectCustomer(e) {
    if (this._selectedCustomer = e, this._showCustomerDropdown = !1, this._creditWarning = null, this._billingAddress = { ...e.billingAddress }, e.hasAccountTerms && e.customerId && e.creditLimit != null) {
      ...
      if (!s && i) {
        const t = e.creditLimit > 0 ? i.totalOutstanding / e.creditLimit * 100 : 0;
        i.totalOutstanding >= e.creditLimit ? this._creditWarning = {
          type: "danger",
        ...
        } : t >= 80 && (this._creditWarning = {
          type: "warning",
          message: `Customer has ${m(i.totalOutstanding, i.currencyCode)} outstanding of ${m(e.creditLimit, i.currencyCode)} limit (${Math.round(t)}% utilized)`,
          outstanding: i.totalOutstanding,
          creditLimit: e.creditLimit,
          currencyCode: i.currencyCode
        });
  ...
  _renderAddressField(e, i, s, t = "text", o = !1) {
    ...
    return r`
      <umb-property-layout
        ...
        <uui-select
          ...
          @change=${(t) => {
      const o = t.target, l = this._countries.find((u) => u.code === o.value);
...
//# sourceMappingURL=create-order-modal.element-DT7lcN0F.js.map
