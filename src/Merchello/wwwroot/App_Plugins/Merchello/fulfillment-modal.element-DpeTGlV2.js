import { nothing as d, html as o, css as S, state as h, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as $, UMB_MODAL_MANAGER_CONTEXT as z, UMB_CONFIRM_MODAL as C } from "@umbraco-cms/backoffice/modal";
import { M as _ } from "./merchello-api-DXy2hS5y.js";
import { b as M } from "./formatting-DbC6qaCT.js";
import "./product-image.element-D7HwAIKr.js";
var T = Object.defineProperty, O = Object.getOwnPropertyDescriptor, x = (t) => {
  throw TypeError(t);
}, c = (t, e, i, r) => {
  for (var s = r > 1 ? void 0 : r ? O(e, i) : e, a = t.length - 1, p; a >= 0; a--)
    (p = t[a]) && (s = (r ? p(e, i, s) : p(s)) || s);
  return r && s && T(e, i, s), s;
}, k = (t, e, i) => e.has(t) || x("Cannot " + i), g = (t, e, i) => (k(t, e, "read from private field"), e.get(t)), b = (t, e, i) => e.has(t) ? x("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), y = (t, e, i, r) => (k(t, e, "write to private field"), e.set(t, i), i), m, v;
let l = class extends $ {
  constructor() {
    super(), this._summary = null, this._isLoading = !0, this._errorMessage = null, this._isCreating = !1, this._shipmentsCreated = 0, this._selectedItems = /* @__PURE__ */ new Map(), this._orderTrackingInfo = /* @__PURE__ */ new Map(), this._expandedOrders = /* @__PURE__ */ new Set(), this._existingShipmentsExpanded = !1, b(this, m, !1), b(this, v), this.consumeContext(z, (t) => {
      y(this, v, t);
    });
  }
  connectedCallback() {
    super.connectedCallback(), y(this, m, !0), this._loadFulfillmentSummary();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), y(this, m, !1);
  }
  async _loadFulfillmentSummary() {
    this._isLoading = !0, this._errorMessage = null;
    const { data: t, error: e } = await _.getFulfillmentSummary(this.data.invoiceId);
    if (g(this, m)) {
      if (e) {
  ...
  async _createAllShipments() {
    ...
    for (const r of t) {
      ...
      }, { error: n } = await _.createShipment(r.orderId, u);
  ...
  async _deleteShipment(t) {
    ...
    const { error: r } = await _.deleteShipment(t);
    if (g(this, m)) {
      if (r) {
  ...
  _renderShipmentCard(t) {
    ...
    const i = this._expandedOrders.has(t.orderId), r = this._orderTrackingInfo.get(t.orderId), s = this._selectedItems.get(t.orderId) ?? /* @__PURE__ */ new Map(), a = this._getSelectedCount(t.orderId), p = this._getTotalSelectedQuantity(t.orderId), u = e.reduce((n, f) => n + f.remainingQuantity, 0);
    return o`
        ...
        >
          <div class="header-info">
            ...
            <span class="item-count">
              ${a > 0 ? `${p} of ${u} selected` : `${u} item${u !== 1 ? "s" : ""} to ship`}
            </span>
          </div>
      ...
      ({ shipment: e, warehouseName: i }) => o`
                    <div class="existing-shipment-card">
                      <div class="existing-shipment-header">
                        ...
                        ${e.trackingNumber ? o`<span class="tracking">${e.trackingNumber}</span>` : d}
...
//# sourceMappingURL=fulfillment-modal.element-DpeTGlV2.js.map
