...
let o = class extends S {
  ...
  _buildUpdateRequest(e) {
    const t = {};
    return this._selectedFields.includes("sku") && (t.sku = e.sku ?? ""), this._selectedFields.includes("gtin") && (t.gtin = e.gtin ?? ""), this._selectedFields.includes("supplierSku") && (t.supplierSku = e.supplierSku ?? ""), this._selectedFields.includes("hsCode") && (t.hsCode = e.hsCode ?? ""), this._selectedFields.includes("price") && (t.price = e.price), this._selectedFields.includes("previousPrice") && (t.previousPrice = e.previousPrice ?? void 0), this._selectedFields.includes("onSale") && (t.onSale = e.onSale), this._selectedFields.includes("costOfGoods") && (t.costOfGoods = e.costOfGoods), this._selectedFields.includes("availableForPurchase") && (t.availableForPurchase = e.availableForPurchase), this._selectedFields.includes("canPurchase") && (t.canPurchase = e.canPurchase), this._selectedFields.includes("trackStock") && (t.warehouseStock = e.warehouseStock.map((r) => ({
...
//# sourceMappingURL=variant-batch-update-modal.element-BkQdWfQN.js.map
