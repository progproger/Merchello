import { LitElement as P, nothing as o, html as r, css as x, state as v, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as M } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as b, UMB_MODAL_MANAGER_CONTEXT as k } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as C } from "@umbraco-cms/backoffice/notification";
import { M as p } from "./merchello-api-CoAMZUgg.js";
const w = new b("Merchello.PaymentProvider.Config.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), z = new b("Merchello.SetupInstructions.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var E = Object.defineProperty, A = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, c = (e, i, a, u) => {
  for (var n = u > 1 ? void 0 : u ? A(i, a) : i, f = e.length - 1, h; f >= 0; f--)
    (h = e[f]) && (n = (u ? h(i, a, n) : h(n)) || n);
  return u && n && E(i, a, n), n;
}, y = (e, i, a) => i.has(e) || _("Cannot " + a), s = (e, i, a) => (y(e, i, "read from private field"), i.get(e)), g = (e, i, a) => i.has(e) ? _("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), m = (e, i, a, u) => (y(e, i, "write to private field"), i.set(e, a), a), d, l;
let t = class extends M(P) {
  constructor() {
    super(), this._availableProviders = [], this._configuredProviders = [], this._isLoading = !0, this._errorMessage = null, g(this, d), g(this, l), this.consumeContext(k, (e) => {
      m(this, d, e);
  ...
  async _toggleProvider(e) {
    ...
    if (i) {
      s(this, l)?.peek("danger", {
        data: { headline: "Error", message: i.message }
      });
      return;
    }
    s(this, l)?.peek("positive", {
      data: {
        headline: "Success",
  ...
  _openSetupInstructions(e) {
    !s(this, d) || !e.setupInstructions || s(this, d).open(this, z, {
      data: {
      ...
      <div class="provider-card configured">
        ...
        <div class="provider-footer">
          <div class="provider-features">
            ...
            ${i?.supportsRefunds ? r`<span class="feature-badge">Refunds</span>` : o}
            ${i?.supportsPartialRefunds ? r`<span class="feature-badge">Partial Refunds</span>` : o}
            ${i?.usesRedirectCheckout ? r`<span class="feature-badge">Redirect Checkout</span>` : o}
            ${i?.supportsAuthAndCapture ? r`<span class="feature-badge">Auth & Capture</span>` : o}
          </div>
...
//# sourceMappingURL=payment-providers-list.element-Cif1w_7-.js.map
