import { LitElement as f, nothing as v, html as r, css as y, property as h, state as l, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as P } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as $, UMB_MODAL_MANAGER_CONTEXT as C } from "@umbraco-cms/backoffice/modal";
import { M as m } from "./merchello-api-B1skiL_A.js";
import { a as T, b as O } from "./navigation-m-G5wLvz.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { g as I } from "./variant-helpers-BWMAK-La.js";
import { a as b } from "./formatting-BB_-NCdW.js";
import { b as A } from "./badge.styles-DUcdl6GY.js";
const E = new $("Merchello.CreateProduct.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
...
var z = Object.defineProperty, L = Object.getOwnPropertyDescriptor, k = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? L(t, a) : t, c = e.length - 1, u; c >= 0; c--)
    (u = e[c]) && (i = (s ? u(t, a, i) : u(i)) || i);
  return s && i && z(t, a, i), i;
};
let g = class extends P(f) {
  constructor() {
...
var N = Object.defineProperty, R = Object.getOwnPropertyDescriptor, p = (e, t, a, s) => {
  for (var i = s > 1 ? void 0 : s ? R(t, a) : t, c = e.length - 1, u; c >= 0; c--)
    (u = e[c]) && (i = (s ? u(t, a, i) : u(i)) || i);
  return s && i && N(t, a, i), i;
};
let d = class extends P(f) {
  constructor() {
    super(...arguments), this.products = [], this.columns = [...D], this.selectable = !1, this.selectedIds = [], this.clickable = !0;
  }
  ...
  _renderHeaderCell(e) {
    return e === "select" ? r`
      ...
      ` : r`<uui-table-head-cell>${M[e]}</uui-table-head-cell>`;
  }
  _renderCell(e, t) {
    switch (t) {
      case "select":
      ...
      case "stock":
        return r`<uui-table-cell><span class="badge ${I(e.stockStatus)}">${e.totalStock}</span></uui-table-cell>`;
      case "variants":
...
let o = class extends P(f) {
  ...
  async _loadFilterOptions() {
    ...
    e.data && (this._productTypes = e.data), t.data && (this._collections = t.data);
  }
  async _loadProducts() {
    ...
    this._searchTerm.trim() && (e.search = this._searchTerm.trim()), this._productTypeId && (e.productTypeId = this._productTypeId), this._collectionId && (e.collectionId = this._collectionId), this._availability !== "all" && (e.availability = this._availability), this._stockStatus !== "all" && (e.stockStatus = this._stockStatus);
    const { data: t, error: a } = await m.getProducts(e);
    if (a) {
  ...
  _handleCollectionChange(e) {
    this._collectionId = e.target.value, this._page = 1, this._loadProducts();
  }
  ...
  async _handleAddProduct() {
    const t = await j(this, _)?.open(this, E, {
      data: {}
    })?.onSubmit().catch(() => {
    });
    t?.isCreated && t.productId && O(t.productId);
  }
  ...
  _getCollectionOptions() {
    return [
      ...
      ...this._collections.map((e) => ({ name: e.name, value: e.id, selected: this._collectionId === e.id }))
    ];
  }
...
//# sourceMappingURL=products-list.element-Nk0Ja1VL.js.map
