import { html as r, nothing as d, css as O, state as c, customElement as z } from "@umbraco-cms/backoffice/external/lit";
...
import { M as f } from "./merchello-api-C2InYbkz.js";
...
}, k = (e, i, o) => i.has(e) || $("Cannot " + o), m = (e, i, o) => (k(e, i, "read from private field"), i.get(e)), x = (e, i, o) => i.has(e) ? $("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, o), w = (e, i, o, t) => (k(e, i, "write to private field"), i.set(e, o), o), v, g;
let n = class extends R {
  constructor() {
    super(), this._invoice = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._editReason = "", this._orders = [], this._lineItems = [], this._customItems = [], this._taxGroups = [], this._removedShippingOrders = /* @__PURE__ */ new Set(), this._taxRemoved = !1, this._removedOrderDiscounts = /* @__PURE__ */ new Set(), this._pendingOrderDiscounts = [], this._previewResult = null, this._previewLoading = !1, x(this, v), x(this, g), this.consumeContext(I, (e) => {
      w(this, v, e);
  ...
  async _openLineItemDiscountModal(e) {
    if (!m(this, v) || !this._invoice) return;
    const i = this._lineItems.find((s) => s.id === e);
    if (!i) return;
    const t = await m(this, v).open(this, y, {
      data: {
  ...
  async _openAddDiscountModal() {
    if (!m(this, v) || !this._invoice) return;
    const i = await m(this, v).open(this, y, {
      data: {
        currencySymbol: this._invoice.currencySymbol,
        isOrderDiscount: !0
      }
  ...
  async _openAddCustomItemModal() {
    if (!m(this, v) || !this._invoice) return;
    const i = await m(this, v).open(this, P, {
      data: {
        currencySymbol: this._invoice.currencySymbol,
...
//# sourceMappingURL=edit-order-modal.element-DTWh4ZYV.js.map
