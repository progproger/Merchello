import { LitElement as k, nothing as D, html as o, css as S, property as v, customElement as T, state as r } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as x } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as A, UMB_MODAL_MANAGER_CONTEXT as E, UMB_CONFIRM_MODAL as z } from "@umbraco-cms/backoffice/modal";
...
import { M as $ } from "./merchello-api-Cd16th0c.js";
import { g as P } from "./store-settings-Dmd0ngDF.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import { e as I } from "./formatting-CbhqdYyc.js";
import { f as O, h as U, i as N } from "./navigation-DfYj5Lv5.js";
import { b as B } from "./badge.styles-B9Lnx6kD.js";
var R = Object.defineProperty, G = Object.getOwnPropertyDescriptor, g = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? G(t, i) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (a = (s ? d(t, i, a) : d(a)) || a);
  return s && a && R(t, i, a), a;
};
let p = class extends x(k) {
  constructor() {
    super(...arguments), this.discounts = [], this.selectable = !1, this.selectedIds = [], this.clickable = !0;
  }
  _handleSelectAll(e) {
    const i = e.target.checked ? this.discounts.map((s) => s.id) : [];
    this._dispatchSelectionChange(i);
  }
  _handleSelectDiscount(e, t) {
    t.stopPropagation();
    const s = t.target.checked ? [...this.selectedIds, e] : this.selectedIds.filter((a) => a !== e);
  ...
  _isAnchorClick(e) {
    return e.composedPath().find((i) => {
      const s = typeof SVGAElement < "u" && i instanceof SVGAElement;
      return i instanceof HTMLAnchorElement || s;
    }) !== void 0;
  }
  _handleRowClick(e, t) {
    if (!this.clickable || this._isAnchorClick(e)) return;
    const i = { discountId: t.id, discount: t };
    this.dispatchEvent(
    ...
    return o`
      ...
      (e) => o`
            <uui-table-row
              ...
              @click=${(t) => this._handleRowClick(t, e)}
            >
              ${this.selectable ? o`
              ...
              <uui-table-cell class="method-cell">
                ...
                ${e.method === C.Automatic ? "Auto" : "Code"}
              </uui-table-cell>
...
const H = new A("Merchello.SelectDiscountType.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var V = Object.defineProperty, W = Object.getOwnPropertyDescriptor, w = (e) => {
  throw TypeError(e);
}, c = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? W(t, i) : t, u = e.length - 1, d; u >= 0; u--)
    (d = e[u]) && (a = (s ? d(t, i, a) : d(a)) || a);
  return s && a && V(t, i, a), a;
}, M = (e, t, i) => t.has(e) || w("Cannot " + i), n = (e, t, i) => (M(e, t, "read from private field"), t.get(e)), y = (e, t, i) => t.has(e) ? w("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), f = (e, t, i, s) => (M(e, t, "write to private field"), t.set(e, i), i), b, _, h;
let l = class extends x(k) {
  constructor() {
    super(), this._discounts = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedDiscounts = /* @__PURE__ */ new Set(), this._searchTerm = "", this._isDeleting = !1, this._searchDebounceTimer = null, y(this, b), y(this, _), y(this, h, !1), this.consumeContext(E, (e) => {
      f(this, b, e);
  ...
  async _loadDiscounts() {
    ...
    const { data: t, error: i } = await $.getDiscounts(e);
    if (n(this, h)) {
      if (i) {
  ...
  _handleSearchInput(e) {
    ...
    this._searchDebounceTimer && clearTimeout(this._searchDebounceTimer), this._searchDebounceTimer = setTimeout(() => {
      this._searchTerm = i, this._page = 1, this._loadDiscounts();
    }, 300);
  }
  _handleSearchClear() {
  ...
  async _handleDeleteSelected() {
    ...
    if (!n(this, h)) return;
    this._isDeleting = !0;
    const i = Array.from(this._selectedDiscounts);
    let s = 0, a = 0;
    for (const u of i) {
      const { error: d } = await $.deleteDiscount(u);
      if (!n(this, h)) return;
      d ? a++ : s++;
    }
    this._isDeleting = !1, a > 0 ? n(this, _)?.peek("warning", {
  ...
  async _handleCreateDiscount() {
    if (!n(this, b)) return;
    const t = await n(this, b).open(this, H, {
      data: {}
    }).onSubmit().catch(() => {
    });
    n(this, h) && t?.selectedCategory !== void 0 && U(t.selectedCategory);
  }
...
//# sourceMappingURL=discounts-list.element-2aBDVqFR.js.map
