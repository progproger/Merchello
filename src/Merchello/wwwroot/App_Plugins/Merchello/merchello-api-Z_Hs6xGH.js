...
async function r(e) {
  try {
    const t = await $(), s = d.baseUrl || "", o = await fetch(`${s}${l}/${e}`, {
      method: "GET",
...
async function n(e, t) {
  try {
    const s = await $(), o = d.baseUrl || "", a = await fetch(`${o}${l}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: s,
...
const m = {
   ...
   */
  getVariantsByIds: (e) => n("products/variants/by-ids", e),
  // Options operations
   ...
   */
  previewAddonPrice: (e, t) => n(`products/variants/${e}/preview-addon-price`, t),
  // ============================================
...
//# sourceMappingURL=merchello-api-Z_Hs6xGH.js.map
