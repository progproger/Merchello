import { LitElement as S, html as s, nothing as c, css as x, state as u, customElement as O } from "@umbraco-cms/backoffice/external/lit";
...
import { M as m } from "./merchello-api-Cd16th0c.js";
import { M as A } from "./supplier-modal.token-CWeQ_zlc.js";
import { M } from "./product-picker-modal.token-BfbHsSHl.js";
import { D as E, E as L, F as P } from "./navigation-DfYj5Lv5.js";
import { b as z } from "./badge.styles-B9Lnx6kD.js";
import { a as F } from "./formatting-CbhqdYyc.js";
import "./product-table.element-ItNuUuOy.js";
...
}, D = (e, t, a) => t.has(e) || C("Cannot " + a), i = (e, t, a) => (D(e, t, "read from private field"), t.get(e)), _ = (e, t, a) => t.has(e) ? C("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), v = (e, t, a, d) => (D(e, t, "write to private field"), t.set(e, a), a), b, p, g, h, r;
function G() {
  return {
    name: null,
    email: null,
...
let o = class extends T(S) {
  ...
  _handleAddressChange(e, t) {
    const a = this._formData.address ?? G();
    this._formData = {
      ...this._formData,
      address: {
        ...a,
...
//# sourceMappingURL=warehouse-detail.element-BO5O5w3P.js.map
