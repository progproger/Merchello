...
import { d as ie, p as ke } from "./purify.es-Cuv6u9x0.js";
...
import { b as N, a as h, g as Se } from "./formatting-BoIk_URG.js";
...
var Ee = Object.defineProperty, De = Object.getOwnPropertyDescriptor, le = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? De(i, t) : i, u = e.length - 1, p; u >= 0; u--)
    (p = e[u]) && (r = (s ? p(i, t, r) : p(r)) || r);
  return s && r && Ee(i, t, r), r;
}, ue = (e, i, t) => i.has(e) || le("Cannot " + t), d = (e, i, t) => (ue(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? le("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), B = (e, i, t, s) => (ue(e, i, "write to private field"), i.set(e, t), t), P, E, x, w;
let b = class extends Y(q) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, this._hasOutstandingBalance = !1, this._paymentStatusDisplay = "", this._balanceDue = 0, this._currencyCode = "", this._currencySymbol = "", W(this, P), W(this, E), W(this, x), W(this, w, !1), this.consumeContext(oe, (e) => {
...
var Oe = Object.defineProperty, Te = Object.getOwnPropertyDescriptor, de = (e) => {
  throw TypeError(e);
}, R = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? Te(i, t) : i, u = e.length - 1, p; u >= 0; u--)
    (p = e[u]) && (r = (s ? p(i, t, r) : p(r)) || r);
  return s && r && Oe(i, t, r), r;
}, ce = (e, i, t) => i.has(e) || de("Cannot " + t), O = (e, i, t) => (ce(e, i, "read from private field"), i.get(e)), ae = (e, i, t) => i.has(e) ? de("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, s) => (ce(e, i, "write to private field"), i.set(e, t), t), D, F;
let M = class extends Y(q) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, ae(this, D), ae(this, F, !1), this.consumeContext(ee, (e) => {
      Q(this, D, e);
    });
  }
  connectedCallback() {
  ...
  async _openManualPaymentModal() {
    if (!O(this, D) || !this._status) return;
    (await O(this, D).open(this, Le, {
      data: {
...
var Fe = Object.defineProperty, Ne = Object.getOwnPropertyDescriptor, pe = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? Ne(i, t) : i, u = e.length - 1, p; u >= 0; u--)
    (p = e[u]) && (r = (s ? p(i, t, r) : p(r)) || r);
  return s && r && Fe(i, t, r), r;
}, me = (e, i, t) => i.has(e) || pe("Cannot " + t), T = (e, i, t) => (me(e, i, "read from private field"), i.get(e)), Re = (e, i, t) => i.has(e) ? pe("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), re = (e, i, t, s) => (me(e, i, "write to private field"), i.set(e, t), t), S;
...
var Ue = Object.defineProperty, Be = Object.getOwnPropertyDescriptor, he = (e) => {
  ...
  for (var r = s > 1 ? void 0 : s ? Be(i, t) : i, u = e.length - 1, p; u >= 0; u--)
    (p = e[u]) && (r = (s ? p(i, t, r) : p(r)) || r);
...
let c = class extends Y(q) {
      ...
      <div class="card fulfillment-card">
        ...
        <div class="fulfillment-shipping-method">
          ...
          <div class="fulfillment-shipping-details">
            ...
            <span class="fulfillment-shipping-cost ${e.shippingCost === 0 ? "free-shipping" : ""}">${e.shippingCost === 0 ? "FREE" : h(e.shippingCost, t, s)}</span>
          </div>
        </div>
  ...
  _getFulfillmentLineItemRows(e) {
    const i = e.filter((m) => this._isAddonLineItem(m)), t = e.filter((m) => !this._isAddonLineItem(m)), s = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map();
    i.forEach((m) => {
      const I = m.parentLineItemId?.trim();
      if (I) {
        const H = s.get(I);
        H ? H.push(m) : s.set(I, [m]);
        return;
      }
    ...
    return t.forEach((m) => {
      u.push({ item: m, isChild: !1 });
      const I = (m.childLineItems ?? []).filter((A) => this._isAddonLineItem(A)), L = m.id?.trim(), U = m.sku?.trim(), H = L ? s.get(L) ?? [] : [], ge = U ? r.get(U) ?? [] : [];
      [...I, ...H, ...ge].filter((A, fe, be) => be.findIndex((ye) => ye.id === A.id) === fe).forEach((A) => {
        u.push({ item: A, isChild: !0 }), p.add(A.id);
      });
    }), i.forEach((m) => {
      p.has(m.id) || u.push({ item: m, isChild: !1 });
    }), u;
  }
  ...
  _renderFulfillmentLineItem(e, i, t, s) {
    const r = i || this._isAddonLineItem(e), u = this._resolveFulfillmentMediaKey(e, i), p = r ? [] : e.selectedOptions ?? [], m = r ? e.name || e.productRootName || "Add-on" : e.productRootName || e.name || "Unknown item", I = r ? "+" : "";
    return a`
      <div class="fulfillment-line-item ${r ? "is-addon" : ""}">
        ...
        <div class="fulfillment-item-pricing">
          <span class="fulfillment-item-price">${I}${h(e.amount, t, s)}</span>
          <span class="fulfillment-item-multiply">x</span>
          <span class="fulfillment-item-qty">${e.quantity}</span>
        </div>
        <div class="fulfillment-item-total">${I}${h(e.calculatedTotal, t, s)}</div>
      </div>
    `;
  }
...
//# sourceMappingURL=order-detail.element-DNkdFnf7.js.map
