import { LitElement as z, nothing as n, html as s, css as E, property as I, customElement as A, state as d } from "@umbraco-cms/backoffice/external/lit";
...
import { UmbModalToken as B, UMB_MODAL_MANAGER_CONTEXT as G, UMB_CONFIRM_MODAL as oe } from "@umbraco-cms/backoffice/modal";
import { f as H, a as y, b as K, g as j, D, e as f, h as v, i as l, d as W, c as ne } from "./discount.types-YWYxoniA.js";
import { M as x } from "./merchello-api-BxVn4Zbt.js";
import { t as ue, u as le, v as ce } from "./navigation-m-G5wLvz.js";
import { a as de, c as F } from "./formatting-BerPqESs.js";
import { M as pe } from "./customer-picker-modal.token-BZSMisS9.js";
import { M as he } from "./product-picker-modal.token-BfbHsSHl.js";
import { M as me } from "./collection-picker-modal.token-DEqocfk-.js";
import { M as ge } from "./product-type-picker-modal.token-BIXbr0YK.js";
import { M as ve } from "./filter-picker-modal.token-DlO79hNz.js";
var ye = Object.defineProperty, be = Object.getOwnPropertyDescriptor, V = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? be(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && ye(t, i, r), r;
};
let R = class extends O(z) {
  constructor() {
  ...
  _formatValue() {
    return this.discount ? this.discount.valueType === y.Percentage ? `${this.discount.value}% off` : this.discount.valueType === y.FixedAmount ? `${this.discount.value} off` : this.discount.valueType === y.Free ? "Free" : "" : "";
  }
  _formatDate(e) {
...
var _e = Object.defineProperty, fe = Object.getOwnPropertyDescriptor, $ = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? fe(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && _e(t, i, r), r;
};
let C = class extends O(z) {
  constructor() {
...
const Ce = new B("Merchello.SegmentPicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var $e = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, Y = (e) => {
  throw TypeError(e);
}, U = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? xe(t, i) : t, u = e.length - 1, o; u >= 0; u--)
    (o = e[u]) && (r = (a ? o(t, i, r) : o(r)) || r);
  return a && r && $e(t, i, r), r;
}, X = (e, t, i) => t.has(e) || Y("Cannot " + i), L = (e, t, i) => (X(e, t, "read from private field"), t.get(e)), De = (e, t, i) => t.has(e) ? Y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Te = (e, t, i, a) => (X(e, t, "write to private field"), t.set(e, i), i), w;
const Q = [
...
let P = class extends O(z) {
  constructor() {
    super(), this.rules = [], this.readonly = !1, De(this, w), this.consumeContext(G, (e) => {
      Te(this, w, e);
    });
  }
  _dispatchChange() {
  ...
  async _openCustomerPicker(e, t) {
    if (!L(this, w)) return;
    const a = await L(this, w).open(this, pe, {
      data: {
  ...
  async _openSegmentPicker(e, t) {
    if (!L(this, w)) return;
    const a = await L(this, w).open(this, Ce, {
      data: {
...
const Ie = new B("Merchello.SupplierPicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), Pe = new B("Merchello.WarehousePicker.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
}, J = (e, t, i) => t.has(e) || Z("Cannot " + i), _ = (e, t, i) => (J(e, t, "read from private field"), t.get(e)), Re = (e, t, i) => t.has(e) ? Z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), ze = (e, t, i, a) => (J(e, t, "write to private field"), t.set(e, i), i), h;
const ee = [
...
let S = class extends O(z) {
  constructor() {
    super(), this.rules = [], this.readonly = !1, Re(this, h), this.consumeContext(G, (e) => {
      ze(this, h, e);
    });
  }
  _dispatchChange() {
  ...
  async _openProductPicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, he, {
      data: {
        config: {
          currencySymbol: "",
  ...
  async _openCollectionPicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, me, {
      data: {
  ...
  async _openProductTypePicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, ge, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openSupplierPicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, Ie, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openWarehousePicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, Pe, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
  ...
  async _openFilterPicker(e, t) {
    if (!_(this, h)) return;
    const a = await _(this, h).open(this, ve, {
      data: {
...
}, ie = (e, t, i) => t.has(e) || te("Cannot " + i), c = (e, t, i) => (ie(e, t, "read from private field"), i ? i.call(e) : t.get(e)), M = (e, t, i) => t.has(e) ? te("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), k = (e, t, i, a) => (ie(e, t, "write to private field"), t.set(e, i), i), m, g, N, T;
let p = class extends O(z) {
  constructor() {
    super(), this._isNew = !0, this._isLoading = !0, this._isSaving = !1, this._validationErrors = /* @__PURE__ */ new Map(), this._codeAvailable = null, this._isGeneratingCode = !1, this._targetRules = [], this._eligibilityRules = [], this._routes = [], this._activePath = "", M(this, m), M(this, g), M(this, N), M(this, T), this._initRoutes(), this.consumeContext(se, (e) => {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), c(this, T) && (clearTimeout(c(this, T)), k(this, T, void 0));
  }
  // ============================================
  // Router Methods
  // ============================================
  ...
  _getValueTypeOptions() {
    const e = [
      { name: "Percentage", value: y.Percentage, selected: this._discount?.valueType === y.Percentage },
      { name: "Fixed amount", value: y.FixedAmount, selected: this._discount?.valueType === y.FixedAmount }
    ];
    return this._discount?.category === W.BuyXGetY && e.push({ name: "Free", value: y.Free, selected: this._discount?.valueType === y.Free }), e;
  }
  ...
  _handleCodeInput(e) {
    ...
    this._handleInputChange("code", i || null), c(this, T) && clearTimeout(c(this, T)), i ? k(this, T, setTimeout(() => {
   ...
   */
  _validate() {
    return this._validationErrors.clear(), this._discount?.name?.trim() || this._validationErrors.set("name", "Name is required"), this._discount?.method === D.Code && !this._discount.code?.trim() && this._validationErrors.set("code", "Code is required for code-based discounts"), this.requestUpdate(), this._validationErrors.size === 0;
  }
  async _handleSave() {
  ...
  async _handleDelete() {
    if (!this._discount?.id || !await c(this, N)?.open(this, oe, {
      data: {
        ...
        <div class="form-grid">
          <umb-property-layout label="Value Type">
            <uui-select
              ...
              .value=${this._discount?.valueType ?? y.Percentage}
              @change=${(e) => this._handleInputChange("valueType", e.target.value)}
            ></uui-select>
          </umb-property-layout>

          ${this._discount?.valueType !== y.Free ? s`
                <umb-property-layout
                  label=${this._discount?.valueType === y.Percentage ? "Percentage (%)" : "Amount"}
                  ?mandatory=${!0}
                  ...
                  <uui-input
                    ...
                    type="number"
                    min="0"
                    max=${this._discount?.valueType === y.Percentage ? "100" : ""}
                    step="0.01"
        ...
        <div class="form-grid">
          <umb-property-layout label="Requirement Type">
            <uui-select
              ...
              .value=${this._discount?.requirementType ?? f.None}
...
//# sourceMappingURL=discount-detail.element-DQeVREQo.js.map
