import { LitElement as q, nothing as s, html as a, css as K, state as n, customElement as X, property as se, unsafeHTML as ye } from "@umbraco-cms/backoffice/external/lit";
...
import { M as xe } from "./edit-order-modal.token-BUHVPYdq.js";
import { M as Ce, a as we } from "./customer-orders-modal.token-BBooCVRJ.js";
import { b as N, a as h, h as Se } from "./formatting-DPh4-DfL.js";
import { M as g } from "./merchello-api-DFeoGYDY.js";
import { q as ze } from "./navigation-BGhEgega.js";
import { S as J, P as te } from "./order.types-_o7xLk2Z.js";
import "./line-item-identity.element-DGDuhyV5.js";
const Ie = new G("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), Pe = new G("Merchello.CancelInvoice.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
...
var Ee = Object.defineProperty, Le = Object.getOwnPropertyDescriptor, le = (e) => {
  throw TypeError(e);
}, M = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Le(i, t) : i, l = e.length - 1, p; l >= 0; l--)
    (p = e[l]) && (r = (o ? p(i, t, r) : p(r)) || r);
  return o && r && Ee(i, t, r), r;
}, ue = (e, i, t) => i.has(e) || le("Cannot " + t), d = (e, i, t) => (ue(e, i, "read from private field"), i.get(e)), j = (e, i, t) => i.has(e) ? le("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), B = (e, i, t, o) => (ue(e, i, "write to private field"), i.set(e, t), t), z, E, x, k;
let w = class extends Y(q) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, j(this, z), j(this, E), j(this, x), j(this, k, !1), this.consumeContext(oe, (e) => {
      B(this, z, e), d(this, z) && this.observe(d(this, z).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), B(this, k, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), B(this, k, !1);
  }
  async _loadShipments() {
    if (!this._invoiceId) return;
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: i } = await g.getFulfillmentSummary(this._invoiceId);
    d(this, k) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  ...
  async _handleDeleteShipment(e) {
    ...
    if (d(this, k)) {
      ...
      this._loadShipments(), this._invoiceId && d(this, z)?.load(this._invoiceId);
    }
  }
  ...
  async _handleMarkAsShipped(e) {
    ...
    if (d(this, k)) {
      ...
      }), this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._loadShipments(), this._invoiceId && d(this, z)?.load(this._invoiceId);
    }
  }
...
const Ae = new G("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), De = new G("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var Oe = Object.defineProperty, Te = Object.getOwnPropertyDescriptor, de = (e) => {
  ...
  for (var r = o > 1 ? void 0 : o ? Te(i, t) : i, l = e.length - 1, p; l >= 0; l--)
    (p = e[l]) && (r = (o ? p(i, t, r) : p(r)) || r);
  return o && r && Oe(i, t, r), r;
}, ce = (e, i, t) => i.has(e) || de("Cannot " + t), O = (e, i, t) => (ce(e, i, "read from private field"), i.get(e)), ae = (e, i, t) => i.has(e) ? de("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (ce(e, i, "write to private field"), i.set(e, t), t), L, F;
let P = class extends Y(q) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, ae(this, L), ae(this, F, !1), this.consumeContext(Z, (e) => {
      Q(this, L, e);
    });
  }
  connectedCallback() {
  ...
  async _openManualPaymentModal() {
    if (!O(this, L) || !this._status) return;
    (await O(this, L).open(this, Ae, {
      data: {
...
R([
  se({ type: String })
], P.prototype, "invoiceId", 2);
R([
  n()
], P.prototype, "_payments", 2);
R([
  n()
...
}, me = (e, i, t) => i.has(e) || pe("Cannot " + t), T = (e, i, t) => (me(e, i, "read from private field"), i.get(e)), Re = (e, i, t) => i.has(e) ? pe("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), re = (e, i, t, o) => (me(e, i, "write to private field"), i.set(e, t), t), C;
let y = class extends Y(q) {
  constructor() {
    super(...arguments), this.invoiceId = "", this._providers = [], this._linkInfo = null, this._selectedProvider = "", this._isLoading = !0, this._isGenerating = !1, this._isDeactivating = !1, this._errorMessage = null, this._copySuccess = !1, Re(this, C, !1);
  }
  connectedCallback() {
    super.connectedCallback(), re(this, C, !0), this.invoiceId && this._loadData();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), re(this, C, !1);
  }
  updated(e) {
...
S([
  n()
], y.prototype, "_providers", 2);
S([
  n()
], y.prototype, "_linkInfo", 2);
S([
  n()
], y.prototype, "_selectedProvider", 2);
S([
  n()
], y.prototype, "_isLoading", 2);
S([
  n()
], y.prototype, "_isGenerating", 2);
S([
  n()
], y.prototype, "_isDeactivating", 2);
S([
  n()
], y.prototype, "_errorMessage", 2);
S([
  n()
], y.prototype, "_copySuccess", 2);
y = S([
...
}, ve = (e, i, t) => i.has(e) || he("Cannot " + t), u = (e, i, t) => (ve(e, i, "read from private field"), i.get(e)), W = (e, i, t) => i.has(e) ? he("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), V = (e, i, t, o) => (ve(e, i, "write to private field"), i.set(e, t), t), b, f, _, $;
let c = class extends Y(q) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, W(this, b), W(this, f), W(this, _), W(this, $, !1), this.consumeContext(oe, (e) => {
      V(this, b, e), u(this, b) && this.observe(u(this, b).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), V(this, $, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  async _openFulfillmentModal() {
    if (!this._order || !u(this, f)) return;
    const e = this._order.id;
    await u(this, f).open(this, Ie, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), u(this, $) && u(this, b)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !u(this, f)) return;
    const e = this._order.id;
    await u(this, f).open(this, xe, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), u(this, $) && u(this, b)?.load(e);
  }
  async _openCancelInvoiceModal() {
    if (!this._order || !u(this, f)) return;
    const i = await u(this, f).open(this, Pe, {
      data: {
    ...
    u(this, $) && i?.cancelled && (u(this, _)?.peek("positive", {
      data: {
  ...
  async _saveEditing() {
    ...
    if (u(this, $)) {
      ...
      u(this, _)?.peek("positive", {
        data: { headline: "Address updated", message: "Changes have been saved successfully" }
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, u(this, b)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (u(this, $)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", u(this, b)?.load(this._order.id);
    }
  }
  ...
  _getFulfillmentLineItemRows(e) {
    ...
    i.forEach((m) => {
      ...
      const A = m.parentLineItemSku?.trim();
      if (!A) return;
      const U = r.get(A);
      U ? U.push(m) : r.set(A, [m]);
    });
    const l = [], p = /* @__PURE__ */ new Set();
    return t.forEach((m) => {
      l.push({ item: m, isChild: !1 });
      const I = (m.childLineItems ?? []).filter((D) => this._isAddonLineItem(D)), A = m.id?.trim(), U = m.sku?.trim(), H = A ? o.get(A) ?? [] : [], ge = U ? r.get(U) ?? [] : [];
      [...I, ...H, ...ge].filter((D, fe, be) => be.findIndex((_e) => _e.id === D.id) === fe).forEach((D) => {
        l.push({ item: D, isChild: !0 }), p.add(D.id);
      });
    }), i.forEach((m) => {
  ...
  _handlePaymentChange() {
    this._order && u(this, b)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (u(this, $)) {
      if (this._isPostingNote = !1, e) {
        this._noteError = e.message || "Failed to post note", u(this, _)?.peek("danger", {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, u(this, b)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
//# sourceMappingURL=order-detail.element-dCdt8fG5.js.map
