import { nothing as p, html as c, css as m, state as u, customElement as h } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as g } from "@umbraco-cms/backoffice/modal";
import { M as f } from "./merchello-api-D-qg1PlO.js";
var _ = Object.defineProperty, v = Object.getOwnPropertyDescriptor, d = (e, a, t, o) => {
  for (var r = o > 1 ? void 0 : o ? v(a, t) : a, n = e.length - 1, s; n >= 0; n--)
    (s = e[n]) && (r = (o ? s(a, t, r) : s(r)) || r);
  return o && r && _(a, t, r), r;
};
let i = class extends g {
  ...
  async _handleGenerate() {
    ...
    const { periodStart: a, periodEnd: t } = this._getDateRange(), { blob: o, filename: r, error: n } = await f.downloadCustomerStatement(
      e,
      a,
      t
    );
    if (this._isGenerating = !1, n || !o) {
      this._error = n?.message ?? "Failed to generate statement";
      return;
    }
    const s = URL.createObjectURL(o), l = document.createElement("a");
    l.href = s, l.download = r ?? "statement.pdf", document.body.appendChild(l), l.click(), document.body.removeChild(l), URL.revokeObjectURL(s), this.value = { downloaded: !0 }, this.modalContext?.submit();
  }
  _handleCancel() {
...
i = d([
  h("merchello-generate-statement-modal")
], i);
const y = i;
export {
...
//# sourceMappingURL=generate-statement-modal.element-CSemwgLY.js.map
