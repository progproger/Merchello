import { LitElement as x, html as c, css as T, state as o, customElement as C } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as S } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as f, UMB_MODAL_MANAGER_CONTEXT as w, UMB_CONFIRM_MODAL as k } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as $ } from "@umbraco-cms/backoffice/notification";
import { M as g } from "./merchello-api-Dp_zU_yi.js";
import { g as M } from "./store-settings-CHgA9WE7.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-D2dcD7_8.js";
import "./order-table.element-rVipQ1aN.js";
import { M as z } from "./edit-order-modal.token-BUHVPYdq.js";
import { n as b, a as D } from "./navigation-CvTcY6zJ.js";
import { a as E } from "./formatting-B_f6AiQh.js";
const L = new f("Merchello.Export.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), I = new f("Merchello.CreateOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
...
var A = Object.defineProperty, P = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var l = n > 1 ? void 0 : n ? P(t, i) : t, _ = e.length - 1, m; _ >= 0; _--)
    (m = e[_]) && (l = (n ? m(t, i, l) : m(l)) || l);
  return n && l && A(t, i, l), l;
...
//# sourceMappingURL=orders-list.element-xI-ifrn6.js.map
