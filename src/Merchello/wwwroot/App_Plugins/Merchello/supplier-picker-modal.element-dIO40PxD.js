...
var g = Object.defineProperty, y = Object.getOwnPropertyDescriptor, p = (e) => {
  ...
  for (var s = i > 1 ? void 0 : i ? y(t, l) : t, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (s = (i ? n(t, l, s) : n(s)) || s);
  return i && s && g(t, l, s), s;
}, _ = (e, t, l) => t.has(e) || p("Cannot " + l), x = (e, t, l) => (_(e, t, "read from private field"), t.get(e)), S = (e, t, l) => t.has(e) ? p("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, l), h = (e, t, l, i) => (_(e, t, "write to private field"), t.set(e, l), l), o;
let a = class extends m {
  ...
  async _loadSuppliers() {
    ...
    const { data: e, error: t } = await v.getSuppliers();
    if (!x(this, o)) return;
    if (t) {
    ...
    this._suppliers = (e ?? []).filter((i) => !l.includes(i.id)), this._isLoading = !1;
  }
  _toggleSelection(e) {
    const t = this.data?.multiSelect !== !1;
    if (this._selectedIds.includes(e.id)) {
      const l = this._selectedIds.indexOf(e.id);
      this._selectedIds = this._selectedIds.filter((i, s) => s !== l), this._selectedNames = this._selectedNames.filter((i, s) => s !== l);
    } else
...
//# sourceMappingURL=supplier-picker-modal.element-dIO40PxD.js.map
