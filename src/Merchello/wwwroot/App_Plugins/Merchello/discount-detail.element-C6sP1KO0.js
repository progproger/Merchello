import { LitElement as z, nothing as n, html as s, css as E, property as T, customElement as A, state as d } from "@umbraco-cms/backoffice/external/lit";
...
import { e as V, b, c as D, a as f, f as v, g as c, D as q, d as oe } from "./discount.types-Du4rtOaW.js";
import { M as x } from "./merchello-api-LENiBVrz.js";
import { g as re } from "./store-settings-Biy0PIJu.js";
import { v as ne, w as ue, x as le } from "./navigation-COkStlQk.js";
import { a as ce, c as W } from "./formatting-CeWY__1B.js";
...
var be = Object.defineProperty, _e = Object.getOwnPropertyDescriptor, G = (e, t, i, a) => {
  for (var o = a > 1 ? void 0 : a ? _e(t, i) : t, u = e.length - 1, r; u >= 0; u--)
    (r = e[u]) && (o = (a ? r(t, i, o) : r(o)) || o);
  return a && o && be(t, i, o), o;
};
...
let C = class extends L(z) {
  ...
  render() {
    return this._isLoading ? this._renderLoading() : this._error ? this._renderError() : !this._performance || this._performance.totalUsageCount === 0 ? this._renderEmptyState() : s`
      ...
      "Total Uses",
      W(this._performance.totalUsageCount),
      "icon-users",
      "var(--uui-color-positive)"
    )}
          ${this._renderMetricCard(
      "Unique Customers",
      W(this._performance.uniqueCustomersCount),
      "icon-user",
            ...
            ${this._performance.remainingUses !== null && this._performance.remainingUses !== void 0 ? s`
                  <div class="revenue-item">
                    ...
                    <span class="revenue-value ${this._performance.remainingUses === 0 ? "exhausted" : ""}">
                      ${W(this._performance.remainingUses)}
                    </span>
                  </div>
                ` : n}
          </div>
...
}, X = (e, t, i) => t.has(e) || Y("Cannot " + i), _ = (e, t, i) => (X(e, t, "read from private field"), t.get(e)), ke = (e, t, i) => t.has(e) ? Y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Re = (e, t, i, a) => (X(e, t, "write to private field"), t.set(e, i), i), m;
const Q = [
...
let S = class extends L(z) {
  ...
  async _openWarehousePicker(e, t) {
    if (!_(this, m)) return;
    const a = await _(this, m).open(this, Te, {
      data: {
        excludeIds: t.targetIds ?? [],
        multiSelect: !0
      }
...
}, J = (e, t, i) => t.has(e) || Z("Cannot " + i), l = (e, t, i) => (J(e, t, "read from private field"), t.get(e)), O = (e, t, i) => t.has(e) ? Z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), k = (e, t, i, a) => (J(e, t, "write to private field"), t.set(e, i), i), p, g, M, w;
let h = class extends L(z) {
  constructor() {
    super(), this._isNew = !0, this._isLoading = !0, this._isSaving = !1, this._validationErrors = /* @__PURE__ */ new Map(), this._codeAvailable = null, this._isGeneratingCode = !1, this._targetRules = [], this._eligibilityRules = [], this._discountCodeLength = 8, this._routes = [], this._activePath = "", O(this, p), O(this, g), O(this, M), O(this, w), this._initRoutes(), this._loadSettings(), this.consumeContext(te, (e) => {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), l(this, w) && (clearTimeout(l(this, w)), k(this, w, void 0));
  }
  async _loadSettings() {
    const e = await re();
  ...
  _getValueTypeOptions() {
    ...
    return this._discount?.category === q.BuyXGetY && e.push({ name: "Free", value: b.Free, selected: this._discount?.valueType === b.Free }), e;
  }
  ...
  _handleCodeInput(e) {
    ...
    this._handleInputChange("code", i || null), l(this, w) && clearTimeout(l(this, w)), i ? k(this, w, setTimeout(() => {
...
//# sourceMappingURL=discount-detail.element-C6sP1KO0.js.map
