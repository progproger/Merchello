...
import { m as C } from "./modal-layout.styles-C2OaUji5.js";
var v = Object.defineProperty, y = Object.getOwnPropertyDescriptor, p = (e) => {
  throw TypeError(e);
}, r = (e, t, l, i) => {
  for (var a = i > 1 ? void 0 : i ? y(t, l) : t, d = e.length - 1, u; d >= 0; d--)
    (u = e[d]) && (a = (i ? u(t, l, a) : u(a)) || a);
  return i && a && v(t, l, a), a;
}, _ = (e, t, l) => t.has(e) || p("Cannot " + l), S = (e, t, l) => (_(e, t, "read from private field"), t.get(e)), x = (e, t, l) => t.has(e) ? p("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, l), h = (e, t, l, i) => (_(e, t, "write to private field"), t.set(e, l), l), n;
let s = class extends f {
  constructor() {
    super(...arguments), this._selectedIds = [], this._collections = [], this._isLoading = !0, this._errorMessage = null, this._searchTerm = "", x(this, n, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=collection-picker-modal.element-B8hD2RCU.js.map
