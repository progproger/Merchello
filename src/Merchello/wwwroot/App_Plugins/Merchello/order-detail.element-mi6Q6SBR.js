import { LitElement as W, nothing as s, html as a, css as K, state as n, customElement as X, property as se, unsafeHTML as _e } from "@umbraco-cms/backoffice/external/lit";
...
}, de = (e, i, t) => i.has(e) || le("Cannot " + t), u = (e, i, t) => (de(e, i, "read from private field"), i.get(e)), j = (e, i, t) => i.has(e) ? le("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), V = (e, i, t, o) => (de(e, i, "write to private field"), i.set(e, t), t), z, E, b, x;
let w = class extends Y(W) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, j(this, z), j(this, E), j(this, b), j(this, x, !1), this.consumeContext(oe, (e) => {
      V(this, z, e), u(this, z) && this.observe(u(this, z).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), V(this, x, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), V(this, x, !1);
  }
  async _loadShipments() {
    if (!this._invoiceId) return;
    this._isLoading = !0, this._errorMessage = null;
    const { data: e, error: i } = await g.getFulfillmentSummary(this._invoiceId);
    u(this, x) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  ...
  async _copyToClipboard(e) {
    try {
      await navigator.clipboard.writeText(e), u(this, b)?.peek("positive", {
...
var Te = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, ue = (e) => {
  throw TypeError(e);
}, R = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Oe(i, t) : i, l = e.length - 1, p; l >= 0; l--)
    (p = e[l]) && (r = (o ? p(i, t, r) : p(r)) || r);
  return o && r && Te(i, t, r), r;
}, ce = (e, i, t) => i.has(e) || ue("Cannot " + t), T = (e, i, t) => (ce(e, i, "read from private field"), i.get(e)), ae = (e, i, t) => i.has(e) ? ue("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (ce(e, i, "write to private field"), i.set(e, t), t), L, F;
let P = class extends Y(W) {
  constructor() {
  ...
  async _openManualPaymentModal() {
    if (!T(this, L) || !this._status) return;
    (await T(this, L).open(this, Ae, {
      data: {
...
}, me = (e, i, t) => i.has(e) || pe("Cannot " + t), O = (e, i, t) => (me(e, i, "read from private field"), i.get(e)), Re = (e, i, t) => i.has(e) ? pe("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), re = (e, i, t, o) => (me(e, i, "write to private field"), i.set(e, t), t), C;
let k = class extends Y(W) {
  constructor() {
...
S([
  se({ type: String })
], k.prototype, "invoiceId", 2);
S([
  n()
], k.prototype, "_providers", 2);
S([
  n()
], k.prototype, "_linkInfo", 2);
S([
  n()
], k.prototype, "_selectedProvider", 2);
S([
  n()
], k.prototype, "_isLoading", 2);
S([
  n()
], k.prototype, "_isGenerating", 2);
S([
  n()
], k.prototype, "_isDeactivating", 2);
S([
  n()
], k.prototype, "_errorMessage", 2);
S([
  n()
], k.prototype, "_copySuccess", 2);
k = S([
  X("merchello-payment-link-panel")
], k);
var Ue = Object.defineProperty, Ve = Object.getOwnPropertyDescriptor, he = (e) => {
  throw TypeError(e);
}, v = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ve(i, t) : i, l = e.length - 1, p; l >= 0; l--)
    (p = e[l]) && (r = (o ? p(i, t, r) : p(r)) || r);
  return o && r && Ue(i, t, r), r;
}, ve = (e, i, t) => i.has(e) || he("Cannot " + t), d = (e, i, t) => (ve(e, i, "read from private field"), i.get(e)), q = (e, i, t) => i.has(e) ? he("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), B = (e, i, t, o) => (ve(e, i, "write to private field"), i.set(e, t), t), y, f, _, $;
let c = class extends Y(W) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, q(this, y), q(this, f), q(this, _), q(this, $, !1), this.consumeContext(oe, (e) => {
      B(this, y, e), d(this, y) && this.observe(d(this, y).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), B(this, $, !0), this._createRoutes(), this._loadCountries();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), B(this, $, !1);
  }
  ...
  async _openFulfillmentModal() {
    ...
    }), d(this, $) && d(this, y)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !d(this, f)) return;
    const e = this._order.id;
    await d(this, f).open(this, $e, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), d(this, $) && d(this, y)?.load(e);
  }
  ...
  async _saveEditing() {
    ...
    if (d(this, $)) {
      ...
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, d(this, y)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (d(this, $)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", d(this, y)?.load(this._order.id);
    }
  }
  ...
  _getFulfillmentLineItemRows(e) {
    ...
    return t.forEach((m) => {
      ...
      [...I, ...H, ...ge].filter((D, fe, be) => be.findIndex((ye) => ye.id === D.id) === fe).forEach((D) => {
  ...
  _handlePaymentChange() {
    this._order && d(this, y)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (d(this, $)) {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, d(this, y)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
...
//# sourceMappingURL=order-detail.element-mi6Q6SBR.js.map
