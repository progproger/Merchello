...
import { M } from "./merchello-api-Dp_zU_yi.js";
import { g as D } from "./store-settings-CHgA9WE7.js";
import { a as f, e as A } from "./formatting-B_f6AiQh.js";
import { n as y, g as z } from "./navigation-CvTcY6zJ.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
const P = new C("Merchello.MarkAsPaid.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var E = Object.defineProperty, L = Object.getOwnPropertyDescriptor, k = (e) => {
  throw TypeError(e);
}, o = (e, t, a, i) => {
  for (var u = i > 1 ? void 0 : i ? L(t, a) : t, b = e.length - 1, v; b >= 0; b--)
    (v = e[b]) && (u = (i ? v(t, a, u) : v(u)) || u);
  return i && u && E(t, a, u), u;
...
let s = class extends x(S) {
  ...
  async _loadInvoices() {
    ...
    const { data: e, error: t } = await M.getOutstandingInvoices(this._buildQueryParams());
    if (l(this, h)) {
      if (t) {
  ...
  _isInteractiveClick(e) {
    const t = /* @__PURE__ */ new Set(["A", "BUTTON", "UUI-BUTTON", "INPUT", "UUI-CHECKBOX"]);
  ...
  _handleRowClick(e, t) {
    this._isInteractiveClick(e) || y(t.id);
  }
  ...
  async _handleMarkAsPaid() {
    ...
    const e = this._getSelectedInvoices(), t = this._getSelectedTotal(), a = await l(this, _)?.open(this, P, {
      data: {
        invoices: e,
  ...
  _renderRow(e) {
    ...
    return r`
      ...
      >
        ...
        <uui-table-cell>
          <a class="invoice-link" href=${z(e.id)}>
...
//# sourceMappingURL=outstanding-list.element-BUdtQwZH.js.map
