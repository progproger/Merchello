...
import { UmbModalToken as y, UmbModalBaseElement as b, UMB_MODAL_MANAGER_CONTEXT as C } from "@umbraco-cms/backoffice/modal";
import { M as g } from "./merchello-api-B76CV0sD.js";
import { a as x } from "./store-settings-7zNVo6g4.js";
import { C as O } from "./order.types-_o7xLk2Z.js";
import "./order-table.element-DaE0IOVo.js";
import "./merchello-empty-state.element-D2dcD7_8.js";
import { n as $, a as z } from "./navigation-CvTcY6zJ.js";
import { a as d } from "./formatting-MfE1tvkN.js";
import { m as M } from "./modal-layout.styles-C2OaUji5.js";
const w = new y("Merchello.GenerateStatement.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
});
var L = Object.defineProperty, E = Object.getOwnPropertyDescriptor, p = (e) => {
  throw TypeError(e);
}, c = (e, a, t, o) => {
  for (var i = o > 1 ? void 0 : o ? E(a, t) : a, u = e.length - 1, _; u >= 0; u--)
    (_ = e[u]) && (i = (o ? _(a, t, i) : _(i)) || i);
  return o && i && L(a, t, i), i;
}, v = (e, a, t) => a.has(e) || p("Cannot " + t), S = (e, a, t) => (v(e, a, "read from private field"), a.get(e)), T = (e, a, t) => a.has(e) ? p("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, t), k = (e, a, t, o) => (v(e, a, "write to private field"), a.set(e, t), t), m;
let n = class extends b {
  constructor() {
    super(), T(this, m), this._orders = [], this._segments = [], this._outstandingBalance = null, this._isLoading = !0, this._errorMessage = null, this.consumeContext(C, (e) => {
      k(this, m, e);
    });
  }
  connectedCallback() {
...
//# sourceMappingURL=customer-orders-modal.element-CnaVkbzZ.js.map
