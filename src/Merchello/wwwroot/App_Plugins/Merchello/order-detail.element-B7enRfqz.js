...
import { b as tt, a as R, d as Nt } from "./formatting-OmNqzjZa.js";
import { M as F } from "./merchello-api-CoAMZUgg.js";
...
function ti() {
  ...
  let ht = !0, Fe = !0, gt = !1, vt = !0, X = !1, ye = !0, G = !1, Ue = !1, He = !1, V = !1, Te = !1, Ee = !1, _t = !0, bt = !1;
  ...
  const ki = a.createElement("form"), St = function(i) {
    ...
    return i && l && E.insertBefore(a.createTextNode(l), E.childNodes[0] || null), J === z ? vi.call(r, G ? "html" : "body")[0] : G ? r.documentElement : E;
  }, kt = function(i) {
    return hi.call(
      i.ownerDocument || i,
      i,
  ...
  const Dt = function(i) {
    ...
    for (; p--; ) {
      ...
      if (l.attrName = ee, l.attrValue = T, l.keepAttr = !0, l.forceKeepAttr = void 0, O(w.uponSanitizeAttribute, i, l), T = l.attrValue, bt && (ee === "id" || ee === "name") && (W(h, i), T = Ai + T), ye && x(/((--!?|])>)|<\/(style|title|textarea)/i, T)) {
        W(h, i);
        continue;
      }
  ...
  return t.sanitize = function(d) {
    ...
    if (Ue || je(i), t.removed = [], typeof d == "string" && (ne = !1), ne) {
      ...
      if (!V && !X && !G && // eslint-disable-next-line unicorn/prefer-includes
      d.indexOf("<") === -1)
    ...
    let $ = G ? r.outerHTML : r.innerHTML;
    return G && _["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && x(ei, r.ownerDocument.doctype.name) && ($ = "<!DOCTYPE " + r.ownerDocument.doctype.name + `>
` + $), X && Ce([ze, Oe, Ne], (N) => {
      $ = ce($, N, " ");
    }), S && Ee ? S.createHTML($) : $;
...
let j = class extends lt(st) {
  ...
  async _loadShipments() {
    ...
    const { data: e, error: t } = await F.getFulfillmentSummary(this._invoiceId);
  ...
  async _handleDeleteShipment(e) {
    ...
    const { error: a } = await F.deleteShipment(e.id);
    if (a) {
      alert(a.message);
      return;
    }
    ...
    if (this.invoiceId) {
      ...
      try {
        const [e, t] = await Promise.all([
          F.getInvoicePayments(this.invoiceId),
          F.getPaymentStatus(this.invoiceId)
        ]);
        if (e.error) {
...
te([
  Mi({ type: String })
], H.prototype, "invoiceId", 2);
te([
  g()
], H.prototype, "_payments", 2);
te([
  g()
...
}, oi = (e, t, a) => t.has(e) || ni("Cannot " + a), B = (e, t, a) => (oi(e, t, "read from private field"), a ? a.call(e) : t.get(e)), Vt = (e, t, a) => t.has(e) ? ni("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), Kt = (e, t, a, s) => (oi(e, t, "write to private field"), t.set(e, a), a), U, ge;
let A = class extends lt(st) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._activeTab = "details", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], Vt(this, U), Vt(this, ge), this.consumeContext(Zt, (e) => {
      Kt(this, U, e), this.observe(B(this, U).order, (t) => {
  ...
  async _loadCountries() {
    const { data: e } = await F.getCountries();
    e && (this._countries = e);
  }
  async _openFulfillmentModal() {
    if (!this._order || !B(this, ge)) return;
    await B(this, ge).open(this, ta, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), B(this, U)?.load(this._order.id);
  }
  ...
  async _saveEditing() {
    ...
    if (this._editingSection === "contact") {
      ...
      e = await F.updateBillingAddress(this._order.id, t);
    } else this._editingSection === "shipping" ? e = await F.updateShippingAddress(this._order.id, this._editFormData) : e = await F.updateBillingAddress(this._order.id, this._editFormData);
    if (this._isSavingAddress = !1, e.error) {
      console.error("Failed to save address:", e.error);
      return;
    }
    this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, B(this, U)?.load(this._order.id);
  }
  ...
  async _handlePostNote() {
    ...
    this._newNoteText = "", this._visibleToCustomer = !1, B(this, U)?.load(this._order.id);
  }
  _renderLoadingState() {
    return n`<div class="loading"><uui-loader></uui-loader></div>`;
  }
...
//# sourceMappingURL=order-detail.element-B7enRfqz.js.map
