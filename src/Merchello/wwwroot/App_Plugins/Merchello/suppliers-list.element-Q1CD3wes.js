...
}, y = (e, i, r) => i.has(e) || g("Cannot " + r), a = (e, i, r) => (y(e, i, "read from private field"), i.get(e)), b = (e, i, r) => i.has(e) ? g("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, r), p = (e, i, r, t) => (y(e, i, "write to private field"), i.set(e, r), r), u, c, s;
let o = class extends M(S) {
  constructor() {
    super(), this._suppliers = [], this._isLoading = !0, this._errorMessage = null, this._isDeleting = null, b(this, u), b(this, c), b(this, s, !1), this.consumeContext(C, (e) => {
      p(this, u, e);
  ...
  async _handleAddSupplier() {
    ...
    a(this, s) && i?.created && this._loadSuppliers();
  }
  async _handleEditSupplier(e) {
    ...
    a(this, s) && r?.updated && this._loadSuppliers();
  }
...
This will remove the supplier association from all linked warehouses.`
    ...
    if (a(this, s)) {
      if (this._isDeleting = null, t) {
        this._errorMessage = `Failed to delete supplier: ${t.message}`, a(this, c)?.peek("danger", {
...
//# sourceMappingURL=suppliers-list.element-Q1CD3wes.js.map
