...
import { c as d } from "./formatting-BoIk_URG.js";
const N = new S("Merchello.AddCustomItem.Modal", {
  modal: {
    type: "dialog",
    size: "medium"
  }
...
var q = Object.defineProperty, E = Object.getOwnPropertyDescriptor, I = (e) => {
  throw TypeError(e);
}, c = (e, i, s, t) => {
...
let u = class extends R {
  ...
  async _openAddCustomItemModal() {
    if (!v(this, h) || !this._invoice) return;
    const i = await v(this, h).open(this, N, {
      data: {
        currencySymbol: this._invoice.currencySymbol,
...
//# sourceMappingURL=edit-order-modal.element-CaWi-RRA.js.map
