import { LitElement as y, html as n, nothing as w, css as k, state as h, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
import { M as f } from "./merchello-api-D-qg1PlO.js";
...
var L = Object.defineProperty, A = Object.getOwnPropertyDescriptor, v = (e) => {
  ...
  for (var a = s > 1 ? void 0 : s ? A(t, i) : t, m = e.length - 1, _; m >= 0; m--)
    (_ = e[m]) && (a = (s ? _(t, i, a) : _(a)) || a);
  return s && a && L(t, i, a), a;
}, C = (e, t, i) => t.has(e) || v("Cannot " + i), o = (e, t, i) => (C(e, t, "read from private field"), t.get(e)), g = (e, t, i) => t.has(e) ? v("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, s) => (C(e, t, "write to private field"), t.set(e, i), i), u, c, r;
let l = class extends M(y) {
  constructor() {
    super(), this._collections = [], this._isLoading = !0, this._errorMessage = null, this._isDeleting = null, this._searchTerm = "", g(this, u), g(this, c), g(this, r, !1), this.consumeContext(E, (e) => {
      p(this, u, e);
  ...
  connectedCallback() {
    super.connectedCallback(), p(this, r, !0), this._loadCollections();
  }
  ...
  async _handleDelete(e, t) {
    ...
    t.productCount > 0 && (i = `This collection is used by ${t.productCount} product${t.productCount === 1 ? "" : "s"}. Deleting it will remove the collection from all these products. Are you sure you want to delete "${t.name}"?`);
    const s = o(this, u)?.open(this, $, {
      data: {
    ...
    const { error: a } = await f.deleteProductCollection(t.id);
    if (o(this, r)) {
      if (this._isDeleting = null, a) {
        this._errorMessage = `Failed to delete collection: ${a.message}`, o(this, c)?.peek("danger", {
          data: { headline: "Failed to delete", message: a.message || "Could not delete collection" }
        });
        return;
      }
...
const U = l;
export {
  l as MerchelloCollectionsWorkspaceElement,
  U as default
};
//# sourceMappingURL=collections-workspace.element-BLbX1l7a.js.map
