...
async function r(e) {
  try {
    const t = await $(), s = d.baseUrl || "", n = await fetch(`${s}${l}/${e}`, {
      method: "GET",
...
async function o(e, t) {
  try {
    const s = await $(), n = d.baseUrl || "", a = await fetch(`${n}${l}/${e}`, {
      method: "POST",
      credentials: d.credentials,
      headers: s,
...
const h = {
  ...
  updatePaymentMethodSetting: (e, t, s) => i(`payment-providers/${e}/methods/${t}`, s),
  /** Reorder payment methods for a provider */
  reorderPaymentMethods: (e, t) => i(`payment-providers/${e}/methods/reorder`, t),
  // ============================================
  // Payments API
  // ============================================
  ...
  updateProductCollection: (e, t) => i(`products/collections/${e}`, t),
  ...
  getProductFulfillmentOptions: (e, t, s) => {
    ...
    return n.set("destinationCountryCode", t), s && n.set("destinationStateCode", s), r(`products/variants/${e}/fulfillment-options?${n.toString()}`);
  },
  /**
  ...
  getShippingOptionsForWarehouse: (e, t, s) => {
    const n = new URLSearchParams();
    return n.set("destinationCountryCode", t), s && n.set("destinationStateCode", s), r(`warehouses/${e}/shipping-options?${n.toString()}`);
  },
  // ============================================
  // Suppliers API
  // ============================================
...
//# sourceMappingURL=merchello-api-BtOE5E-_.js.map
