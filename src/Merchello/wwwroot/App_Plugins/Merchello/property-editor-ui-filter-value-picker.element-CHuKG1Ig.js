...
import { M as E } from "./merchello-api-B1P1cUX9.js";
var K = Object.defineProperty, X = Object.getOwnPropertyDescriptor, J = Object.getPrototypeOf, Q = Reflect.set, L = (e) => {
  throw TypeError(e);
}, p = (e, t, i, l) => {
  for (var s = l > 1 ? void 0 : l ? X(t, i) : t, d = e.length - 1, h; d >= 0; d--)
    (h = e[d]) && (s = (l ? h(t, i, s) : h(s)) || s);
  return l && s && K(t, i, s), s;
}, C = (e, t, i) => t.has(e) || L("Cannot " + i), a = (e, t, i) => (C(e, t, "read from private field"), i ? i.call(e) : t.get(e)), _ = (e, t, i) => t.has(e) ? L("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), I = (e, t, i, l) => (C(e, t, "write to private field"), t.set(e, i), i), n = (e, t, i) => (C(e, t, "access private method"), i), Y = (e, t, i, l) => ({
  set _(s) {
    I(e, t, s);
  },
  get _() {
...
}), Z = (e, t, i, l) => (Q(J(e), i, l, t), l), y, f, g, c, o, S, F, x, v, M, $, w, G, P, O;
let u = class extends D(
  W,
  void 0
) {
  constructor() {
    super(), _(this, o), this.readonly = !1, this._selection = [], this._maxItems = 1 / 0, this._isLoading = !1, this._allFilterGroups = [], _(this, y), _(this, f, !1), _(this, g, 0), _(this, c, new T(this, {
      ...
      onChange: ({ model: e }) => {
        this._selection = e, n(this, o, x).call(this);
      }
    })), a(this, c).disable(), this.consumeContext(q, (e) => {
      I(this, y, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), I(this, f, !0);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), I(this, f, !1);
  }
  set config(e) {
    const t = e?.getValueByAlias("maxItems");
    if (this._maxItems = t === 0 ? 1 / 0 : t ?? 1 / 0, this._filterGroupId = e?.getValueByAlias("filterGroupId"), this._maxItems === 1) {
      a(this, c).disable();
      return;
    }
    a(this, c).enable(), a(this, c).setModel(this._selection);
  }
  set value(e) {
    super.value = e, n(this, o, S).call(this, e);
  }
  get value() {
    return super.value;
  }
  render() {
    ...
    return !e && this._isLoading && this._selection.length === 0 ? r`<uui-loader></uui-loader>` : e ? n(this, o, P).call(this) : n(this, o, G).call(this);
  }
};
...
S = async function(e) {
  const t = ++Y(this, g)._;
  if (!e) {
    this._selection = [], this._maxItems !== 1 && a(this, c).setModel([]);
    return;
  }
  ...
  const l = [];
  for (const s of i) {
    const d = n(this, o, F).call(this, s);
    d ? l.push(d) : l.push({
      id: s,
  ...
  this._selection = l, this._maxItems !== 1 && a(this, c).setModel(l);
};
F = function(e) {
  for (const t of this._allFilterGroups) {
    const i = t.filters.find((l) => l.id === e);
    if (i)
      return {
        id: i.id,
        name: i.name,
...
x = function() {
  ...
  Z(u.prototype, this, "value", e), this.dispatchEvent(new B());
};
v = async function() {
  ...
  const l = i.selectedFilterIds.map((s, d) => {
    const h = n(this, o, F).call(this, s), k = i.selectedFilterNames[d] ?? "", [A, N] = k.includes(": ") ? k.split(": ", 2) : ["", k];
    return {
      id: s,
      name: h?.name ?? N,
  ...
  if (e) {
    const s = [...this._selection, ...l];
    this._selection = this._maxItems === 1 / 0 ? s : s.slice(0, this._maxItems);
  } else
    this._selection = l.slice(0, 1);
  a(this, c).setModel(this._selection), n(this, o, x).call(this);
};
M = function(e) {
  this._selection = this._selection.filter((t) => t.id !== e), a(this, c).setModel(this._selection), n(this, o, x).call(this);
};
$ = function() {
  this._selection = [], a(this, c).setModel([]), n(this, o, x).call(this);
};
w = function(e) {
  return e ? r`
      <span
...
G = function() {
  ...
  return e ? e.notFound ? r`
      ...
      <div class="single-select-display">
        <div class="filter-info">
          ${n(this, o, w).call(this, e.hexColour)}
          <span class="filter-name">${e.name}</span>
        ...
        <div class="filter-item not-found" data-id=${e.id}>
          ...
          ${this.readonly ? m : r`
                <uui-button
                  ...
                  look="secondary"
                  label="Remove"
                  @click=${() => n(this, o, M).call(this, e.id)}>
                  <uui-icon name="icon-trash"></uui-icon>
                </uui-button>
              `}
        </div>
...
p([
  b()
], u.prototype, "_filterGroupId", 2);
p([
  b()
], u.prototype, "_isLoading", 2);
p([
  b()
], u.prototype, "_allFilterGroups", 2);
u = p([
  V("merchello-property-editor-ui-filter-value-picker")
], u);
const ae = u;
export {
  u as MerchelloPropertyEditorUiFilterValuePickerElement,
  ae as default
};
//# sourceMappingURL=property-editor-ui-filter-value-picker.element-CHuKG1Ig.js.map
