import { LitElement as Pe, html as z, css as Ae, property as U, state as st, customElement as Oe, svg as Ao, query as Oo } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as Le } from "@umbraco-cms/backoffice/element-api";
import { M as ae } from "./merchello-api-BT8AWvQk.js";
import { c as me } from "./formatting-6Hz_EImA.js";
...
const T = Math.PI, I = 2 * T, ha = I + T, Qe = Number.POSITIVE_INFINITY, da = T / 180, H = T / 2, zt = T / 4, cs = T * 2 / 3, wt = Math.log10, dt = Math.sign;
function _e(i, t, e) {
...
const Yi = (i) => i === "start" ? "left" : i === "end" ? "right" : "center", G = (i, t, e) => i === "start" ? t : i === "end" ? e : (t + e) / 2, va = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t;
function Vn(i, t, e) {
  const s = t.length;
  let n = 0, o = s;
  if (i._sorted) {
...
function Ha(i, t, e) {
  ...
  let r = s[t];
  return Lt(r) && a.isScriptable(t) && (r = ja(t, r, i, e)), V(r) && r.length && (r = Ya(t, r, i, a.isIndexable)), Gi(t, r) && (r = te(r, n, o && o[t], a)), r;
}
function ja(i, t, e, s) {
...
const Xa = (i, t) => i === !0 ? t : typeof i == "string" ? Ot(t, i) : void 0;
...
function el(i, t, e, s) {
  ...
  if (r && t === r.axis && t !== "r" && a && o.length) {
    const c = r._reversePixels ? ba : _t;
    if (s) {
      if (n._sharedOptions) {
...
var Z = {
  ...
  update(i, t, e, s) {
    if (!i)
      return;
    const n = J(i.options.layout.padding), o = Math.max(t - n.width, 0), a = Math.max(e - n.height, 0), r = cl(i.boxes), l = r.vertical, c = r.horizontal;
    R(i.boxes, (p) => {
...
class Ut extends vt {
  ...
  _computeGridLineItems(t) {
    ...
    for (v = 0; v < d; v += E) {
      ...
      y = El(this, v, l), y !== void 0 && (x = It(s, y, K), c ? k = S = C = L = x : M = w = P = X = x, f.push({
        tx1: k,
        ty1: M,
        tx2: S,
        ty2: w,
...
const ic = (i) => O(i) && Object.getOwnPropertyNames(i).some((t) => Lt(i[t]));
function sc(i, t) {
  const { isScriptable: e, isIndexable: s } = jn(i);
  for (const n of t) {
    const o = e(n), a = s(n), r = (a || o) && i[n];
    if (o && (Lt(r) || ic(r)) || a && V(r))
      return !0;
  }
  return !1;
}
...
class es {
  ...
  constructor(t, e) {
    ...
    gt.listen(this, "complete", qs), gt.listen(this, "progress", ac), this._initialize(), this.attached && this.update();
  }
  get aspectRatio() {
...
class pc extends vt {
  ...
  inRange(t, e, s) {
    const n = this.getProps([
      ...
      "outerRadius",
      "circumference"
    ], s), u = (this.options.spacing + this.options.borderWidth) / 2, f = D(d, l - r), g = Se(o, r, l) && r !== l, p = f >= I || g, m = bt(a, c + u, h + u);
    return p && m;
  }
  getCenterPoint(t) {
...
function Nh(i, t, e) {
  const s = i.drawingArea, { extra: n, additionalAngle: o, padding: a, size: r } = e, l = i.getPointPosition(t, s + n + a, o), c = Math.round(Hi(q(l.angle + H))), h = Yh(l.y, r.h, c), d = Hh(c), u = jh(l.x, r.w, d);
  return {
    visible: !0,
    x: l.x,
    y: h,
...
class qh extends ni {
  ...
  setDimensions() {
    const t = this._padding = J(Ii(this.options) / 2), e = this.width = this.maxWidth - t.width, s = this.height = this.maxHeight - t.height;
...
var sd = Object.defineProperty, nd = Object.getOwnPropertyDescriptor, ut = (i, t, e, s) => {
...
}, Po = (i, t, e) => t.has(i) || Co("Cannot " + e), Ke = (i, t, e) => (Po(i, t, "read from private field"), t.get(i)), cd = (i, t, e) => t.has(i) ? Co("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(i) : t.set(i, e), Cn = (i, t, e, s) => (Po(i, t, "write to private field"), t.set(i, e), e), Mt;
let at = class extends Le(Pe) {
  constructor() {
    super(...arguments), this._dateRange = this._getDefaultDateRange(), this._summary = null, this._salesResult = null, this._aovResult = null, this._breakdown = null, this._isLoading = !0, this._errorMessage = "", this._currencySymbol = "$", cd(this, Mt, !1);
  }
  _getDefaultDateRange() {
    const i = /* @__PURE__ */ new Date(), t = /* @__PURE__ */ new Date();
    return t.setDate(t.getDate() - 30), { startDate: t, endDate: i };
...
//# sourceMappingURL=analytics-workspace.element-C8lBHoeZ.js.map
