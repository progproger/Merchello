...
var y = Object.defineProperty, z = Object.getOwnPropertyDescriptor, g = (e) => {
  ...
  for (var a = o > 1 ? void 0 : o ? z(r, s) : r, l = e.length - 1, c; l >= 0; l--)
    (c = e[l]) && (a = (o ? c(r, s, a) : c(a)) || a);
  return o && a && y(r, s, a), a;
}, f = (e, r, s) => r.has(e) || g("Cannot " + s), $ = (e, r, s) => (f(e, r, "read from private field"), r.get(e)), k = (e, r, s) => r.has(e) ? g("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, s), v = (e, r, s, o) => (f(e, r, "write to private field"), r.set(e, s), s), u;
let n = class extends _ {
  constructor() {
    super(...arguments), this._isTesting = !1, this._errorMessage = null, k(this, u, !1);
  }
  connectedCallback() {
...
//# sourceMappingURL=test-provider-modal.element-BdDxwNDC.js.map
