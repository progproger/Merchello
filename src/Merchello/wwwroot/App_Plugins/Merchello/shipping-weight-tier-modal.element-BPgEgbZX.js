import { nothing as _, html as n, css as v, state as r, customElement as f } from "@umbraco-cms/backoffice/external/lit";
...
import { M as d } from "./merchello-api-DNSJzonx.js";
import { b as p, g as S } from "./store-settings-BPUUVKYl.js";
var x = Object.defineProperty, W = Object.getOwnPropertyDescriptor, m = (i) => {
  throw TypeError(i);
}, o = (i, e, a, h) => {
  for (var u = h > 1 ? void 0 : h ? W(e, a) : e, g = i.length - 1, c; g >= 0; g--)
    (c = i[g]) && (u = (h ? c(e, a, u) : c(u)) || u);
  return h && u && x(e, a, u), u;
}, y = (i, e, a) => e.has(i) || m("Cannot " + a), l = (i, e, a) => (y(i, e, "read from private field"), e.get(i)), w = (i, e, a) => e.has(i) ? m("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, a), $ = (i, e, a, h) => (y(i, e, "write to private field"), e.set(i, a), a), s;
let t = class extends C {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._countryCode = "", this._regionCode = "", this._minWeightKg = 0, this._maxWeightKg = null, this._surcharge = 0, this._currencySymbol = p(), this._countries = [], this._regions = [], w(this, s), this.consumeContext(b, (i) => {
      $(this, s, i);
    });
  }
  connectedCallback() {
  ...
  async _loadCountries() {
    if (this._isLoadingCountries = !0, this.data?.warehouseId) {
      const { data: i } = await d.getAvailableDestinationsForWarehouse(this.data.warehouseId);
      i && (this._countries = i);
    } else {
      const { data: i } = await d.getCountries();
      i && (this._countries = i);
    }
  ...
  async _loadRegions(i) {
    if (this._isLoadingRegions = !0, this._regions = [], this.data?.warehouseId) {
      const { data: e } = await d.getAvailableRegionsForWarehouse(this.data.warehouseId, i);
      e && (this._regions = e);
    } else {
      const { data: e } = await d.getLocalityRegions(i);
      e && (this._regions = e);
    }
  ...
  async _save() {
    ...
    try {
      const e = this.data?.tier ? await d.updateShippingWeightTier(this.data.tier.id, i) : await d.addShippingWeightTier(this.data?.optionId, i);
      if (e.error) {
      ...
      this._maxWeightKg = a ? parseFloat(a) : null;
        ...
        <div slot="actions">
          ...
          <uui-button
            ...
            @click=${this._save}
          >
            ${this._isSaving ? n`<uui-loader-circle></uui-loader-circle>` : _}
...
//# sourceMappingURL=shipping-weight-tier-modal.element-BPgEgbZX.js.map
