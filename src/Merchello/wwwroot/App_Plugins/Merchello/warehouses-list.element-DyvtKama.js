...
import { UMB_MODAL_MANAGER_CONTEXT as $, UMB_CONFIRM_MODAL as D } from "@umbraco-cms/backoffice/modal";
import { M as v } from "./merchello-api-B76CV0sD.js";
import { q as A, e as _, r as L } from "./navigation-CvTcY6zJ.js";
import { b as z } from "./badge.styles-C7D4rnJo.js";
import { c as E } from "./collection-layout.styles-BLT_S_EA.js";
import "./merchello-empty-state.element-D2dcD7_8.js";
var O = Object.defineProperty, S = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, c = (e, a, i, r) => {
  for (var s = r > 1 ? void 0 : r ? S(a, i) : a, g = e.length - 1, b; g >= 0; g--)
    (b = e[g]) && (s = (r ? b(a, i, s) : b(s)) || s);
  return r && s && O(a, i, s), s;
...
//# sourceMappingURL=warehouses-list.element-DyvtKama.js.map
