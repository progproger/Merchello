import { LitElement as S, html as n, nothing as l, css as x, state as u, customElement as D } from "@umbraco-cms/backoffice/external/lit";
...
import { b as I } from "./badge.styles-C7D4rnJo.js";
import { u as k } from "./navigation-CvTcY6zJ.js";
import "./product-shipping-exclusions.element-CweWHtOE.js";
...
let i = class extends F(S) {
  ...
  _updateVariantFromProduct() {
    if (!this._product || !r(this, m)) {
      this._variant = null, this._isLoading = !0, this._errorMessage = null;
      return;
    }
    const t = this._product.variants.find((e) => e.id === r(this, m));
    if (!t) {
      this._variant = null, this._formData = {}, this._isLoading = !1, this._errorMessage = "Variant not found for this product.";
      return;
    }
    this._variant = t, this._formData = { ...t }, this._isLoading = !1, this._errorMessage = null, this._loadAssignedFilters(), this._initializeShippingExclusions(t);
  }
  ...
  render() {
    if (this._isLoading)
      ...
      `;
    const t = this._product?.id ? k(this._product.id) : "";
    if (!this._variant)
      return n`
    ...
    return n`
      <umb-body-layout header-fit-height main-no-padding>
        ...
        <umb-body-layout header-fit-height header-no-padding>
          ...
          ${e === "basic" ? this._renderBasicTab() : l}
          ${e === "packages" ? this._renderPackagesTab() : l}
          ${e === "seo" ? this._renderSeoTab() : l}
          ${e === "feed" ? this._renderFeedTab() : l}
          ${e === "stock" ? this._renderStockTab() : l}
          ${e === "filters" ? this._renderFiltersTab() : l}
        </umb-body-layout>
...
//# sourceMappingURL=variant-detail.element-DWxcU9sN.js.map
