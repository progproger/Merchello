import { LitElement as L, html as l, nothing as n, css as M, property as H, customElement as F, state as v } from "@umbraco-cms/backoffice/external/lit";
...
import { UMB_MODAL_MANAGER_CONTEXT as z, UmbModalToken as oe, UMB_CONFIRM_MODAL as ue } from "@umbraco-cms/backoffice/modal";
import { d as r, e as d, f as I, a as b, U as _, C, b as ne } from "./upsell.types-ChZp0X_-.js";
import { M as R } from "./merchello-api-DNSJzonx.js";
import { c as S, f as V, a as D } from "./formatting-YHMza1vS.js";
import { C as ce, D as de, E as pe } from "./navigation-BGhEgega.js";
import { M as W } from "./product-picker-modal.token-BfbHsSHl.js";
...
import { a as q, M as he } from "./supplier-picker-modal.token-CHapAKSP.js";
import { M as w } from "./filter-picker-modal.token-DlO79hNz.js";
import { M as me } from "./customer-picker-modal.token-BZSMisS9.js";
var ge = Object.defineProperty, ve = Object.getOwnPropertyDescriptor, Y = (e) => {
  throw TypeError(e);
}, X = (e, t, a, i) => {
  for (var s = i > 1 ? void 0 : i ? ve(t, a) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (s = (i ? h(t, a, s) : h(s)) || s);
  return i && s && ge(t, a, s), s;
}, J = (e, t, a) => t.has(e) || Y("Cannot " + a), $ = (e, t, a) => (J(e, t, "read from private field"), t.get(e)), be = (e, t, a) => t.has(e) ? Y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), _e = (e, t, a, i) => (J(e, t, "write to private field"), t.set(e, a), a), y;
const ye = [
...
let T = class extends U(L) {
  constructor() {
    super(), this.rules = [], be(this, y), this.consumeContext(z, (e) => {
      _e(this, y, e);
    });
  }
  _dispatchChange() {
    ...
    if ($(this, y))
      switch (t.triggerType) {
        case r.SpecificProducts: {
          const i = await $(this, y).open(this, W, {
        ...
        case r.Collections: {
          const i = await $(this, y).open(this, G, {
        ...
        case r.ProductTypes: {
          const i = await $(this, y).open(this, K, {
            data: { excludeIds: t.triggerIds ?? [], multiSelect: !0 }
          }).onSubmit().catch(() => {
          });
          i?.selectedIds?.length && this._handleUpdateRule(e, {
        ...
        case r.Suppliers: {
          const i = await $(this, y).open(this, q, {
            data: { excludeIds: t.triggerIds ?? [], multiSelect: !0 }
          }).onSubmit().catch(() => {
          });
          i?.selectedIds?.length && this._handleUpdateRule(e, {
      ...
      <div class="rule-card">
        ...
        ${this._needsEntityPicker(e.triggerType) ? l`
            ...
            ${this._supportsFilterExtraction(e.triggerType) ? l`
              ...
              ` : n}
          ` : this._isCartValueTrigger(e.triggerType) ? this._renderCartValueRule(e, t) : n}
      </div>
    `;
  }
  _renderCartValueRule(e, t) {
    return l`
      <div class="rule-body cart-value-body">
        ${e.triggerType === r.CartValueBetween ? l`
          ...
          ` : l`
            <uui-input
              ...
              step="0.01"
              min="0"
              label=${e.triggerType === r.MinimumCartValue ? "Minimum cart value" : "Maximum cart value"}
...
var Ie = Object.defineProperty, Ce = Object.getOwnPropertyDescriptor, Q = (e) => {
  throw TypeError(e);
}, Z = (e, t, a, i) => {
  for (var s = i > 1 ? void 0 : i ? Ce(t, a) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (s = (i ? h(t, a, s) : h(s)) || s);
  return i && s && Ie(t, a, s), s;
}, j = (e, t, a) => t.has(e) || Q("Cannot " + a), k = (e, t, a) => (j(e, t, "read from private field"), t.get(e)), $e = (e, t, a) => t.has(e) ? Q("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), ke = (e, t, a, i) => (j(e, t, "write to private field"), t.set(e, a), a), f;
const Se = [
...
let E = class extends U(L) {
  constructor() {
    super(), this.rules = [], $e(this, f), this.consumeContext(z, (e) => {
      ke(this, f, e);
    });
  }
  _dispatchChange() {
    ...
    if (k(this, f))
      switch (t.recommendationType) {
        case d.SpecificProducts: {
          const i = await k(this, f).open(this, W, {
...
var Pe = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, ee = (e) => {
  throw TypeError(e);
}, te = (e, t, a, i) => {
  for (var s = i > 1 ? void 0 : i ? xe(t, a) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (s = (i ? h(t, a, s) : h(s)) || s);
  return i && s && Pe(t, a, s), s;
}, ie = (e, t, a) => t.has(e) || ee("Cannot " + a), A = (e, t, a) => (ie(e, t, "read from private field"), t.get(e)), we = (e, t, a) => t.has(e) ? ee("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), Te = (e, t, a, i) => (ie(e, t, "write to private field"), t.set(e, a), a), P;
const Ee = [
...
let N = class extends U(L) {
  constructor() {
    super(), this.rules = [], we(this, P), this.consumeContext(z, (e) => {
      Te(this, P, e);
    });
  }
  _dispatchChange() {
  ...
  async _openPicker(e, t) {
    if (A(this, P)) {
      if (t.eligibilityType === I.CustomerSegments) {
        const i = await A(this, P).open(this, he, {
        ...
        const i = await A(this, P).open(this, me, {
...
const Le = new oe("Merchello.UpsellStyle.Modal", {
  modal: {
    type: "dialog",
    size: "large"
  }
});
var Me = Object.defineProperty, Fe = Object.getOwnPropertyDescriptor, ae = (e) => {
  throw TypeError(e);
}, m = (e, t, a, i) => {
  for (var s = i > 1 ? void 0 : i ? Fe(t, a) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (s = (i ? h(t, a, s) : h(s)) || s);
  return i && s && Me(t, a, s), s;
}, se = (e, t, a) => t.has(e) || ae("Cannot " + a), o = (e, t, a) => (se(e, t, "read from private field"), t.get(e)), O = (e, t, a) => t.has(e) ? ae("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), B = (e, t, a, i) => (se(e, t, "write to private field"), t.set(e, a), a), c, g, x;
let u = class extends U(L) {
  constructor() {
    super(), this._isNew = !0, this._isLoading = !0, this._isSaving = !1, this._validationErrors = /* @__PURE__ */ new Map(), this._triggerRules = [], this._recommendationRules = [], this._eligibilityRules = [], this._performanceLoading = !1, this._routes = [], this._activePath = "", O(this, c), O(this, g), O(this, x), this._initRoutes(), this.consumeContext(le, (e) => {
  ...
  async _handleSave() {
    ...
    if (o(this, c)?.setIsSaving(!0), this._isNew) {
      ...
      }, { data: t, error: a } = await R.createUpsell(e);
      ...
      }, { data: t, error: a } = await R.updateUpsell(this._upsell.id, e);
      if (o(this, c)?.setIsSaving(!1), a) {
        o(this, g)?.peek("danger", {
  ...
  async _handleDelete() {
    ...
    const { error: t } = await R.deleteUpsell(this._upsell.id);
    if (t) {
      o(this, g)?.peek("danger", {
  ...
  async _handleActivate() {
    if (!this._upsell?.id) return;
    const { data: e, error: t } = await R.activateUpsell(this._upsell.id);
    if (t) {
      o(this, g)?.peek("danger", {
  ...
  async _handleDeactivate() {
    if (!this._upsell?.id) return;
    const { data: e, error: t } = await R.deactivateUpsell(this._upsell.id);
    if (t) {
      o(this, g)?.peek("danger", {
  ...
  async _openStyleModal() {
    if (!o(this, x) || !this._upsell) return;
    const t = await o(this, x).open(this, Le, {
      data: {
  ...
  async _loadPerformance() {
    ...
    const { data: e, error: t } = await R.getUpsellPerformance(this._upsell.id);
    ...
    return !e || e.totalImpressions === 0 && e.totalClicks === 0 && e.totalConversions === 0 ? l`
      ...
      <div class="perf-stats-grid">
        <uui-box headline="Impressions">
          <div class="stat-value">${S(e.totalImpressions)}</div>
          <div class="stat-label">Total views</div>
        </uui-box>
        <uui-box headline="Clicks">
          <div class="stat-value">${S(e.totalClicks)}</div>
          <div class="stat-label">CTR: ${V(e.clickThroughRate)}</div>
        </uui-box>
        <uui-box headline="Conversions">
          <div class="stat-value">${S(e.totalConversions)}</div>
          <div class="stat-label">Rate: ${V(e.conversionRate)}</div>
        </uui-box>
        <uui-box headline="Revenue">
          <div class="stat-value">${D(e.totalRevenue)}</div>
          <div class="stat-label">Avg: ${D(e.averageOrderValue)}</div>
        </uui-box>
      </div>
      ...
      <uui-box headline="Additional Metrics">
        <div class="metrics-list">
          <div class="metric-row">
            ...
            <span class="metric-value">${S(e.uniqueCustomersCount)}</span>
          </div>
          ${e.firstImpression ? l`
            <div class="metric-row">
      ...
      (t) => l`
                    <tr>
                      ...
                      <td>${S(t.impressions)}</td>
                      <td>${S(t.clicks)}</td>
                      <td>${S(t.conversions)}</td>
                      <td>${D(t.revenue)}</td>
                    </tr>
                  `
    )}
...
//# sourceMappingURL=upsell-detail.element-D3Dy4D-K.js.map
