import { LitElement as m, nothing as u, html as o, css as b, property as n, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as f } from "@umbraco-cms/backoffice/element-api";
import { t as w } from "./navigation-DfYj5Lv5.js";
var C = Object.defineProperty, S = Object.getOwnPropertyDescriptor, k = (e, i, t, r) => {
  for (var a = r > 1 ? void 0 : r ? S(i, t) : i, s = e.length - 1, l; s >= 0; s--)
    (l = e[s]) && (a = (r ? l(i, t, a) : l(a)) || a);
  return r && a && C(i, t, a), a;
};
...
var z = Object.defineProperty, E = Object.getOwnPropertyDescriptor, F = (e, i, t, r) => {
  for (var a = r > 1 ? void 0 : r ? E(i, t) : i, s = e.length - 1, l; s >= 0; s--)
    (l = e[s]) && (a = (r ? l(i, t, a) : l(a)) || a);
...
var D = Object.defineProperty, V = Object.getOwnPropertyDescriptor, _ = (e, i, t, r) => {
  for (var a = r > 1 ? void 0 : r ? V(i, t) : i, s = e.length - 1, l; s >= 0; s--)
    (l = e[s]) && (a = (r ? l(i, t, a) : l(a)) || a);
...
var U = Object.defineProperty, O = Object.getOwnPropertyDescriptor, x = (e, i, t, r) => {
  for (var a = r > 1 ? void 0 : r ? O(i, t) : i, s = e.length - 1, l; s >= 0; s--)
    (l = e[s]) && (a = (r ? l(i, t, a) : l(a)) || a);
...
let c = class extends f(m) {
  ...
  _renderPackageCard(e, i) {
    const t = e.lengthCm && e.widthCm && e.heightCm ? `${e.lengthCm} × ${e.widthCm} × ${e.heightCm} cm` : "No dimensions";
        ...
        <div class="package-fields">
          <div class="field-group">
            ...
            <uui-input
              ...
              @input=${(r) => this._updatePackage(i, "weight", parseFloat(r.target.value) || 0)}
              placeholder="0.50">
            </uui-input>
          </div>
          <div class="field-group">
            ...
            <uui-input
              ...
              @input=${(r) => this._updatePackage(i, "lengthCm", parseFloat(r.target.value) || null)}
              placeholder="20">
            </uui-input>
          </div>
          <div class="field-group">
            ...
            <uui-input
              ...
              @input=${(r) => this._updatePackage(i, "widthCm", parseFloat(r.target.value) || null)}
              placeholder="15">
            </uui-input>
          </div>
          <div class="field-group">
            ...
            <uui-input
              ...
              @input=${(r) => this._updatePackage(i, "heightCm", parseFloat(r.target.value) || null)}
              placeholder="10">
            </uui-input>
          </div>
        </div>
...
var N = Object.defineProperty, T = Object.getOwnPropertyDescriptor, $ = (e, i, t, r) => {
  for (var a = r > 1 ? void 0 : r ? T(i, t) : i, s = e.length - 1, l; s >= 0; s--)
    (l = e[s]) && (a = (r ? l(i, t, a) : l(a)) || a);
  return r && a && N(i, t, a), a;
};
...
var B = Object.defineProperty, I = Object.getOwnPropertyDescriptor, y = (e, i, t, r) => {
  for (var a = r > 1 ? void 0 : r ? I(i, t) : i, s = e.length - 1, l; s >= 0; s--)
    (l = e[s]) && (a = (r ? l(i, t, a) : l(a)) || a);
  return r && a && B(i, t, a), a;
};
let p = class extends f(m) {
  constructor() {
...
//# sourceMappingURL=product-shipping-exclusions.element-DcUqzyUF.js.map
