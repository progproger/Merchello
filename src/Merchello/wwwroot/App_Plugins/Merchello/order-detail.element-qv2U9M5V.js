...
import { b as L, a as p, h as ge } from "./formatting-DPh4-DfL.js";
import { M as m } from "./merchello-api-DFeoGYDY.js";
import { q as fe } from "./navigation-BGhEgega.js";
import { S as j, P as K } from "./order.types-_o7xLk2Z.js";
import "./line-item-identity.element-DTtPHFdM.js";
const be = new F("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), _e = new F("Merchello.CancelInvoice.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), ye = new F("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var ke = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, te = (e) => {
  throw TypeError(e);
}, P = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? $e(i, t) : i, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && ke(i, t, r), r;
...
P([
  n()
], C.prototype, "_expandedShipmentId", 2);
P([
  n()
], C.prototype, "_trackingForm", 2);
P([
  n()
], C.prototype, "_isUpdatingStatus", 2);
C = P([
  B("merchello-shipments-view")
], C);
const xe = new F("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
...
var we = Object.defineProperty, Se = Object.getOwnPropertyDescriptor, re = (e) => {
  throw TypeError(e);
}, O = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Se(i, t) : i, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && we(i, t, r), r;
...
var ze = Object.defineProperty, Pe = Object.getOwnPropertyDescriptor, oe = (e) => {
  throw TypeError(e);
}, w = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Pe(i, t) : i, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && ze(i, t, r), r;
}, ne = (e, i, t) => i.has(e) || oe("Cannot " + t), D = (e, i, t) => (ne(e, i, "read from private field"), i.get(e)), Me = (e, i, t) => i.has(e) ? oe("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, o) => (ne(e, i, "write to private field"), i.set(e, t), t), x;
let _ = class extends H(V) {
  constructor() {
    super(...arguments), this.invoiceId = "", this._providers = [], this._linkInfo = null, this._selectedProvider = "", this._isLoading = !0, this._isGenerating = !1, this._isDeactivating = !1, this._errorMessage = null, this._copySuccess = !1, Me(this, x, !1);
  }
  connectedCallback() {
...
var Ie = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, le = (e) => {
  throw TypeError(e);
}, h = (e, i, t, o) => {
  for (var r = o > 1 ? void 0 : o ? Ee(i, t) : i, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (r = (o ? v(i, t, r) : v(r)) || r);
  return o && r && Ie(i, t, r), r;
...
let c = class extends H(V) {
  ...
  async _openCancelInvoiceModal() {
    if (!this._order || !l(this, g)) return;
    const i = await l(this, g).open(this, _e, {
      data: {
      ...
      <div class="card fulfillment-card">
        ...
        <div class="fulfillment-shipping-method">
          ...
          <div class="fulfillment-shipping-details">
            ...
            <span class="fulfillment-shipping-cost ${e.shippingCost === 0 ? "free-shipping" : ""}">${e.shippingCost === 0 ? "FREE" : p(e.shippingCost, t, o)}</span>
          </div>
        </div>
            ...
            <div class="card payment-card">
              ...
              <div class="payment-summary">
                ...
                <div class="summary-row">
                  ...
                  <span class="${e.shippingCost === 0 ? "free-shipping" : ""}">${e.shippingCost === 0 ? "FREE" : p(e.shippingCost, e.currencyCode, e.currencySymbol)}</span>
                </div>
                ${e.tax > 0 ? a`
                  <div class="summary-row">
                    <span>Tax</span>
...
//# sourceMappingURL=order-detail.element-qv2U9M5V.js.map
