...
var y = Object.defineProperty, x = Object.getOwnPropertyDescriptor, g = (e) => {
  ...
  for (var t = d > 1 ? void 0 : d ? x(i, a) : i, c = e.length - 1, p; c >= 0; c--)
    (p = e[c]) && (t = (d ? p(i, a, t) : p(t)) || t);
  return d && t && y(i, a, t), t;
}, _ = (e, i, a) => i.has(e) || g("Cannot " + a), h = (e, i, a) => (_(e, i, "read from private field"), i.get(e)), T = (e, i, a) => i.has(e) ? g("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), $ = (e, i, a, d) => (_(e, i, "write to private field"), i.set(e, a), a), n;
let s = class extends b {
  constructor() {
    super(), this._preview = null, this._isLoading = !0, this._errorMessage = null, this._testRecipient = "", this._isSendingTest = !1, T(this, n), this.consumeContext(w, (e) => {
      $(this, n, e);
    });
  }
  connectedCallback() {
...
//# sourceMappingURL=email-preview-modal.element-BcE-ri3n.js.map
