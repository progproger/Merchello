import { nothing as g, html as s, css as m, state as r, customElement as y } from "@umbraco-cms/backoffice/external/lit";
...
var b = Object.defineProperty, S = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, a = (e, i, t, l) => {
  for (var d = l > 1 ? void 0 : l ? S(i, t) : i, h = e.length - 1, c; h >= 0; h--)
    (c = e[h]) && (d = (l ? c(i, t, d) : c(d)) || d);
  return l && d && b(i, t, d), d;
}, v = (e, i, t) => i.has(e) || _("Cannot " + t), u = (e, i, t) => (v(e, i, "read from private field"), i.get(e)), T = (e, i, t) => i.has(e) ? _("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), G = (e, i, t, l) => (v(e, i, "write to private field"), i.set(e, t), t), n;
let o = class extends C {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._isLoadingRegions = !1, this._isLoadingTaxGroups = !0, this._countryCode = "", this._regionCode = "", this._shippingTaxGroupId = null, this._countries = [], this._regions = [], this._taxGroups = [], T(this, n), this.consumeContext(f, (e) => {
      G(this, n, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), this._loadCountries(), this._loadTaxGroups(), this.data?.override && (this._countryCode = this.data.override.countryCode, this._regionCode = this.data.override.regionCode ?? "", this._shippingTaxGroupId = this.data.override.shippingTaxGroupId ?? null, this._countryCode && this._loadRegions(this._countryCode));
  }
...
//# sourceMappingURL=shipping-tax-override-modal.element-AyMOLOFa.js.map
