...
import { UmbMediaPickerInputContext as M, UMB_MEDIA_PICKER_MODAL as $ } from "@umbraco-cms/backoffice/media";
import "@umbraco-cms/backoffice/imaging";
import { m as k } from "./modal-layout.styles-C2OaUji5.js";
var C = Object.defineProperty, S = Object.getOwnPropertyDescriptor, b = (e) => {
  throw TypeError(e);
}, c = (e, i, t, a) => {
  for (var o = a > 1 ? void 0 : a ? S(i, t) : i, s = e.length - 1, v; s >= 0; s--)
    (v = e[s]) && (o = (a ? v(i, t, o) : v(o)) || o);
  return a && o && C(i, t, o), o;
}, _ = (e, i, t) => i.has(e) || b("Cannot " + t), d = (e, i, t) => (_(e, i, "read from private field"), i.get(e)), g = (e, i, t) => i.has(e) ? b("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), m = (e, i, t, a) => (_(e, i, "write to private field"), i.set(e, t), t), h, p, u;
let n = class extends x {
  constructor() {
    super(), this._formData = {
      ...
      isRequired: !1,
      values: []
    }, this._isSaving = !1, this._errorMessage = null, this._originalIsVariant = !1, g(this, h), g(this, p), g(this, u, !1), new M(this), this.consumeContext(A, (e) => {
      m(this, h, e);
  ...
  _getFirstDropdownValue(e) {
    if (Array.isArray(e)) {
      const i = e.find((t) => typeof t == "string");
  ...
  _handleOptionDetailsDatasetChange(e) {
    const i = e.target, t = this._toPropertyValueMap(i.value ?? []), a = this._getBooleanFromPropertyValue(t.isVariant, !1);
    this._formData = {
      ...this._formData,
      ...
      isVariant: a,
      isMultiSelect: a ? !1 : this._getBooleanFromPropertyValue(t.isMultiSelect, !0),
      isRequired: a ? !1 : this._getBooleanFromPropertyValue(t.isRequired, !1)
    };
  }
  async _handleSave() {
  ...
  _removeValue(e) {
    ...
    i.splice(e, 1), i.forEach((t, a) => t.sortOrder = a), this._formData = { ...this._formData, values: i };
  }
  _updateValue(e, i, t) {
    const a = [...this._formData.values || []];
    a[e] = { ...a[e], [i]: t }, this._formData = { ...this._formData, values: a };
  }
  async _openMediaPicker(e) {
    const i = this._formData.values?.[e];
    if (!i) return;
    const t = d(this, p)?.open(this, $, {
      data: {
        multiple: !1
      },
      value: {
    ...
    try {
      ...
      if (!d(this, u)) return;
      a?.selection?.length && this._updateValue(e, "mediaKey", a.selection[0]);
    } catch {
    }
  }
  _clearMedia(e) {
  ...
  _renderValueEditor(e, i) {
    const t = this._formData.optionUiAlias, a = !this._formData.isVariant;
    return r`
      <div class="value-row ${a ? "is-addon" : ""}">
  ...
  render() {
    const e = !this.data?.option, i = this._formData.values?.length || 0, t = this._getMaxValues(), a = this._formData.isVariant && i > 0 ? `Will create ${i} variants` : "";
    return r`
        ...
        <div class="modal-content">
          ...
          ${this._formData.isVariant && i > 0 ? r`
                <div class="info-banner">
                  ...
                  <div>
                    ...
                    <p>${a} (when combined with other variant options, this creates a cartesian product)</p>
                  </div>
                </div>
              ` : l}
          ...
          <uui-box>
            <div class="section-header" slot="headline">
              ...
              <span class="value-count">${i}/${t}</span>
            </div>
...
//# sourceMappingURL=option-editor-modal.element-LgZ68rx2.js.map
