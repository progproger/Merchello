import { LitElement as D, nothing as C, html as u, css as w, state as n, customElement as A } from "@umbraco-cms/backoffice/external/lit";
import { UmbElementMixin as M } from "@umbraco-cms/backoffice/element-api";
import { UmbModalToken as L, UMB_MODAL_MANAGER_CONTEXT as R, UMB_CONFIRM_MODAL as P } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as z } from "@umbraco-cms/backoffice/notification";
import { c as B, a as b, C as f, b as g } from "./upsell.types-ChZp0X_-.js";
import { M as v } from "./merchello-api-B76CV0sD.js";
import { g as E } from "./store-settings-7zNVo6g4.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-D2dcD7_8.js";
import { s as x } from "./navigation-CvTcY6zJ.js";
import { b as U, a as I } from "./formatting-MfE1tvkN.js";
...
var W = Object.defineProperty, F = Object.getOwnPropertyDescriptor, S = (e) => {
  throw TypeError(e);
}, o = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? F(i, t) : i, _ = e.length - 1, $; _ >= 0; _--)
    ($ = e[_]) && (r = (s ? $(i, t, r) : $(r)) || r);
  return s && r && W(i, t, r), r;
}, T = (e, i, t) => i.has(e) || S("Cannot " + t), a = (e, i, t) => (T(e, i, "read from private field"), i.get(e)), m = (e, i, t) => i.has(e) ? S("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), d = (e, i, t, s) => (T(e, i, "write to private field"), i.set(e, t), t), p, h, c, y, k;
let l = class extends M(D) {
  constructor() {
    super(), this._upsells = [], this._isLoading = !0, this._errorMessage = null, this._page = 1, this._pageSize = 50, this._totalItems = 0, this._totalPages = 0, this._activeTab = "all", this._selectedUpsells = /* @__PURE__ */ new Set(), this._searchTerm = "", this._isDeleting = !1, this._isBulkActionRunning = !1, this._searchDebounceTimer = null, m(this, p), m(this, h), m(this, c, !1), m(this, y), m(this, k), this.consumeContext(R, (e) => {
      d(this, p, e);
  ...
  async _handleCreateUpsell() {
    if (!a(this, p)) return;
    const i = await a(this, p).open(this, N, {
      data: {}
    }).onSubmit().catch(() => {
    });
    a(this, c) && i?.id && x(i.id);
  }
  _getDisplayLocationIcons(e) {
    const i = [];
    return e & b.Checkout && i.push("icon-credit-card"), e & b.Basket && i.push("icon-shopping-basket"), e & b.ProductPage && i.push("icon-box"), e & b.Email && i.push("icon-mailbox"), e & b.Confirmation && i.push("icon-check"), i;
  }
    ...
    return u`
      ...
      (t) => u`
        ...
        (s) => u`<uui-icon
                ...
                <uui-table-cell style="text-align: right;">${U(t.totalImpressions)}</uui-table-cell>
                <uui-table-cell style="text-align: right;">${this._formatCtr(t.totalImpressions, t.totalClicks)}</uui-table-cell>
                <uui-table-cell style="text-align: right;">${U(t.totalConversions)}</uui-table-cell>
...
//# sourceMappingURL=upsells-list.element-DOdEnL8M.js.map
