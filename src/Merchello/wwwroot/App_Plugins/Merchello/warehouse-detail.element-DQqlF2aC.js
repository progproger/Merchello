...
import { m as E, z as L, A as P } from "./navigation-Bu0pwyW2.js";
import { b as z } from "./badge.styles-DUcdl6GY.js";
import { a as F } from "./formatting-DQoM1drN.js";
...
}, S = (e, t, a) => t.has(e) || C("Cannot " + a), i = (e, t, a) => (S(e, t, "read from private field"), t.get(e)), _ = (e, t, a) => t.has(e) ? C("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), v = (e, t, a, d) => (S(e, t, "write to private field"), t.set(e, a), a), b, p, m, h, o;
function H() {
  return {
    name: null,
    email: null,
...
let r = class extends T(D) {
  ...
  connectedCallback() {
    super.connectedCallback(), v(this, o, !0), this._createRoutes(), this._loadSuppliers(), this._loadCountries(), this._loadFulfilmentProviders();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), v(this, o, !1), i(this, b) && (clearTimeout(i(this, b)), v(this, b, null));
  }
  // Tab routing
  _createRoutes() {
  ...
  async _openCreateSupplierModal() {
    ...
    i(this, o) && t?.isCreated && t.supplier && (this._suppliers = [...this._suppliers, t.supplier], this._formData = { ...this._formData, supplierId: t.supplier.id });
  }
  async _handleSave() {
  ...
  async _openServiceRegionModal(e) {
    ...
    const a = await i(this, m).open(this, W, {
      data: {
    ...
    i(this, o) && a?.isSaved && i(this, p)?.reload();
  }
  async _handleDeleteRegion(e, t) {
    if (e.stopPropagation(), !this._warehouse?.id) return;
    const a = t.regionDisplay || `${t.stateOrProvinceCode || ""} ${t.countryCode}`.trim(), d = i(this, m)?.open(this, y, {
      data: {
    ...
    const { error: l } = await g.deleteServiceRegion(this._warehouse.id, t.id);
    if (i(this, o)) {
  ...
  async _openShippingOptionModal(e) {
    ...
    i(this, o) && a?.isSaved && (this._loadShippingOptions(), i(this, p)?.reload());
  }
  ...
  async _handleAddProducts() {
    ...
    if (i(this, o) && a?.selections?.length) {
      const d = [...new Set(a.selections.map((f) => f.productRootId))], { error: l } = await g.addProductsToWarehouse(this._warehouse.id, d);
      if (!i(this, o)) return;
      if (l) {
        i(this, h)?.peek("danger", {
...
n([
  u()
], r.prototype, "_warehouseProducts", 2);
n([
  u()
], r.prototype, "_productsPage", 2);
n([
  u()
], r.prototype, "_productsTotalPages", 2);
n([
  u()
], r.prototype, "_productsTotalItems", 2);
n([
  u()
], r.prototype, "_productsSearch", 2);
n([
  u()
], r.prototype, "_selectedProductIds", 2);
n([
  u()
], r.prototype, "_isLoadingProducts", 2);
n([
  u()
], r.prototype, "_isRemovingProducts", 2);
n([
  u()
], r.prototype, "_productsLoaded", 2);
r = n([
...
//# sourceMappingURL=warehouse-detail.element-DQqlF2aC.js.map
