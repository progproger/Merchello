import { LitElement as A, html as o, nothing as d, css as x, property as b, state as p, customElement as P } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as z } from "@umbraco-cms/backoffice/modal";
import { M as S } from "./merchello-api-BT8AWvQk.js";
import { c as O } from "./formatting-6Hz_EImA.js";
...
var M = Object.defineProperty, V = Object.getOwnPropertyDescriptor, h = (e, i, t, s) => {
...
let l = class extends z {
  ...
  async _loadVariantsForRoot(e) {
    ...
    ), r = a.reduce((c, g) => c + g.availableStock, 0), n = t.isDigitalProduct;
    let m = "InStock";
    n ? m = "Untracked" : r <= 0 ? m = "OutOfStock" : a.some((c) => c.stockStatus === "LowStock") && (m = "LowStock"), this._productRoots = this._productRoots.map(
      (c, g) => g === i ? { ...c, variants: a, variantsLoaded: !0, totalStock: r, stockStatus: m } : c
    );
  }
  async _mapToPickerVariant(e, i) {
    ...
    let a = !0, r = null, n = !0, m = null, c = null, g = "InStock";
    if (!this._isPropertyEditorMode) {
      if (this._config?.shippingAddress && !i.isDigitalProduct) {
        ...
        a = u.canAddToOrder, r = u.blockedReason, n = u.canAddToOrder, m = u.warehouseId, c = u.warehouseName, g = u.aggregateStockStatus;
      } else if (!i.isDigitalProduct && e.warehouseStock.length > 0) {
        const u = await this._getDefaultFulfillingWarehouse(e.id);
        a = u.canAddToOrder, r = u.blockedReason, m = u.warehouseId, c = u.warehouseName, g = u.aggregateStockStatus;
      }
    }
    let $ = g;
    if (m) {
  ...
  async _transitionToShippingSelection(e, i) {
    ...
    const c = n.availableOptions.map((g) => ({
      id: g.id,
      name: g.name,
      ...
      <umb-body-layout headline="Select Add-ons (Optional)">
        <div id="main">
          ...
          <div class="addon-options">
            ${e.addonOptions.map((g) => this._renderAddonOption(g))}
          </div>
        </div>
...
//# sourceMappingURL=product-picker-modal.element-1rDrFHeP.js.map
