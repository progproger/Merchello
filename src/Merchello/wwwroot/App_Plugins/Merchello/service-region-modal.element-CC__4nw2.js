import { nothing as g, html as u, css as h, state as a, customElement as p } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as v } from "@umbraco-cms/backoffice/modal";
import { M as d } from "./merchello-api-BSrPLgGs.js";
import { b as m } from "./badge.styles-C_lNgH9O.js";
var _ = Object.defineProperty, b = Object.getOwnPropertyDescriptor, r = (e, i, o, s) => {
  for (var n = s > 1 ? void 0 : s ? b(i, o) : i, c = e.length - 1, l; c >= 0; c--)
    (l = e[c]) && (n = (s ? l(i, o, n) : l(n)) || n);
  return s && n && _(i, o, n), n;
};
let t = class extends v {
  ...
  _validate() {
    ...
    return this._countryCode || (e.country = "Please select a country"), (this.data?.existingRegions ?? []).some(
      (s) => s.countryCode === this._countryCode && (s.stateOrProvinceCode || "") === (this._stateOrProvinceCode || "") && s.id !== this.data?.region?.id
...
//# sourceMappingURL=service-region-modal.element-CC__4nw2.js.map
