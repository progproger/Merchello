import { LitElement as $, html as n, nothing as g, css as C, state as m, customElement as z } from "@umbraco-cms/backoffice/external/lit";
...
var O = Object.defineProperty, D = Object.getOwnPropertyDescriptor, w = (e) => {
  throw TypeError(e);
}, h = (e, i, r, o) => {
  for (var a = o > 1 ? void 0 : o ? D(i, r) : i, c = e.length - 1, _; c >= 0; c--)
    (_ = e[c]) && (a = (o ? _(i, r, a) : _(a)) || a);
  return o && a && O(i, r, a), a;
}, G = (e, i, r) => i.has(e) || w("Cannot " + r), t = (e, i, r) => (G(e, i, "read from private field"), r ? r.call(e) : i.get(e)), f = (e, i, r) => i.has(e) ? w("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, r), b = (e, i, r, o) => (G(e, i, "write to private field"), i.set(e, r), r), u, s, l, y, p;
let d = class extends E($) {
  constructor() {
    super(), this._filterGroups = [], this._isLoading = !0, this._errorMessage = null, this._isDeletingGroup = null, this._expandedGroups = /* @__PURE__ */ new Set(), f(this, u), f(this, s), f(this, l, !1), f(this, y, new x(this, {
    ...
    })), f(this, p, /* @__PURE__ */ new Map()), this.consumeContext(S, (e) => {
      b(this, u, e);
  ...
  connectedCallback() {
    super.connectedCallback(), b(this, l, !0), this._loadFilterGroups();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), b(this, l, !1), t(this, p).clear();
  }
  ...
  async _handleAddFilterGroup() {
    ...
    t(this, l) && i?.isCreated && (t(this, s)?.peek("positive", {
      data: {
  ...
  async _handleEditFilterGroup(e) {
    ...
    t(this, l) && r?.isUpdated && (t(this, s)?.peek("positive", {
      data: {
  ...
  async _handleDeleteFilterGroup(e, i) {
    ...
    const r = i.filters?.length || 0, o = r > 0 ? ` This will also delete ${r} filter${r > 1 ? "s" : ""} in this group.` : "", a = t(this, u)?.open(this, A, {
      data: {
    ...
    if (t(this, l)) {
      if (this._isDeletingGroup = null, c) {
        this._errorMessage = `Failed to delete filter group: ${c.message}`, t(this, s)?.peek("danger", {
          data: { headline: "Failed to delete", message: c.message }
        });
        return;
      }
      t(this, s)?.peek("positive", {
  ...
  async _handleAddFilter(e) {
    ...
    t(this, l) && r?.isCreated && (t(this, s)?.peek("positive", {
      data: {
  ...
  async _handleEditFilter(e, i) {
    ...
    t(this, l) && (o?.isUpdated ? (t(this, s)?.peek("positive", {
      data: {
        headline: "Filter updated",
        message: `"${o.filter?.name}" has been updated successfully`
      }
    }), this._loadFilterGroups()) : o?.isDeleted && (t(this, s)?.peek("positive", {
    ...
    return n`
      <div
        ...
        <div class="filter-item-content">
          ${e.hexColour ? n`<span class="filter-color-swatch" style="background: ${e.hexColour}"></span>` : g}
          <span class="filter-name">${e.name}</span>
          ${e.productCount > 0 ? n`<span class="filter-product-count">${e.productCount} product${e.productCount > 1 ? "s" : ""}</span>` : g}
        </div>
        ...
        ${i ? n`
              <div class="filter-group-content">
                <div class="filters-container" data-group-id=${e.id}>
                  ${e.filters && e.filters.length > 0 ? e.filters.map((a) => this._renderFilterItem(a, e.id)) : n`
      ...
      <umb-body-layout header-fit-height main-no-padding>
        <div class="filters-container">
          ...
          <div class="filter-groups-container">
            ${this._isLoading || this._errorMessage ? g : this._filterGroups.length === 0 ? this._renderEmptyState() : this._filterGroups.map((e) => this._renderFilterGroupCard(e))}
          </div>
        </div>
      </umb-body-layout>
    `;
...
//# sourceMappingURL=filters-list.element-CNnbX301.js.map
