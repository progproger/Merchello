import { LitElement as G, nothing as o, html as a, css as V, state as l, customElement as B, property as J, unsafeHTML as de } from "@umbraco-cms/backoffice/external/lit";
import { d as q, p as ue } from "./purify.es-Cuv6u9x0.js";
...
import { UmbModalToken as T, UMB_MODAL_MANAGER_CONTEXT as W, UMB_CONFIRM_MODAL as ce } from "@umbraco-cms/backoffice/modal";
...
import { M as he, a as ve } from "./customer-orders-modal.token-BBooCVRJ.js";
import { b as A, P as X, a as c, h as ee, j as ge } from "./formatting-6Hz_EImA.js";
import { M as h } from "./merchello-api-BT8AWvQk.js";
import { m as fe } from "./navigation-CgHIQALx.js";
import "./product-image.element-D7HwAIKr.js";
const be = new T("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), ye = new T("Merchello.CancelInvoice.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), _e = new T("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var ke = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, ie = (e) => {
  throw TypeError(e);
}, N = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? xe(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && ke(i, t, r), r;
}, te = (e, i, t) => i.has(e) || ie("Cannot " + t), x = (e, i, t) => (te(e, i, "read from private field"), t ? t.call(e) : i.get(e)), R = (e, i, t) => i.has(e) ? ie("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), D = (e, i, t, s) => (te(e, i, "write to private field"), i.set(e, t), t), O, E, U, w;
let z = class extends j(G) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, R(this, O), R(this, E), R(this, U), R(this, w, !1), this.consumeContext(Q, (e) => {
      D(this, O, e), this.observe(x(this, O).order, (i) => {
  ...
  async _loadShipments() {
    ...
    x(this, w) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  async _handleEditShipment(e) {
    if (!x(this, E)) return;
    (await x(this, E).open(this, _e, {
      data: { shipment: e }
    }).onSubmit().catch(() => {
    }))?.isUpdated && this._loadShipments();
  }
  async _handleDeleteShipment(e) {
    if (!await x(this, E)?.open(this, ce, {
      data: {
    ...
    if (x(this, w)) {
      if (s) {
        x(this, U)?.peek("danger", {
          data: { headline: "Failed to delete", message: s.message }
        });
        return;
      }
      this._loadShipments(), this._invoiceId && x(this, O)?.load(this._invoiceId);
    }
  }
...
const $e = new T("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), we = new T("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var Ce = Object.defineProperty, ze = Object.getOwnPropertyDescriptor, ae = (e) => {
  throw TypeError(e);
}, I = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? ze(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Ce(i, t, r), r;
}, re = (e, i, t) => i.has(e) || ae("Cannot " + t), S = (e, i, t) => (re(e, i, "read from private field"), i.get(e)), Y = (e, i, t) => i.has(e) ? ae("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), H = (e, i, t, s) => (re(e, i, "write to private field"), i.set(e, t), t), C, M;
let $ = class extends j(G) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, Y(this, C), Y(this, M, !1), this.consumeContext(W, (e) => {
      H(this, C, e);
    });
  }
  connectedCallback() {
    super.connectedCallback(), H(this, M, !0), this.invoiceId && this._loadPayments();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), H(this, M, !1);
  }
  updated(e) {
...
var Se = Object.defineProperty, Pe = Object.getOwnPropertyDescriptor, se = (e) => {
  throw TypeError(e);
}, k = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? Pe(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Se(i, t, r), r;
}, oe = (e, i, t) => i.has(e) || se("Cannot " + t), P = (e, i, t) => (oe(e, i, "read from private field"), i.get(e)), Ee = (e, i, t) => i.has(e) ? se("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), K = (e, i, t, s) => (oe(e, i, "write to private field"), i.set(e, t), t), _;
let b = class extends j(G) {
  constructor() {
    super(...arguments), this.invoiceId = "", this._providers = [], this._linkInfo = null, this._selectedProvider = "", this._isLoading = !0, this._isGenerating = !1, this._isDeactivating = !1, this._errorMessage = null, this._copySuccess = !1, Ee(this, _, !1);
  }
  connectedCallback() {
    super.connectedCallback(), K(this, _, !0), this.invoiceId && this._loadData();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), K(this, _, !1);
  }
  updated(e) {
...
k([
  l()
], b.prototype, "_providers", 2);
k([
  l()
], b.prototype, "_linkInfo", 2);
k([
  l()
], b.prototype, "_selectedProvider", 2);
k([
  l()
], b.prototype, "_isLoading", 2);
k([
  l()
], b.prototype, "_isGenerating", 2);
k([
  l()
], b.prototype, "_isDeactivating", 2);
k([
  l()
], b.prototype, "_errorMessage", 2);
k([
  l()
], b.prototype, "_copySuccess", 2);
b = k([
  B("merchello-payment-link-panel")
], b);
var Me = Object.defineProperty, Ie = Object.getOwnPropertyDescriptor, ne = (e) => {
  throw TypeError(e);
}, p = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? Ie(i, t) : i, d = e.length - 1, m; d >= 0; d--)
    (m = e[d]) && (r = (s ? m(i, t, r) : m(r)) || r);
  return s && r && Me(i, t, r), r;
}, le = (e, i, t) => i.has(e) || ne("Cannot " + t), n = (e, i, t) => (le(e, i, "read from private field"), i.get(e)), F = (e, i, t) => i.has(e) ? ne("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), L = (e, i, t, s) => (le(e, i, "write to private field"), i.set(e, t), t), g, v, f, y;
let u = class extends j(G) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, F(this, g), F(this, v), F(this, f), F(this, y, !1), this.consumeContext(Q, (e) => {
      L(this, g, e), n(this, g) && this.observe(n(this, g).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), L(this, y, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), L(this, y, !1);
  }
  async _loadCountries() {
    const { data: e } = await h.getCountries();
    n(this, y) && e && (this._countries = e);
  }
  ...
  async _openFulfillmentModal() {
    ...
    await n(this, v).open(this, be, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), n(this, y) && n(this, g)?.load(e);
  }
  async _openEditOrderModal() {
    if (!this._order || !n(this, v)) return;
    const e = this._order.id;
    await n(this, v).open(this, me, {
      data: { invoiceId: e }
    }).onSubmit().catch(() => {
    }), n(this, y) && n(this, g)?.load(e);
  }
  async _openCancelInvoiceModal() {
    if (!this._order || !n(this, v)) return;
    const i = await n(this, v).open(this, ye, {
      data: {
    ...
    n(this, y) && i?.cancelled && (n(this, f)?.peek("positive", {
      data: {
  ...
  async _openCustomerEditModal() {
    if (!this._order?.customerId || !n(this, v)) return;
    const { data: e, error: i } = await h.getCustomer(this._order.customerId);
    if (i || !e) {
    ...
    (await n(this, v).open(this, ve, {
      data: { customer: e }
    })?.onSubmit().catch(() => {
    }))?.isUpdated && n(this, f)?.peek("positive", {
  ...
  _renderMarkdown(e) {
    ...
    const i = q.parse(e), t = ue.sanitize(i);
    return de(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
  ...
  async _saveEditing() {
    ...
    if (n(this, y)) {
      ...
      }), this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, n(this, g)?.load(this._order.id);
    }
  }
  ...
  async _savePurchaseOrder() {
    ...
    if (n(this, y)) {
      ...
      }), this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", n(this, g)?.load(this._order.id);
    }
  }
  ...
  _renderFulfillmentCard(e) {
    const i = this._order?.canFulfill ?? !1, t = this._order?.currencyCode, s = this._order?.currencySymbol;
    return a`
  ...
  _handlePaymentChange() {
    this._order && n(this, g)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    if (n(this, y)) {
      if (this._isPostingNote = !1, e) {
        this._noteError = e.message || "Failed to post note", n(this, f)?.peek("danger", {
      ...
      }), this._newNoteText = "", this._isVisibleToCustomer = !1, n(this, g)?.load(this._order.id);
    }
  }
  _renderLoadingState() {
    return a`<div class="loading"><uui-loader></uui-loader></div>`;
  ...
  render() {
    ...
    return a`
      <umb-body-layout header-fit-height main-no-padding>
        <!-- Back button -->
        <uui-button slot="header" compact href=${fe()} label="Back to orders" class="back-button">
        ...
        <div id="header" slot="header">
          ...
          <div class="header-title">
            ...
            <span class="order-meta">${ge(e.dateCreated)} from ${e.channel}</span>
          </div>
...
//# sourceMappingURL=order-detail.element-__nkD8f0.js.map
