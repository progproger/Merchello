import { html as l, css as d, state as s, customElement as m } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as p } from "@umbraco-cms/backoffice/modal";
import { M as h } from "./merchello-api-DFeoGYDY.js";
import { b as v } from "./formatting-DPh4-DfL.js";
import "./line-item-identity.element-DGDuhyV5.js";
var g = Object.defineProperty, b = Object.getOwnPropertyDescriptor, a = (i, e, u, o) => {
  for (var r = o > 1 ? void 0 : o ? b(e, u) : e, n = i.length - 1, c; n >= 0; n--)
    (c = i[n]) && (r = (o ? c(e, u, r) : c(r)) || r);
  return o && r && g(e, u, r), r;
};
...
//# sourceMappingURL=shipment-edit-modal.element-C6uT-Klw.js.map
