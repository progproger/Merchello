import { nothing as n, html as r, css as D, state as h, customElement as x } from "@umbraco-cms/backoffice/external/lit";
...
var U = Object.defineProperty, O = Object.getOwnPropertyDescriptor, b = (e) => {
  ...
  for (var o = i > 1 ? void 0 : i ? O(a, t) : a, l = e.length - 1, _; l >= 0; l--)
    (_ = e[l]) && (o = (i ? _(a, t, o) : _(o)) || o);
  return i && o && U(a, t, o), o;
}, y = (e, a, t) => a.has(e) || b("Cannot " + t), u = (e, a, t) => (y(e, a, "read from private field"), t ? t.call(e) : a.get(e)), f = (e, a, t) => a.has(e) ? b("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, t), v = (e, a, t, i) => (y(e, a, "write to private field"), a.set(e, t), t), g, c, d, m;
let s = class extends w {
  constructor() {
    super(), this._formData = {
      ...
      isRequired: !1,
      values: []
    }, this._isSaving = !1, this._errorMessage = null, this._originalIsVariant = !1, this._hasAttemptedSave = !1, f(this, g), f(this, c), f(this, d, !1), f(this, m, new M(this, {
      ...
      onChange: ({ model: e }) => {
        e.forEach((a, t) => a.sortOrder = t), this._formData = { ...this._formData, values: e };
      }
  ...
  connectedCallback() {
    ...
    }, this._originalIsVariant = this.data.option.isVariant), u(this, m).setModel(this._formData.values ?? []);
  }
  ...
  _getFirstDropdownValue(e) {
    if (Array.isArray(e)) {
      const a = e.find((t) => typeof t == "string");
      return typeof a == "string" ? a : "";
    }
    return typeof e == "string" ? e : "";
  }
  _getBooleanFromPropertyValue(e, a) {
  ...
  _getOptionUiPropertyConfig() {
    return [
      {
        alias: "items",
        value: (this.data?.settings?.optionUiAliases ?? []).map((a) => ({
          name: a.charAt(0).toUpperCase() + a.slice(1),
          value: a
        }))
      }
  ...
  _handleOptionDetailsDatasetChange(e) {
    const a = e.target, t = this._toPropertyValueMap(a.value ?? []), i = this._getBooleanFromPropertyValue(t.isVariant, !1);
    this._formData = {
      ...this._formData,
      name: this._getStringFromPropertyValue(t.name),
      alias: this._getStringFromPropertyValue(t.alias),
      optionTypeAlias: this._getFirstDropdownValue(t.optionTypeAlias),
      optionUiAlias: this._getFirstDropdownValue(t.optionUiAlias),
      isVariant: i,
      isMultiSelect: i ? !1 : this._getBooleanFromPropertyValue(t.isMultiSelect, !0),
      isRequired: i ? !1 : this._getBooleanFromPropertyValue(t.isRequired, !1)
    };
  }
  async _handleSave() {
    if (this._validateForm()) {
      if (this.data?.option && this._originalIsVariant !== this._formData.isVariant) {
        const e = this._formData.isVariant ? "Enabling 'Generates Variants' will create new product variants. You'll need to regenerate variants for this to take effect." : "Disabling 'Generates Variants' will not delete existing variants, but they won't be regenerated.", a = u(this, c)?.open(this, A, {
          data: {
      ...
      }, u(this, g)?.peek("positive", { data: { headline: "Option saved", message: `"${this._formData.name}" has been saved` } }), this.modalContext?.submit();
    }
  }
  _handleDelete() {
    this.value = {
  ...
  _validateForm() {
    ...
    const e = this._formData.values.filter((t) => !t.name?.trim());
    if (e.length > 0)
    ...
    for (const t of this._formData.values) {
      const i = t.name.trim().toLowerCase();
      if (a.has(i))
        return this._errorMessage = `Duplicate value name "${t.name.trim()}". Each value must have a unique name.`, !1;
      a.add(i);
    }
    return !0;
  }
  async _addValue() {
    ...
    this._errorMessage = null, e.push({
      ...
      skuSuffix: null,
      weightKg: null
    }), this._formData = { ...this._formData, values: e }, u(this, m).setModel(e), await this.updateComplete;
    const a = this.renderRoot.querySelectorAll(".value-row uui-input[label='Value name']");
    a[a.length - 1]?.focus();
  }
  _removeValue(e) {
    const a = [...this._formData.values || []];
    a.splice(e, 1), a.forEach((t, i) => t.sortOrder = i), this._formData = { ...this._formData, values: a }, u(this, m).setModel(a);
  }
  _updateValue(e, a, t) {
    const i = [...this._formData.values || []];
    i[e] = { ...i[e], [a]: t }, this._formData = { ...this._formData, values: i }, a === "name" && this._errorMessage && (this._errorMessage = null);
  }
  async _openMediaPicker(e) {
    const a = this._formData.values?.[e];
    if (!a) return;
    const t = u(this, c)?.open(this, C, {
      data: {
        multiple: !1
      },
      value: {
        selection: a.mediaKey ? [a.mediaKey] : []
      }
    });
    try {
  ...
  _renderValueEditor(e, a) {
    const t = this._formData.optionUiAlias, i = !this._formData.isVariant;
    return r`
        ...
        <div class="value-content">
          <div class="value-name-row">
            <uui-input
              ...
              @input=${(o) => this._updateValue(a, "name", o.target.value)}>
            </uui-input>
            ...
            ${t === "colour" ? r`
                  <uui-input
                    ...
                    @input=${(o) => this._updateValue(a, "hexValue", o.target.value)}>
                  </uui-input>
                ` : n}
            ...
            ${t === "image" ? r`
                  <div class="image-picker">
                    ${e.mediaKey ? r`
                          <div class="image-preview" @click=${() => this._openMediaPicker(a)}>
                ...
                <div class="addon-fields">
                  <div class="addon-field">
                    ...
                    <uui-input
                      ...
                      placeholder="0.00"
                      @input=${(o) => this._updateValue(a, "priceAdjustment", parseFloat(o.target.value) || 0)}>
                    </uui-input>
                  </div>
                  ...
                  <div class="addon-field">
                    ...
                    <uui-input
                      ...
                      placeholder="0.00"
                      @input=${(o) => this._updateValue(a, "costAdjustment", parseFloat(o.target.value) || 0)}>
                    </uui-input>
                  </div>
                  ...
                  <div class="addon-field sku-field">
                    ...
                    <uui-input
                      ...
                      .value=${e.skuSuffix || ""}
                      placeholder="e.g., -GW"
                      @input=${(o) => this._updateValue(a, "skuSuffix", o.target.value)}>
                    </uui-input>
                  </div>
                </div>
      ...
      this._updateValue(a, "weightKg", l ? parseFloat(l) : null);
    }}>
                    </uui-input>
        ...
        <uui-button compact look="secondary" color="danger" label="Remove value" @click=${() => this._removeValue(a)}>
  ...
  render() {
    const e = !this.data?.option, a = this._formData.values?.length || 0, t = this._getMaxValues(), i = this._formData.isVariant && a > 0 ? `Will create ${a} variants` : "";
    return r`
      <umb-body-layout headline="${e ? "Add Option" : `Edit Option: ${this._formData.name}`}">
        <div class="modal-content">
          ...
          ${this._formData.isVariant && a > 0 ? r`
          ...
          <uui-box headline="Option Details">
            <umb-property-dataset
              ...
              ${this._formData.isVariant ?? !1 ? n : r`
                    <umb-property
                      alias="isMultiSelect"
          ...
          <uui-box>
            <div class="section-header" slot="headline">
              ...
              <span class="value-count">${a}/${t}</span>
            </div>

            <div class="values-list">
              ${this._formData.values && this._formData.values.length > 0 ? this._formData.values.map((o, l) => this._renderValueEditor(o, l)) : r`
...
p([
  h()
], s.prototype, "_originalIsVariant", 2);
p([
  h()
], s.prototype, "_hasAttemptedSave", 2);
s = p([
  x("merchello-option-editor-modal")
], s);
const R = s;
export {
  s as MerchelloOptionEditorModalElement,
  R as default
};
//# sourceMappingURL=option-editor-modal.element-CLRqWCpS.js.map
