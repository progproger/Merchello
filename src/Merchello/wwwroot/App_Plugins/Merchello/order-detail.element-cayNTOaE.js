import { LitElement as nt, nothing as p, html as s, css as ot, state as h, customElement as st, property as $i, unsafeHTML as Mi } from "@umbraco-cms/backoffice/external/lit";
import { d as It } from "./marked.esm-B6IoMkOX.js";
...
import { UmbModalToken as ve, UMB_MODAL_MANAGER_CONTEXT as dt } from "@umbraco-cms/backoffice/modal";
import { UMB_CURRENT_USER_CONTEXT as zi } from "@umbraco-cms/backoffice/current-user";
import { b as tt, a as C, d as Li } from "./formatting-CH1NCLNK.js";
import { M as H } from "./merchello-api-CzSx3Q3Y.js";
import { I as de, P as Nt } from "./order.types-DjkMLpgj.js";
const {
  entries: Zt,
  setPrototypeOf: Pt,
  isFrozen: Ri,
...
const ke = D(Array.prototype.forEach), Ni = D(Array.prototype.lastIndexOf), Ft = D(Array.prototype.pop), ue = D(Array.prototype.push), Pi = D(Array.prototype.splice), ze = D(String.prototype.toLowerCase), Ve = D(String.prototype.toString), Ke = D(String.prototype.match), ce = D(String.prototype.replace), Fi = D(String.prototype.indexOf), Ui = D(String.prototype.trim), R = D(Object.prototype.hasOwnProperty), S = D(RegExp.prototype.test), pe = Hi(TypeError);
function D(e) {
  return function(t) {
...
function U(e) {
  ...
  for (const [a, r] of Zt(e))
    R(e, a) && (Array.isArray(r) ? t[a] = Gi(r) : r && typeof r == "object" && r.constructor === Object ? t[a] = U(r) : t[a] = r);
  return t;
}
function me(e, t) {
  for (; e !== null; ) {
...
const Ut = k(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "search", "section", "select", "shadow", "slot", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]), Ze = k(["svg", "a", "altglyph", "altglyphdef", "altglyphitem", "animatecolor", "animatemotion", "animatetransform", "circle", "clippath", "defs", "desc", "ellipse", "enterkeyhint", "exportparts", "filter", "font", "g", "glyph", "glyphref", "hkern", "image", "inputmode", "line", "lineargradient", "marker", "mask", "metadata", "mpath", "part", "path", "pattern", "polygon", "polyline", "radialgradient", "rect", "stop", "style", "switch", "symbol", "text", "textpath", "title", "tref", "tspan", "view", "vkern"]), Je = k(["feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence"]), Bi = k(["animate", "color-profile", "cursor", "discard", "font-face", "font-face-format", "font-face-name", "font-face-src", "font-face-uri", "foreignobject", "hatch", "hatchpath", "mesh", "meshgradient", "meshpatch", "meshrow", "missing-glyph", "script", "set", "solidcolor", "unknown", "use"]), Qe = k(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover", "mprescripts"]), Wi = k(["maction", "maligngroup", "malignmark", "mlongdiv", "mscarries", "mscarry", "msgroup", "mstack", "msline", "msrow", "semantics", "annotation", "annotation-xml", "mprescripts", "none"]), Ht = k(["#text"]), Gt = k(["accept", "action", "align", "alt", "autocapitalize", "autocomplete", "autopictureinpicture", "autoplay", "background", "bgcolor", "border", "capture", "cellpadding", "cellspacing", "checked", "cite", "class", "clear", "color", "cols", "colspan", "controls", "controlslist", "coords", "crossorigin", "datetime", "decoding", "default", "dir", "disabled", "disablepictureinpicture", "disableremoteplayback", "download", "draggable", "enctype", "enterkeyhint", "exportparts", "face", "for", "headers", "height", "hidden", "high", "href", "hreflang", "id", "inert", "inputmode", "integrity", "ismap", "kind", "label", "lang", "list", "loading", "loop", "low", "max", "maxlength", "media", "method", "min", "minlength", "multiple", "muted", "name", "nonce", "noshade", "novalidate", "nowrap", "open", "optimum", "part", "pattern", "placeholder", "playsinline", "popover", "popovertarget", "popovertargetaction", "poster", "preload", "pubdate", "radiogroup", "readonly", "rel", "required", "rev", "reversed", "role", "rows", "rowspan", "spellcheck", "scope", "selected", "shape", "size", "sizes", "slot", "span", "srclang", "start", "src", "srcset", "step", "style", "summary", "tabindex", "title", "translate", "type", "usemap", "valign", "value", "width", "wrap", "xmlns", "slot"]), et = k(["accent-height", "accumulate", "additive", "alignment-baseline", "amplitude", "ascent", "attributename", "attributetype", "azimuth", "basefrequency", "baseline-shift", "begin", "bias", "by", "class", "clip", "clippathunits", "clip-path", "clip-rule", "color", "color-interpolation", "color-interpolation-filters", "color-profile", "color-rendering", "cx", "cy", "d", "dx", "dy", "diffuseconstant", "direction", "display", "divisor", "dur", "edgemode", "elevation", "end", "exponent", "fill", "fill-opacity", "fill-rule", "filter", "filterunits", "flood-color", "flood-opacity", "font-family", "font-size", "font-size-adjust", "font-stretch", "font-style", "font-variant", "font-weight", "fx", "fy", "g1", "g2", "glyph-name", "glyphref", "gradientunits", "gradienttransform", "height", "href", "id", "image-rendering", "in", "in2", "intercept", "k", "k1", "k2", "k3", "k4", "kerning", "keypoints", "keysplines", "keytimes", "lang", "lengthadjust", "letter-spacing", "kernelmatrix", "kernelunitlength", "lighting-color", "local", "marker-end", "marker-mid", "marker-start", "markerheight", "markerunits", "markerwidth", "maskcontentunits", "maskunits", "max", "mask", "mask-type", "media", "method", "mode", "min", "name", "numoctaves", "offset", "operator", "opacity", "order", "orient", "orientation", "origin", "overflow", "paint-order", "path", "pathlength", "patterncontentunits", "patterntransform", "patternunits", "points", "preservealpha", "preserveaspectratio", "primitiveunits", "r", "rx", "ry", "radius", "refx", "refy", "repeatcount", "repeatdur", "restart", "result", "rotate", "scale", "seed", "shape-rendering", "slope", "specularconstant", "specularexponent", "spreadmethod", "startoffset", "stddeviation", "stitchtiles", "stop-color", "stop-opacity", "stroke-dasharray", "stroke-dashoffset", "stroke-linecap", "stroke-linejoin", "stroke-miterlimit", "stroke-opacity", "stroke", "stroke-width", "style", "surfacescale", "systemlanguage", "tabindex", "tablevalues", "targetx", "targety", "transform", "transform-origin", "text-anchor", "text-decoration", "text-rendering", "textlength", "type", "u1", "u2", "unicode", "values", "viewbox", "visibility", "version", "vert-adv-y", "vert-origin-x", "vert-origin-y", "width", "word-spacing", "wrap", "writing-mode", "xchannelselector", "ychannelselector", "x", "x1", "x2", "xmlns", "y", "y1", "y2", "z", "zoomandpan"]), Bt = k(["accent", "accentunder", "align", "bevelled", "close", "columnsalign", "columnlines", "columnspan", "denomalign", "depth", "dir", "display", "displaystyle", "encoding", "fence", "frame", "height", "href", "id", "largeop", "length", "linethickness", "lspace", "lquote", "mathbackground", "mathcolor", "mathsize", "mathvariant", "maxsize", "minsize", "movablelimits", "notation", "numalign", "open", "rowalign", "rowlines", "rowspacing", "rowspan", "rspace", "rquote", "scriptlevel", "scriptminsize", "scriptsizemultiplier", "selection", "separator", "separators", "stretchy", "subscriptshift", "supscriptshift", "symmetric", "voffset", "width", "xmlns"]), De = k(["xlink:href", "xml:id", "xlink:title", "xml:space", "xmlns:xlink"]), ji = z(/\{\{[\w\W]*|[\w\W]*\}\}/gm), Yi = z(/<%[\w\W]*|[\w\W]*%>/gm), qi = z(/\$\{[\w\W]*/gm), Xi = z(/^data-[\-\w.\u00B7-\uFFFF]+$/), Vi = z(/^aria-[\-\w]+$/), Jt = z(
...
function ei() {
  ...
  const t = (d) => ei(d);
  if (t.version = "3.3.0", t.removed = [], !e || !e.document || e.document.nodeType !== fe.document || !e.Element)
  ...
  const r = a, o = r.currentScript, {
    ...
    DOMParser: di,
    trustedTypes: be
  } = e, re = ut.prototype, ui = me(re, "cloneNode"), ci = me(re, "remove"), pi = me(re, "nextSibling"), mi = me(re, "childNodes"), ye = me(re, "parentNode");
  ...
  let A = jt();
  t.isSupported = typeof Zt == "function" && typeof ye == "function" && Re && Re.createHTMLDocument !== void 0;
  const {
    MUSTACHE_EXPR: Oe,
    ERB_EXPR: Ie,
    TMPLIT_EXPR: Ne,
  ...
  let ht = !0, Fe = !0, gt = !1, vt = !0, V = !1, Te = !0, B = !1, Ue = !1, He = !1, K = !1, Ee = !1, xe = !1, _t = !0, bt = !1;
  const Ei = "user-content-";
  let Ge = !0, se = !1, Z = {}, J = null;
  ...
  let Be = null;
  const xt = c({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "role", "summary", "title", "value", "style", "xmlns"]), we = "http://www.w3.org/1998/Math/MathML", Ae = "http://www.w3.org/2000/svg", N = "http://www.w3.org/1999/xhtml";
  let Q = N, We = !1, je = null;
  const xi = c({}, [we, Ae, N], Ve);
  let Se = c({}, ["mi", "mo", "mn", "ms", "mtext"]), Ce = c({}, ["annotation-xml"]);
  ...
  const Ci = a.createElement("form"), wt = function(i) {
    ...
    if (!(ee && ee === i)) {
      if ((!i || typeof i != "object") && (i = {}), i = U(i), le = // eslint-disable-next-line unicorn/prefer-includes
      Ai.indexOf(i.PARSER_MEDIA_TYPE) === -1 ? Si : i.PARSER_MEDIA_TYPE, b = le === "application/xhtml+xml" ? Ve : ze, _ = R(i, "ALLOWED_TAGS") ? c({}, i.ALLOWED_TAGS, b) : mt, y = R(i, "ALLOWED_ATTR") ? c({}, i.ALLOWED_ATTR, b) : ft, je = R(i, "ALLOWED_NAMESPACES") ? c({}, i.ALLOWED_NAMESPACES, Ve) : xi, Be = R(i, "ADD_URI_SAFE_ATTR") ? c(U(xt), i.ADD_URI_SAFE_ATTR, b) : xt, Tt = R(i, "ADD_DATA_URI_TAGS") ? c(U(Et), i.ADD_DATA_URI_TAGS, b) : Et, J = R(i, "FORBID_CONTENTS") ? c({}, i.FORBID_CONTENTS, b) : yt, oe = R(i, "FORBID_TAGS") ? c({}, i.FORBID_TAGS, b) : U({}), Pe = R(i, "FORBID_ATTR") ? c({}, i.FORBID_ATTR, b) : U({}), Z = R(i, "USE_PROFILES") ? i.USE_PROFILES : !1, ht = i.ALLOW_ARIA_ATTR !== !1, Fe = i.ALLOW_DATA_ATTR !== !1, gt = i.ALLOW_UNKNOWN_PROTOCOLS || !1, vt = i.ALLOW_SELF_CLOSE_IN_ATTR !== !1, V = i.SAFE_FOR_TEMPLATES || !1, Te = i.SAFE_FOR_XML !== !1, B = i.WHOLE_DOCUMENT || !1, K = i.RETURN_DOM || !1, Ee = i.RETURN_DOM_FRAGMENT || !1, xe = i.RETURN_TRUSTED_TYPE || !1, He = i.FORCE_BODY || !1, _t = i.SANITIZE_DOM !== !1, bt = i.SANITIZE_NAMED_PROPS || !1, Ge = i.KEEP_CONTENT !== !1, se = i.IN_PLACE || !1, pt = i.ALLOWED_URI_REGEXP || Jt, Q = i.NAMESPACE || N, Se = i.MATHML_TEXT_INTEGRATION_POINTS || Se, Ce = i.HTML_INTEGRATION_POINTS || Ce, f = i.CUSTOM_ELEMENT_HANDLING || {}, i.CUSTOM_ELEMENT_HANDLING && wt(i.CUSTOM_ELEMENT_HANDLING.tagNameCheck) && (f.tagNameCheck = i.CUSTOM_ELEMENT_HANDLING.tagNameCheck), i.CUSTOM_ELEMENT_HANDLING && wt(i.CUSTOM_ELEMENT_HANDLING.attributeNameCheck) && (f.attributeNameCheck = i.CUSTOM_ELEMENT_HANDLING.attributeNameCheck), i.CUSTOM_ELEMENT_HANDLING && typeof i.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements == "boolean" && (f.allowCustomizedBuiltInElements = i.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements), V && (Fe = !1), Ee && (K = !0), Z && (_ = c({}, Ht), y = [], Z.html === !0 && (c(_, Ut), c(y, Gt)), Z.svg === !0 && (c(_, Ze), c(y, et), c(y, De)), Z.svgFilters === !0 && (c(_, Je), c(y, et), c(y, De)), Z.mathMl === !0 && (c(_, Qe), c(y, Bt), c(y, De))), i.ADD_TAGS && (typeof i.ADD_TAGS == "function" ? X.tagCheck = i.ADD_TAGS : (_ === mt && (_ = U(_)), c(_, i.ADD_TAGS, b))), i.ADD_ATTR && (typeof i.ADD_ATTR == "function" ? X.attributeCheck = i.ADD_ATTR : (y === ft && (y = U(y)), c(y, i.ADD_ATTR, b))), i.ADD_URI_SAFE_ATTR && c(Be, i.ADD_URI_SAFE_ATTR, b), i.FORBID_CONTENTS && (J === yt && (J = U(J)), c(J, i.FORBID_CONTENTS, b)), Ge && (_["#text"] = !0), B && c(_, ["html", "head", "body"]), _.table && (c(_, ["tbody"]), delete oe.tbody), i.TRUSTED_TYPES_POLICY) {
        ...
        w = i.TRUSTED_TYPES_POLICY, ne = w.createHTML("");
      } else
        w === void 0 && (w = ea(be, o)), w !== null && typeof ne == "string" && (ne = w.createHTML(""));
      k && k(i), ee = i;
    }
    ...
    const l = ze(i.tagName), m = ze(n.tagName);
    return je[i.namespaceURI] ? i.namespaceURI === Ae ? n.namespaceURI === N ? l === "svg" : n.namespaceURI === we ? l === "svg" && (m === "annotation-xml" || Se[m]) : !!At[l] : i.namespaceURI === we ? n.namespaceURI === N ? l === "math" : n.namespaceURI === Ae ? l === "math" && Ce[m] : !!St[l] : i.namespaceURI === N ? n.namespaceURI === Ae && !Ce[m] || n.namespaceURI === we && !Se[m] ? !1 : !St[l] && (wi[l] || !At[l]) : !!(le === "application/xhtml+xml" && je[i.namespaceURI]) : !1;
  }, O = function(i) {
    ue(t.removed, {
      element: i
    });
    ...
    le === "application/xhtml+xml" && Q === N && (i = '<html xmlns="http://www.w3.org/1999/xhtml"><head></head><body>' + i + "</body></html>");
    const m = w ? w.createHTML(i) : i;
    if (Q === N)
      try {
        n = new di().parseFromString(m, le);
      } catch {
      }
    if (!n || !n.documentElement) {
      n = Re.createDocument(Q, "template", null);
      try {
        n.documentElement.innerHTML = We ? ne : m;
      } catch {
      }
    }
    const x = n.body || n.documentElement;
    return i && l && x.insertBefore(a.createTextNode(l), x.childNodes[0] || null), Q === N ? gi.call(n, B ? "html" : "body")[0] : B ? n.documentElement : x;
  }, kt = function(i) {
    return fi.call(
      i.ownerDocument || i,
      i,
      // eslint-disable-next-line no-bitwise
      ae.SHOW_ELEMENT | ae.SHOW_COMMENT | ae.SHOW_TEXT | ae.SHOW_PROCESSING_INSTRUCTION | ae.SHOW_CDATA_SECTION,
      null
    );
  }, qe = function(i) {
  ...
  const $t = function(i) {
    let n = null;
    if (P(A.beforeSanitizeElements, i, null), qe(i))
      return O(i), !0;
    const l = b(i.nodeName);
    if (P(A.uponSanitizeElement, i, {
      tagName: l,
      allowedTags: _
    }), Te && i.hasChildNodes() && !Dt(i.firstElementChild) && S(/<[/\w!]/g, i.innerHTML) && S(/<[/\w!]/g, i.textContent) || i.nodeType === fe.progressingInstruction || Te && i.nodeType === fe.comment && S(/<[/\w]/g, i.data))
      return O(i), !0;
    if (!(X.tagCheck instanceof Function && X.tagCheck(l)) && (!_[l] || oe[l])) {
      if (!oe[l] && zt(l) && (f.tagNameCheck instanceof RegExp && S(f.tagNameCheck, l) || f.tagNameCheck instanceof Function && f.tagNameCheck(l)))
        return !1;
      if (Ge && !J[l]) {
        const m = ye(i) || i.parentNode, x = mi(i) || i.childNodes;
        if (x && m) {
          const g = x.length;
          for (let $ = g - 1; $ >= 0; --$) {
            const F = ui(x[$], !0);
            F.__removalCount = (i.__removalCount || 0) + 1, m.insertBefore(F, pi(i));
          }
        }
      }
      return O(i), !0;
    }
    return i instanceof ut && !ki(i) || (l === "noscript" || l === "noembed" || l === "noframes") && S(/<\/no(script|embed|frames)/i, i.innerHTML) ? (O(i), !0) : (V && i.nodeType === fe.text && (n = i.textContent, ke([Oe, Ie, Ne], (m) => {
      n = ce(n, m, " ");
    }), i.textContent !== n && (ue(t.removed, {
      element: i.cloneNode()
    }), i.textContent = n)), P(A.afterSanitizeElements, i, null), !1);
  }, Mt = function(i, n, l) {
    if (_t && (n === "id" || n === "name") && (l in a || l in Ci))
      return !1;
    if (!(Fe && !Pe[n] && S(_i, n))) {
      if (!(ht && S(bi, n))) {
        if (!(X.attributeCheck instanceof Function && X.attributeCheck(n, i))) {
          if (!y[n] || Pe[n]) {
            if (
              // First condition does a very basic check if a) it's basically a valid custom element tagname AND
              // b) if the tagName passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.tagNameCheck
              // and c) if the attribute name passes whatever the user has configured for CUSTOM_ELEMENT_HANDLING.attributeNameCheck
              !(zt(i) && (f.tagNameCheck instanceof RegExp && S(f.tagNameCheck, i) || f.tagNameCheck instanceof Function && f.tagNameCheck(i)) && (f.attributeNameCheck instanceof RegExp && S(f.attributeNameCheck, n) || f.attributeNameCheck instanceof Function && f.attributeNameCheck(n, i)) || // Alternative, second condition checks if it's an `is`-attribute, AND
    ...
    P(A.beforeSanitizeAttributes, i, null);
    const {
      attributes: n
    } = i;
    if (!n || qe(i))
    ...
    for (; m--; ) {
      ...
      if (l.attrName = te, l.attrValue = T, l.keepAttr = !0, l.forceKeepAttr = void 0, P(A.uponSanitizeAttribute, i, l), T = l.attrValue, bt && (te === "id" || te === "name") && (W(g, i), T = Ei + T), Te && S(/((--!?|])>)|<\/(style|title|textarea)/i, T)) {
        W(g, i);
        continue;
      }
      if (te === "attributename" && Ke(T, "href")) {
        W(g, i);
        continue;
      }
      if (l.forceKeepAttr)
      ...
      if (w && typeof be == "object" && typeof be.getAttributeType == "function" && !$)
        switch (be.getAttributeType(Rt, te)) {
          case "TrustedHTML": {
            T = w.createHTML(T);
            break;
          }
      ...
      if (T !== Xe)
        try {
          $ ? i.setAttributeNS($, g, T) : i.setAttribute(g, T), qe(i) ? O(i) : Ft(t.removed);
        } catch {
          W(g, i);
        }
    }
    P(A.afterSanitizeAttributes, i, null);
  }, Di = function d(i) {
    let n = null;
    const l = kt(i);
    for (P(A.beforeSanitizeShadowDOM, i, null); n = l.nextNode(); )
      P(A.uponSanitizeShadowNode, n, null), $t(n), Lt(n), n.content instanceof u && d(n.content);
    P(A.afterSanitizeShadowDOM, i, null);
  };
  return t.sanitize = function(d) {
    let i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, n = null, l = null, m = null, x = null;
    ...
    if (!t.isSupported)
      return d;
    if (Ue || Ye(i), t.removed = [], typeof d == "string" && (se = !1), se) {
      if (d.nodeName) {
        const F = b(d.nodeName);
        if (!_[F] || oe[F])
          throw pe("root node is forbidden and cannot be sanitized in-place");
      }
    } else if (d instanceof Le)
      n = Ct("<!---->"), l = n.ownerDocument.importNode(d, !0), l.nodeType === fe.element && l.nodeName === "BODY" || l.nodeName === "HTML" ? n = l : n.appendChild(l);
    else {
      if (!K && !V && !B && // eslint-disable-next-line unicorn/prefer-includes
      d.indexOf("<") === -1)
        return w && xe ? w.createHTML(d) : d;
      if (n = Ct(d), !n)
        return K ? null : xe ? ne : "";
    }
    n && He && O(n.firstChild);
    const g = kt(se ? d : n);
    for (; m = g.nextNode(); )
      $t(m), Lt(m), m.content instanceof u && Di(m.content);
    if (se)
      return d;
    if (K) {
      if (Ee)
    ...
    let $ = B ? n.outerHTML : n.innerHTML;
    return B && _["!doctype"] && n.ownerDocument && n.ownerDocument.doctype && n.ownerDocument.doctype.name && S(Qt, n.ownerDocument.doctype.name) && ($ = "<!DOCTYPE " + n.ownerDocument.doctype.name + `>
` + $), V && ke([Oe, Ie, Ne], (F) => {
      $ = ce($, F, " ");
    }), w && xe ? w.createHTML($) : $;
...
var ta = ei();
const ia = new ve("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), aa = new ve("Merchello.EditOrder.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), ra = new ve("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var na = Object.defineProperty, oa = Object.getOwnPropertyDescriptor, ti = (e) => {
  throw TypeError(e);
}, _e = (e, t, a, r) => {
  for (var o = r > 1 ? void 0 : r ? oa(t, a) : t, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (o = (r ? v(t, a, o) : v(o)) || o);
  return r && o && na(t, a, o), o;
}, ii = (e, t, a) => t.has(e) || ti("Cannot " + a), $e = (e, t, a) => (ii(e, t, "read from private field"), a ? a.call(e) : t.get(e)), Yt = (e, t, a) => t.has(e) ? ti("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), qt = (e, t, a, r) => (ii(e, t, "write to private field"), t.set(e, a), a), he, ge;
let q = class extends lt(nt) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, Yt(this, he), Yt(this, ge), this.consumeContext(Kt, (e) => {
      qt(this, he, e), this.observe($e(this, he).order, (t) => {
  ...
  async _handleDeleteShipment(e) {
    ...
    const { error: a } = await H.deleteShipment(e.id);
    if (a) {
      alert(a.message);
      return;
    }
    this._loadShipments(), this._invoiceId && $e(this, he)?.load(this._invoiceId);
  }
      ...
      (r) => s`
              <div class="item-row">
                ...
                <div class="item-info">
                  ...
                  ${r.sku ? s`<div class="item-sku">${r.sku}</div>` : p}
                </div>
...
_e([
  h()
], q.prototype, "_invoiceId", 2);
_e([
  h()
], q.prototype, "_fulfillmentData", 2);
_e([
  h()
], q.prototype, "_isLoading", 2);
_e([
  h()
], q.prototype, "_errorMessage", 2);
q = _e([
  st("merchello-shipments-view")
], q);
const sa = new ve("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), la = new ve("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
});
var da = Object.defineProperty, ua = Object.getOwnPropertyDescriptor, ai = (e) => {
  throw TypeError(e);
}, ie = (e, t, a, r) => {
  for (var o = r > 1 ? void 0 : r ? ua(t, a) : t, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (o = (r ? v(t, a, o) : v(o)) || o);
  return r && o && da(t, a, o), o;
}, ri = (e, t, a) => t.has(e) || ai("Cannot " + a), Me = (e, t, a) => (ri(e, t, "read from private field"), t.get(e)), ca = (e, t, a) => t.has(e) ? ai("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), pa = (e, t, a, r) => (ri(e, t, "write to private field"), t.set(e, a), a), j;
let G = class extends lt(nt) {
  constructor() {
    super(), this.invoiceId = "", this._payments = [], this._status = null, this._isLoading = !0, this._errorMessage = null, ca(this, j), this.consumeContext(dt, (e) => {
      pa(this, j, e);
    });
  }
  connectedCallback() {
  ...
  async _openManualPaymentModal() {
    if (!Me(this, j) || !this._status) return;
    (await Me(this, j).open(this, sa, {
      data: {
  ...
  _getStatusBadgeClass(e) {
    switch (e) {
      case de.Paid:
        return "paid";
      case de.PartiallyPaid:
        return "partial";
      case de.Refunded:
      case de.PartiallyRefunded:
        return "refunded";
      case de.AwaitingPayment:
        return "awaiting";
      default:
        return "unpaid";
    }
        ...
        <div class="payment-main">
          <div class="payment-info">
            <div class="payment-method">
              ...
              ${e.paymentProviderAlias ? s`<span class="provider-badge">${e.paymentProviderAlias}</span>` : p}
            </div>
            <div class="payment-date">${tt(e.dateCreated)}</div>
            ${e.transactionId ? s`<div class="transaction-id">ID: ${e.transactionId}</div>` : p}
            ${e.description ? s`<div class="payment-description">${e.description}</div>` : p}
            ${e.refundReason ? s`<div class="refund-reason">Reason: ${e.refundReason}</div>` : p}
          </div>
          <div class="payment-amount ${t ? "negative" : ""}">
            ${t ? "-" : ""}${C(Math.abs(e.amount))}
          </div>
          ...
          ${e ? s`
                <div class="status-details">
                  <div class="status-row">
                    ...
                    <span>${C(e.invoiceTotal)}</span>
                  </div>
                  <div class="status-row">
                    <span>Total Paid</span>
                    <span class="positive">${C(e.totalPaid)}</span>
                  </div>
                  ${e.totalRefunded > 0 ? s`
                        <div class="status-row">
                          <span>Total Refunded</span>
                          <span class="negative">-${C(e.totalRefunded)}</span>
                        </div>
                      ` : p}
...
var ma = Object.defineProperty, fa = Object.getOwnPropertyDescriptor, ni = (e) => {
  throw TypeError(e);
}, M = (e, t, a, r) => {
  for (var o = r > 1 ? void 0 : r ? fa(t, a) : t, u = e.length - 1, v; u >= 0; u--)
    (v = e[u]) && (o = (r ? v(t, a, o) : v(o)) || o);
  return r && o && ma(t, a, o), o;
}, oi = (e, t, a) => t.has(e) || ni("Cannot " + a), L = (e, t, a) => (oi(e, t, "read from private field"), t.get(e)), Xt = (e, t, a) => t.has(e) ? ni("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), Vt = (e, t, a, r) => (oi(e, t, "write to private field"), t.set(e, a), a), I, Y;
let E = class extends lt(nt) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._activeTab = "details", this._newNoteText = "", this._visibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], Xt(this, I), Xt(this, Y), this.consumeContext(Kt, (e) => {
      Vt(this, I, e), L(this, I) && this.observe(L(this, I).order, (t) => {
        this._order = t ?? null, this._isLoading = !t;
      });
    }), this.consumeContext(dt, (e) => {
      Vt(this, Y, e);
    }), this.consumeContext(zi, (e) => {
  ...
  async _openFulfillmentModal() {
    if (!this._order || !L(this, Y)) return;
    await L(this, Y).open(this, ia, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), L(this, I)?.load(this._order.id);
  }
  async _openEditOrderModal() {
    if (!this._order || !L(this, Y)) return;
    await L(this, Y).open(this, aa, {
      data: { invoiceId: this._order.id }
    }).onSubmit().catch(() => {
    }), L(this, I)?.load(this._order.id);
  }
  ...
  _renderMarkdown(e) {
    It.setOptions({ breaks: !0, gfm: !0 });
    const t = It.parse(e), a = ta.sanitize(t);
    return Mi(a);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
  ...
  async _saveEditing() {
    ...
    if (this._editingSection === "contact") {
      ...
      e = await H.updateBillingAddress(this._order.id, t);
    } else if (this._editingSection === "shipping") {
      const t = {
        ...this._order.shippingAddress,
        ...this._editFormData
      };
      e = await H.updateShippingAddress(this._order.id, t);
    } else {
      const t = {
        ...this._order.billingAddress,
        ...this._editFormData
    ...
    this._editingSection = null, this._editFormData = {}, this._validationErrors = {}, L(this, I)?.load(this._order.id);
  }
  ...
  _renderInput(e, t, a, r = "text") {
    ...
    return s`
      <div class="form-field ${o ? "has-error" : ""}">
        ...
        ></uui-input>
        ${o ? s`<span class="field-error">${this._validationErrors[e]}</span>` : p}
      </div>
    `;
  }
  _renderCountrySelect() {
    ...
    return s`
      ...
      if (this._editFormData = {
        ...
        ${e ? s`<span class="field-error">${this._validationErrors.countryCode}</span>` : p}
      </div>
    `;
  }
      ...
      (o) => s`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-pricing">
                  <span class="fulfillment-item-price">${C(o.amount)}</span>
                  <span class="fulfillment-item-multiply">×</span>
                  <span class="fulfillment-item-qty">${o.quantity}</span>
                </div>
                <div class="fulfillment-item-total">${C(o.amount * o.quantity)}</div>
              </div>
            `
    )}
        </div>
        <div class="fulfillment-footer">
          <div class="fulfillment-actions">
            <uui-button
              ...
              ?disabled=${a}
              @click=${a ? p : this._openFulfillmentModal}
            >
              ${a ? "Fulfilled" : "Fulfil"}
            </uui-button>
  ...
  _handlePaymentChange() {
    this._order && L(this, I)?.load(this._order.id);
  }
  async _handlePostNote() {
    ...
    this._newNoteText = "", this._visibleToCustomer = !1, L(this, I)?.load(this._order.id);
  }
  _renderLoadingState() {
    return s`<div class="loading"><uui-loader></uui-loader></div>`;
  }
  ...
  render() {
    ...
    return s`
            ...
            <div class="card payment-card">
              ...
              <div class="payment-summary">
                <div class="summary-row">
                  ...
                  <span>${C(e.subTotal)}</span>
                </div>
                ${e.discountTotal > 0 ? s`
                  <div class="summary-row discount">
                    <span>Discounts</span>
                    <span></span>
                    <span>-${C(e.discountTotal)}</span>
                  </div>
                ` : p}
                <div class="summary-row">
                  <span>Shipping</span>
                  <span>${e.orders[0]?.deliveryMethod || "Standard"}</span>
                  <span>${C(e.shippingCost)}</span>
                </div>
                ${e.tax > 0 ? s`
                  <div class="summary-row">
                    <span>Tax</span>
                ...
                ${e.balanceDue !== 0 ? s`
                  <div class="summary-row balance ${e.balanceDue > 0 ? "underpaid" : "overpaid"}">
                    ...
                    <span></span>
                    <span>${e.balanceDue > 0 ? C(e.balanceDue) : C(Math.abs(e.balanceDue))}</span>
                  </div>
                ` : p}
              </div>
            </div>
      ...
      this._newNoteText = t.target.value, this._noteError = null;
                  ...
                  ${this._noteError ? s`<div class="note-error">${this._noteError}</div>` : p}
                </div>
              </div>
        ...
        (r) => s`
                                <div class="timeline-event ${r.visibleToCustomer ? "customer-visible" : ""}">
                                  ...
                                  <div class="timeline-event-content">
                                    ${r.visibleToCustomer ? s`<span class="customer-badge">Customer visible</span>` : p}
                                    <div class="event-text markdown-content">${this._renderMarkdown(r.text)}</div>
                                    ${r.author ? s`<span class="event-author">by ${r.author}</span>` : p}
                                  </div>
            ...
            <div class="card">
              ...
              <div class="section">
                ...
                ` : s`
                  ...
                  ${this._getGoogleMapsUrl(e.shippingAddress) ? s`<a href=${this._getGoogleMapsUrl(e.shippingAddress)} target="_blank" rel="noopener noreferrer" class="view-map">View map</a>` : p}
                `}
              </div>
              <div class="section">
                <div class="section-header">
...
//# sourceMappingURL=order-detail.element-cayNTOaE.js.map
