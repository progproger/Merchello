...
import { k as A, l as _, m as D } from "./navigation-m-G5wLvz.js";
...
var L = Object.defineProperty, O = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var r = n > 1 ? void 0 : n ? O(a, i) : a, g = e.length - 1, b; g >= 0; g--)
    (b = e[g]) && (r = (n ? b(a, i, r) : b(r)) || r);
  return n && r && L(a, i, r), r;
}, w = (e, a, i) => a.has(e) || y("Cannot " + i), l = (e, a, i) => (w(e, a, "read from private field"), a.get(e)), m = (e, a, i) => a.has(e) ? y("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, i), d = (e, a, i, n) => (w(e, a, "write to private field"), a.set(e, i), i), u, h, s;
let o = class extends k(x) {
  constructor() {
    super(), this._warehouses = [], this._isLoading = !0, this._errorMessage = null, this._isDeleting = null, m(this, u), m(this, h), m(this, s, !1), this.consumeContext(M, (e) => {
      d(this, u, e);
  ...
  connectedCallback() {
    super.connectedCallback(), d(this, s, !0), this._loadWarehouses();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), d(this, s, !1);
  }
  ...
  async _handleDelete(e, a) {
    if (e.preventDefault(), e.stopPropagation(), !await l(this, h)?.open(this, z, {
      data: {
...
//# sourceMappingURL=warehouses-list.element-DD5Zpo9s.js.map
