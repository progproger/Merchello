...
async function r(e) {
  try {
    const t = await $(), o = u.baseUrl || "", i = await fetch(`${o}${m}/${e}`, {
      method: "GET",
...
async function s(e, t) {
  try {
    const o = await $(), i = u.baseUrl || "", a = await fetch(`${i}${m}/${e}`, {
      method: "POST",
      credentials: u.credentials,
      headers: o,
...
const w = {
  ...
  installSeedData: () => s("seed-data/install"),
  // ============================================
  // Tax Groups API
  // ============================================
  /** Get all tax groups */
  ...
  createTaxGroup: (e) => s("tax-groups", e),
   ...
   */
  previewCustomItemTax: (e) => s("tax-groups/preview-custom-item", e),
  // ============================================
  ...
  createTaxGroupRate: (e, t) => s(`tax-groups/${e}/rates`, t),
  ...
  testTaxProvider: (e) => s(`tax-providers/${e}/test`),
  // ============================================
  ...
  createShippingTaxOverride: (e) => s("shipping-tax-overrides", e),
  ...
  addInvoiceNote: (e, t) => s(`orders/${e}/notes`, t),
  ...
  searchOrderProducts: (e, t = 10) => {
    const o = new URLSearchParams();
    return o.set("query", e), o.set("limit", t.toString()), r(`orders/product-autocomplete?${o.toString()}`);
  },
  ...
  getOrderAddressLookupSuggestions: (e) => s("orders/address-lookup/suggestions", e),
  /** Resolve an address lookup suggestion into a full address (backoffice - no rate limiting) */
  resolveOrderAddressLookup: (e) => s("orders/address-lookup/resolve", e),
  /** Export orders within a date range for CSV generation */
  exportOrders: (e) => s("orders/export", e),
  /** Soft-delete multiple orders/invoices */
  deleteOrders: (e) => s("orders/delete", { ids: e }),
  ...
  createShipment: (e, t) => s(`orders/${e}/shipments`, t),
  ...
  batchMarkAsPaid: (e) => s("orders/batch-mark-paid", e),
  ...
  downloadCustomerStatement: async (e, t, o) => {
    try {
      const i = await $(), a = u.baseUrl || "", c = new URLSearchParams();
      t && c.append("periodStart", t), o && c.append("periodEnd", o);
      const l = c.toString(), S = `${a}${m}/customers/${e}/statement${l ? `?${l}` : ""}`, g = await fetch(S, {
        method: "GET",
        credentials: u.credentials,
      ...
      const y = await g.blob(), h = g.headers.get("content-disposition");
      let f = "statement.pdf";
      if (h) {
  ...
  createPaymentProvider: (e) => s("payment-providers", e),
  ...
  testPaymentProvider: (e, t) => s(`payment-providers/${e}/test`, t),
  /** Process a test payment (for hosted fields/widget integration types) */
  processTestPayment: (e, t) => s(`payment-providers/${e}/test/process-payment`, t),
  /** Get express checkout client configuration for testing */
  getTestExpressConfig: (e, t, o = 100) => r(`payment-providers/${e}/test/express-config?methodAlias=${t}&amount=${o}`),
  ...
  simulateWebhook: (e, t) => s(`payment-providers/${e}/test/simulate-webhook`, t),
  /** Test payment link generation for a provider */
  testPaymentLink: (e, t) => s(`payment-providers/${e}/test/payment-link`, t),
  /** Test vault setup session creation */
  testVaultSetup: (e, t) => s(`payment-providers/${e}/test/vault-setup`, t),
  /** Test vault setup confirmation */
  testVaultConfirm: (e, t) => s(`payment-providers/${e}/test/vault-confirm`, t),
  /** Test charging a vaulted payment method */
  testVaultCharge: (e, t) => s(`payment-providers/${e}/test/vault-charge`, t),
  ...
  updatePaymentMethodSetting: (e, t, o) => n(`payment-providers/${e}/methods/${t}`, o),
  ...
  createPaymentLink: (e) => s("payment-links", e),
  ...
  deactivatePaymentLink: (e) => s(`invoices/${e}/payment-link/deactivate`),
  // ============================================
  ...
  createShippingProvider: (e) => s("shipping-providers", e),
  ...
  testShippingProvider: (e, t) => s(`shipping-providers/${e}/test`, t),
  // ============================================
  // Products API
  // ============================================
  ...
  createProductType: (e) => s("products/types", e),
  ...
  createProductCollection: (e) => s("products/collections", e),
  ...
  /** Update a variant */
  updateVariant: (e, t, o) => n(`products/${e}/variants/${t}`, o),
   ...
   */
  getVariantsByIds: (e) => s("products/variants/by-ids", e),
  // Options operations
  ...
  updateVariantShippingExclusions: (e, t, o) => n(`products/${e}/variants/${t}/shipping-exclusions`, {
    excludedShippingOptionIds: o
  }),
  /**
   ...
   */
  getProductFulfillmentOptions: (e, t, o) => {
    const i = new URLSearchParams();
    return i.set("destinationCountryCode", t), o && i.set("destinationStateCode", o), r(`products/variants/${e}/fulfillment-options?${i.toString()}`);
  },
  /**
   ...
   */
  previewAddonPrice: (e, t) => s(`products/variants/${e}/preview-addon-price`, t),
  // ============================================
  // Product Feeds API
  // ============================================
  ...
  createProductFeed: (e) => s("product-feeds", e),
  ...
  rebuildProductFeed: (e) => s(`product-feeds/${e}/rebuild`),
  ...
  validateProductFeed: (e, t) => s(`product-feeds/${e}/validate`, t),
  ...
  createShippingOption: (e) => s("shipping-options", e),
  ...
  addShippingCost: (e, t) => s(`shipping-options/${e}/costs`, t),
  ...
  addShippingWeightTier: (e, t) => s(`shipping-options/${e}/weight-tiers`, t),
  ...
  addShippingPostcodeRule: (e, t) => s(`shipping-options/${e}/postcode-rules`, t),
  ...
  createWarehouse: (e) => s("warehouses", e),
  /** Update a warehouse */
  ...
  addServiceRegion: (e, t) => s(`warehouses/${e}/service-regions`, t),
  /** Update a service region */
  updateServiceRegion: (e, t, o) => n(`warehouses/${e}/service-regions/${t}`, o),
  ...
  getWarehouseProducts: (e, t = 1, o = 20, i) => {
    const a = new URLSearchParams({ page: String(t), pageSize: String(o) });
    return i && a.set("search", i), r(`warehouses/${e}/products?${a.toString()}`);
  },
  /** Add products to a warehouse */
  addProductsToWarehouse: (e, t) => s(`warehouses/${e}/products`, { productRootIds: t }),
  /** Remove products from a warehouse */
  removeProductsFromWarehouse: (e, t) => s(`warehouses/${e}/products/remove`, { productRootIds: t }),
  // ============================================
  ...
  getShippingOptionsForWarehouse: (e, t, o) => {
    const i = new URLSearchParams();
    return i.set("destinationCountryCode", t), o && i.set("destinationStateCode", o), r(`warehouses/${e}/shipping-options?${i.toString()}`);
  },
  // ============================================
  // Suppliers API
  // ============================================
  ...
  createSupplier: (e) => s("suppliers", e),
  ...
  testSupplierFtpConnection: (e) => s("suppliers/test-ftp-connection", e),
  // ============================================
  // Customers API
  // ============================================
  ...
  createCustomerSegment: (e) => s("customer-segments", e),
  ...
  getSegmentMembers: (e, t = 1, o = 50) => r(
    `customer-segments/${e}/members?page=${t}&pageSize=${o}`
  ),
  /** Add members to a manual segment */
  addSegmentMembers: (e, t) => s(`customer-segments/${e}/members`, t),
  /** Remove members from a manual segment */
  removeSegmentMembers: (e, t) => s(`customer-segments/${e}/members/remove`, t),
  /** Preview customers matching an automated segment's criteria */
  previewSegmentMatches: (e, t = 1, o = 50) => r(
    `customer-segments/${e}/preview?page=${t}&pageSize=${o}`
  ),
  ...
  validateCriteria: (e) => s("customer-segments/criteria/validate", e),
  /** Search customers for segment member picker */
  searchCustomersForSegment: (e, t, o = 50) => {
    const i = new URLSearchParams({ search: e, pageSize: String(o) });
  ...
  testExchangeRateProvider: (e) => s(`exchange-rate-providers/${e}/test`),
  /** Force refresh the exchange rate cache */
  refreshExchangeRates: () => s("exchange-rate-providers/refresh"),
  ...
  testAddressLookupProvider: (e) => s(`address-lookup-providers/${e}/test`),
  // ============================================
  // Filters API
  // ============================================
  ...
  createFilterGroup: (e) => s("filter-groups", e),
  ...
  createFilter: (e, t) => s(`filter-groups/${e}/filters`, t),
  ...
  createDiscount: (e) => s("discounts", e),
  /** Update an existing discount */
  updateDiscount: (e, t) => n(`discounts/${e}`, t),
  /** Delete a discount */
  deleteDiscount: (e) => p(`discounts/${e}`),
  /** Activate a discount */
  activateDiscount: (e) => s(`discounts/${e}/activate`),
  /** Deactivate a discount */
  deactivateDiscount: (e) => s(`discounts/${e}/deactivate`),
  ...
  checkDiscountCodeAvailable: (e, t) => {
    const o = new URLSearchParams({ code: e });
    return t && o.set("excludeId", t), r(`discounts/validate-code?${o.toString()}`);
  },
  /** Apply a promotional discount to an invoice */
  applyDiscountToInvoice: (e, t) => s(`orders/${e}/apply-discount`, { discountId: t }),
  /** Get performance metrics for a discount */
  getDiscountPerformance: (e, t, o) => {
    const i = new URLSearchParams();
    t && i.set("startDate", t), o && i.set("endDate", o);
    const a = i.toString();
  ...
  activateUpsell: (e) => s(`upsells/${e}/activate`),
  /** Deactivate an upsell rule */
  deactivateUpsell: (e) => s(`upsells/${e}/deactivate`),
  /** Get performance metrics for an upsell rule */
  getUpsellPerformance: (e, t, o) => {
    const i = new URLSearchParams();
    t && i.set("startDate", t), o && i.set("endDate", o);
    const a = i.toString();
  ...
  getUpsellDashboard: (e, t) => {
    const o = new URLSearchParams();
    e && o.set("startDate", e), t && o.set("endDate", t);
    const i = o.toString();
    return r(`upsells/dashboard${i ? `?${i}` : ""}`);
  },
  /** Get aggregated upsell summary report */
  getUpsellSummary: (e, t, o) => {
    const i = new URLSearchParams();
    e && i.set("startDate", e), t && i.set("endDate", t), o && i.set("topN", o.toString());
    const a = i.toString();
  ...
  createEmailConfiguration: (e) => s("emails", e),
  ...
  toggleEmailConfiguration: (e) => s(`emails/${e}/toggle`),
  /** Preview an email without sending */
  previewEmail: (e) => r(`emails/${e}/preview`),
  /** Send a test email */
  sendTestEmail: (e, t) => s(`emails/${e}/test`, t),
  // ============================================
  // Email Metadata API
  // ============================================
  ...
  createWebhookSubscription: (e) => s("webhooks", e),
  ...
  regenerateWebhookSecret: (e) => s(`webhooks/${e}/regenerate-secret`),
  /** Send a test webhook */
  testWebhookSubscription: (e) => s(`webhooks/${e}/test`),
  /** Ping a webhook URL to test connectivity */
  pingWebhookUrl: (e) => s("webhooks/ping", { url: e }),
  // ============================================
  // Webhook Topics API
  // ============================================
  ...
  getAbandonedCheckoutStats: (e, t) => {
    const o = {};
    e && (o.fromDate = e), t && (o.toDate = t);
    const i = d(o);
    return r(`abandoned-checkouts/stats${i ? `?${i}` : ""}`);
  },
  /** Resend recovery email for an abandoned checkout */
  resendRecoveryEmail: (e) => s(`abandoned-checkouts/${e}/resend-email`),
  /** Regenerate recovery link for an abandoned checkout */
  regenerateRecoveryLink: (e) => s(`abandoned-checkouts/${e}/regenerate-link`),
  // ============================================
  ...
  createFulfilmentProvider: (e) => s("fulfilment-providers", e),
  ...
  testFulfilmentProvider: (e) => s(`fulfilment-providers/${e}/test/connection`),
  /** Submit a test order directly to the fulfilment provider */
  testFulfilmentOrderSubmission: (e, t) => s(`fulfilment-providers/${e}/test/order`, t),
  ...
  simulateFulfilmentWebhook: (e, t) => s(`fulfilment-providers/${e}/test/simulate-webhook`, t),
  ...
  triggerProductSync: (e) => s(`fulfilment-providers/${e}/sync/products`),
  /** Trigger product sync through test endpoint for provider modal */
  testFulfilmentProductSync: (e) => s(`fulfilment-providers/${e}/test/product-sync`),
  /** Trigger an inventory sync for a provider */
  triggerInventorySync: (e) => s(`fulfilment-providers/${e}/sync/inventory`),
  /** Trigger inventory sync through test endpoint for provider modal */
  testFulfilmentInventorySync: (e) => s(`fulfilment-providers/${e}/test/inventory-sync`),
  // ============================================
...
//# sourceMappingURL=merchello-api-COnU_HX2.js.map
