import { html as r, nothing as s, css as f, state as d, customElement as h } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as y } from "@umbraco-cms/backoffice/modal";
import { O as p, a as g } from "./webhooks.types-BbN-5DbD.js";
import { M as v } from "./merchello-api-D-qg1PlO.js";
var _ = Object.defineProperty, b = Object.getOwnPropertyDescriptor, l = (e, a, t, n) => {
  for (var o = n > 1 ? void 0 : n ? b(a, t) : a, u = e.length - 1, c; u >= 0; u--)
    (c = e[u]) && (o = (n ? c(a, t, o) : c(o)) || o);
  return n && o && _(a, t, o), o;
};
let i = class extends y {
  ...
  async _loadDelivery() {
    ...
    const { data: a, error: t } = await v.getDeliveryDetail(e);
  ...
  _formatHeaders(e) {
    ...
    try {
      const a = JSON.parse(e);
      return Object.entries(a).map(([t, n]) => `${t}: ${n}`).join(`
`);
    } catch {
      return e;
    }
  ...
  _renderStatusBadge() {
    if (!this._delivery) return s;
    const e = g(this._delivery.status);
    return r`
  ...
  _renderRequestSection() {
    return !this._delivery?.requestHeaders && !this._delivery?.requestBody ? s : r`
  ...
  _renderResponseSection() {
    return !this._delivery?.responseHeaders && !this._delivery?.responseBody ? s : r`
      <div class="data-section">
        <h4>Response</h4>
  ...
  render() {
    return r`
      <umb-body-layout headline="Delivery Details">
        <div id="main">
          ${this._errorMessage ? r`<div class="error-banner">${this._errorMessage}</div>` : s}
...
//# sourceMappingURL=delivery-detail-modal.element-gH_A3x-B.js.map
