...
import { b as M, a as O } from "./formatting-BoIk_URG.js";
import "./line-item-identity.element-DGDuhyV5.js";
var T = Object.defineProperty, E = Object.getOwnPropertyDescriptor, x = (t) => {
  throw TypeError(t);
}, c = (t, e, i, a) => {
  for (var s = a > 1 ? void 0 : a ? E(e, i) : e, r = t.length - 1, p; r >= 0; r--)
    (p = t[r]) && (s = (a ? p(e, i, s) : p(s)) || s);
  return a && s && T(e, i, s), s;
...
//# sourceMappingURL=fulfillment-modal.element---l_HnOf.js.map
