import { LitElement as G, nothing as o, html as a, css as V, state as n, customElement as j, property as Z, unsafeHTML as ce } from "@umbraco-cms/backoffice/external/lit";
import { d as X, p as pe } from "./purify.es-Cuv6u9x0.js";
import { UmbElementMixin as B } from "@umbraco-cms/backoffice/element-api";
import { UMB_WORKSPACE_CONTEXT as ee } from "@umbraco-cms/backoffice/workspace";
import { UmbModalToken as N, UMB_MODAL_MANAGER_CONTEXT as q, UMB_CONFIRM_MODAL as Y } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as ie } from "@umbraco-cms/backoffice/notification";
import { UMB_CURRENT_USER_CONTEXT as he } from "@umbraco-cms/backoffice/current-user";
import { M as me } from "./edit-order-modal.token-BUHVPYdq.js";
import { M as ve, a as ge } from "./customer-orders-modal.token-BBooCVRJ.js";
import { S as H, b as L, P as K, a as p, h as te, j as fe } from "./formatting-DC2_cf8C.js";
...
const _e = new N("Merchello.Fulfillment.Modal", {
  modal: {
    type: "sidebar",
    size: "large"
  }
}), ye = new N("Merchello.CancelInvoice.Modal", {
  modal: {
    type: "sidebar",
    size: "small"
  }
}), ke = new N("Merchello.ShipmentEdit.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var xe = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, ae = (e) => {
  throw TypeError(e);
}, P = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? $e(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (s ? v(i, t, r) : v(r)) || r);
  return s && r && xe(i, t, r), r;
}, re = (e, i, t) => i.has(e) || ae("Cannot " + t), u = (e, i, t) => (re(e, i, "read from private field"), t ? t.call(e) : i.get(e)), U = (e, i, t) => i.has(e) ? ae("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), T = (e, i, t, s) => (re(e, i, "write to private field"), i.set(e, t), t), S, M, x, y;
let w = class extends B(G) {
  constructor() {
    super(), this._invoiceId = null, this._fulfillmentData = null, this._isLoading = !0, this._errorMessage = null, this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._isUpdatingStatus = !1, U(this, S), U(this, M), U(this, x), U(this, y, !1), this.consumeContext(ee, (e) => {
      T(this, S, e), this.observe(u(this, S).order, (i) => {
  ...
  async _loadShipments() {
    ...
    u(this, y) && (i ? this._errorMessage = i.message : this._fulfillmentData = e ?? null, this._isLoading = !1);
  }
  async _handleEditShipment(e) {
    if (!u(this, M)) return;
    (await u(this, M).open(this, ke, {
      data: { shipment: e }
    }).onSubmit().catch(() => {
    }))?.isUpdated && this._loadShipments();
  }
  async _handleDeleteShipment(e) {
    if (!await u(this, M)?.open(this, Y, {
      data: {
    ...
    const { error: s } = await m.deleteShipment(e.id);
    if (u(this, y)) {
      if (s) {
      ...
      this._loadShipments(), this._invoiceId && u(this, S)?.load(this._invoiceId);
    }
  }
  ...
  async _handleMarkAsShipped(e) {
    ...
    if (u(this, y)) {
      ...
      }), this._expandedShipmentId = null, this._trackingForm = { carrier: "", trackingNumber: "", trackingUrl: "" }, this._loadShipments(), this._invoiceId && u(this, S)?.load(this._invoiceId);
    }
  }
  ...
  async _handleCancelShipment(e) {
    ...
    this._isUpdatingStatus = !0;
    const { error: s } = await m.updateShipmentStatus(e.id, {
      newStatus: H.Cancelled
    });
    if (u(this, y)) {
      if (this._isUpdatingStatus = !1, s) {
        u(this, x)?.peek("danger", {
          data: { headline: "Failed to cancel shipment", message: s.message }
        });
        return;
      }
      u(this, x)?.peek("positive", {
      ...
      (r) => a`
              <div class="item-row">
                ...
                <div class="item-info">
                  ...
                  ${r.sku ? a`<div class="item-sku">${r.sku}</div>` : o}
                </div>
...
w = P([
  j("merchello-shipments-view")
], w);
const we = new N("Merchello.ManualPayment.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
}), Ce = new N("Merchello.Refund.Modal", {
  modal: {
    type: "sidebar",
    size: "medium"
  }
});
var Se = Object.defineProperty, ze = Object.getOwnPropertyDescriptor, se = (e) => {
  throw TypeError(e);
}, O = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? ze(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (s ? v(i, t, r) : v(r)) || r);
  return s && r && Se(i, t, r), r;
}, oe = (e, i, t) => i.has(e) || se("Cannot " + t), E = (e, i, t) => (oe(e, i, "read from private field"), i.get(e)), J = (e, i, t) => i.has(e) ? se("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), W = (e, i, t, s) => (oe(e, i, "write to private field"), i.set(e, t), t), I, A;
let z = class extends B(G) {
  constructor() {
        ...
        <div class="status-summary">
          <div class="status-header">
            <div class="status-badges">
              <span class="status-badge ${e ? te(e.status) : "unpaid"}">
...
z = O([
  j("merchello-payment-panel")
], z);
var Pe = Object.defineProperty, Me = Object.getOwnPropertyDescriptor, ne = (e) => {
  throw TypeError(e);
}, C = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? Me(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (s ? v(i, t, r) : v(r)) || r);
  return s && r && Pe(i, t, r), r;
}, le = (e, i, t) => i.has(e) || ne("Cannot " + t), D = (e, i, t) => (le(e, i, "read from private field"), i.get(e)), Ie = (e, i, t) => i.has(e) ? ne("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), Q = (e, i, t, s) => (le(e, i, "write to private field"), i.set(e, t), t), $;
let _ = class extends B(G) {
  constructor() {
    super(...arguments), this.invoiceId = "", this._providers = [], this._linkInfo = null, this._selectedProvider = "", this._isLoading = !0, this._isGenerating = !1, this._isDeactivating = !1, this._errorMessage = null, this._copySuccess = !1, Ie(this, $, !1);
  }
  connectedCallback() {
    super.connectedCallback(), Q(this, $, !0), this.invoiceId && this._loadData();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Q(this, $, !1);
  }
  updated(e) {
    ...
    return this._linkInfo?.hasActiveLink ? a`
      <div class="active-link">
        ...
        <div class="link-meta">
          ...
          ${this._linkInfo.createdAt ? a`<span>${L(this._linkInfo.createdAt)}</span>` : o}
        </div>
  ...
  _renderPaidStatus() {
    return this._linkInfo?.isPaid ? a`
      <div class="paid-status">
        ...
        ${this._linkInfo.createdAt ? a`<span class="paid-date">${L(this._linkInfo.createdAt)}</span>` : o}
      </div>
    ` : o;
  }
  _renderGenerator() {
...
_ = C([
  j("merchello-payment-link-panel")
], _);
var Ee = Object.defineProperty, De = Object.getOwnPropertyDescriptor, de = (e) => {
  throw TypeError(e);
}, h = (e, i, t, s) => {
  for (var r = s > 1 ? void 0 : s ? De(i, t) : i, d = e.length - 1, v; d >= 0; d--)
    (v = e[d]) && (r = (s ? v(i, t, r) : v(r)) || r);
  return s && r && Ee(i, t, r), r;
}, ue = (e, i, t) => i.has(e) || de("Cannot " + t), l = (e, i, t) => (ue(e, i, "read from private field"), i.get(e)), R = (e, i, t) => i.has(e) ? de("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), F = (e, i, t, s) => (ue(e, i, "write to private field"), i.set(e, t), t), f, g, b, k;
let c = class extends B(G) {
  constructor() {
    super(), this._order = null, this._isLoading = !0, this._routes = [], this._activePath = "", this._newNoteText = "", this._isVisibleToCustomer = !1, this._isPostingNote = !1, this._noteError = null, this._editingSection = null, this._editFormData = {}, this._isSavingAddress = !1, this._validationErrors = {}, this._countries = [], this._isEditingPurchaseOrder = !1, this._purchaseOrderValue = "", this._isSavingPurchaseOrder = !1, R(this, f), R(this, g), R(this, b), R(this, k, !1), this.consumeContext(ee, (e) => {
      F(this, f, e), l(this, f) && this.observe(l(this, f).order, (i) => {
  ...
  connectedCallback() {
    super.connectedCallback(), F(this, k, !0), this._createRoutes();
  }
  _createRoutes() {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), F(this, k, !1);
  }
  ...
  _renderMarkdown(e) {
    ...
    const i = X.parse(e), t = pe.sanitize(i);
    return ce(t);
  }
  _getGoogleMapsUrl(e) {
    if (!e) return "";
      ...
      <div class="card fulfillment-card">
        ...
        <div class="fulfillment-shipping-method">
          ...
          <div class="fulfillment-shipping-details">
            ...
            <span class="fulfillment-shipping-cost">${p(e.shippingCost, t, s)}</span>
          </div>
        </div>
      ...
      (r) => a`
              <div class="fulfillment-line-item">
                ...
                <div class="fulfillment-item-pricing">
                  <span class="fulfillment-item-price">${p(r.amount, t, s)}</span>
                  <span class="fulfillment-item-multiply">×</span>
                  <span class="fulfillment-item-qty">${r.quantity}</span>
                </div>
                <div class="fulfillment-item-total">${p(r.calculatedTotal, t, s)}</div>
              </div>
            `
    )}
        </div>
    ...
    return a`
      <umb-body-layout header-fit-height main-no-padding>
        ...
        <div id="header" slot="header">
          ...
          <span class="badge ${te(e.paymentStatus)}">${e.paymentStatusDisplay}</span>
...
//# sourceMappingURL=order-detail.element-CH9zYXOV.js.map
