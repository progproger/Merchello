...
import { r as re, s as se } from "./navigation-m-G5wLvz.js";
...
import { a as ue } from "./formatting-QYLVqNiR.js";
import { g as de } from "./store-settings-BXLLfekO.js";
      ...
      ${this._formData.segmentType === "Manual" && !this._isNew && this._segment?.id ? s`
        <uui-box headline="Members (${this._segment?.memberCount ?? 0})">
          <merchello-segment-members-table
            ...
            @members-changed=${() => h(this, v)?.reload()}>
          </merchello-segment-members-table>
        </uui-box>
      ` : d}
...
//# sourceMappingURL=segment-detail.element-fsrjEqGg.js.map
