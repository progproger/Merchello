...
import { a as o } from "./bundle.manifests-DpXnf-5Q.js";
import { M as h } from "./merchello-api-Rt7qKkDA.js";
const m = "Merchello.Orders.Workspace";
class _ extends i {
  constructor(t) {
    super(t, d.toString()), this.workspaceAlias = m, this.#r = new a(this), this.#e = new p(void 0), this.order = this.#e.asObservable(), this.#r.setEntityType(o), this.#r.setUnique("orders"), this.routes = new n(t), this.routes.setRoutes([
      // Order detail route (GUID parameter)
      {
        path: "edit/orders/:id",
        component: () => import("./order-detail.element-C2mAry8e.js"),
        setup: (r, e) => {
...
//# sourceMappingURL=orders-workspace.context-DK2g8mMv.js.map
