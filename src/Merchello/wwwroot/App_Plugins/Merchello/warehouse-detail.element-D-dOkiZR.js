import { LitElement as S, html as s, nothing as c, css as x, state as p, customElement as O } from "@umbraco-cms/backoffice/external/lit";
...
import { m as E, y as z, z as w } from "./navigation-Y0bwD8V1.js";
import { b as I } from "./badge.styles-DUcdl6GY.js";
import { a as P } from "./formatting-D5bm7SYx.js";
...
var W = Object.defineProperty, F = Object.getOwnPropertyDescriptor, $ = (e) => {
  ...
  for (var o = d > 1 ? void 0 : d ? F(i, a) : i, b = e.length - 1, _; b >= 0; b--)
    (_ = e[b]) && (o = (d ? _(i, a, o) : _(o)) || o);
  return d && o && W(i, a, o), o;
}, D = (e, i, a) => i.has(e) || $("Cannot " + a), t = (e, i, a) => (D(e, i, "read from private field"), i.get(e)), v = (e, i, a) => i.has(e) ? $("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, a), f = (e, i, a, d) => (D(e, i, "write to private field"), i.set(e, a), a), l, g, h, r;
let n = class extends k(S) {
  constructor() {
    super(), this._warehouse = null, this._isLoading = !0, this._isSaving = !1, this._errorMessage = null, this._routes = [], this._activePath = "", this._formData = {}, this._suppliers = [], this._countries = [], this._shippingOptions = [], this._isDeletingRegion = null, this._isDeletingOption = null, v(this, l), v(this, g), v(this, h), v(this, r, !1), this.consumeContext(R, (e) => {
  ...
  async _openCreateSupplierModal() {
    if (!t(this, g)) return;
    const i = await t(this, g).open(this, M, {
      data: {}
    }).onSubmit().catch(() => {
    });
  ...
  async _handleSave() {
    ...
    try {
      if (e) {
        ...
        if (!t(this, r)) return;
        if (a) {
          this._errorMessage = a.message, t(this, h)?.peek("danger", {
            data: { headline: "Failed to create", message: a.message || "Could not create warehouse" }
          });
          return;
        }
        i && (t(this, l)?.updateWarehouse(i), history.replaceState({}, "", E(i.id)), t(this, h)?.peek("positive", {
        ...
        i && (t(this, l)?.updateWarehouse(i), t(this, h)?.peek("positive", {
  ...
  async _handleDelete() {
    ...
    if (t(this, r)) {
      if (i) {
        this._errorMessage = `Failed to delete warehouse: ${i.message}`, t(this, h)?.peek("danger", {
          data: { headline: "Failed to delete", message: i.message || "Could not delete warehouse" }
        });
        return;
      }
      t(this, h)?.peek("positive", {
  ...
  async _handleDeleteRegion(e, i) {
    ...
    const a = i.regionDisplay || `${i.stateOrProvinceCode || ""} ${i.countryCode}`.trim(), d = t(this, g)?.open(this, y, {
      data: {
    ...
    const { error: o } = await m.deleteServiceRegion(this._warehouse.id, i.id);
    if (t(this, r)) {
      if (this._isDeletingRegion = null, o) {
        this._errorMessage = `Failed to delete region: ${o.message}`, t(this, h)?.peek("danger", {
          data: { headline: "Failed to delete", message: o.message || "Could not delete region" }
        });
        return;
      }
      t(this, h)?.peek("positive", {
  ...
  async _openShippingOptionModal(e) {
    if (!t(this, g) || !this._warehouse?.id) return;
    const a = await t(this, g).open(this, N, {
      data: {
        optionId: e?.id,
        warehouseId: this._warehouse.id
      }
  ...
  async _handleDeleteOption(e, i) {
    ...
    const { error: d } = await m.deleteShippingOption(i.id);
    if (t(this, r)) {
      if (this._isDeletingOption = null, d) {
        this._errorMessage = `Failed to delete option: ${d.message}`, t(this, h)?.peek("danger", {
  ...
  _renderOptionRow(e) {
    const i = this._isDeletingOption === e.id, a = e.usesLiveRates, d = e.isNextDay ? "Next Day" : e.daysFrom === e.daysTo ? `${e.daysFrom} days` : `${e.daysFrom}-${e.daysTo} days`;
    let o;
...
//# sourceMappingURL=warehouse-detail.element-D-dOkiZR.js.map
