...
import { M as l } from "./merchello-api-BW8jq3Oc.js";
class u extends i {
  constructor(e) {
    super(e, o.toString()), this.workspaceAlias = "Merchello.Order.Detail.Workspace", this.#e = new d(void 0), this.order = this.#e.asObservable(), this.routes = new a(e), this.provideContext(o, this), this.routes.setRoutes([
      {
        path: "edit/:id",
        component: () => import("./order-detail.element-CdFgY_O_.js"),
        setup: (t, r) => {
...
//# sourceMappingURL=order-detail-workspace.context-D6LJqfRd.js.map
