...
import { g as k } from "./store-settings-Biy0PIJu.js";
import "./pagination.element-sDi4Myhy.js";
import "./merchello-empty-state.element-mt97UoA5.js";
import "./order-table.element-DvhqOBdF.js";
import { M as w } from "./edit-order-modal.token-BUHVPYdq.js";
import { n as z, a as D } from "./navigation-COkStlQk.js";
import { a as E } from "./formatting-CeWY__1B.js";
...
var A = Object.defineProperty, P = Object.getOwnPropertyDescriptor, f = (e) => {
  ...
  for (var u = l > 1 ? void 0 : l ? P(t, i) : t, _ = e.length - 1, g; _ >= 0; _--)
    (g = e[_]) && (u = (l ? g(t, i, u) : g(u)) || u);
  return l && u && A(t, i, u), u;
}, y = (e, t, i) => t.has(e) || f("Cannot " + i), s = (e, t, i) => (y(e, t, "read from private field"), t.get(e)), v = (e, t, i) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), p = (e, t, i, l) => (y(e, t, "write to private field"), t.set(e, i), i), d, h, n;
let a = class extends C(x) {
  ...
  async _initializeAndLoad() {
    const e = await k();
    s(this, n) && (this._pageSize = e.defaultPaginationPageSize, this._loadOrders(), this._loadStats());
  }
  ...
  async _loadOrders() {
    ...
    const { data: t, error: i } = await m.getOrders(e);
    if (s(this, n)) {
      if (i) {
  ...
  async _loadStats() {
    const { data: e } = await m.getOrderStats();
    s(this, n) && e && (this._stats = e);
  }
  _handleTabClick(e) {
  ...
  async _handleDeleteSelected() {
    ...
    if (!s(this, n)) return;
    this._isDeleting = !0;
    const i = Array.from(this._selectedOrders), { error: l } = await m.deleteOrders(i);
    if (s(this, n)) {
  ...
  async _handleCreateOrder() {
    ...
    if (s(this, n) && t?.isCreated && t.invoiceId)
...
//# sourceMappingURL=orders-list.element-CJs31n8O.js.map
