import { nothing as g, html as l, css as v, state as o, customElement as f } from "@umbraco-cms/backoffice/external/lit";
...
import { b as m, g as S } from "./store-settings-BPUUVKYl.js";
var x = Object.defineProperty, w = Object.getOwnPropertyDescriptor, _ = (t) => {
  throw TypeError(t);
}, r = (t, e, a, c) => {
  for (var u = c > 1 ? void 0 : c ? w(e, a) : e, h = t.length - 1, p; h >= 0; h--)
    (p = t[h]) && (u = (c ? p(e, a, u) : p(u)) || u);
  return c && u && x(e, a, u), u;
}, y = (t, e, a) => e.has(t) || _("Cannot " + a), n = (t, e, a) => (y(t, e, "read from private field"), e.get(t)), T = (t, e, a) => e.has(t) ? _("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), $ = (t, e, a, c) => (y(t, e, "write to private field"), e.set(t, a), a), s;
let i = class extends b {
  constructor() {
    super(), this._isSaving = !1, this._isLoadingCountries = !0, this._countryCode = "", this._pattern = "", this._matchType = "Prefix", this._action = "Block", this._surcharge = 0, this._currencySymbol = m(), this._description = "", this._countries = [], T(this, s), this.consumeContext(C, (t) => {
      $(this, s, t);
    });
  }
  connectedCallback() {
    super.connectedCallback(), this._loadCurrencySymbol(), this._loadCountries(), this.data?.rule && (this._countryCode = this.data.rule.countryCode, this._pattern = this.data.rule.pattern, this._matchType = this.data.rule.matchType, this._action = this.data.rule.action, this._surcharge = this.data.rule.surcharge, this._description = this.data.rule.description ?? "");
  }
  async _loadCurrencySymbol() {
    try {
      await S(), this._currencySymbol = m();
    } catch {
      this._currencySymbol = m();
    }
  }
      ...
      <umb-body-layout headline="${t ? "Edit" : "Add"} Postcode Rule">
        ...
        <div slot="actions">
          ...
          <uui-button
            ...
            @click=${this._save}
          >
            ${this._isSaving ? l`<uui-loader-circle></uui-loader-circle>` : g}
...
i = r([
  f("merchello-shipping-postcode-rule-modal")
], i);
const O = i;
export {
...
//# sourceMappingURL=shipping-postcode-rule-modal.element-Br3VqGw7.js.map
