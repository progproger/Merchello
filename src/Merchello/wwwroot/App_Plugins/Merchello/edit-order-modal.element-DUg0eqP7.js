import { html as n, nothing as p, css as D, state as l, customElement as T } from "@umbraco-cms/backoffice/external/lit";
...
var q = Object.defineProperty, N = Object.getOwnPropertyDescriptor, S = (e) => {
  throw TypeError(e);
}, c = (e, i, s, t) => {
  for (var o = t > 1 ? void 0 : t ? N(i, s) : i, r = e.length - 1, g; r >= 0; r--)
    (g = e[r]) && (o = (t ? g(i, s, o) : g(o)) || o);
  return t && o && q(i, s, o), o;
}, I = (e, i, s) => i.has(e) || S("Cannot " + s), v = (e, i, s) => (I(e, i, "read from private field"), i.get(e)), x = (e, i, s) => i.has(e) ? S("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, s), $ = (e, i, s, t) => (I(e, i, "write to private field"), i.set(e, s), s), h, _;
let d = class extends z {
  ...
  async _openProductPickerModal() {
    if (!v(this, h) || !this._invoice) return;
    const e = this._lineItems.filter((o) => o.productId && !o.isRemoved).map((o) => o.productId), i = this._pendingProducts.map((o) => o.productId), t = await v(this, h).open(this, M, {
      data: {
        config: {
          currencySymbol: this._invoice.currencySymbol,
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, s = this._subtotalBeforeDiscounts, t = this._discountTotal, o = this._adjustedSubtotal, r = this._newTax, g = this._newTotal, f = this._hasChanges(), m = this._lineItems.filter((u) => u.isRemoved), C = t > 0;
    return n`
...
//# sourceMappingURL=edit-order-modal.element-DUg0eqP7.js.map
