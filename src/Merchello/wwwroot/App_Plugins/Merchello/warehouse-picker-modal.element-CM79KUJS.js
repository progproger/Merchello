import { html as o, css as _, state as u, customElement as g } from "@umbraco-cms/backoffice/external/lit";
...
var y = Object.defineProperty, C = Object.getOwnPropertyDescriptor, p = (t) => {
  throw TypeError(t);
}, l = (t, e, s, a) => {
  for (var r = a > 1 ? void 0 : a ? C(e, s) : e, c = t.length - 1, d; c >= 0; c--)
    (d = t[c]) && (r = (a ? d(e, s, r) : d(r)) || r);
  return a && r && y(e, s, r), r;
}, m = (t, e, s) => e.has(t) || p("Cannot " + s), w = (t, e, s) => (m(t, e, "read from private field"), e.get(t)), S = (t, e, s) => e.has(t) ? p("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), h = (t, e, s, a) => (m(t, e, "write to private field"), e.set(t, s), s), n;
let i = class extends b {
  constructor() {
    super(...arguments), this._selectedIds = [], this._warehouses = [], this._isLoading = !0, this._errorMessage = null, this._searchTerm = "", S(this, n, !1);
  }
  connectedCallback() {
  ...
  async _loadWarehouses() {
    ...
    const { data: t, error: e } = await f.getWarehousesList();
    if (!w(this, n)) return;
    if (e) {
  ...
  _renderContent() {
    return this._isLoading ? o`<div class="loading"><uui-loader></uui-loader></div>` : this._errorMessage ? o`
      ...
      ` : this._warehouses.length === 0 ? o`<p class="empty-state">No warehouses available.</p>` : this._filteredWarehouses.length === 0 ? o`<p class="empty-state">No warehouses match your search.</p>` : o`
      <umb-table
...
//# sourceMappingURL=warehouse-picker-modal.element-CM79KUJS.js.map
