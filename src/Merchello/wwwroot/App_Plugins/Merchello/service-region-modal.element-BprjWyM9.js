import { nothing as g, html as a, css as h, state as n, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalBaseElement as p } from "@umbraco-cms/backoffice/modal";
import { M as d } from "./merchello-api-DuHTSXU5.js";
import { b as m } from "./badge.styles-C_lNgH9O.js";
var _ = Object.defineProperty, f = Object.getOwnPropertyDescriptor, r = (e, i, o, t) => {
  for (var c = t > 1 ? void 0 : t ? f(i, o) : i, l = e.length - 1, u; l >= 0; l--)
    (u = e[l]) && (c = (t ? u(i, o, c) : u(c)) || c);
  return t && c && _(i, o, c), c;
};
let s = class extends p {
  constructor() {
    super(...arguments), this._countryCode = "", this._stateOrProvinceCode = "", this._isExcluded = !1, this._countries = [], this._regions = [], this._isLoadingRegions = !1, this._isSaving = !1, this._errors = {};
  }
  connectedCallback() {
    super.connectedCallback(), this._loadCountries(), this.data?.region && (this._countryCode = this.data.region.countryCode, this._stateOrProvinceCode = this.data.region.stateOrProvinceCode || "", this._isExcluded = this.data.region.isExcluded, this._countryCode && this._loadRegions(this._countryCode));
  }
  ...
  _handleCountryChange(e) {
    ...
    this._countryCode = i, this._stateOrProvinceCode = "", i ? this._loadRegions(i) : this._regions = [];
  }
  _handleStateChange(e) {
    this._stateOrProvinceCode = e.target.value;
  }
  _validate() {
    const e = {};
    return this._countryCode || (e.country = "Please select a country"), (this.data?.existingRegions ?? []).some(
      (t) => t.countryCode === this._countryCode && (t.stateOrProvinceCode || "") === (this._stateOrProvinceCode || "") && t.id !== this.data?.region?.id
    ...
    return a`
      <umb-body-layout headline="${i}">
        <div id="main">
          ...
          ${this._errors.general ? a`
                <div class="error-banner">
                  <uui-icon name="icon-alert"></uui-icon>
                  <span>${this._errors.general}</span>
                </div>
              ` : g}
          ${this._errors.duplicate ? a`
                <div class="error-banner">
                  <uui-icon name="icon-alert"></uui-icon>
          ...
          <div class="form-section">
            <div class="form-row">
              ...
              ${this._errors.country ? a`<span class="field-error">${this._errors.country}</span>` : g}
            </div>
            ...
            <div class="form-row">
              ...
              ${this._regions.length === 0 && this._countryCode && !this._isLoadingRegions ? a`<span class="hint">No subdivisions available — rule applies to entire country</span>` : a`<span class="hint">Leave as "All regions" to apply to entire country</span>`}
            </div>
          </div>
...
r([
  n()
], s.prototype, "_countryCode", 2);
r([
  n()
], s.prototype, "_stateOrProvinceCode", 2);
r([
  n()
], s.prototype, "_isExcluded", 2);
r([
  n()
], s.prototype, "_countries", 2);
r([
  n()
], s.prototype, "_regions", 2);
r([
  n()
], s.prototype, "_isLoadingRegions", 2);
r([
  n()
...
s = r([
  v("merchello-service-region-modal")
], s);
const S = s;
export {
  s as MerchelloServiceRegionModalElement,
  S as default
};
//# sourceMappingURL=service-region-modal.element-BprjWyM9.js.map
