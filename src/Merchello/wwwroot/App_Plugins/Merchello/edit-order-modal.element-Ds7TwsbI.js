import { html as r, nothing as l, css as D, state as d, customElement as O } from "@umbraco-cms/backoffice/external/lit";
import { UmbModalToken as z, UmbModalBaseElement as I, UMB_MODAL_MANAGER_CONTEXT as C } from "@umbraco-cms/backoffice/modal";
import { UMB_NOTIFICATION_CONTEXT as R } from "@umbraco-cms/backoffice/notification";
import { M as f } from "./merchello-api-BSrPLgGs.js";
import { D as h } from "./order.types-B45a7FtJ.js";
import { M, a as L } from "./product-picker-modal.token-9wv1TYI8.js";
const b = new z("Merchello.AddDiscount.Modal", {
  modal: {
    type: "dialog",
    size: "small"
  }
...
var q = Object.defineProperty, A = Object.getOwnPropertyDescriptor, $ = (e) => {
  ...
  for (var s = t > 1 ? void 0 : t ? A(i, o) : i, n = e.length - 1, m; n >= 0; n--)
    (m = e[n]) && (s = (t ? m(i, o, s) : m(s)) || s);
  return t && s && q(i, o, s), s;
}, k = (e, i, o) => i.has(e) || $("Cannot " + o), v = (e, i, o) => (k(e, i, "read from private field"), i.get(e)), x = (e, i, o) => i.has(e) ? $("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, o), w = (e, i, o, t) => (k(e, i, "write to private field"), i.set(e, o), o), p, g;
let a = class extends I {
  ...
  async _openLineItemDiscountModal(e) {
    if (!v(this, p) || !this._invoice) return;
    const i = this._lineItems.find((s) => s.id === e);
    if (!i) return;
    const t = await v(this, p).open(this, b, {
      data: {
  ...
  async _openAddDiscountModal() {
    if (!v(this, p) || !this._invoice) return;
    const i = await v(this, p).open(this, b, {
      data: {
        currencySymbol: this._invoice.currencySymbol,
        isOrderDiscount: !0
      }
  ...
  async _openAddCustomItemModal() {
    if (!v(this, p) || !this._invoice) return;
    const i = await v(this, p).open(this, M, {
      data: {
        currencySymbol: this._invoice.currencySymbol,
  ...
  async _openProductPickerModal() {
    if (!v(this, p) || !this._invoice) return;
    const e = this._lineItems.filter((s) => s.productId && !s.isRemoved).map((s) => s.productId), i = this._pendingProducts.map((s) => s.productId), t = await v(this, p).open(this, L, {
      data: {
        config: {
          currencySymbol: this._invoice.currencySymbol,
  ...
  _renderLineItem(e) {
    ...
    const i = this._invoice?.currencySymbol ?? "£", o = e.discount !== null, t = e.newQuantity < e.quantity, s = e.newQuantity > e.quantity, n = e.newQuantity - e.quantity, m = s && e.isStockTracked && e.availableStock !== null && e.availableStock < n, y = !e.hadOriginalDiscount || o;
    return r`
      <div class="line-item ${m ? "has-error" : ""}">
        <div class="line-item-product">
          ...
          <div class="line-item-details">
            ...
            ${e.isStockTracked && e.availableStock !== null ? r`
              <div class="stock-info ${m ? "error" : ""}">
                ${m ? r`<uui-icon name="icon-alert"></uui-icon> Only ${e.availableStock} available` : r`${e.availableStock} in stock`}
              </div>
            ` : l}
          </div>
        </div>
  ...
  render() {
    ...
    const e = this._invoice.currencySymbol, i = this._invoice.currencyCode, o = this._subtotalBeforeDiscounts, t = this._discountTotal, s = this._adjustedSubtotal, n = this._newTax, m = this._newTotal, y = this._hasChanges(), _ = this._lineItems.filter((u) => u.isRemoved), S = t > 0;
    return r`
...
//# sourceMappingURL=edit-order-modal.element-Ds7TwsbI.js.map
