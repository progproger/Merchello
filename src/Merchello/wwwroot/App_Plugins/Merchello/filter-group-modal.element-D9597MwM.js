...
var g = Object.defineProperty, v = Object.getOwnPropertyDescriptor, n = (r, e, t, a) => {
  for (var i = a > 1 ? void 0 : a ? v(e, t) : e, l = r.length - 1, o; l >= 0; l--)
    (o = r[l]) && (i = (a ? o(e, t, i) : o(i)) || i);
...
let s = class extends _ {
  ...
  async _handleSave(r) {
    ...
    if (this._isEditMode) {
      const i = this.data?.filterGroup?.id;
      if (!i) {
        this._errors = { general: "Filter group ID is missing" }, this._isSaving = !1;
        return;
      }
      const { data: l, error: o } = await c.updateFilterGroup(i, {
        name: e
      });
    ...
    const { data: t, error: a } = await c.createFilterGroup({
      name: e
    });
    ...
    this.value = { filterGroup: t, isCreated: !0 }, this.modalContext?.submit();
  }
  _handleCancel() {
    this.modalContext?.reject();
  }
  render() {
    const r = this._isEditMode ? "Edit Filter Group" : "Add Filter Group", e = this._isEditMode ? "Save Changes" : "Create Filter Group", t = this._isSaving ? "Saving..." : e;
    return u`
...
//# sourceMappingURL=filter-group-modal.element-D9597MwM.js.map
