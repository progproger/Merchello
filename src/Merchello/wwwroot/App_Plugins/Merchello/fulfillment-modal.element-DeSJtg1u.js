...
import { b as M } from "./formatting-DGOWmvpU.js";
import "./line-item-identity.element-DTtPHFdM.js";
var O = Object.defineProperty, T = Object.getOwnPropertyDescriptor, x = (t) => {
  throw TypeError(t);
}, c = (t, e, i, r) => {
  for (var s = r > 1 ? void 0 : r ? T(e, i) : e, a = t.length - 1, p; a >= 0; a--)
    (p = t[a]) && (s = (r ? p(e, i, s) : p(s)) || s);
  return r && s && O(e, i, s), s;
}, k = (t, e, i) => e.has(t) || x("Cannot " + i), g = (t, e, i) => (k(t, e, "read from private field"), e.get(t)), b = (t, e, i) => e.has(t) ? x("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), _ = (t, e, i, r) => (k(t, e, "write to private field"), e.set(t, i), i), m, f;
let l = class extends $ {
  constructor() {
  ...
  async _createAllShipments() {
    ...
    for (const r of t) {
      ...
      }, { error: n } = await y.createShipment(r.orderId, u);
  ...
  _renderShipmentCard(t) {
    ...
    const i = this._expandedOrders.has(t.orderId), r = this._orderTrackingInfo.get(t.orderId), s = this._selectedItems.get(t.orderId) ?? /* @__PURE__ */ new Map(), a = this._getSelectedCount(t.orderId), p = this._getTotalSelectedQuantity(t.orderId), u = e.reduce((n, v) => n + v.remainingQuantity, 0);
    return o`
...
//# sourceMappingURL=fulfillment-modal.element-DeSJtg1u.js.map
