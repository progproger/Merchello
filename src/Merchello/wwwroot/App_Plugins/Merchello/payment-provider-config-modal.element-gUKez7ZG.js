import { nothing as r, html as a, css as b, state as n, customElement as f } from "@umbraco-cms/backoffice/external/lit";
...
var $ = Object.defineProperty, k = Object.getOwnPropertyDescriptor, _ = (e) => {
  ...
  for (var l = d > 1 ? void 0 : d ? k(s, i) : s, c = e.length - 1, p; c >= 0; c--)
    (p = e[c]) && (l = (d ? p(s, i, l) : p(l)) || l);
  return d && l && $(s, i, l), l;
}, m = (e, s, i) => s.has(e) || _("Cannot " + i), h = (e, s, i) => (m(e, s, "read from private field"), s.get(e)), x = (e, s, i) => s.has(e) ? _("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(e) : s.set(e, i), g = (e, s, i, d) => (m(e, s, "write to private field"), s.set(e, i), i), u;
let t = class extends y {
  ...
  async _loadFields() {
    ...
    for (const c of this._fields)
      this._values[c.key] = l[c.key] ?? c.defaultValue ?? "";
    this._isLoading = !1;
  }
...
//# sourceMappingURL=payment-provider-config-modal.element-gUKez7ZG.js.map
