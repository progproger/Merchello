...
import type { UpdateShipmentRequest } from "../types.js";
...
> {
  ...
  private async _handleSave(): Promise<void> {
    ...
    try {
      ...
      this._error = e instanceof Error ? e.message : "Failed to update shipment";
    } finally {
      this._saving = false;
    }
  }
    ...
    return html`
      <umb-body-layout headline="Edit Shipment">
        <div id="main">
          <div class="shipment-summary">
            <div class="summary-row">
              ...
              <span>${this._formatDate(shipment.dateCreated)}</span>
            </div>
            <div class="summary-row">
          ...
          ${this._error
            ? html`<div class="error-message"><uui-icon name="icon-alert"></uui-icon> ${this._error}</div>`
            : ""}
        ...
        <div slot="actions">
          ...
          >
            ${this._saving ? html`<uui-loader-circle></uui-loader-circle>` : "Save Changes"}
          </uui-button>
        </div>
      </umb-body-layout>
    `;
