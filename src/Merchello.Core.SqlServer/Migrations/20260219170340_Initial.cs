        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTaxEstimated = table.Column<bool>(type: "bit", nullable: false),
                    TaxEstimationReason = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UcpJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EligibilityRulesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DisplayStylesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductOptions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ShoppingFeedBrand = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ShoppingFeedCondition = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "new"),
                    RootImages = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ElementTypeAlias = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ShoppingFeedTitle = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ShoppingFeedDescription = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ...
                    ShoppingFeedBrand = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    ShoppingFeedCondition = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostcodeRulesJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrackStock = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
