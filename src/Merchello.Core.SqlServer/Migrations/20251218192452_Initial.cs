        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyTriggerType = table.Column<int>(type: "int", nullable: false),
                    BuyTriggerValue = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    BuyTargetType = table.Column<int>(type: "int", nullable: false),
                    BuyTargetIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GetQuantity = table.Column<int>(type: "int", nullable: false),
                    GetTargetType = table.Column<int>(type: "int", nullable: false),
                    GetTargetIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GetValueType = table.Column<int>(type: "int", nullable: false),
                    GetValue = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    SelectionMethod = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiscountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EligibilityType = table.Column<int>(type: "int", nullable: false),
                    EligibilityIds = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DiscountId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CountryScope = table.Column<int>(type: "int", nullable: false),
                    CountryCodes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExcludeRatesOverAmount = table.Column<bool>(type: "bit", nullable: false),
                    ExcludeRatesOverValue = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    AllowedShippingOptionIds = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountAmountInStoreCurrency = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    CurrencyCode = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_merchelloDiscountUsages_CustomerId",
                table: "merchelloDiscountUsages",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_merchelloDiscountUsages_DateUsed",
                table: "merchelloDiscountUsages",
                column: "DateUsed");
