...
public class PaymentResult
{
    ...
    /// <summary>
    /// Action required to complete the payment (e.g., 3DS challenge, redirect).
    /// Only set when Status is RequiresAction.
    /// </summary>
    public PaymentActionRequired? ActionRequired { get; init; }
